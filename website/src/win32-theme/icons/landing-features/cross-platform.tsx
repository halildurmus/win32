...
export const CrossPlatformIcon = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <rect
      ...
      x={0.5}
      y={0.5}
      stroke="url(#cross-platform-b)"
      strokeOpacity={0.5}
      rx={15.5}
    />
    <symbol id="cross-platform-icon" viewBox="0 0 16 16">
      <PiDevicesLight />
    </symbol>
    <use href="#cross-platform-icon" x={16} y={16} width={32} height={32} />
    <defs>
      <radialGradient
        id="cross-platform-a"
        cx={0}
