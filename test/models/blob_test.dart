...
void main() {
  group('UncompressedData', () {
    ...
    test('Conversion test 6', () {
      const compressed = [0xC0, 0x00, 0x40, 0x00];
      final uncompressed = UncompressedData.fromBlob(compressed);
    ...
    test('Conversion test 7', () {
      const compressed = [0xDF, 0xFF, 0xFF, 0xFF];
      final uncompressed = UncompressedData.fromBlob(compressed);
