...
void main() {
  ...
  group('Test spoolss functions', () {
    ...
    test('Can instantiate DeletePrinter', () {
      final spoolss = DynamicLibrary.open('spoolss.dll');
      final DeletePrinter = spoolss.lookupFunction<
          Int32 Function(IntPtr hPrinter),
    ...
    test('Can instantiate EndDocPrinter', () {
      final spoolss = DynamicLibrary.open('spoolss.dll');
      final EndDocPrinter = spoolss.lookupFunction<
          Int32 Function(IntPtr hPrinter),
    ...
    test('Can instantiate EndPagePrinter', () {
      final spoolss = DynamicLibrary.open('spoolss.dll');
      final EndPagePrinter = spoolss.lookupFunction<
          Int32 Function(IntPtr hPrinter),
    ...
    test('Can instantiate FindClosePrinterChangeNotification', () {
      final spoolss = DynamicLibrary.open('spoolss.dll');
      final FindClosePrinterChangeNotification = spoolss.lookupFunction<
    ...
    test('Can instantiate ReadPrinter', () {
      final spoolss = DynamicLibrary.open('spoolss.dll');
      final ReadPrinter = spoolss.lookupFunction<
    ...
    test('Can instantiate ReportJobProcessingProgress', () {
      final spoolss = DynamicLibrary.open('spoolss.dll');
      final ReportJobProcessingProgress = spoolss.lookupFunction<
          Int32 Function(IntPtr printerHandle, Uint32 jobId,
              Uint32 jobOperation, Uint32 jobProgress),
    ...
    test('Can instantiate ScheduleJob', () {
      final spoolss = DynamicLibrary.open('spoolss.dll');
      final ScheduleJob = spoolss.lookupFunction<
    ...
    test('Can instantiate StartPagePrinter', () {
      final spoolss = DynamicLibrary.open('spoolss.dll');
      final StartPagePrinter = spoolss.lookupFunction<
          Int32 Function(IntPtr hPrinter),
    ...
    test('Can instantiate WritePrinter', () {
      final spoolss = DynamicLibrary.open('spoolss.dll');
      final WritePrinter = spoolss.lookupFunction<
          Int32 Function(IntPtr hPrinter, Pointer pBuf, Uint32 cbBuf,
  ...
  group('Test user32 functions', () {
    ...
    if (windowsBuildNumber >= 9200) {
      test('Can instantiate GetDisplayAutoRotationPreferences', () {
        ...
        final GetDisplayAutoRotationPreferences = user32.lookupFunction<
                ...
                int Function(Pointer<Uint32> pOrientation)>(
    ...
    test('Can instantiate GetScrollBarInfo', () {
      ...
      final GetScrollBarInfo = user32.lookupFunction<
          Int32 Function(
              IntPtr hwnd, Uint32 idObject, Pointer<SCROLLBARINFO> psbi),
  ...
  group('Test wlanapi functions', () {
    test('Can instantiate WlanAllocateMemory', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanAllocateMemory = wlanapi.lookupFunction<
          Pointer Function(Uint32 dwMemorySize),
          Pointer Function(int dwMemorySize)>('WlanAllocateMemory');
      expect(WlanAllocateMemory, isA<Function>());
    });
    test('Can instantiate WlanCloseHandle', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanCloseHandle = wlanapi.lookupFunction<
          Uint32 Function(IntPtr hClientHandle, Pointer pReserved),
          int Function(
              int hClientHandle, Pointer pReserved)>('WlanCloseHandle');
      expect(WlanCloseHandle, isA<Function>());
    });
    test('Can instantiate WlanConnect', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanConnect = wlanapi.lookupFunction<
          Uint32 Function(
      ...
      expect(WlanConnect, isA<Function>());
    });
    test('Can instantiate WlanDeleteProfile', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanDeleteProfile = wlanapi.lookupFunction<
          ...
          int Function(
              ...
              Pointer pReserved)>('WlanDeleteProfile');
      expect(WlanDeleteProfile, isA<Function>());
    });
    test('Can instantiate WlanDeviceServiceCommand', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanDeviceServiceCommand = wlanapi.lookupFunction<
          Uint32 Function(
              IntPtr hClientHandle,
              Pointer<GUID> pInterfaceGuid,
      ...
      expect(WlanDeviceServiceCommand, isA<Function>());
    });
    test('Can instantiate WlanDisconnect', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanDisconnect = wlanapi.lookupFunction<
          Uint32 Function(IntPtr hClientHandle, Pointer<GUID> pInterfaceGuid,
              Pointer pReserved),
          int Function(int hClientHandle, Pointer<GUID> pInterfaceGuid,
              Pointer pReserved)>('WlanDisconnect');
      expect(WlanDisconnect, isA<Function>());
    });
    test('Can instantiate WlanEnumInterfaces', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanEnumInterfaces = wlanapi.lookupFunction<
              Uint32 Function(IntPtr hClientHandle, Pointer pReserved,
                  Pointer<Pointer<WLAN_INTERFACE_INFO_LIST>> ppInterfaceList),
              int Function(int hClientHandle, Pointer pReserved,
                  Pointer<Pointer<WLAN_INTERFACE_INFO_LIST>> ppInterfaceList)>(
          'WlanEnumInterfaces');
      expect(WlanEnumInterfaces, isA<Function>());
    });
    test('Can instantiate WlanExtractPsdIEDataList', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanExtractPsdIEDataList = wlanapi.lookupFunction<
              Uint32 Function(
                  IntPtr hClientHandle,
                  Uint32 dwIeDataSize,
      ...
      expect(WlanExtractPsdIEDataList, isA<Function>());
    });
    test('Can instantiate WlanFreeMemory', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanFreeMemory = wlanapi.lookupFunction<
          Void Function(Pointer pMemory),
          void Function(Pointer pMemory)>('WlanFreeMemory');
      expect(WlanFreeMemory, isA<Function>());
    });
    test('Can instantiate WlanGetAvailableNetworkList', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanGetAvailableNetworkList = wlanapi.lookupFunction<
          Uint32 Function(
              IntPtr hClientHandle,
              Pointer<GUID> pInterfaceGuid,
              Uint32 dwFlags,
      ...
      expect(WlanGetAvailableNetworkList, isA<Function>());
    });
    test('Can instantiate WlanGetFilterList', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanGetFilterList = wlanapi.lookupFunction<
              Uint32 Function(
                  IntPtr hClientHandle,
                  Uint32 wlanFilterListType,
                  Pointer pReserved,
              ...
              int Function(
                  ...
                  Pointer<Pointer<DOT11_NETWORK_LIST>> ppNetworkList)>(
          'WlanGetFilterList');
      expect(WlanGetFilterList, isA<Function>());
    });
    test('Can instantiate WlanGetInterfaceCapability', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanGetInterfaceCapability = wlanapi.lookupFunction<
              Uint32 Function(
                  IntPtr hClientHandle,
                  Pointer<GUID> pInterfaceGuid,
                  Pointer pReserved,
      ...
      expect(WlanGetInterfaceCapability, isA<Function>());
    });
    test('Can instantiate WlanGetNetworkBssList', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanGetNetworkBssList = wlanapi.lookupFunction<
              Uint32 Function(
                  IntPtr hClientHandle,
                  Pointer<GUID> pInterfaceGuid,
      ...
      expect(WlanGetNetworkBssList, isA<Function>());
    });
    test('Can instantiate WlanGetProfile', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanGetProfile = wlanapi.lookupFunction<
          Uint32 Function(
              IntPtr hClientHandle,
              Pointer<GUID> pInterfaceGuid,
              Pointer<Utf16> strProfileName,
      ...
      expect(WlanGetProfile, isA<Function>());
    });
    test('Can instantiate WlanGetProfileCustomUserData', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanGetProfileCustomUserData = wlanapi.lookupFunction<
          Uint32 Function(
              IntPtr hClientHandle,
              Pointer<GUID> pInterfaceGuid,
              Pointer<Utf16> strProfileName,
      ...
      expect(WlanGetProfileCustomUserData, isA<Function>());
    });
    test('Can instantiate WlanGetProfileList', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanGetProfileList = wlanapi.lookupFunction<
              Uint32 Function(
                  IntPtr hClientHandle,
                  Pointer<GUID> pInterfaceGuid,
                  Pointer pReserved,
              ...
              int Function(
                  ...
                  Pointer<Pointer<WLAN_PROFILE_INFO_LIST>> ppProfileList)>(
          'WlanGetProfileList');
      expect(WlanGetProfileList, isA<Function>());
    });
    test('Can instantiate WlanGetSecuritySettings', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanGetSecuritySettings = wlanapi.lookupFunction<
          Uint32 Function(
              IntPtr hClientHandle,
      ...
      expect(WlanGetSecuritySettings, isA<Function>());
    });
    test('Can instantiate WlanGetSupportedDeviceServices', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanGetSupportedDeviceServices = wlanapi.lookupFunction<
          Uint32 Function(IntPtr hClientHandle, Pointer<GUID> pInterfaceGuid,
          ...
          int Function(
              ...
              Pointer<Pointer<WLAN_DEVICE_SERVICE_GUID_LIST>>
                  ppDevSvcGuidList)>('WlanGetSupportedDeviceServices');
      expect(WlanGetSupportedDeviceServices, isA<Function>());
    });
    test('Can instantiate WlanHostedNetworkForceStart', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanHostedNetworkForceStart = wlanapi.lookupFunction<
          Uint32 Function(IntPtr hClientHandle, Pointer<Uint32> pFailReason,
              Pointer pvReserved),
          int Function(int hClientHandle, Pointer<Uint32> pFailReason,
              Pointer pvReserved)>('WlanHostedNetworkForceStart');
      expect(WlanHostedNetworkForceStart, isA<Function>());
    });
    test('Can instantiate WlanHostedNetworkForceStop', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanHostedNetworkForceStop = wlanapi.lookupFunction<
          Uint32 Function(IntPtr hClientHandle, Pointer<Uint32> pFailReason,
              Pointer pvReserved),
          int Function(int hClientHandle, Pointer<Uint32> pFailReason,
              Pointer pvReserved)>('WlanHostedNetworkForceStop');
      expect(WlanHostedNetworkForceStop, isA<Function>());
    });
    test('Can instantiate WlanHostedNetworkInitSettings', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanHostedNetworkInitSettings = wlanapi.lookupFunction<
          Uint32 Function(IntPtr hClientHandle, Pointer<Uint32> pFailReason,
              Pointer pvReserved),
          int Function(int hClientHandle, Pointer<Uint32> pFailReason,
              Pointer pvReserved)>('WlanHostedNetworkInitSettings');
      expect(WlanHostedNetworkInitSettings, isA<Function>());
    });
    test('Can instantiate WlanHostedNetworkQueryProperty', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanHostedNetworkQueryProperty = wlanapi.lookupFunction<
          Uint32 Function(
              IntPtr hClientHandle,
              Uint32 OpCode,
              Pointer<Uint32> pdwDataSize,
      ...
      expect(WlanHostedNetworkQueryProperty, isA<Function>());
    });
    test('Can instantiate WlanHostedNetworkQuerySecondaryKey', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanHostedNetworkQuerySecondaryKey = wlanapi.lookupFunction<
          Uint32 Function(
              IntPtr hClientHandle,
      ...
      expect(WlanHostedNetworkQuerySecondaryKey, isA<Function>());
    });
    test('Can instantiate WlanHostedNetworkQueryStatus', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanHostedNetworkQueryStatus = wlanapi.lookupFunction<
          Uint32 Function(
              IntPtr hClientHandle,
      ...
      expect(WlanHostedNetworkQueryStatus, isA<Function>());
    });
    test('Can instantiate WlanHostedNetworkRefreshSecuritySettings', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanHostedNetworkRefreshSecuritySettings = wlanapi.lookupFunction<
          Uint32 Function(IntPtr hClientHandle, Pointer<Uint32> pFailReason,
              Pointer pvReserved),
          int Function(int hClientHandle, Pointer<Uint32> pFailReason,
              Pointer pvReserved)>('WlanHostedNetworkRefreshSecuritySettings');
      expect(WlanHostedNetworkRefreshSecuritySettings, isA<Function>());
    });
    test('Can instantiate WlanHostedNetworkSetProperty', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanHostedNetworkSetProperty = wlanapi.lookupFunction<
          Uint32 Function(
              IntPtr hClientHandle,
              Uint32 OpCode,
              Uint32 dwDataSize,
      ...
      expect(WlanHostedNetworkSetProperty, isA<Function>());
    });
    test('Can instantiate WlanHostedNetworkSetSecondaryKey', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanHostedNetworkSetSecondaryKey = wlanapi.lookupFunction<
          Uint32 Function(
              IntPtr hClientHandle,
              Uint32 dwKeyLength,
      ...
      expect(WlanHostedNetworkSetSecondaryKey, isA<Function>());
    });
    test('Can instantiate WlanHostedNetworkStartUsing', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanHostedNetworkStartUsing = wlanapi.lookupFunction<
          Uint32 Function(IntPtr hClientHandle, Pointer<Uint32> pFailReason,
              Pointer pvReserved),
          int Function(int hClientHandle, Pointer<Uint32> pFailReason,
              Pointer pvReserved)>('WlanHostedNetworkStartUsing');
      expect(WlanHostedNetworkStartUsing, isA<Function>());
    });
    test('Can instantiate WlanHostedNetworkStopUsing', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanHostedNetworkStopUsing = wlanapi.lookupFunction<
          Uint32 Function(IntPtr hClientHandle, Pointer<Uint32> pFailReason,
              Pointer pvReserved),
          int Function(int hClientHandle, Pointer<Uint32> pFailReason,
              Pointer pvReserved)>('WlanHostedNetworkStopUsing');
      expect(WlanHostedNetworkStopUsing, isA<Function>());
    });
    test('Can instantiate WlanIhvControl', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanIhvControl = wlanapi.lookupFunction<
          Uint32 Function(
              IntPtr hClientHandle,
              Pointer<GUID> pInterfaceGuid,
              Uint32 Type,
      ...
      expect(WlanIhvControl, isA<Function>());
    });
    test('Can instantiate WlanOpenHandle', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanOpenHandle = wlanapi.lookupFunction<
          Uint32 Function(
      ...
      expect(WlanOpenHandle, isA<Function>());
    });
    test('Can instantiate WlanQueryAutoConfigParameter', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanQueryAutoConfigParameter = wlanapi.lookupFunction<
              Uint32 Function(
                  IntPtr hClientHandle,
                  Uint32 OpCode,
                  Pointer pReserved,
      ...
      expect(WlanQueryAutoConfigParameter, isA<Function>());
    });
    test('Can instantiate WlanQueryInterface', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanQueryInterface = wlanapi.lookupFunction<
          Uint32 Function(
              IntPtr hClientHandle,
              Pointer<GUID> pInterfaceGuid,
              Uint32 OpCode,
      ...
      expect(WlanQueryInterface, isA<Function>());
    });
    test('Can instantiate WlanReasonCodeToString', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanReasonCodeToString = wlanapi.lookupFunction<
      ...
      expect(WlanReasonCodeToString, isA<Function>());
    });
    test('Can instantiate WlanRegisterDeviceServiceNotification', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanRegisterDeviceServiceNotification = wlanapi.lookupFunction<
      ...
      expect(WlanRegisterDeviceServiceNotification, isA<Function>());
    });
    test('Can instantiate WlanRegisterNotification', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanRegisterNotification = wlanapi.lookupFunction<
          Uint32 Function(
              IntPtr hClientHandle,
      ...
      expect(WlanRegisterNotification, isA<Function>());
    });
    test('Can instantiate WlanRegisterVirtualStationNotification', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanRegisterVirtualStationNotification = wlanapi.lookupFunction<
          Uint32 Function(
              IntPtr hClientHandle, Int32 bRegister, Pointer pReserved),
          int Function(int hClientHandle, int bRegister,
              Pointer pReserved)>('WlanRegisterVirtualStationNotification');
      expect(WlanRegisterVirtualStationNotification, isA<Function>());
    });
    test('Can instantiate WlanRenameProfile', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanRenameProfile = wlanapi.lookupFunction<
          Uint32 Function(
              IntPtr hClientHandle,
              Pointer<GUID> pInterfaceGuid,
      ...
      expect(WlanRenameProfile, isA<Function>());
    });
    test('Can instantiate WlanSaveTemporaryProfile', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanSaveTemporaryProfile = wlanapi.lookupFunction<
          Uint32 Function(
              IntPtr hClientHandle,
              Pointer<GUID> pInterfaceGuid,
              Pointer<Utf16> strProfileName,
      ...
      expect(WlanSaveTemporaryProfile, isA<Function>());
    });
    test('Can instantiate WlanScan', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanScan = wlanapi.lookupFunction<
          Uint32 Function(
              IntPtr hClientHandle,
              Pointer<GUID> pInterfaceGuid,
              Pointer<DOT11_SSID> pDot11Ssid,
      ...
      expect(WlanScan, isA<Function>());
    });
    test('Can instantiate WlanSetAutoConfigParameter', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanSetAutoConfigParameter = wlanapi.lookupFunction<
          Uint32 Function(IntPtr hClientHandle, Uint32 OpCode,
              Uint32 dwDataSize, Pointer pData, Pointer pReserved),
          int Function(int hClientHandle, int OpCode, int dwDataSize,
              Pointer pData, Pointer pReserved)>('WlanSetAutoConfigParameter');
      expect(WlanSetAutoConfigParameter, isA<Function>());
    });
    test('Can instantiate WlanSetFilterList', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanSetFilterList = wlanapi.lookupFunction<
      ...
      expect(WlanSetFilterList, isA<Function>());
    });
    test('Can instantiate WlanSetInterface', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanSetInterface = wlanapi.lookupFunction<
          Uint32 Function(
              IntPtr hClientHandle,
              Pointer<GUID> pInterfaceGuid,
              Uint32 OpCode,
          ...
          int Function(
              ...
              int dwDataSize,
              Pointer pData,
              Pointer pReserved)>('WlanSetInterface');
      expect(WlanSetInterface, isA<Function>());
    });
    test('Can instantiate WlanSetProfile', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanSetProfile = wlanapi.lookupFunction<
          Uint32 Function(
              IntPtr hClientHandle,
              Pointer<GUID> pInterfaceGuid,
              Uint32 dwFlags,
      ...
      expect(WlanSetProfile, isA<Function>());
    });
    test('Can instantiate WlanSetProfileCustomUserData', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanSetProfileCustomUserData = wlanapi.lookupFunction<
          Uint32 Function(
              IntPtr hClientHandle,
              Pointer<GUID> pInterfaceGuid,
              Pointer<Utf16> strProfileName,
      ...
      expect(WlanSetProfileCustomUserData, isA<Function>());
    });
    test('Can instantiate WlanSetProfileEapUserData', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanSetProfileEapUserData = wlanapi.lookupFunction<
          Uint32 Function(
              IntPtr hClientHandle,
              Pointer<GUID> pInterfaceGuid,
              Pointer<Utf16> strProfileName,
      ...
      expect(WlanSetProfileEapUserData, isA<Function>());
    });
    test('Can instantiate WlanSetProfileEapXmlUserData', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanSetProfileEapXmlUserData = wlanapi.lookupFunction<
          Uint32 Function(
              IntPtr hClientHandle,
              Pointer<GUID> pInterfaceGuid,
              Pointer<Utf16> strProfileName,
      ...
      expect(WlanSetProfileEapXmlUserData, isA<Function>());
    });
    test('Can instantiate WlanSetProfileList', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanSetProfileList = wlanapi.lookupFunction<
          Uint32 Function(
              IntPtr hClientHandle,
              Pointer<GUID> pInterfaceGuid,
              Uint32 dwItems,
      ...
      expect(WlanSetProfileList, isA<Function>());
    });
    test('Can instantiate WlanSetProfilePosition', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanSetProfilePosition = wlanapi.lookupFunction<
          Uint32 Function(
              IntPtr hClientHandle,
              Pointer<GUID> pInterfaceGuid,
              Pointer<Utf16> strProfileName,
      ...
      expect(WlanSetProfilePosition, isA<Function>());
    });
    test('Can instantiate WlanSetPsdIEDataList', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanSetPsdIEDataList = wlanapi.lookupFunction<
      ...
      expect(WlanSetPsdIEDataList, isA<Function>());
    });
    test('Can instantiate WlanSetSecuritySettings', () {
      final wlanapi = DynamicLibrary.open('wlanapi.dll');
      final WlanSetSecuritySettings = wlanapi.lookupFunction<
