...
void main() {
  ...
  test('Can instantiate IAudioClient2.isOffloadCapable', () {
    expect(audioclient2.isOffloadCapable, isA<Function>());
  });
  test('Can instantiate IAudioClient2.setClientProperties', () {
    expect(audioclient2.setClientProperties, isA<Function>());
  });
