...
```text
chore(release): `package:win32_gamepad` v1.0.10
```
...
[Release]: https://github.com/halildurmus/win32_gamepad/blob/main/.github/workflows/release.yml
