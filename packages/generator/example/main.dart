...
void printProjection<T>(
  ...
  final typeDef = WindowsMetadata.typeDef(type);
...
void printConstant([String name = 'HKEY_LOCAL_MACHINE']) {
  final constant = WindowsMetadata.constant(name);
...
void printFunction([String name = 'BroadcastSystemMessageW']) {
  final function = WindowsMetadata.function(name);
...
void printGetProperty([
  ...
  final typeDef = WindowsMetadata.typeDef(interface);
