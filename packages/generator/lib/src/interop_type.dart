...
sealed class InteropType {
  ...
  static const _remappedTypes = <String, InteropType>{
    ...
    'Windows.Win32.System.Rpc.RPC_STATUS': RPC_STATUSType(),
    ...
    'Windows.Win32.Foundation.WIN32_ERROR': WIN32_ERRORType(),
  };
  ...
  String get cType => switch (this) {
    ...
    TypeDefType(:final typeDef) =>
      typeDef.isEnum
          ...
          : switch (typeDef.name) {
              'MEMORY_MAPPED_VIEW_ADDRESS' || 'PRINTER_HANDLE' => 'HANDLE',
              'PROCESSTRACE_HANDLE' => 'TRACEHANDLE',
              _ => typeDef.name,
            },
    VoidType() => 'void',
    WIN32_ERRORType() => 'DWORD',
    _ => publicType,
  };
  ...
  String get ffiType => switch (this) {
    ...
    BSTRType() => 'Pointer<Utf16>',
    DEVPROPKEYType() => 'DEVPROPKEY',
    GUIDType() => 'GUID',
    HRESULTType() || NTSTATUSType() || RPC_STATUSType() => 'Int32',
    WIN32_ERRORType() => 'Uint32',
    IUnknownType() || ObjectType() => 'VTablePointer',
    PCSTRType() => 'Pointer<Utf8>',
    PCWSTRType() => 'Pointer<Utf16>',
    PrimitiveOrEnumType(:final primitive) => primitive.ffiType,
    PROPERTYKEYType() => 'PROPERTYKEY',
    PROPVARIANTType() => 'PROPVARIANT',
    PSTRType() => 'Pointer<Utf8>',
    PWSTRType() => 'Pointer<Utf16>',
...
final class RPC_STATUSType extends InteropType {
  const RPC_STATUSType();
}
...
final class WIN32_ERRORType extends InteropType {
  const WIN32_ERRORType();
}
