...
base class FunctionProjection extends Projection with ProjectionMixin {
  ...
  String get win32ResultType {
    ...
    if (originalReturnType case TypeDefType(
      ...
      if (!isVoidPtrHandle && isPointer) return 'ptr';
      return 'i64';
    }
    ...
    return switch (originalReturnType.ffiType) {
      'Pointer' || 'FARPROC' || 'PROC' => 'ptr',
      'Int8' => 'i8',
      'Int16' => 'i16',
      'Int32' || 'BOOL' => 'i32',
      'Int64' || 'IntPtr' || 'HSTRING' => 'i64',
      'Uint8' || 'BOOLEAN' => 'u8',
      'Uint16' => 'u16',
      'Uint32' => 'u32',
      'Uint64' => 'u64',
  ...
  cb.Code _generateDefaultFunctionBody() {
    ...
    if (originalReturnType.publicType == 'HRESULT' ||
        originalReturnType.publicType == 'NTSTATUS' ||
        originalReturnType.publicType == 'RPC_STATUS') {
      return cb.refer(originalReturnType.publicType).newInstance([
        ffiCall,
      ]).statement;
    }
  ...
  List<cb.Code> _generateResultHandlingCode(ParameterProjection parameter) {
    ...
    if (type.publicType case 'HRESULT' || 'NTSTATUS' || 'RPC_STATUS') {
      return [
        cb
            .refer(type.publicType)
