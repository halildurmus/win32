...
final class StructProjection extends Projection with ProjectionMixin {
  ...
  late final fieldProjections = typeDef.fields
  ...
  late final needsPropertyAccessors = _computeNeedsPropertyAccessors();
  ...
  late final nestedTypeProjections = typeDef.nestedTypes
