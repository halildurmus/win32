...
/// Dart projection for a COM get property, defined by a [Method].
///
    ...
    return cb.Library(
      (b) => b.body.add(
        cb.Method(
          (b) =>
              b
                ..docs.addAll(generateApiDocs(apiDetails, tokenObject: method))
                ..returns = returnType
...
/// Dart projection for a COM set property, defined by a [Method].
///
