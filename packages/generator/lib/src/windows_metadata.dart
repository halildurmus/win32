...
abstract final class WindowsMetadata {
  ...
  static final scopes = UnmodifiableListView([wdk, win32]);
  ...
  static final wdk = MetadataStore.scopeCache['Windows.Wdk.winmd']!;

  /// Returns the Win32 scope.
  static final win32 = MetadataStore.scopeCache['Windows.Win32.winmd']!;

  /// Returns the WinRT scope.
  static final winrt = MetadataStore.scopeCache['Windows.winmd']!;
  ...
  @pragma('vm:prefer-inline')
  static List<Field> findConstants(List<String> names) =>
      MetadataStore.scopeCache.values
          .expand((scope) => scope.constants)
  ...
  @pragma('vm:prefer-inline')
  static List<Method> findFunctions(List<String> names) =>
      MetadataStore.scopeCache.values
          .expand((scope) => scope.functions)
  ...
  @pragma('vm:prefer-inline')
  static List<TypeDef> findTypeDefs(List<String> names) =>
      MetadataStore.scopeCache.values
          .expand((scope) => scope.typeDefs)
