...
abstract final class WindowsMetadata {
  ...
  static Future<(Scope wdk, Scope win32, Scope winrt, DocsManager docs)> load({
    ...
    final (wdk, win32, winrt, docs) = await (
  ...
  @pragma('vm:prefer-inline')
  static List<Field> findConstants(Set<String> names) => constants
  ...
  @pragma('vm:prefer-inline')
  static List<Method> findFunctions(Set<String> names) => functions
  ...
  @pragma('vm:prefer-inline')
  static List<TypeDef> findTypeDefs(Set<String> names) => typeDefs
