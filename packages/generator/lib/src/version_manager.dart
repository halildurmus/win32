...
final class VersionManager {
  ...
  factory VersionManager.load([String? path]) {
    ...
    final versions = <MetadataPackage, String>{};
  ...
  final Map<MetadataPackage, String> _versions;

  /// Returns an unmodifiable view of the stored package versions.
  Map<MetadataPackage, String> get versions => Map.unmodifiable(_versions);

  /// Returns the version of the [MetadataPackage.wdk] package.
  String get wdk => _getVersion(MetadataPackage.wdk);

  /// Returns the version of the [MetadataPackage.win32Docs] package.
  String get win32Docs => _getVersion(MetadataPackage.win32Docs);

  /// Returns the version of the [MetadataPackage.win32] package.
  String get win32 => _getVersion(MetadataPackage.win32);

  /// Returns the version of the [MetadataPackage.winrt] package.
  String get winrt => _getVersion(MetadataPackage.winrt);

  /// Returns the version of the specified [package].
  String? operator [](MetadataPackage package) => _getVersion(package);

  /// Updates the [version] of a given [package].
  void updateVersion(MetadataPackage package, String version) {
    if (version.isEmpty) {
  ...
  /// missing.
  String _getVersion(MetadataPackage package) =>
      _versions[package] ??
  ...
  /// [MetadataPackage].
  static const Map<String, MetadataPackage> _constantToPackage = {
    'wdkMetadataVersion': MetadataPackage.wdk,
    'win32DocsVersion': MetadataPackage.win32Docs,
    'win32MetadataVersion': MetadataPackage.win32,
    'winrtMetadataVersion': MetadataPackage.winrt,
  };
