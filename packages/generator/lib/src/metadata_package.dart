...
enum MetadataPackage {
  ...
  static MetadataPackage fromPackageId(String packageId) => switch (packageId) {
    ...
    'microsoft.windows.sdk.win32docs' => win32Docs,
