...
extension TypeDefHelpers on TypeDef {
  ...
  bool get hasGuid => existsAttribute(Win32Attribute.guid);
  ...
  bool get isBitwiseEnum => isEnum && existsAttribute(SystemAttribute.flags);
  ...
  bool get isHandle =>
      existsAttribute(Win32Attribute.nativeTypedef) ||
      existsAttribute(Win32Attribute.metadataTypedef);
