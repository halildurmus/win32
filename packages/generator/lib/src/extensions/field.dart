...
extension FieldHelpers on Field {
  ...
  bool get isBitField => existsAttribute(Win32Attribute.nativeBitfield);
  ...
  bool get isFlexibleArray =>
      isArray && existsAttribute(Win32Attribute.flexibleArray);
  ...
  bool get isObsoleteOrReserved =>
      existsAttribute(SystemAttribute.obsolete) ||
