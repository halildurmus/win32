...
final class DocsManager {
  ...
  /// Retrieves documentation based on a [TokenObject] by using the resolved keys.
  ApiDetails? documentation(TokenObject tokenObject) {
    final keys = DocsKeyResolver.resolve(tokenObject);
    return _lookup(keys);
  }
