...
void testCallbackGolden(String callbackName) {
  test(callbackName, () {
    final typeDef = WindowsMetadata.typeDef(callbackName);
...
void testConstantGolden(String constantName) {
  test(constantName, () {
    final constant = WindowsMetadata.constant(constantName);
...
void testEnumGolden(String enumName) {
  test(enumName, () {
    final typeDef = WindowsMetadata.typeDef(enumName);
    final fileName = typeDef.nameWithoutEncoding.safeFilename;
...
void testFunctionGolden(String functionName) {
  test(functionName, () {
    final function = WindowsMetadata.function(functionName);
...
void testInterfaceGolden(String interfaceName) {
  test(interfaceName, () {
    final typeDef = WindowsMetadata.typeDef(interfaceName);
    final fileName = typeDef.nameWithoutEncoding.safeFilename;
...
void testStructGolden(String structName) {
  test(structName, () {
    final typeDef = WindowsMetadata.typeDef(structName);
    final fileName = typeDef.nameWithoutEncoding.safeFilename;
