...
void main() {
  group('VersionManager', () {
    ...
    setUp(() {
      ...
      final file = File('${tempDir.path}/versions.dart')..writeAsStringSync('''
...
''');
    ...
    test('updates versions correctly', () {
      manager
        ..updateVersion(MetadataPackage.wdk, '0.13.26-experimental')
        ..updateVersion(MetadataPackage.win32Docs, '0.1.43-alpha')
        ..updateVersion(MetadataPackage.win32, '63.0.32-preview')
        ..updateVersion(MetadataPackage.winrt, '10.0.26100.1743')
        ..save();
