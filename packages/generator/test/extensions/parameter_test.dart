...
void main() {
  ...
  group('Parameter', () {
    test('isComOutPtr', () {
      ...
      final coGetMalloc = WindowsMetadata.findFunction('CoGetMalloc');
    ...
    test('isNullable', () {
      ...
      final coRegisterClassObject = WindowsMetadata.findFunction(
    ...
    test('isReserved', () {
      final coInitEx = WindowsMetadata.findFunction('CoInitializeEx');
