...
void main() {
  group('LocalStorageManager', () {
    ...
    test(
      'getPackageDirectory downloads and extracts package if missing',
      () async {
    ...
    test(
      'storedPackageDirectories returns valid package directories',
      () async {
        ...
        final directories = storageManager.storedPackageDirectories;
        check(directories.length).equals(1);
        check(
          directories.first,
        ).contains('microsoft.windows.sdk.win32docs@1.0.0');
      },
    );
...
const dummyPackage = MetadataPackage.win32Docs;
const version = '1.0.0';
