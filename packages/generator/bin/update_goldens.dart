...
''');
  ...
  info('📝 Found ${goldenFiles.length} golden file(s).');

  for (final file in goldenFiles) {
    trace('⏳ Processing ${file.goldenType}/${file.fileName}...');
