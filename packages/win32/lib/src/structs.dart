...
//
// This file defines handwritten structures that are required by certain
// Win32 APIs but are not present in the metadata used to generate bindings.
...
base class ACCENT_POLICY extends Struct {
  ...
  Pointer<ACCENT_POLICY> toNative({Allocator allocator = adaptiveCalloc}) =>
      allocator()..ref = this;
}
...
base class WINDOWCOMPOSITIONATTRIBDATA extends Struct {
  ...
  /// responsible for freeing it, unless a scoped allocator (such as [Arena])
  /// is used, in which case the allocator manages the lifetime.
  Pointer<WINDOWCOMPOSITIONATTRIBDATA> toNative({
