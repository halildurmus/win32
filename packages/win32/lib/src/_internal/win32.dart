...
@internal
final deleteBSTRAddress = Native.addressOf<NativeFunction<Void Function(BSTR)>>(
  deleteBSTR,
);

/// The native address of the [deleteHSTRING] function.
@internal
final deleteHSTRINGAddress =
