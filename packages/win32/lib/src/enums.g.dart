...
/// {@category enum}
extension type const DNS_QUERY_OPTIONS(int _) implements int {
  /// Whether this instance has all the bit fields specified in [other].
  bool has(DNS_QUERY_OPTIONS other) => _ & other._ == other._;

  DNS_QUERY_OPTIONS operator &(int other) => .new(_ & other);
  DNS_QUERY_OPTIONS operator |(int other) => .new(_ | other);
}

const DNS_QUERY_PARSE_ALL_RECORDS = DNS_QUERY_OPTIONS(0);

const DNS_QUERY_STANDARD = DNS_QUERY_OPTIONS(0);

const DNS_QUERY_ACCEPT_TRUNCATED_RESPONSE = DNS_QUERY_OPTIONS(1);

const DNS_QUERY_USE_TCP_ONLY = DNS_QUERY_OPTIONS(2);

const DNS_QUERY_NO_RECURSION = DNS_QUERY_OPTIONS(4);

const DNS_QUERY_BYPASS_CACHE = DNS_QUERY_OPTIONS(8);

const DNS_QUERY_NO_WIRE_QUERY = DNS_QUERY_OPTIONS(16);

const DNS_QUERY_NO_LOCAL_NAME = DNS_QUERY_OPTIONS(32);

const DNS_QUERY_NO_HOSTS_FILE = DNS_QUERY_OPTIONS(64);

const DNS_QUERY_NO_NETBT = DNS_QUERY_OPTIONS(128);

const DNS_QUERY_WIRE_ONLY = DNS_QUERY_OPTIONS(256);

const DNS_QUERY_RETURN_MESSAGE = DNS_QUERY_OPTIONS(512);

const DNS_QUERY_MULTICAST_ONLY = DNS_QUERY_OPTIONS(1024);

const DNS_QUERY_NO_MULTICAST = DNS_QUERY_OPTIONS(2048);

const DNS_QUERY_TREAT_AS_FQDN = DNS_QUERY_OPTIONS(4096);

const DNS_QUERY_ADDRCONFIG = DNS_QUERY_OPTIONS(8192);

const DNS_QUERY_DUAL_ADDR = DNS_QUERY_OPTIONS(16384);

const DNS_QUERY_DONT_RESET_TTL_VALUES = DNS_QUERY_OPTIONS(1048576);

const DNS_QUERY_DISABLE_IDN_ENCODING = DNS_QUERY_OPTIONS(2097152);

const DNS_QUERY_APPEND_MULTILABEL = DNS_QUERY_OPTIONS(8388608);

const DNS_QUERY_DNSSEC_OK = DNS_QUERY_OPTIONS(16777216);

const DNS_QUERY_DNSSEC_CHECKING_DISABLED = DNS_QUERY_OPTIONS(33554432);

const DNS_QUERY_DNSSEC_REQUIRED = DNS_QUERY_OPTIONS(67108864);

const DNS_QUERY_RESERVED = DNS_QUERY_OPTIONS(4026531840);

const DNS_QUERY_CACHE_ONLY = DNS_QUERY_OPTIONS(16);

const DNS_QUERY_REQUEST_VERSION1 = DNS_QUERY_OPTIONS(1);

const DNS_QUERY_REQUEST_VERSION2 = DNS_QUERY_OPTIONS(2);

const DNS_QUERY_RESULTS_VERSION1 = DNS_QUERY_OPTIONS(1);

const DNS_QUERY_REQUEST_VERSION3 = DNS_QUERY_OPTIONS(3);

const DNS_QUERY_RAW_RESULTS_VERSION1 = DNS_QUERY_OPTIONS(1);

const DNS_QUERY_RAW_REQUEST_VERSION1 = DNS_QUERY_OPTIONS(1);

const DNS_QUERY_RAW_OPTION_BEST_EFFORT_PARSE = DNS_QUERY_OPTIONS(1);
