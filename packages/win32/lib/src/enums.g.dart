...
/// purposes.
const DWMWA_LAST = DWMWINDOWATTRIBUTE(39);
...
const MaxJobObjectInfoClass = JOBOBJECTINFOCLASS(50);
...
const PRODUCT_IOTUAPCOMMERCIAL = OS_PRODUCT_TYPE(131);
...
const PRODUCT_MOBILE_CORE = OS_PRODUCT_TYPE(104);

const PRODUCT_MOBILE_ENTERPRISE = OS_PRODUCT_TYPE(133);
...
const PRODUCT_STANDARD_SERVER_CORE_ = OS_PRODUCT_TYPE(13);
...
const PowerInformationLevelMaximum = POWER_INFORMATION_LEVEL(98);
...
const MaxTokenInfoClass = TOKEN_INFORMATION_CLASS(49);
...
const ERROR_INVALID_CONFIG_VALUE = WIN32_ERROR(479);
