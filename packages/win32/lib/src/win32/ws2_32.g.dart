...
///
/// {@category winsock}
Win32Result<int> bind(int s, Pointer<SOCKADDR> name, int namelen) {
...
///
/// {@category winsock}
Win32Result<int> closesocket(int s) {
...
///
/// {@category winsock}
Win32Result<int> connect(int s, Pointer<SOCKADDR> name, int namelen) {
...
///
/// {@category winsock}
Win32Result<int> ioctlsocket(int s, int cmd, Pointer<Uint32> argp) {
...
///
/// {@category winsock}
Win32Result<int> listen(int s, int backlog) {
...
///
/// {@category winsock}
Win32Result<int> recv(int s, PSTR buf, int len, SEND_RECV_FLAGS flags) {
...
///
/// {@category winsock}
Win32Result<int> send(int s, PCSTR buf, int len, SEND_RECV_FLAGS flags) {
...
///
/// {@category winsock}
Win32Result<int> shutdown(int s, WINSOCK_SHUTDOWN_HOW how) {
...
///
/// {@category winsock}
Win32Result<int> socket(int af, WINSOCK_SOCKET_TYPE type, int protocol) {
