...
///
/// {@category advapi32}
Win32Result<bool> CloseServiceHandle(int hSCObject) {
...
///
/// {@category advapi32}
Win32Result<bool> DeleteService(int hService) {
...
///
/// {@category advapi32}
Win32Result<int> RegisterServiceCtrlHandler(
  PCWSTR lpServiceName,
...
///
/// {@category advapi32}
Win32Result<int> RegisterServiceCtrlHandlerEx(
  PCWSTR lpServiceName,
...
///
/// {@category advapi32}
Win32Result<bool> SetThreadToken(Pointer<HANDLE>? thread, int? token) {
  final result_ = SetThreadToken_Wrapper(thread ?? nullptr, token ?? NULL);
  return Win32Result(value: result_.value.i32 != FALSE, error: result_.error);
}
