...
///
/// {@category winspool}
Win32Result<int> AddPrinter(PCWSTR? pName, int level, Pointer<Uint8> pPrinter) {
...
///
/// {@category winspool}
Win32Result<bool> ClosePrinter(int hPrinter) {
...
///
/// {@category winspool}
Win32Result<bool> DeletePrinter(int hPrinter) {
...
@Native<BOOL Function(FINDPRINTERCHANGENOTIFICATION_HANDLE)>(
  symbol: 'FindClosePrinterChangeNotification',
)
...
@Native<
  FINDPRINTERCHANGENOTIFICATION_HANDLE Function(
    PRINTER_HANDLE,
    Uint32,
    Uint32,
    Pointer,
...
///
/// {@category winspool}
Win32Result<int> GetSpoolFileHandle(int hPrinter) {
