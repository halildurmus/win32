...
///
/// {@category dbghelp}
Win32Result<bool> SymCleanup(int hProcess) {
...
///
/// {@category dbghelp}
Win32Result<bool> SymSetParentWindow(int hwnd) {
...
///
/// {@category dbghelp}
Win32Result<bool> SymSetScopeFromAddr(int hProcess, int address) {
...
///
/// {@category dbghelp}
Win32Result<bool> SymSetScopeFromIndex(int hProcess, int baseOfDll, int index) {
...
///
/// {@category dbghelp}
Win32Result<bool> SymSetSearchPath(int hProcess, PCWSTR? searchPathA) {
...
///
/// {@category dbghelp}
Win32Result<bool> SymUnloadModule(int hProcess, int baseOfDll) {
...
///
/// {@category dbghelp}
Win32Result<bool> SymUnloadModule64(int hProcess, int baseOfDll) {
