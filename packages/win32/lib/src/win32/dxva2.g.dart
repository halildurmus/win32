...
///
/// {@category dxva2}
Win32Result<bool> DestroyPhysicalMonitor(int hMonitor) {
...
///
/// {@category dxva2}
Win32Result<int> SaveCurrentMonitorSettings(int hMonitor) {
...
///
/// {@category dxva2}
Win32Result<int> SetMonitorBrightness(int hMonitor, int dwNewBrightness) {
...
///
/// {@category dxva2}
Win32Result<int> SetMonitorContrast(int hMonitor, int dwNewContrast) {
