...
///
/// {@category kernel32}
Win32Result<bool> ActivateActCtx(int? hActCtx, Pointer<IntPtr> lpCookie) {
  final result_ = ActivateActCtx_Wrapper(hActCtx ?? NULL, lpCookie);
...
///
/// {@category kernel32}
Win32Result<bool> AssignProcessToJobObject(int hJob, int hProcess) {
...
///
/// {@category kernel32}
Win32Result<int> BeginUpdateResource(
  PCWSTR pFileName,
...
///
/// {@category kernel32}
Win32Result<bool> CancelIo(int hFile) {
...
///
/// {@category kernel32}
Win32Result<bool> CancelIoEx(int hFile, Pointer<OVERLAPPED>? lpOverlapped) {
...
///
/// {@category kernel32}
Win32Result<bool> CancelSynchronousIo(int hThread) {
...
///
/// {@category kernel32}
Win32Result<bool> ClearCommBreak(int hFile) {
...
///
/// {@category kernel32}
Win32Result<bool> CloseHandle(int hObject) {
...
Win32Result<bool> CommConfigDialog(
  ...
  final result_ = CommConfigDialogW_Wrapper(lpszName, hWnd ?? NULL, lpCC);
  return Win32Result(value: result_.value.i32 != FALSE, error: result_.error);
}
...
///
/// {@category kernel32}
Win32Result<int> CreateActCtx(Pointer<ACTCTX> pActCtx) {
...
///
/// {@category kernel32}
Win32Result<int> CreateConsoleScreenBuffer(
  int dwDesiredAccess,
  int dwShareMode,
...
///
/// {@category kernel32}
Win32Result<int> CreateIoCompletionPort(
  int fileHandle,
...
///
/// {@category kernel32}
Win32Result<int> CreateJobObject(
...
///
/// {@category kernel32}
Win32Result<int> CreateRemoteThread(
  int hProcess,
  Pointer<SECURITY_ATTRIBUTES>? lpThreadAttributes,
  int dwStackSize,
...
///
/// {@category kernel32}
Win32Result<int> CreateRemoteThreadEx(
  int hProcess,
  Pointer<SECURITY_ATTRIBUTES>? lpThreadAttributes,
  int dwStackSize,
  Pointer<NativeFunction<LPTHREAD_START_ROUTINE>> lpStartAddress,
...
///
/// {@category kernel32}
Win32Result<bool> DebugBreakProcess(int process) {
...
///
/// {@category kernel32}
Win32Result<bool> DisableThreadLibraryCalls(int hLibModule) {
...
///
/// {@category kernel32}
Win32Result<bool> DisconnectNamedPipe(int hNamedPipe) {
...
///
/// {@category kernel32}
Win32Result<bool> EndUpdateResource(int hUpdate, bool fDiscard) {
...
///
/// {@category kernel32}
Win32Result<bool> EscapeCommFunction(int hFile, ESCAPE_COMM_FUNCTION dwFunc) {
...
///
/// {@category kernel32}
Win32Result<bool> FindClose(int hFindFile) {
...
///
/// {@category kernel32}
Win32Result<bool> FindCloseChangeNotification(int hChangeHandle) {
...
///
/// {@category kernel32}
Win32Result<int> FindFirstChangeNotification(
  PCWSTR lpPathName,
  bool bWatchSubtree,
...
///
/// {@category kernel32}
Win32Result<int> FindFirstFileEx(
  PCWSTR lpFileName,
...
///
/// {@category kernel32}
Win32Result<int> FindFirstFileName(
  PCWSTR lpFileName,
  int dwFlags,
...
///
/// {@category kernel32}
Win32Result<int> FindFirstStream(
  PCWSTR lpFileName,
...
///
/// {@category kernel32}
Win32Result<int> FindFirstVolume(PWSTR lpszVolumeName, int cchBufferLength) {
...
///
/// {@category kernel32}
Win32Result<bool> FindNextChangeNotification(int hChangeHandle) {
...
///
/// {@category kernel32}
Win32Result<bool> FindNextStream(int hFindStream, Pointer lpFindStreamData) {
...
///
/// {@category kernel32}
Win32Result<bool> FindVolumeClose(int hFindVolume) {
...
///
/// {@category kernel32}
Win32Result<bool> FlushConsoleInputBuffer(int hConsoleInput) {
...
///
/// {@category kernel32}
Win32Result<bool> FlushFileBuffers(int hFile) {
...
///
/// {@category kernel32}
Win32Result<bool> FreeLibrary(int hLibModule) {
...
///
/// {@category kernel32}
Win32Result<bool> GetCommMask(int hFile, Pointer<Uint32> lpEvtMask) {
...
///
/// {@category kernel32}
Win32Result<bool> GetCommModemStatus(int hFile, Pointer<Uint32> lpModemStat) {
...
///
/// {@category kernel32}
Win32Result<bool> GetCommProperties(int hFile, Pointer<COMMPROP> lpCommProp) {
...
///
/// {@category kernel32}
Win32Result<bool> GetCommState(int hFile, Pointer<DCB> lpDCB) {
...
///
/// {@category kernel32}
Win32Result<bool> GetConsoleMode(int hConsoleHandle, Pointer<Uint32> lpMode) {
...
///
/// {@category kernel32}
Win32Result<bool> GetCurrentActCtx(Pointer<HANDLE> lphActCtx) {
...
///
/// {@category kernel32}
Win32Result<bool> GetExitCodeProcess(int hProcess, Pointer<Uint32> lpExitCode) {
...
///
/// {@category kernel32}
Win32Result<int> GetFileSize(int hFile, Pointer<Uint32>? lpFileSizeHigh) {
...
///
/// {@category kernel32}
Win32Result<bool> GetFileSizeEx(int hFile, Pointer<Int64> lpFileSize) {
...
///
/// {@category kernel32}
Win32Result<FILE_TYPE> GetFileType(int hFile) {
...
///
/// {@category kernel32}
Win32Result<bool> GetHandleInformation(int hObject, Pointer<Uint32> lpdwFlags) {
...
///
/// {@category kernel32}
Win32Result<COORD> GetLargestConsoleWindowSize(int hConsoleOutput) {
...
///
/// {@category kernel32}
Win32Result<int> GetModuleFileName(int? hModule, PWSTR lpFilename, int nSize) {
...
///
/// {@category kernel32}
Win32Result<int> GetModuleHandle(PCWSTR? lpModuleName) {
...
///
/// {@category kernel32}
Win32Result<FARPROC> GetProcAddress(int hModule, PCSTR lpProcName) {
...
///
/// {@category kernel32}
Win32Result<int> GetProcessHeap() {
...
///
/// {@category kernel32}
Win32Result<int> GetProcessId(int process) {
...
///
/// {@category kernel32}
Win32Result<int> GetStdHandle(STD_HANDLE nStdHandle) {
...
///
/// {@category kernel32}
Win32Result<int> GetThreadId(int thread) {
...
///
/// {@category kernel32}
Win32Result<int> GlobalAlloc(GLOBAL_ALLOC_FLAGS uFlags, int dwBytes) {
...
///
/// {@category kernel32}
Win32Result<int> GlobalFree(int? hMem) {
  final result_ = GlobalFree_Wrapper(hMem ?? NULL);
  return Win32Result(value: result_.value.i64, error: result_.error);
}
...
///
/// {@category kernel32}
Win32Result<Pointer> GlobalLock(int hMem) {
...
///
/// {@category kernel32}
Win32Result<int> GlobalSize(int hMem) {
...
///
/// {@category kernel32}
Win32Result<bool> GlobalUnlock(int hMem) {
...
///
/// {@category kernel32}
Win32Result<int> HeapCompact(int hHeap, HEAP_FLAGS dwFlags) {
...
///
/// {@category kernel32}
Win32Result<bool> HeapDestroy(int hHeap) {
...
///
/// {@category kernel32}
Win32Result<bool> HeapFree(int hHeap, HEAP_FLAGS dwFlags, Pointer? lpMem) {
...
///
/// {@category kernel32}
Win32Result<bool> HeapLock(int hHeap) {
...
///
/// {@category kernel32}
Win32Result<bool> HeapUnlock(int hHeap) {
...
///
/// {@category kernel32}
Win32Result<bool> HeapWalk(int hHeap, Pointer<PROCESS_HEAP_ENTRY> lpEntry) {
...
///
/// {@category kernel32}
Win32Result<bool> IsNativeVhdBoot(Pointer<BOOL> nativeVhdBoot) {
...
///
/// {@category kernel32}
Win32Result<int> LoadLibrary(PCWSTR lpLibFileName) {
...
///
/// {@category kernel32}
Win32Result<int> LoadLibraryEx(
  PCWSTR lpLibFileName,
  LOAD_LIBRARY_FLAGS dwFlags,
) {
  final result_ = LoadLibraryExW_Wrapper(lpLibFileName, NULL, dwFlags);
  return Win32Result(value: result_.value.i64, error: result_.error);
}
...
///
/// {@category kernel32}
Win32Result<int> LoadResource(int? hModule, int hResInfo) {
  final result_ = LoadResource_Wrapper(hModule ?? NULL, hResInfo);
  return Win32Result(value: result_.value.i64, error: result_.error);
}
...
///
/// {@category kernel32}
Win32Result<int> LocalAlloc(LOCAL_ALLOC_FLAGS uFlags, int uBytes) {
...
///
/// {@category kernel32}
Win32Result<int> LocalFree(int? hMem) {
  final result_ = LocalFree_Wrapper(hMem ?? NULL);
  return Win32Result(value: result_.value.i64, error: result_.error);
}
...
///
/// {@category kernel32}
Win32Result<bool> PurgeComm(int hFile, PURGE_COMM_FLAGS dwFlags) {
...
///
/// {@category kernel32}
Win32Result<bool> ResetEvent(int hEvent) {
...
///
/// {@category kernel32}
Win32Result<bool> SetCommBreak(int hFile) {
...
///
/// {@category kernel32}
Win32Result<bool> SetCommMask(int hFile, COMM_EVENT_MASK dwEvtMask) {
...
///
/// {@category kernel32}
Win32Result<bool> SetCommState(int hFile, Pointer<DCB> lpDCB) {
...
///
/// {@category kernel32}
Win32Result<bool> SetConsoleMode(int hConsoleHandle, CONSOLE_MODE dwMode) {
...
///
/// {@category kernel32}
Win32Result<bool> SetEndOfFile(int hFile) {
...
///
/// {@category kernel32}
Win32Result<bool> SetEvent(int hEvent) {
...
///
/// {@category kernel32}
Win32Result<bool> SetFileShortName(int hFile, PCWSTR lpShortName) {
...
///
/// {@category kernel32}
Win32Result<bool> SetFileValidData(int hFile, int validDataLength) {
...
///
/// {@category kernel32}
Win32Result<bool> SetStdHandle(STD_HANDLE nStdHandle, int hHandle) {
...
///
/// {@category kernel32}
Win32Result<int> SetThreadAffinityMask(int hThread, int dwThreadAffinityMask) {
...
///
/// {@category kernel32}
Win32Result<bool> SetupComm(int hFile, int dwInQueue, int dwOutQueue) {
...
///
/// {@category kernel32}
Win32Result<int> SizeofResource(int? hModule, int hResInfo) {
  final result_ = SizeofResource_Wrapper(hModule ?? NULL, hResInfo);
  return Win32Result(value: result_.value.u32, error: result_.error);
}
...
///
/// {@category kernel32}
Win32Result<bool> TerminateJobObject(int hJob, int uExitCode) {
...
///
/// {@category kernel32}
Win32Result<bool> TerminateProcess(int hProcess, int uExitCode) {
...
///
/// {@category kernel32}
Win32Result<bool> TerminateThread(int hThread, int dwExitCode) {
...
///
/// {@category kernel32}
Win32Result<bool> TransmitCommChar(int hFile, int cChar) {
...
///
/// {@category kernel32}
Win32Result<WAIT_EVENT> WaitForSingleObject(int hHandle, int dwMilliseconds) {
...
///
/// {@category kernel32}
Win32Result<int> Wow64SuspendThread(int hThread) {
