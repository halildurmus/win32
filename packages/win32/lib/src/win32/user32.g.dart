...
///
/// {@category user32}
Win32Result<int> ActivateKeyboardLayout(
  int hkl,
...
///
/// {@category user32}
Win32Result<bool> AddClipboardFormatListener(int hwnd) {
...
///
/// {@category user32}
Win32Result<int> ArrangeIconicWindows(int hWnd) {
...
///
/// {@category user32}
Win32Result<int> BeginDeferWindowPos(int nNumWindows) {
...
///
/// {@category user32}
Win32Result<bool> BringWindowToTop(int hWnd) {
...
///
/// {@category user32}
Win32Result<bool> CloseGestureInfoHandle(int hGestureInfo) {
...
///
/// {@category user32}
Win32Result<bool> CloseTouchInputHandle(int hTouchInput) {
...
///
/// {@category user32}
Win32Result<bool> CloseWindow(int hWnd) {
...
///
/// {@category user32}
Win32Result<int> CopyIcon(int hIcon) {
...
///
/// {@category user32}
Win32Result<int> CreateAcceleratorTable(Pointer<ACCEL> paccel, int cAccel) {
...
///
/// {@category user32}
Win32Result<bool> CreateCaret(int hWnd, int? hBitmap, int nWidth, int nHeight) {
  final result_ = CreateCaret_Wrapper(hWnd, hBitmap ?? NULL, nWidth, nHeight);
  return Win32Result(value: result_.value.i32 != FALSE, error: result_.error);
}
...
///
/// {@category user32}
Win32Result<int> CreateDesktopEx(
  PCWSTR lpszDesktop,
  DESKTOP_CONTROL_FLAGS dwFlags,
  int dwDesiredAccess,
  Pointer<SECURITY_ATTRIBUTES>? lpsa,
...
///
/// {@category user32}
Win32Result<int> CreateDialogIndirectParam(
  int? hInstance,
...
///
/// {@category user32}
Win32Result<int> CreateIconFromResource(
...
///
/// {@category user32}
Win32Result<int> CreateIconFromResourceEx(
  Pointer<Uint8> presbits,
  int dwResSize,
  bool fIcon,
  int dwVer,
...
///
/// {@category user32}
Win32Result<int> CreateIconIndirect(Pointer<ICONINFO> piconinfo) {
...
///
/// {@category user32}
Win32Result<int> CreateMDIWindow(
  PCWSTR lpClassName,
  PCWSTR lpWindowName,
  WINDOW_STYLE dwStyle,
  int x,
...
///
/// {@category user32}
Win32Result<int> CreatePopupMenu() {
...
///
/// {@category user32}
Win32Result<int> CreateWindowEx(
  WINDOW_EX_STYLE dwExStyle,
  PCWSTR? lpClassName,
  PCWSTR? lpWindowName,
  WINDOW_STYLE dwStyle,
...
///
/// {@category user32}
Win32Result<int> CreateWindowStation(
  PCWSTR? lpwinsta,
  int dwFlags,
  int dwDesiredAccess,
  Pointer<SECURITY_ATTRIBUTES>? lpsa,
...
///
/// {@category user32}
Win32Result<int> DeferWindowPos(
  int hWinPosInfo,
  int hWnd,
  int? hWndInsertAfter,
  int x,
...
///
/// {@category user32}
Win32Result<bool> DeleteMenu(int hMenu, int uPosition, MENU_ITEM_FLAGS uFlags) {
...
///
/// {@category user32}
Win32Result<bool> DestroyCursor(int hCursor) {
...
///
/// {@category user32}
Win32Result<bool> DestroyIcon(int hIcon) {
...
///
/// {@category user32}
Win32Result<bool> DestroyMenu(int hMenu) {
...
///
/// {@category user32}
Win32Result<bool> DestroyWindow(int hWnd) {
...
/// {@category user32}
@pragma('vm:prefer-inline')
bool DrawFrameControl(int hdc, Pointer<RECT> lprc, int uType, int uState) =>
...
///
/// {@category user32}
Win32Result<bool> DrawIcon(int hDC, int x, int y, int hIcon) {
...
///
/// {@category user32}
Win32Result<bool> EnableNonClientDpiScaling(int hwnd) {
...
///
/// {@category user32}
Win32Result<bool> EndDeferWindowPos(int hWinPosInfo) {
...
///
/// {@category user32}
Win32Result<bool> EndDialog(int hDlg, int nResult) {
...
Win32Result<bool> EnumDesktopWindows(
  ...
  final result_ = EnumDesktopWindows_Wrapper(hDesktop ?? NULL, lpfn, lParam);
  return Win32Result(value: result_.value.i32 != FALSE, error: result_.error);
}
...
///
/// {@category user32}
Win32Result<int> FindWindow(PCWSTR? lpClassName, PCWSTR? lpWindowName) {
...
Win32Result<bool> GetClassInfoEx(
  ...
  final result_ = GetClassInfoExW_Wrapper(hInstance ?? NULL, lpszClass, lpwcx);
  return Win32Result(value: result_.value.i32 != FALSE, error: result_.error);
}
...
///
/// {@category user32}
Win32Result<int> GetClassLongPtr(int hWnd, GET_CLASS_LONG_INDEX nIndex) {
...
///
/// {@category user32}
Win32Result<int> GetClassName(int hWnd, PWSTR lpClassName, int nMaxCount) {
...
///
/// {@category user32}
Win32Result<bool> GetClientRect(int hWnd, Pointer<RECT> lpRect) {
...
///
/// {@category user32}
Win32Result<int> GetClipboardData(int uFormat) {
...
///
/// {@category user32}
Win32Result<int> GetClipboardOwner() {
...
///
/// {@category user32}
Win32Result<int> GetClipboardViewer() {
...
GetDialogControlDpiChangeBehavior(int hWnd) {
...
///
/// {@category user32}
Win32Result<DIALOG_DPI_CHANGE_BEHAVIORS> GetDialogDpiChangeBehavior(int hDlg) {
...
///
/// {@category user32}
Win32Result<int> GetDlgItem(int? hDlg, int nIDDlgItem) {
  final result_ = GetDlgItem_Wrapper(hDlg ?? NULL, nIDDlgItem);
  return Win32Result(value: result_.value.i64, error: result_.error);
}
...
///
/// {@category user32}
Win32Result<bool> GetIconInfo(int hIcon, Pointer<ICONINFO> piconinfo) {
...
///
/// {@category user32}
Win32Result<int> GetKeyboardLayoutList(int nBuff, Pointer<HKL>? lpList) {
...
///
/// {@category user32}
Win32Result<bool> GetMenuInfo(int param0, Pointer<MENUINFO> param1) {
...
///
/// {@category user32}
Win32Result<int> GetMenuItemCount(int? hMenu) {
  final result_ = GetMenuItemCount_Wrapper(hMenu ?? NULL);
  return Win32Result(value: result_.value.i32, error: result_.error);
}
...
Win32Result<bool> GetMenuItemRect(
  ...
  final result_ = GetMenuItemRect_Wrapper(hWnd ?? NULL, hMenu, uItem, lprcItem);
  return Win32Result(value: result_.value.i32 != FALSE, error: result_.error);
}
...
///
/// {@category user32}
Win32Result<int> GetNextDlgGroupItem(int hDlg, int? hCtl, bool bPrevious) {
...
///
/// {@category user32}
Win32Result<int> GetNextDlgTabItem(int hDlg, int? hCtl, bool bPrevious) {
...
///
/// {@category user32}
Win32Result<int> GetOpenClipboardWindow() {
...
///
/// {@category user32}
Win32Result<int> GetParent(int hWnd) {
...
///
/// {@category user32}
Win32Result<int> GetProcessWindowStation() {
...
///
/// {@category user32}
Win32Result<int> GetThreadDesktop(int dwThreadId) {
...
///
/// {@category user32}
Win32Result<bool> GetTitleBarInfo(int hwnd, Pointer<TITLEBARINFO> pti) {
...
///
/// {@category user32}
Win32Result<int> GetTopWindow(int? hWnd) {
  final result_ = GetTopWindow_Wrapper(hWnd ?? NULL);
  return Win32Result(value: result_.value.i64, error: result_.error);
}
...
///
/// {@category user32}
Win32Result<int> GetWindow(int hWnd, GET_WINDOW_CMD uCmd) {
...
///
/// {@category user32}
Win32Result<bool> GetWindowInfo(int hwnd, Pointer<WINDOWINFO> pwi) {
...
///
/// {@category user32}
Win32Result<int> GetWindowLongPtr(int hWnd, WINDOW_LONG_PTR_INDEX nIndex) {
...
///
/// {@category user32}
Win32Result<bool> GetWindowRect(int hWnd, Pointer<RECT> lpRect) {
...
///
/// {@category user32}
Win32Result<int> GetWindowText(int hWnd, PWSTR lpString, int nMaxCount) {
...
///
/// {@category user32}
Win32Result<int> GetWindowTextLength(int hWnd) {
...
///
/// {@category user32}
Win32Result<bool> HideCaret(int? hWnd) {
  final result_ = HideCaret_Wrapper(hWnd ?? NULL);
  return Win32Result(value: result_.value.i32 != FALSE, error: result_.error);
}
...
///
/// {@category user32}
Win32Result<bool> IsImmersiveProcess(int hProcess) {
...
///
/// {@category user32}
Win32Result<bool> KillTimer(int? hWnd, int uIDEvent) {
  final result_ = KillTimer_Wrapper(hWnd ?? NULL, uIDEvent);
  return Win32Result(value: result_.value.i32 != FALSE, error: result_.error);
}
...
///
/// {@category user32}
Win32Result<int> LoadAccelerators(int? hInstance, PCWSTR lpTableName) {
  final result_ = LoadAcceleratorsW_Wrapper(hInstance ?? NULL, lpTableName);
  return Win32Result(value: result_.value.i64, error: result_.error);
}
...
///
/// {@category user32}
Win32Result<int> LoadCursor(int? hInstance, PCWSTR lpCursorName) {
  final result_ = LoadCursorW_Wrapper(hInstance ?? NULL, lpCursorName);
  return Win32Result(value: result_.value.i64, error: result_.error);
}
...
///
/// {@category user32}
Win32Result<int> LoadCursorFromFile(PCWSTR lpFileName) {
...
///
/// {@category user32}
Win32Result<int> LoadIcon(int? hInstance, PCWSTR lpIconName) {
  final result_ = LoadIconW_Wrapper(hInstance ?? NULL, lpIconName);
  return Win32Result(value: result_.value.i64, error: result_.error);
}
...
Win32Result<int> LoadImage(
  ...
  final result_ = LoadImageW_Wrapper(hInst ?? NULL, name, type, cx, cy, fuLoad);
  return Win32Result(value: result_.value.i64, error: result_.error);
}
...
///
/// {@category user32}
Win32Result<int> LoadKeyboardLayout(
  PCWSTR pwszKLID,
  ACTIVATE_KEYBOARD_LAYOUT_FLAGS flags,
) {
...
///
/// {@category user32}
Win32Result<int> LoadMenu(int? hInstance, PCWSTR lpMenuName) {
  final result_ = LoadMenuW_Wrapper(hInstance ?? NULL, lpMenuName);
  return Win32Result(value: result_.value.i64, error: result_.error);
}
...
///
/// {@category user32}
Win32Result<int> LoadMenuIndirect(Pointer lpMenuTemplate) {
...
///
/// {@category user32}
Win32Result<bool> MapDialogRect(int hDlg, Pointer<RECT> lpRect) {
...
///
/// {@category user32}
Win32Result<bool> OpenClipboard(int? hWndNewOwner) {
  final result_ = OpenClipboard_Wrapper(hWndNewOwner ?? NULL);
  return Win32Result(value: result_.value.i32 != FALSE, error: result_.error);
}
...
///
/// {@category user32}
Win32Result<bool> OpenIcon(int hWnd) {
...
///
/// {@category user32}
Win32Result<int> OpenInputDesktop(
  DESKTOP_CONTROL_FLAGS dwFlags,
  bool fInherit,
...
///
/// {@category user32}
Win32Result<int> OpenWindowStation(
  PCWSTR lpszWinSta,
  bool fInherit,
  int dwDesiredAccess,
) {
...
///
/// {@category user32}
Win32Result<bool> PostMessage(int? hWnd, int msg, int wParam, int lParam) {
  final result_ = PostMessageW_Wrapper(hWnd ?? NULL, msg, wParam, lParam);
  return Win32Result(value: result_.value.i32 != FALSE, error: result_.error);
}
...
///
/// {@category user32}
Win32Result<int> RegisterDeviceNotification(
  int hRecipient,
...
Win32Result<bool> RegisterHotKey(
  ...
  final result_ = RegisterHotKey_Wrapper(hWnd ?? NULL, id, fsModifiers, vk);
  return Win32Result(value: result_.value.i32 != FALSE, error: result_.error);
}
...
///
/// {@category user32}
Win32Result<int> RegisterPowerSettingNotification(
  int hRecipient,
...
///
/// {@category user32}
Win32Result<bool> RegisterTouchHitTestingWindow(int hwnd, int value) {
...
///
/// {@category user32}
Win32Result<bool> RemoveClipboardFormatListener(int hwnd) {
...
///
/// {@category user32}
Win32Result<bool> RemoveMenu(int hMenu, int uPosition, MENU_ITEM_FLAGS uFlags) {
...
///
/// {@category user32}
Win32Result<int> RemoveProp(int hWnd, PCWSTR lpString) {
...
///
/// {@category user32}
Win32Result<int> SendMessage(int hWnd, int msg, int? wParam, int? lParam) {
...
///
/// {@category user32}
Win32Result<int> SendMessageTimeout(
  int hWnd,
  int msg,
  int wParam,
  int lParam,
...
///
/// {@category user32}
Win32Result<bool> SendNotifyMessage(int hWnd, int msg, int wParam, int lParam) {
...
///
/// {@category user32}
Win32Result<int> SetActiveWindow(int hWnd) {
...
///
/// {@category user32}
Win32Result<int> SetClipboardData(int uFormat, int? hMem) {
  final result_ = SetClipboardData_Wrapper(uFormat, hMem ?? NULL);
  return Win32Result(value: result_.value.i64, error: result_.error);
}
...
///
/// {@category user32}
Win32Result<int> SetClipboardViewer(int hWndNewViewer) {
...
///
/// {@category user32}
Win32Result<bool> SetDlgItemText(int hDlg, int nIDDlgItem, PCWSTR lpString) {
...
///
/// {@category user32}
Win32Result<int> SetFocus(int? hWnd) {
  final result_ = SetFocus_Wrapper(hWnd ?? NULL);
  return Win32Result(value: result_.value.i64, error: result_.error);
}
...
///
/// {@category user32}
Win32Result<bool> SetMenu(int hWnd, int? hMenu) {
  final result_ = SetMenu_Wrapper(hWnd, hMenu ?? NULL);
  return Win32Result(value: result_.value.i32 != FALSE, error: result_.error);
}
...
///
/// {@category user32}
Win32Result<bool> SetMenuDefaultItem(int hMenu, int uItem, int fByPos) {
...
///
/// {@category user32}
Win32Result<bool> SetMenuInfo(int param0, Pointer<MENUINFO> param1) {
...
///
/// {@category user32}
Win32Result<int> SetParent(int hWndChild, int? hWndNewParent) {
  final result_ = SetParent_Wrapper(hWndChild, hWndNewParent ?? NULL);
  return Win32Result(value: result_.value.i64, error: result_.error);
}
...
///
/// {@category user32}
Win32Result<bool> SetProcessDpiAwarenessContext(int value) {
...
///
/// {@category user32}
Win32Result<bool> SetProp(int hWnd, PCWSTR lpString, int? hData) {
  final result_ = SetPropW_Wrapper(hWnd, lpString, hData ?? NULL);
  return Win32Result(value: result_.value.i32 != FALSE, error: result_.error);
}
...
///
/// {@category user32}
Win32Result<bool> SetSystemCursor(int hcur, SYSTEM_CURSOR_ID id) {
...
///
/// {@category user32}
Win32Result<int> SetWindowsHookEx(
...
///
/// {@category user32}
Win32Result<bool> SetWindowText(int hWnd, PCWSTR? lpString) {
...
///
/// {@category user32}
Win32Result<bool> ShowCaret(int? hWnd) {
  final result_ = ShowCaret_Wrapper(hWnd ?? NULL);
  return Win32Result(value: result_.value.i32 != FALSE, error: result_.error);
}
...
///
/// {@category user32}
Win32Result<bool> ShowOwnedPopups(int hWnd, bool fShow) {
...
///
/// {@category user32}
Win32Result<bool> SwitchDesktop(int hDesktop) {
...
///
/// {@category user32}
Win32Result<bool> UnhookWindowsHookEx(int hhk) {
...
///
/// {@category user32}
Win32Result<bool> UnloadKeyboardLayout(int hkl) {
...
///
/// {@category user32}
Win32Result<bool> UnregisterClass(PCWSTR lpClassName, int? hInstance) {
  final result_ = UnregisterClassW_Wrapper(lpClassName, hInstance ?? NULL);
  return Win32Result(value: result_.value.i32 != FALSE, error: result_.error);
}
...
///
/// {@category user32}
Win32Result<bool> UnregisterDeviceNotification(int handle) {
...
///
/// {@category user32}
Win32Result<bool> UnregisterHotKey(int? hWnd, int id) {
  final result_ = UnregisterHotKey_Wrapper(hWnd ?? NULL, id);
  return Win32Result(value: result_.value.i32 != FALSE, error: result_.error);
}
...
///
/// {@category user32}
Win32Result<bool> UnregisterPowerSettingNotification(int handle) {
...
///
/// {@category user32}
Win32Result<bool> UnregisterTouchWindow(int hwnd) {
