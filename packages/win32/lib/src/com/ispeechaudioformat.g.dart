...
class ISpeechAudioFormat extends IDispatch implements ComInterface {
  ...
  late final _get_TypeFn =
      _vtable.get_Type
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _put_TypeFn =
      _vtable.put_Type.asFunction<int Function(VTablePointer, int)>();
  late final _get_GuidFn =
      _vtable.get_Guid.asFunction<int Function(VTablePointer, Pointer<BSTR>)>();
  late final _put_GuidFn =
      _vtable.put_Guid.asFunction<int Function(VTablePointer, BSTR)>();
  late final _GetWaveFormatExFn =
      _vtable.GetWaveFormatEx.asFunction<
        int Function(VTablePointer, Pointer<VTablePointer>)
      >();
  late final _SetWaveFormatExFn =
