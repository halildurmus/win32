...
class IAppxFactory extends IUnknown implements ComInterface {
  ...
  factory IAppxFactory.from(IUnknown interface) => interface.queryInterface();
  ...
  IAppxPackageWriter? createPackageWriter(
    ...
    final packageWriter = adaptiveCalloc<VTablePointer>();
    final hr$ = HRESULT(
  ...
  IAppxPackageReader? createPackageReader(IStream? inputStream) {
    final packageReader = adaptiveCalloc<VTablePointer>();
    final hr$ = HRESULT(
