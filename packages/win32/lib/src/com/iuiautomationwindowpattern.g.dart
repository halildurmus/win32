...
class IUIAutomationWindowPattern extends IUnknown implements ComInterface {
  ...
  late final _WaitForInputIdleFn =
      ...
      >();
  late final _SetWindowVisualStateFn =
      _vtable
          .SetWindowVisualState.asFunction<int Function(VTablePointer, int)>();
  late final _get_CurrentCanMaximizeFn =
      _vtable.get_CurrentCanMaximize
          .asFunction<int Function(VTablePointer, Pointer<BOOL>)>();
  late final _get_CurrentCanMinimizeFn =
      _vtable.get_CurrentCanMinimize
          .asFunction<int Function(VTablePointer, Pointer<BOOL>)>();
  late final _get_CurrentIsModalFn =
      _vtable.get_CurrentIsModal
          .asFunction<int Function(VTablePointer, Pointer<BOOL>)>();
  late final _get_CurrentIsTopmostFn =
      _vtable.get_CurrentIsTopmost
          .asFunction<int Function(VTablePointer, Pointer<BOOL>)>();
  late final _get_CurrentWindowVisualStateFn =
      _vtable.get_CurrentWindowVisualState
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_CurrentWindowInteractionStateFn =
      _vtable.get_CurrentWindowInteractionState
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_CachedCanMaximizeFn =
      _vtable.get_CachedCanMaximize
          .asFunction<int Function(VTablePointer, Pointer<BOOL>)>();
  late final _get_CachedCanMinimizeFn =
      _vtable.get_CachedCanMinimize
          .asFunction<int Function(VTablePointer, Pointer<BOOL>)>();
  late final _get_CachedIsModalFn =
      _vtable.get_CachedIsModal
          .asFunction<int Function(VTablePointer, Pointer<BOOL>)>();
  late final _get_CachedIsTopmostFn =
      _vtable.get_CachedIsTopmost
          .asFunction<int Function(VTablePointer, Pointer<BOOL>)>();
  late final _get_CachedWindowVisualStateFn =
      _vtable.get_CachedWindowVisualState
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_CachedWindowInteractionStateFn =
