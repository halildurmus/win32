...
class IAccessible extends IDispatch implements ComInterface {
  ...
  late final _get_accParentFn =
      _vtable.get_accParent
          .asFunction<int Function(VTablePointer, Pointer<VTablePointer>)>();
  late final _get_accChildCountFn =
      _vtable.get_accChildCount
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_accChildFn =
      _vtable.get_accChild
          .asFunction<
            int Function(VTablePointer, VARIANT, Pointer<VTablePointer>)
          >();
  late final _get_accNameFn =
      _vtable.get_accName
          .asFunction<int Function(VTablePointer, VARIANT, Pointer<BSTR>)>();
  late final _get_accValueFn =
      _vtable.get_accValue
          .asFunction<int Function(VTablePointer, VARIANT, Pointer<BSTR>)>();
  late final _get_accDescriptionFn =
      _vtable.get_accDescription
          .asFunction<int Function(VTablePointer, VARIANT, Pointer<BSTR>)>();
  late final _get_accRoleFn =
      _vtable.get_accRole
          .asFunction<int Function(VTablePointer, VARIANT, Pointer<VARIANT>)>();
  late final _get_accStateFn =
      _vtable.get_accState
          .asFunction<int Function(VTablePointer, VARIANT, Pointer<VARIANT>)>();
  late final _get_accHelpFn =
      _vtable.get_accHelp
          .asFunction<int Function(VTablePointer, VARIANT, Pointer<BSTR>)>();
  late final _get_accHelpTopicFn =
      _vtable.get_accHelpTopic
          .asFunction<
            int Function(VTablePointer, Pointer<BSTR>, VARIANT, Pointer<Int32>)
          >();
  late final _get_accKeyboardShortcutFn =
      _vtable.get_accKeyboardShortcut
          .asFunction<int Function(VTablePointer, VARIANT, Pointer<BSTR>)>();
  late final _get_accFocusFn =
      _vtable.get_accFocus
          .asFunction<int Function(VTablePointer, Pointer<VARIANT>)>();
  late final _get_accSelectionFn =
      _vtable.get_accSelection
          .asFunction<int Function(VTablePointer, Pointer<VARIANT>)>();
  late final _get_accDefaultActionFn =
      _vtable.get_accDefaultAction
          .asFunction<int Function(VTablePointer, VARIANT, Pointer<BSTR>)>();
  late final _accSelectFn =
      _vtable.accSelect.asFunction<int Function(VTablePointer, int, VARIANT)>();
  late final _accLocationFn =
      _vtable.accLocation
          .asFunction<
            int Function(
              VTablePointer,
