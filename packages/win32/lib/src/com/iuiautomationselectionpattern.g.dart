...
class IUIAutomationSelectionPattern extends IUnknown implements ComInterface {
  ...
  late final _GetCurrentSelectionFn =
      ...
      >();
  late final _get_CurrentCanSelectMultipleFn =
      _vtable.get_CurrentCanSelectMultiple
          .asFunction<int Function(VTablePointer, Pointer<BOOL>)>();
  late final _get_CurrentIsSelectionRequiredFn =
  ...
  late final _GetCachedSelectionFn =
      _vtable.GetCachedSelection.asFunction<
        int Function(VTablePointer, Pointer<VTablePointer>)
      >();
  late final _get_CachedCanSelectMultipleFn =
      _vtable.get_CachedCanSelectMultiple
          .asFunction<int Function(VTablePointer, Pointer<BOOL>)>();
  late final _get_CachedIsSelectionRequiredFn =
