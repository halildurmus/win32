...
class IUIAutomationGridPattern extends IUnknown implements ComInterface {
  ...
  late final _GetItemFn =
      ...
      >();
  late final _get_CurrentRowCountFn =
      _vtable.get_CurrentRowCount
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_CurrentColumnCountFn =
      _vtable.get_CurrentColumnCount
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_CachedRowCountFn =
      _vtable.get_CachedRowCount
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_CachedColumnCountFn =
