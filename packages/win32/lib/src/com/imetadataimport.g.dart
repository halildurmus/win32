...
final IID_IMetaDataImport = GUID.fromComponents(
  ...
  0xd3ae,
  0x4c75,
  .fromList(const [0x9b, 0x67, 0x92, 0x80, 0x1a, 0x49, 0x7d, 0x44]),
);
...
class IMetaDataImport extends IUnknown implements ComInterface {
  ...
  late final _GetModuleRefPropsFn =
      _vtable.GetModuleRefProps.asFunction<
        int Function(VTablePointer, int, Pointer<Utf16>, int, Pointer<Uint32>)
      >();
  ...
  late final _FindTypeRefFn =
      _vtable.FindTypeRef.asFunction<
        int Function(VTablePointer, int, Pointer<Utf16>, Pointer<Uint32>)
      >();
...
base class IMetaDataImportVtbl extends Struct {
  ...
  external Pointer<
    NativeFunction<Int32 Function(VTablePointer this$, Uint32 tk)>
  >
  IsValidToken;
  external Pointer<
    NativeFunction<
