...
class IPersistFile extends IPersist implements ComInterface {
  ...
  factory IPersistFile.from(IUnknown interface) => interface.queryInterface();

  final IPersistFileVtbl _vtable;
  late final _IsDirtyFn =
      _vtable.IsDirty.asFunction<int Function(VTablePointer)>();
  late final _LoadFn = _vtable
      .Load.asFunction<int Function(VTablePointer, Pointer<Utf16>, int)>();
  late final _SaveFn = _vtable
      .Save.asFunction<int Function(VTablePointer, Pointer<Utf16>, int)>();
  late final _SaveCompletedFn = _vtable
      .SaveCompleted.asFunction<int Function(VTablePointer, Pointer<Utf16>)>();
  late final _GetCurFileFn =
  ...
  PWSTR getCurFile() {
    final ppszFileName = adaptiveCalloc<Pointer<Utf16>>();
...
base class IPersistFileVtbl extends Struct {
  ...
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Pointer<Utf16> pszFileName)
    >
  >
  SaveCompleted;
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Pointer<Pointer<Utf16>> ppszFileName)
    >
  >
  GetCurFile;
}
