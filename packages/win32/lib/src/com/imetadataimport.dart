...
class IMetaDataImport extends IUnknown {
  ...
  int countEnum(Pointer hEnum, Pointer<Uint32> pulCount) => (ptr.ref.vtable + 4)
      .cast<
        Pointer<
          NativeFunction<
            Int32 Function(Pointer, Pointer hEnum, Pointer<Uint32> pulCount)
          >
        >
      >()
      .value
  ...
  int resetEnum(Pointer hEnum, int ulPos) => (ptr.ref.vtable + 5)
      .cast<
        Pointer<
          NativeFunction<Int32 Function(Pointer, Pointer hEnum, Uint32 ulPos)>
        >
      >()
      .value
      .asFunction<
  ...
  int getInterfaceImplProps(
    ...
    Pointer<Uint32> ptkIface,
      ...
      >()(ptr.ref.lpVtbl, iiImpl, pClass, ptkIface);
  ...
  int getNameFromToken(int tk, Pointer<Pointer<Int8>> pszUtf8NamePtr) =>
      (ptr.ref.vtable + 45)
          ...
          .value
          .asFunction<
            int Function(Pointer, int tk, Pointer<Pointer<Int8>> pszUtf8NamePtr)
  ...
  int getParamForMethodIndex(int md, int ulParamSeq, Pointer<Uint32> ppd) =>
      (ptr.ref.vtable + 52)
          ...
          .value
          .asFunction<
            int Function(Pointer, int md, int ulParamSeq, Pointer<Uint32> ppd)
          >()(ptr.ref.lpVtbl, md, ulParamSeq, ppd);
