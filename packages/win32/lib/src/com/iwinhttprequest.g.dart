...
final IID_IWinHttpRequest = GUID.fromComponents(
  ...
  0xb2c8,
  0x45f8,
  .fromList(const [0xb2, 0x3b, 0x39, 0xe5, 0x3a, 0x75, 0x39, 0x6b]),
);
...
class IWinHttpRequest extends IDispatch implements ComInterface {
  ...
  late final _SetCredentialsFn =
      _vtable.SetCredentials.asFunction<
        int Function(VTablePointer, Pointer<Utf16>, Pointer<Utf16>, int)
      >();
  late final _OpenFn =
      _vtable.Open.asFunction<
        int Function(VTablePointer, Pointer<Utf16>, Pointer<Utf16>, VARIANT)
      >();
  late final _SetRequestHeaderFn =
  ...
  late final _WaitForResponseFn =
      _vtable.WaitForResponse.asFunction<
        int Function(VTablePointer, VARIANT, Pointer<Int16>)
      >();
  ...
  late final _SetTimeoutsFn =
      ...
      >();
  late final _SetClientCertificateFn =
  ...
  BSTR getAllResponseHeaders() {
    final headers = adaptiveCalloc<Pointer<Utf16>>();
  ...
  BSTR get statusText {
    final status = adaptiveCalloc<Pointer<Utf16>>();
  ...
  Pointer<VARIANT> get responseBody {
    final body = adaptiveCalloc<VARIANT>();
  ...
  bool waitForResponse(VARIANT timeout) {
    final succeeded = adaptiveCalloc<Int16>();
...
base class IWinHttpRequestVtbl extends Struct {
  ...
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Pointer<Pointer<Utf16>> headers)
    >
  >
  ...
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Pointer<Pointer<Utf16>> status)
    >
  >
  get_StatusText;
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Pointer<Pointer<Utf16>> body)
    >
  >
  get_ResponseText;
  external Pointer<
  ...
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Pointer<Utf16> clientCertificate)
    >
  >
