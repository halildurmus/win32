...
class IWinHttpRequest extends IDispatch implements ComInterface {
  ...
  late final _SetRequestHeaderFn =
      _vtable.SetRequestHeader.asFunction<
        int Function(VTablePointer, BSTR, BSTR)
      >();
  ...
  late final _get_StatusTextFn =
      _vtable.get_StatusText
          .asFunction<int Function(VTablePointer, Pointer<BSTR>)>();
  late final _get_ResponseTextFn =
      _vtable.get_ResponseText
          .asFunction<int Function(VTablePointer, Pointer<BSTR>)>();
  late final _get_ResponseBodyFn =
      _vtable.get_ResponseBody
          .asFunction<int Function(VTablePointer, Pointer<VARIANT>)>();
  late final _get_ResponseStreamFn =
      _vtable.get_ResponseStream
          .asFunction<int Function(VTablePointer, Pointer<VARIANT>)>();
  late final _get_OptionFn =
      _vtable.get_Option
          .asFunction<int Function(VTablePointer, int, Pointer<VARIANT>)>();
  late final _put_OptionFn =
      _vtable.put_Option
