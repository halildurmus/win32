...
class ISpeechVoiceStatus extends IDispatch implements ComInterface {
  ...
  int get lastHResult {
    final hResult = adaptiveCalloc<Int32>();
  ...
  BSTR get lastBookmark {
    final bookmark = adaptiveCalloc<Pointer<Utf16>>();
  ...
  int get lastBookmarkId {
    final bookmarkId = adaptiveCalloc<Int32>();
  ...
  int get phonemeId {
    final phoneId = adaptiveCalloc<Int16>();
  ...
  int get visemeId {
    final visemeId = adaptiveCalloc<Int16>();
...
base class ISpeechVoiceStatusVtbl extends Struct {
  ...
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Pointer<Pointer<Utf16>> bookmark)
    >
  >
  get_LastBookmark;
  external Pointer<
