...
class ISpeechVoiceStatus extends IDispatch implements ComInterface {
  ...
  late final _get_CurrentStreamNumberFn =
      _vtable.get_CurrentStreamNumber
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_LastStreamNumberQueuedFn =
      _vtable.get_LastStreamNumberQueued
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_LastHResultFn =
      _vtable.get_LastHResult
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_RunningStateFn =
      _vtable.get_RunningState
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_InputWordPositionFn =
      _vtable.get_InputWordPosition
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_InputWordLengthFn =
      _vtable.get_InputWordLength
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_InputSentencePositionFn =
      _vtable.get_InputSentencePosition
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_InputSentenceLengthFn =
      _vtable.get_InputSentenceLength
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_LastBookmarkFn =
      _vtable.get_LastBookmark
          .asFunction<int Function(VTablePointer, Pointer<BSTR>)>();
  late final _get_LastBookmarkIdFn =
      _vtable.get_LastBookmarkId
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_PhonemeIdFn =
      _vtable.get_PhonemeId
          .asFunction<int Function(VTablePointer, Pointer<Int16>)>();
  late final _get_VisemeIdFn =
      _vtable.get_VisemeId
          .asFunction<int Function(VTablePointer, Pointer<Int16>)>();
