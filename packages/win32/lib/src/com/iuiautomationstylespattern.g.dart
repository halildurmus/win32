...
class IUIAutomationStylesPattern extends IUnknown implements ComInterface {
  ...
  late final _get_CurrentStyleIdFn =
      _vtable.get_CurrentStyleId
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_CurrentStyleNameFn =
      _vtable.get_CurrentStyleName
          .asFunction<int Function(VTablePointer, Pointer<BSTR>)>();
  late final _get_CurrentFillColorFn =
      _vtable.get_CurrentFillColor
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_CurrentFillPatternStyleFn =
      _vtable.get_CurrentFillPatternStyle
          .asFunction<int Function(VTablePointer, Pointer<BSTR>)>();
  late final _get_CurrentShapeFn =
      _vtable.get_CurrentShape
          .asFunction<int Function(VTablePointer, Pointer<BSTR>)>();
  late final _get_CurrentFillPatternColorFn =
      _vtable.get_CurrentFillPatternColor
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_CurrentExtendedPropertiesFn =
      _vtable.get_CurrentExtendedProperties
          .asFunction<int Function(VTablePointer, Pointer<BSTR>)>();
  late final _GetCurrentExtendedPropertiesAsArrayFn =
      ...
      >();
  late final _get_CachedStyleIdFn =
      _vtable.get_CachedStyleId
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_CachedStyleNameFn =
      _vtable.get_CachedStyleName
          .asFunction<int Function(VTablePointer, Pointer<BSTR>)>();
  late final _get_CachedFillColorFn =
      _vtable.get_CachedFillColor
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_CachedFillPatternStyleFn =
      _vtable.get_CachedFillPatternStyle
          .asFunction<int Function(VTablePointer, Pointer<BSTR>)>();
  late final _get_CachedShapeFn =
      _vtable.get_CachedShape
          .asFunction<int Function(VTablePointer, Pointer<BSTR>)>();
  late final _get_CachedFillPatternColorFn =
      _vtable.get_CachedFillPatternColor
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_CachedExtendedPropertiesFn =
      _vtable.get_CachedExtendedProperties
          .asFunction<int Function(VTablePointer, Pointer<BSTR>)>();
