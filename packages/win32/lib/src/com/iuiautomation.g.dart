...
class IUIAutomation extends IUnknown implements ComInterface {
  ...
  late final _CreateTreeWalkerFn =
      _vtable.CreateTreeWalker.asFunction<
        int Function(VTablePointer, VTablePointer, Pointer<VTablePointer>)
      >();
  late final _get_ControlViewWalkerFn =
      _vtable.get_ControlViewWalker
          .asFunction<int Function(VTablePointer, Pointer<VTablePointer>)>();
  late final _get_ContentViewWalkerFn =
      _vtable.get_ContentViewWalker
          .asFunction<int Function(VTablePointer, Pointer<VTablePointer>)>();
  late final _get_RawViewWalkerFn =
      _vtable.get_RawViewWalker
          .asFunction<int Function(VTablePointer, Pointer<VTablePointer>)>();
  late final _get_RawViewConditionFn =
      _vtable.get_RawViewCondition
          .asFunction<int Function(VTablePointer, Pointer<VTablePointer>)>();
  late final _get_ControlViewConditionFn =
      _vtable.get_ControlViewCondition
          .asFunction<int Function(VTablePointer, Pointer<VTablePointer>)>();
  late final _get_ContentViewConditionFn =
      _vtable.get_ContentViewCondition
          .asFunction<int Function(VTablePointer, Pointer<VTablePointer>)>();
  ...
  late final _CreateProxyFactoryEntryFn =
      _vtable.CreateProxyFactoryEntry.asFunction<
        int Function(VTablePointer, VTablePointer, Pointer<VTablePointer>)
      >();
  late final _get_ProxyFactoryMappingFn =
      _vtable.get_ProxyFactoryMapping
          .asFunction<int Function(VTablePointer, Pointer<VTablePointer>)>();
  ...
  late final _CheckNotSupportedFn =
      ...
      >();
  late final _get_ReservedNotSupportedValueFn =
      _vtable.get_ReservedNotSupportedValue
          .asFunction<int Function(VTablePointer, Pointer<VTablePointer>)>();
  late final _get_ReservedMixedAttributeValueFn =
      _vtable.get_ReservedMixedAttributeValue
          .asFunction<int Function(VTablePointer, Pointer<VTablePointer>)>();
