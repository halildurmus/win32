...
class IUIAutomation extends IUnknown implements ComInterface {
  ...
  factory IUIAutomation.from(IUnknown interface) => interface.queryInterface();
  ...
  late final _CheckNotSupportedFn =
      _vtable.CheckNotSupported.asFunction<
        int Function(VTablePointer, VARIANT, Pointer<Int32>)
      >();
  ...
  IUIAutomationCondition? get rawViewCondition {
    final condition = adaptiveCalloc<VTablePointer>();
  ...
  Pointer<SAFEARRAY> intNativeArrayToSafeArray(
    ...
    final safeArray = adaptiveCalloc<Pointer<SAFEARRAY>>();
    final hr$ = HRESULT(
  ...
  Pointer<VARIANT> rectToVariant(RECT rc) {
    final var$ = adaptiveCalloc<VARIANT>();
  ...
  IUIAutomationProxyFactoryMapping? get proxyFactoryMapping {
    final factoryMapping = adaptiveCalloc<VTablePointer>();
  ...
  bool checkNotSupported(VARIANT value) {
    final isNotSupported = adaptiveCalloc<Int32>();
  ...
  IUnknown? get reservedMixedAttributeValue {
    final mixedAttributeValue = adaptiveCalloc<VTablePointer>();
    final hr$ = HRESULT(
