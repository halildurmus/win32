...
class ISpeechObjectToken extends IDispatch implements ComInterface {
  ...
  late final _RemoveFn =
      _vtable.Remove.asFunction<int Function(VTablePointer, Pointer<Utf16>)>();
  ...
  late final _MatchesAttributesFn =
      _vtable.MatchesAttributes.asFunction<
        int Function(VTablePointer, Pointer<Utf16>, Pointer<Int16>)
      >();

  BSTR get id {
    final objectId = adaptiveCalloc<Pointer<Utf16>>();
  ...
  ISpeechObjectTokenCategory? get category {
    final category = adaptiveCalloc<VTablePointer>();
  ...
  BSTR getDescription(int locale) {
    final description = adaptiveCalloc<Pointer<Utf16>>();
  ...
  IUnknown? createInstance(IUnknown? pUnkOuter, SpeechTokenContext clsContext) {
    final object = adaptiveCalloc<VTablePointer>();
    final hr$ = HRESULT(
  ...
  BSTR getStorageFileName(
    ...
    final filePath = adaptiveCalloc<Pointer<Utf16>>();
    final hr$ = HRESULT(
  ...
  bool matchesAttributes(BSTR attributes) {
    final matches = adaptiveCalloc<Int16>();
...
base class ISpeechObjectTokenVtbl extends Struct {
  ...
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Pointer<Pointer<Utf16>> objectId)
    >
  >
  get_Id;
  external Pointer<
  ...
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Pointer<Utf16> objectStorageCLSID)
    >
  >
  Remove;
  external Pointer<
