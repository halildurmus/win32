...
class IAppxManifestQualifiedResource extends IUnknown implements ComInterface {
  ...
  factory IAppxManifestQualifiedResource.from(IUnknown interface) =>
      interface.queryInterface();

  final IAppxManifestQualifiedResourceVtbl _vtable;
  late final _GetLanguageFn =
      _vtable.GetLanguage.asFunction<
  ...
  PWSTR getLanguage() {
    final language = adaptiveCalloc<Pointer<Utf16>>();
...
base class IAppxManifestQualifiedResourceVtbl extends Struct {
  ...
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Pointer<Pointer<Utf16>> language)
    >
  >
  GetLanguage;
  external Pointer<
