...
class IUIAutomationTextRange extends IUnknown implements ComInterface {
  ...
  IUIAutomationTextRange? clone() {
    final clonedRange = adaptiveCalloc<VTablePointer>();
  ...
  int compareEndpoints(
    ...
    final compValue = adaptiveCalloc<Int32>();
    final hr$ = HRESULT(
      _CompareEndpointsFn(
        ptr,
        srcEndPoint,
  ...
  Pointer<SAFEARRAY> getBoundingRectangles() {
    final boundingRects = adaptiveCalloc<Pointer<SAFEARRAY>>();
  ...
  IUIAutomationElement? getEnclosingElement() {
    final enclosingElement = adaptiveCalloc<VTablePointer>();
  ...
  int move(TextUnit unit, int count) {
    final moved = adaptiveCalloc<Int32>();
...
base class IUIAutomationTextRangeVtbl extends Struct {
  ...
  RemoveFromSelection;
  external Pointer<
    NativeFunction<Int32 Function(VTablePointer this$, Int32 alignToTop)>
  >
  ScrollIntoView;
  external Pointer<
    NativeFunction<
