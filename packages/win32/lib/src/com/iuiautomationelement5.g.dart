...
class IUIAutomationElement5 extends IUIAutomationElement4
  ...
  late final _get_CurrentLandmarkTypeFn =
      _vtable.get_CurrentLandmarkType
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_CurrentLocalizedLandmarkTypeFn =
      _vtable.get_CurrentLocalizedLandmarkType
          .asFunction<int Function(VTablePointer, Pointer<BSTR>)>();
  late final _get_CachedLandmarkTypeFn =
      _vtable.get_CachedLandmarkType
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_CachedLocalizedLandmarkTypeFn =
      _vtable.get_CachedLocalizedLandmarkType
          .asFunction<int Function(VTablePointer, Pointer<BSTR>)>();
