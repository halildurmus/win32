...
class IUIAutomationDragPattern extends IUnknown implements ComInterface {
  ...
  late final _get_CurrentIsGrabbedFn =
      _vtable.get_CurrentIsGrabbed
          .asFunction<int Function(VTablePointer, Pointer<BOOL>)>();
  late final _get_CachedIsGrabbedFn =
      _vtable.get_CachedIsGrabbed
          .asFunction<int Function(VTablePointer, Pointer<BOOL>)>();
  late final _get_CurrentDropEffectFn =
      _vtable.get_CurrentDropEffect
          .asFunction<int Function(VTablePointer, Pointer<BSTR>)>();
  late final _get_CachedDropEffectFn =
      _vtable.get_CachedDropEffect
          .asFunction<int Function(VTablePointer, Pointer<BSTR>)>();
  late final _get_CurrentDropEffectsFn =
      _vtable.get_CurrentDropEffects
          .asFunction<
            int Function(VTablePointer, Pointer<Pointer<SAFEARRAY>>)
          >();
  late final _get_CachedDropEffectsFn =
      _vtable.get_CachedDropEffects
          .asFunction<
            int Function(VTablePointer, Pointer<Pointer<SAFEARRAY>>)
          >();
