...
class ISpeechVoice extends IDispatch implements ComInterface {
  ...
  factory ISpeechVoice.from(IUnknown interface) => interface.queryInterface();
  ...
  late final _WaitUntilDoneFn =
      _vtable.WaitUntilDone.asFunction<
        int Function(VTablePointer, int, Pointer<Int16>)
      >();
  ...
  ISpeechVoiceStatus? get status {
    final status = adaptiveCalloc<VTablePointer>();
  ...
  ISpeechObjectToken? get voice {
    final voice = adaptiveCalloc<VTablePointer>();
  ...
  ISpeechObjectToken? get audioOutput {
    final audioOutput = adaptiveCalloc<VTablePointer>();
  ...
  ISpeechBaseStream? get audioOutputStream {
    final audioOutputStream = adaptiveCalloc<VTablePointer>();
  ...
  int get rate {
    final rate = adaptiveCalloc<Int32>();
  ...
  int get volume {
    final volume = adaptiveCalloc<Int32>();
  ...
  bool get allowAudioOutputFormatChangesOnNextSet {
    final allow = adaptiveCalloc<Int16>();
    final hr$ = HRESULT(
  ...
  SpeechVoiceEvents get eventInterests {
    final eventInterestFlags = adaptiveCalloc<Int32>();
  ...
  SpeechVoicePriority get priority {
    final priority = adaptiveCalloc<Int32>();
  ...
  SpeechVoiceEvents get alertBoundary {
    final boundary = adaptiveCalloc<Int32>();
  ...
  int get synchronousSpeakTimeout {
    final msTimeout = adaptiveCalloc<Int32>();
  ...
  int speak(BSTR text, SpeechVoiceSpeakFlags flags) {
    final streamNumber = adaptiveCalloc<Int32>();
  ...
  int skip(BSTR type, int numItems) {
    final numSkipped = adaptiveCalloc<Int32>();
  ...
  int speakCompleteEvent() {
    final handle = adaptiveCalloc<Int32>();
...
base class ISpeechVoiceVtbl extends Struct {
  ...
  put_Volume;
  external Pointer<
    NativeFunction<Int32 Function(VTablePointer this$, Int16 allow)>
  >
  put_AllowAudioOutputFormatChangesOnNextSet;
  external Pointer<
    NativeFunction<Int32 Function(VTablePointer this$, Pointer<Int16> allow)>
  >
  get_AllowAudioOutputFormatChangesOnNextSet;
  external Pointer<
    NativeFunction<
  ...
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Int32 msTimeout, Pointer<Int16> done)
    >
  >
  WaitUntilDone;
  external Pointer<
