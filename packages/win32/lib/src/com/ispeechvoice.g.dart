...
class ISpeechVoice extends IDispatch implements ComInterface {
  ...
  late final _get_StatusFn =
      _vtable.get_Status
          .asFunction<int Function(VTablePointer, Pointer<VTablePointer>)>();
  late final _get_VoiceFn =
      _vtable.get_Voice
          .asFunction<int Function(VTablePointer, Pointer<VTablePointer>)>();
  late final _putref_VoiceFn =
      _vtable.putref_Voice
          .asFunction<int Function(VTablePointer, VTablePointer)>();
  late final _get_AudioOutputFn =
      _vtable.get_AudioOutput
          .asFunction<int Function(VTablePointer, Pointer<VTablePointer>)>();
  late final _putref_AudioOutputFn =
      _vtable.putref_AudioOutput
          .asFunction<int Function(VTablePointer, VTablePointer)>();
  late final _get_AudioOutputStreamFn =
      _vtable.get_AudioOutputStream
          .asFunction<int Function(VTablePointer, Pointer<VTablePointer>)>();
  late final _putref_AudioOutputStreamFn =
      _vtable.putref_AudioOutputStream
          .asFunction<int Function(VTablePointer, VTablePointer)>();
  late final _get_RateFn =
      _vtable.get_Rate
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _put_RateFn =
      _vtable.put_Rate.asFunction<int Function(VTablePointer, int)>();
  late final _get_VolumeFn =
      _vtable.get_Volume
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _put_VolumeFn =
      _vtable.put_Volume.asFunction<int Function(VTablePointer, int)>();
  late final _put_AllowAudioOutputFormatChangesOnNextSetFn =
      _vtable.put_AllowAudioOutputFormatChangesOnNextSet
          .asFunction<int Function(VTablePointer, int)>();
  late final _get_AllowAudioOutputFormatChangesOnNextSetFn =
      _vtable.get_AllowAudioOutputFormatChangesOnNextSet
          .asFunction<int Function(VTablePointer, Pointer<VARIANT_BOOL>)>();
  late final _get_EventInterestsFn =
      _vtable.get_EventInterests
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _put_EventInterestsFn =
      _vtable.put_EventInterests.asFunction<int Function(VTablePointer, int)>();
  late final _put_PriorityFn =
      _vtable.put_Priority.asFunction<int Function(VTablePointer, int)>();
  late final _get_PriorityFn =
      _vtable.get_Priority
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _put_AlertBoundaryFn =
      _vtable.put_AlertBoundary.asFunction<int Function(VTablePointer, int)>();
  late final _get_AlertBoundaryFn =
      _vtable.get_AlertBoundary
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _put_SynchronousSpeakTimeoutFn =
      _vtable.put_SynchronousSpeakTimeout
          .asFunction<int Function(VTablePointer, int)>();
  late final _get_SynchronousSpeakTimeoutFn =
      _vtable.get_SynchronousSpeakTimeout
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _SpeakFn =
