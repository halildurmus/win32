...
final IID_IAudioClock = GUID.fromComponents(
  ...
  0x3fba,
  0x4a1b,
  .fromList(const [0x81, 0x2c, 0xef, 0x96, 0x35, 0x87, 0x28, 0xe7]),
);
...
class IAudioClock extends IUnknown implements ComInterface {
  ...
  factory IAudioClock.from(IUnknown interface) => interface.queryInterface();
  ...
  int getFrequency() {
    final pu64Frequency = adaptiveCalloc<Uint64>();
  ...
  int getCharacteristics() {
    final pdwCharacteristics = adaptiveCalloc<Uint32>();
