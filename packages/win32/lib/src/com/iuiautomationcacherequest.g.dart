...
class IUIAutomationCacheRequest extends IUnknown implements ComInterface {
  ...
  late final _CloneFn =
      ...
      >();
  late final _get_TreeScopeFn =
      _vtable.get_TreeScope
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _put_TreeScopeFn =
      _vtable.put_TreeScope.asFunction<int Function(VTablePointer, int)>();
  late final _get_TreeFilterFn =
      _vtable.get_TreeFilter
          .asFunction<int Function(VTablePointer, Pointer<VTablePointer>)>();
  late final _put_TreeFilterFn =
      _vtable.put_TreeFilter
          .asFunction<int Function(VTablePointer, VTablePointer)>();
  late final _get_AutomationElementModeFn =
      _vtable.get_AutomationElementMode
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _put_AutomationElementModeFn =
      _vtable.put_AutomationElementMode
