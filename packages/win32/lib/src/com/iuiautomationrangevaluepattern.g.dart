...
class IUIAutomationRangeValuePattern extends IUnknown implements ComInterface {
  ...
  late final _get_CurrentIsReadOnlyFn =
      _vtable.get_CurrentIsReadOnly
          .asFunction<int Function(VTablePointer, Pointer<BOOL>)>();
  late final _get_CurrentMaximumFn =
      _vtable.get_CurrentMaximum
          .asFunction<int Function(VTablePointer, Pointer<Double>)>();
  late final _get_CurrentMinimumFn =
      _vtable.get_CurrentMinimum
          .asFunction<int Function(VTablePointer, Pointer<Double>)>();
  late final _get_CurrentLargeChangeFn =
      _vtable.get_CurrentLargeChange
          .asFunction<int Function(VTablePointer, Pointer<Double>)>();
  late final _get_CurrentSmallChangeFn =
      _vtable.get_CurrentSmallChange
          .asFunction<int Function(VTablePointer, Pointer<Double>)>();
  late final _get_CachedValueFn =
      _vtable.get_CachedValue
          .asFunction<int Function(VTablePointer, Pointer<Double>)>();
  late final _get_CachedIsReadOnlyFn =
      _vtable.get_CachedIsReadOnly
          .asFunction<int Function(VTablePointer, Pointer<BOOL>)>();
  late final _get_CachedMaximumFn =
      _vtable.get_CachedMaximum
          .asFunction<int Function(VTablePointer, Pointer<Double>)>();
  late final _get_CachedMinimumFn =
      _vtable.get_CachedMinimum
          .asFunction<int Function(VTablePointer, Pointer<Double>)>();
  late final _get_CachedLargeChangeFn =
      _vtable.get_CachedLargeChange
          .asFunction<int Function(VTablePointer, Pointer<Double>)>();
  late final _get_CachedSmallChangeFn =
      _vtable.get_CachedSmallChange
          .asFunction<int Function(VTablePointer, Pointer<Double>)>();
