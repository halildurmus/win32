...
class ISpVoice extends ISpEventSource implements ComInterface {
  ...
  factory ISpVoice.from(IUnknown interface) => interface.queryInterface();
  ...
  late final _SpeakCompleteEventFn =
      _vtable.SpeakCompleteEvent.asFunction<Pointer Function(VTablePointer)>();
  ...
  ISpObjectToken? getOutputObjectToken() {
    final ppObjectToken = adaptiveCalloc<VTablePointer>();
  ...
  ISpStreamFormat? getOutputStream() {
    final ppStream = adaptiveCalloc<VTablePointer>();
  ...
  ISpObjectToken? getVoice() {
    final ppToken = adaptiveCalloc<VTablePointer>();
  ...
  @pragma('vm:prefer-inline')
  HANDLE speakCompleteEvent() => HANDLE(_SpeakCompleteEventFn(ptr));
