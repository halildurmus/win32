...
class IUIAutomationLegacyIAccessiblePattern extends IUnknown {
  ...
  int setValue(Pointer<Utf16> szValue) => (ptr.ref.vtable + 5)
      ...
      .value
      .asFunction<
        int Function(Pointer, Pointer<Utf16> szValue)
  ...
  int get currentChildId {
    ...
    try {
      final hr = (ptr.ref.vtable + 6)
          ...
          .value
          .asFunction<
            int Function(Pointer, Pointer<Int32> pRetVal)
  ...
  int get currentRole {
    ...
    try {
      final hr = (ptr.ref.vtable + 10)
          ...
          .value
          .asFunction<
            int Function(Pointer, Pointer<Uint32> pdwRole)
          >()(ptr.ref.lpVtbl, retValuePtr);
  ...
  int get currentState {
    ...
    try {
      final hr = (ptr.ref.vtable + 11)
          ...
          .value
          .asFunction<
            int Function(Pointer, Pointer<Uint32> pdwState)
          >()(ptr.ref.lpVtbl, retValuePtr);
