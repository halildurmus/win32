...
class IAppxFile extends IUnknown implements ComInterface {
  ...
  factory IAppxFile.from(IUnknown interface) => interface.queryInterface();
  ...
  APPX_COMPRESSION_OPTION getCompressionOption() {
    final compressionOption = adaptiveCalloc<Int32>();
  ...
  PWSTR getName() {
    final fileName = adaptiveCalloc<Pointer<Utf16>>();
  ...
  int getSize() {
    final size = adaptiveCalloc<Uint64>();
  ...
  IStream? getStream() {
    final stream = adaptiveCalloc<VTablePointer>();
...
base class IAppxFileVtbl extends Struct {
  ...
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Pointer<Pointer<Utf16>> contentType)
    >
  >
  GetContentType;
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Pointer<Pointer<Utf16>> fileName)
    >
  >
  GetName;
  external Pointer<
