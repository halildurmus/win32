...
final IID_IAudioClient2 = GUID.fromComponents(
  ...
  0xf60a,
  0x4eda,
  .fromList(const [0x82, 0xde, 0xe4, 0x76, 0x10, 0xcd, 0x78, 0xaa]),
);
...
class IAudioClient2 extends IAudioClient implements ComInterface {
  ...
  factory IAudioClient2.from(IUnknown interface) => interface.queryInterface();
  ...
  bool isOffloadCapable(AUDIO_STREAM_CATEGORY category) {
    final pbOffloadCapable = adaptiveCalloc<Int32>();
