...
class ISpellChecker extends IUnknown implements ComInterface {
  ...
  late final _get_LanguageTagFn =
      _vtable.get_LanguageTag
  ...
  late final _AutoCorrectFn =
      _vtable.AutoCorrect.asFunction<
        int Function(VTablePointer, PCWSTR, PCWSTR)
      >();
  late final _GetOptionValueFn =
      _vtable.GetOptionValue.asFunction<
        int Function(VTablePointer, PCWSTR, Pointer<Uint8>)
      >();
  late final _get_OptionIdsFn =
      _vtable.get_OptionIds
          .asFunction<int Function(VTablePointer, Pointer<VTablePointer>)>();
  late final _get_IdFn =
      _vtable.get_Id.asFunction<int Function(VTablePointer, Pointer<PWSTR>)>();
  late final _get_LocalizedNameFn =
      _vtable.get_LocalizedName
          .asFunction<int Function(VTablePointer, Pointer<PWSTR>)>();
  late final _add_SpellCheckerChangedFn =
      _vtable.add_SpellCheckerChanged
          .asFunction<
            int Function(VTablePointer, VTablePointer, Pointer<Uint32>)
          >();
  late final _remove_SpellCheckerChangedFn =
