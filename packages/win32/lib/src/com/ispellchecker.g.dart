...
class ISpellChecker extends IUnknown implements ComInterface {
  ...
  factory ISpellChecker.from(IUnknown interface) => interface.queryInterface();
  ...
  late final _SuggestFn =
      ...
      >();
  late final _AddFn =
      _vtable.Add.asFunction<int Function(VTablePointer, Pointer<Utf16>)>();
  late final _IgnoreFn =
      _vtable.Ignore.asFunction<int Function(VTablePointer, Pointer<Utf16>)>();
  ...
  late final _GetOptionValueFn =
      _vtable.GetOptionValue.asFunction<
        int Function(VTablePointer, Pointer<Utf16>, Pointer<Uint8>)
      >();
  ...
  int getOptionValue(PCWSTR optionId) {
    final value = adaptiveCalloc<Uint8>();
...
base class ISpellCheckerVtbl extends Struct {
  ...
  Suggest;
  external Pointer<
    NativeFunction<Int32 Function(VTablePointer this$, Pointer<Utf16> word)>
  >
  Add;
  external Pointer<
    NativeFunction<Int32 Function(VTablePointer this$, Pointer<Utf16> word)>
