...
class IStorage extends IUnknown implements ComInterface {
  ...
  factory IStorage.from(IUnknown interface) => interface.queryInterface();
  ...
  late final _EnumElementsFn =
      ...
      >();
  late final _DestroyElementFn = _vtable
      .DestroyElement.asFunction<int Function(VTablePointer, Pointer<Utf16>)>();
  late final _RenameElementFn =
      _vtable.RenameElement.asFunction<
  ...
  IStorage? createStorage(
    ...
    final ppstg = adaptiveCalloc<VTablePointer>();
    final hr$ = HRESULT(
...
base class IStorageVtbl extends Struct {
  ...
  EnumElements;
  external Pointer<
    NativeFunction<Int32 Function(VTablePointer this$, Pointer<Utf16> pwcsName)>
  >
  DestroyElement;
  external Pointer<
    NativeFunction<
