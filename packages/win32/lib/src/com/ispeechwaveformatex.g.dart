...
final IID_ISpeechWaveFormatEx = GUID.fromComponents(
  ...
  0x1581,
  0x4741,
  .fromList(const [0x88, 0xe4, 0x20, 0x9a, 0x49, 0xf1, 0x1a, 0x10]),
);
...
class ISpeechWaveFormatEx extends IDispatch implements ComInterface {
  ...
  int get formatTag {
    final formatTag = adaptiveCalloc<Int16>();
  ...
  int get samplesPerSec {
    final samplesPerSec = adaptiveCalloc<Int32>();
  ...
  int get avgBytesPerSec {
    final avgBytesPerSec = adaptiveCalloc<Int32>();
  ...
  int get blockAlign {
    final blockAlign = adaptiveCalloc<Int16>();
  ...
  int get bitsPerSample {
    final bitsPerSample = adaptiveCalloc<Int16>();
  ...
  Pointer<VARIANT> extraData() {
    final extraData = adaptiveCalloc<VARIANT>();
