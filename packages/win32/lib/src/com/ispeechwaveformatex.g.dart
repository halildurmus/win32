...
class ISpeechWaveFormatEx extends IDispatch implements ComInterface {
  ...
  late final _get_FormatTagFn =
      _vtable.get_FormatTag
          .asFunction<int Function(VTablePointer, Pointer<Int16>)>();
  late final _put_FormatTagFn =
      _vtable.put_FormatTag.asFunction<int Function(VTablePointer, int)>();
  late final _get_ChannelsFn =
      _vtable.get_Channels
          .asFunction<int Function(VTablePointer, Pointer<Int16>)>();
  late final _put_ChannelsFn =
      _vtable.put_Channels.asFunction<int Function(VTablePointer, int)>();
  late final _get_SamplesPerSecFn =
      _vtable.get_SamplesPerSec
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _put_SamplesPerSecFn =
      _vtable.put_SamplesPerSec.asFunction<int Function(VTablePointer, int)>();
  late final _get_AvgBytesPerSecFn =
      _vtable.get_AvgBytesPerSec
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _put_AvgBytesPerSecFn =
      _vtable.put_AvgBytesPerSec.asFunction<int Function(VTablePointer, int)>();
  late final _get_BlockAlignFn =
      _vtable.get_BlockAlign
          .asFunction<int Function(VTablePointer, Pointer<Int16>)>();
  late final _put_BlockAlignFn =
      _vtable.put_BlockAlign.asFunction<int Function(VTablePointer, int)>();
  late final _get_BitsPerSampleFn =
      _vtable.get_BitsPerSample
          .asFunction<int Function(VTablePointer, Pointer<Int16>)>();
  late final _put_BitsPerSampleFn =
      _vtable.put_BitsPerSample.asFunction<int Function(VTablePointer, int)>();
  late final _get_ExtraDataFn =
      _vtable.get_ExtraData
          .asFunction<int Function(VTablePointer, Pointer<VARIANT>)>();
  late final _put_ExtraDataFn =
      _vtable.put_ExtraData.asFunction<int Function(VTablePointer, VARIANT)>();
