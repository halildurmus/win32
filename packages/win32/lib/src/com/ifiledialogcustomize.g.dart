...
class IFileDialogCustomize extends IUnknown implements ComInterface {
  ...
  late final _AddMenuFn = _vtable
      .AddMenu.asFunction<int Function(VTablePointer, int, Pointer<Utf16>)>();
  late final _AddPushButtonFn =
      _vtable.AddPushButton.asFunction<
        int Function(VTablePointer, int, Pointer<Utf16>)
      >();
  ...
  late final _AddCheckButtonFn =
      _vtable.AddCheckButton.asFunction<
        int Function(VTablePointer, int, Pointer<Utf16>, int)
      >();
  ...
  late final _AddTextFn = _vtable
      .AddText.asFunction<int Function(VTablePointer, int, Pointer<Utf16>)>();
  late final _SetControlLabelFn =
  ...
  late final _AddControlItemFn =
      _vtable.AddControlItem.asFunction<
        int Function(VTablePointer, int, int, Pointer<Utf16>)
      >();
  ...
  late final _SetSelectedControlItemFn =
      ...
      >();
  late final _StartVisualGroupFn =
  ...
  CDCONTROLSTATEF getControlState(int dwIDCtl) {
    final pdwState = adaptiveCalloc<Int32>();
  ...
  Pointer<Uint16> getEditBoxText(int dwIDCtl) {
    final ppszText = adaptiveCalloc<Pointer<Uint16>>();
  ...
  bool getCheckButtonState(int dwIDCtl) {
    final pbChecked = adaptiveCalloc<Int32>();
  ...
  int getSelectedControlItem(int dwIDCtl) {
    final pdwIDItem = adaptiveCalloc<Uint32>();
...
base class IFileDialogCustomizeVtbl extends Struct {
  ...
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Uint32 dwIDCtl, Int32 bChecked)
    >
  >
  SetCheckButtonState;
  external Pointer<
