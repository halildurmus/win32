...
class IFileDialog extends IModalWindow implements ComInterface {
  ...
  factory IFileDialog.from(IUnknown interface) => interface.queryInterface();
  ...
  late final _GetCurrentSelectionFn =
      _vtable.GetCurrentSelection.asFunction<
        int Function(VTablePointer, Pointer<VTablePointer>)
      >();
  late final _SetFileNameFn = _vtable
      .SetFileName.asFunction<int Function(VTablePointer, Pointer<Utf16>)>();
  late final _GetFileNameFn =
      _vtable.GetFileName.asFunction<
        int Function(VTablePointer, Pointer<Pointer<Utf16>>)
      >();
  late final _SetTitleFn = _vtable
      .SetTitle.asFunction<int Function(VTablePointer, Pointer<Utf16>)>();
  late final _SetOkButtonLabelFn =
      _vtable.SetOkButtonLabel.asFunction<
        int Function(VTablePointer, Pointer<Utf16>)
      >();
  late final _SetFileNameLabelFn =
  ...
  late final _SetDefaultExtensionFn =
  ...
  int getFileTypeIndex() {
    final piFileType = adaptiveCalloc<Uint32>();
...
base class IFileDialogVtbl extends Struct {
  ...
  GetFileName;
  external Pointer<
    NativeFunction<Int32 Function(VTablePointer this$, Pointer<Utf16> pszTitle)>
  >
  SetTitle;
  external Pointer<
    NativeFunction<Int32 Function(VTablePointer this$, Pointer<Utf16> pszText)>
  >
  SetOkButtonLabel;
  external Pointer<
    NativeFunction<Int32 Function(VTablePointer this$, Pointer<Utf16> pszLabel)>
  >
  SetFileNameLabel;
  external Pointer<
    NativeFunction<
  ...
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Pointer<Utf16> pszDefaultExtension)
    >
  >
  SetDefaultExtension;
  external Pointer<
