...
class IFileDialog extends IModalWindow implements ComInterface {
  ...
  late final _GetOptionsFn =
      _vtable.GetOptions.asFunction<
        int Function(VTablePointer, Pointer<Uint32>)
      >();
  ...
  late final _SetClientGuidFn =
      _vtable.SetClientGuid.asFunction<
