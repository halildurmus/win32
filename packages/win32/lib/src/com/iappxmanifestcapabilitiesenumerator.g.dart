...
class IAppxManifestCapabilitiesEnumerator extends IUnknown
  ...
  factory IAppxManifestCapabilitiesEnumerator.from(IUnknown interface) =>
  ...
  PWSTR getCurrent() {
    final capability = adaptiveCalloc<Pointer<Utf16>>();
...
base class IAppxManifestCapabilitiesEnumeratorVtbl extends Struct {
  ...
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Pointer<Pointer<Utf16>> capability)
    >
  >
  GetCurrent;
  external Pointer<
