...
class IAppxManifestReader extends IUnknown implements ComInterface {
  ...
  late final _GetPrerequisiteFn =
      _vtable.GetPrerequisite.asFunction<
        int Function(VTablePointer, Pointer<Utf16>, Pointer<Uint64>)
      >();
  ...
  IAppxManifestProperties? getProperties() {
    final packageProperties = adaptiveCalloc<VTablePointer>();
  ...
  IAppxManifestPackageDependenciesEnumerator? getPackageDependencies() {
    final dependencies = adaptiveCalloc<VTablePointer>();
  ...
  APPX_CAPABILITIES getCapabilities() {
    final capabilities = adaptiveCalloc<Int32>();
  ...
  IAppxManifestDeviceCapabilitiesEnumerator? getDeviceCapabilities() {
    final deviceCapabilities = adaptiveCalloc<VTablePointer>();
  ...
  int getPrerequisite(PCWSTR name) {
    final value = adaptiveCalloc<Uint64>();
  ...
  IAppxManifestApplicationsEnumerator? getApplications() {
    final applications = adaptiveCalloc<VTablePointer>();
  ...
  IStream? getStream() {
    final manifestStream = adaptiveCalloc<VTablePointer>();
