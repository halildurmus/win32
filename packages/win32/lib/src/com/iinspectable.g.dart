...
final IID_IInspectable = GUID.fromComponents(
  ...
  0xb12d,
  0x4c6a,
  .fromList(const [0x9c, 0x5a, 0xd7, 0xaa, 0x65, 0x10, 0x1e, 0x90]),
);
...
class IInspectable extends IUnknown implements ComInterface {
  ...
  factory IInspectable.from(IUnknown interface) => interface.queryInterface();
  ...
  HSTRING getRuntimeClassName() {
    final className = adaptiveCalloc<Pointer>();
  ...
  TrustLevel getTrustLevel() {
    final trustLevel = adaptiveCalloc<Int32>();
...
base class IInspectableVtbl extends Struct {
  ...
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Pointer<Pointer> className)
    >
  >
  GetRuntimeClassName;
  external Pointer<
