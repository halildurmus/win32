...
class IShellLink extends IUnknown implements ComInterface {
  ...
  factory IShellLink.from(IUnknown interface) => interface.queryInterface();
  ...
  late final _GetDescriptionFn =
      ...
      >();
  late final _SetDescriptionFn = _vtable
      .SetDescription.asFunction<int Function(VTablePointer, Pointer<Utf16>)>();
  late final _GetWorkingDirectoryFn =
      _vtable.GetWorkingDirectory.asFunction<
        int Function(VTablePointer, Pointer<Utf16>, int)
      >();
  late final _SetWorkingDirectoryFn =
      _vtable.SetWorkingDirectory.asFunction<
        int Function(VTablePointer, Pointer<Utf16>)
      >();
  late final _GetArgumentsFn =
      _vtable.GetArguments.asFunction<
        int Function(VTablePointer, Pointer<Utf16>, int)
      >();
  late final _SetArgumentsFn = _vtable
      .SetArguments.asFunction<int Function(VTablePointer, Pointer<Utf16>)>();
  ...
  late final _SetIconLocationFn =
      _vtable.SetIconLocation.asFunction<
        int Function(VTablePointer, Pointer<Utf16>, int)
      >();
  late final _SetRelativePathFn =
      _vtable.SetRelativePath.asFunction<
        int Function(VTablePointer, Pointer<Utf16>, int)
      >();
  late final _ResolveFn =
      _vtable.Resolve.asFunction<int Function(VTablePointer, Pointer, int)>();
  late final _SetPathFn =
      _vtable.SetPath.asFunction<int Function(VTablePointer, Pointer<Utf16>)>();
  ...
  int getHotkey() {
    final pwHotkey = adaptiveCalloc<Uint16>();
  ...
  SHOW_WINDOW_CMD getShowCmd() {
    final piShowCmd = adaptiveCalloc<Int32>();
  ...
  @pragma('vm:prefer-inline')
  void resolve(HWND hwnd, int fFlags) {
...
base class IShellLinkVtbl extends Struct {
  ...
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Pointer<Utf16> pszName, Int32 cch)
    >
  >
  GetDescription;
  external Pointer<
    NativeFunction<Int32 Function(VTablePointer this$, Pointer<Utf16> pszName)>
  >
  SetDescription;
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Pointer<Utf16> pszDir, Int32 cch)
    >
  >
  GetWorkingDirectory;
  external Pointer<
    NativeFunction<Int32 Function(VTablePointer this$, Pointer<Utf16> pszDir)>
  >
  SetWorkingDirectory;
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Pointer<Utf16> pszArgs, Int32 cch)
    >
  >
  GetArguments;
  external Pointer<
    NativeFunction<Int32 Function(VTablePointer this$, Pointer<Utf16> pszArgs)>
  >
  SetArguments;
  external Pointer<
    NativeFunction<
  ...
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Pointer hwnd, Uint32 fFlags)
    >
  >
  Resolve;
  external Pointer<
    NativeFunction<Int32 Function(VTablePointer this$, Pointer<Utf16> pszFile)>
  >
  SetPath;
}
