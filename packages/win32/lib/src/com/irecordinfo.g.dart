...
class IRecordInfo extends IUnknown implements ComInterface {
  ...
  factory IRecordInfo.from(IUnknown interface) => interface.queryInterface();
  ...
  late final _GetFieldFn =
      _vtable.GetField.asFunction<
        int Function(VTablePointer, Pointer, Pointer<Utf16>, Pointer<VARIANT>)
      >();
  ...
  late final _GetFieldNamesFn =
      _vtable.GetFieldNames.asFunction<
        int Function(VTablePointer, Pointer<Uint32>, Pointer<Pointer<Utf16>>)
      >();
  ...
  BSTR getName() {
    final pbstrName = adaptiveCalloc<Pointer<Utf16>>();
  ...
  ITypeInfo? getTypeInfo() {
    final ppTypeInfo = adaptiveCalloc<VTablePointer>();
  ...
  Pointer<VARIANT> getField(Pointer pvData, PCWSTR szFieldName) {
    final pvarField = adaptiveCalloc<VARIANT>();
...
base class IRecordInfoVtbl extends Struct {
  ...
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Pointer<Pointer<Utf16>> pbstrName)
    >
  >
  GetName;
  external Pointer<
  ...
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, VTablePointer pRecordInfo)
    >
  >
  IsMatchingType;
