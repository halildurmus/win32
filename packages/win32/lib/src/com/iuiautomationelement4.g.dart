...
class IUIAutomationElement4 extends IUIAutomationElement3
  ...
  late final _get_CurrentPositionInSetFn =
      _vtable.get_CurrentPositionInSet
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_CurrentSizeOfSetFn =
      _vtable.get_CurrentSizeOfSet
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_CurrentLevelFn =
      _vtable.get_CurrentLevel
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_CurrentAnnotationTypesFn =
      _vtable.get_CurrentAnnotationTypes
          .asFunction<
            int Function(VTablePointer, Pointer<Pointer<SAFEARRAY>>)
          >();
  late final _get_CurrentAnnotationObjectsFn =
      _vtable.get_CurrentAnnotationObjects
          .asFunction<int Function(VTablePointer, Pointer<VTablePointer>)>();
  late final _get_CachedPositionInSetFn =
      _vtable.get_CachedPositionInSet
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_CachedSizeOfSetFn =
      _vtable.get_CachedSizeOfSet
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_CachedLevelFn =
      _vtable.get_CachedLevel
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_CachedAnnotationTypesFn =
      _vtable.get_CachedAnnotationTypes
          .asFunction<
            int Function(VTablePointer, Pointer<Pointer<SAFEARRAY>>)
          >();
  late final _get_CachedAnnotationObjectsFn =
      _vtable.get_CachedAnnotationObjects
          .asFunction<int Function(VTablePointer, Pointer<VTablePointer>)>();
