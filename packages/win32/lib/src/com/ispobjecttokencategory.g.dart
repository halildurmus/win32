...
class ISpObjectTokenCategory extends ISpDataKey implements ComInterface {
  ...
  factory ISpObjectTokenCategory.from(IUnknown interface) =>
  ...
  late final _EnumTokensFn =
      ...
      >();
  late final _SetDefaultTokenIdFn =
      _vtable.SetDefaultTokenId.asFunction<
  ...
  /// Throws a [WindowsException] on failure.
  PWSTR getId() {
    final ppszCoMemCategoryId = adaptiveCalloc<Pointer<Utf16>>();
  ...
  ISpDataKey? getDataKey(SPDATAKEYLOCATION spdkl) {
    final ppDataKey = adaptiveCalloc<VTablePointer>();
...
base class ISpObjectTokenCategoryVtbl extends Struct {
  ...
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Pointer<Utf16> pszTokenId)
    >
  >
  SetDefaultTokenId;
  external Pointer<
