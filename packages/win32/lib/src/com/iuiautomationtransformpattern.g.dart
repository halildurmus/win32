...
class IUIAutomationTransformPattern extends IUnknown implements ComInterface {
  ...
  late final _get_CurrentCanMoveFn =
      _vtable.get_CurrentCanMove
          .asFunction<int Function(VTablePointer, Pointer<BOOL>)>();
  late final _get_CurrentCanResizeFn =
      _vtable.get_CurrentCanResize
          .asFunction<int Function(VTablePointer, Pointer<BOOL>)>();
  late final _get_CurrentCanRotateFn =
      _vtable.get_CurrentCanRotate
          .asFunction<int Function(VTablePointer, Pointer<BOOL>)>();
  late final _get_CachedCanMoveFn =
      _vtable.get_CachedCanMove
          .asFunction<int Function(VTablePointer, Pointer<BOOL>)>();
  late final _get_CachedCanResizeFn =
      _vtable.get_CachedCanResize
          .asFunction<int Function(VTablePointer, Pointer<BOOL>)>();
  late final _get_CachedCanRotateFn =
      _vtable.get_CachedCanRotate
          .asFunction<int Function(VTablePointer, Pointer<BOOL>)>();
