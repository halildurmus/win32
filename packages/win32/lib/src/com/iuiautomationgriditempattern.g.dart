...
class IUIAutomationGridItemPattern extends IUnknown implements ComInterface {
  ...
  late final _get_CurrentContainingGridFn =
      _vtable.get_CurrentContainingGrid
          .asFunction<int Function(VTablePointer, Pointer<VTablePointer>)>();
  late final _get_CurrentRowFn =
      _vtable.get_CurrentRow
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_CurrentColumnFn =
      _vtable.get_CurrentColumn
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_CurrentRowSpanFn =
      _vtable.get_CurrentRowSpan
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_CurrentColumnSpanFn =
      _vtable.get_CurrentColumnSpan
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_CachedContainingGridFn =
      _vtable.get_CachedContainingGrid
          .asFunction<int Function(VTablePointer, Pointer<VTablePointer>)>();
  late final _get_CachedRowFn =
      _vtable.get_CachedRow
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_CachedColumnFn =
      _vtable.get_CachedColumn
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_CachedRowSpanFn =
      _vtable.get_CachedRowSpan
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_CachedColumnSpanFn =
