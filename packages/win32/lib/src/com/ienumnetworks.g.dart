...
///
/// {@category com}
class IEnumNetworks extends IDispatch implements ComInterface {
  /// Creates a new instance of [IEnumNetworks] from a [VTablePointer].
  ///
  /// This constructor requires a valid pointer to the [IEnumNetworks]
  ...
  /// reference to the [IEnumNetworks] interface.
  ///
  /// Throws a [WindowsException] if the [queryInterface] call fails.
  @pragma('vm:prefer-inline')
  factory IEnumNetworks.from(IUnknown interface) => interface.queryInterface();
  ...
  IEnumVARIANT? get newEnum {
    final ppEnumVar = adaptiveCalloc<VTablePointer>();
  ...
  @override
  String toString() => 'IEnumNetworks(ptr: $ptr)';
}
...
@internal
final class IEnumNetworksCompanion extends ComCompanion<IEnumNetworks> {
  const IEnumNetworksCompanion();

  @pragma('vm:prefer-inline')
  @override
  IEnumNetworks Function(VTablePointer) get fromPointer => IEnumNetworks.new;

  @pragma('vm:prefer-inline')
  @override
  GUID get iid => IID_IEnumNetworks;
}
