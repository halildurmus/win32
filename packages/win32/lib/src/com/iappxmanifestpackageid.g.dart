...
class IAppxManifestPackageId extends IUnknown implements ComInterface {
  ...
  int getVersion() {
    final packageVersion = adaptiveCalloc<Uint64>();
  ...
  PWSTR getResourceId() {
    final resourceId = adaptiveCalloc<Pointer<Utf16>>();
  ...
  bool comparePublisher(PCWSTR other) {
    final isSame = adaptiveCalloc<Int32>();
...
base class IAppxManifestPackageIdVtbl extends Struct {
  ...
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Pointer<Pointer<Utf16>> resourceId)
    >
  >
  GetResourceId;
  external Pointer<
