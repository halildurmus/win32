...
final IID_IMMNotificationClient = GUID.fromComponents(
  ...
  0x7e89,
  0x4d85,
  .fromList(const [0x83, 0x90, 0x6c, 0x70, 0x3c, 0xec, 0x60, 0xc0]),
);
...
class IMMNotificationClient extends IUnknown implements ComInterface {
  ...
  late final _OnDeviceStateChangedFn =
      ...
      >();
  late final _OnDeviceAddedFn = _vtable
      .OnDeviceAdded.asFunction<int Function(VTablePointer, Pointer<Utf16>)>();
  ...
  late final _OnPropertyValueChangedFn =
      _vtable.OnPropertyValueChanged.asFunction<
        int Function(VTablePointer, Pointer<Utf16>, PROPERTYKEY)
      >();
...
base class IMMNotificationClientVtbl extends Struct {
  ...
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Pointer<Utf16> pwstrDeviceId)
    >
  >
  OnDeviceAdded;
  external Pointer<
