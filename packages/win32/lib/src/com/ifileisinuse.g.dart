...
class IFileIsInUse extends IUnknown implements ComInterface {
  ...
  factory IFileIsInUse.from(IUnknown interface) => interface.queryInterface();

  final IFileIsInUseVtbl _vtable;
  late final _GetAppNameFn =
  ...
  FILE_USAGE_TYPE getUsage() {
    final pfut = adaptiveCalloc<Int32>();
  ...
  int getCapabilities() {
    final pdwCapFlags = adaptiveCalloc<Uint32>();
  ...
  HWND getSwitchToHWND() {
    final phwnd = adaptiveCalloc<Pointer>();
...
base class IFileIsInUseVtbl extends Struct {
  ...
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Pointer<Pointer<Utf16>> ppszName)
    >
  >
  GetAppName;
  external Pointer<
  ...
  GetCapabilities;
  external Pointer<
    NativeFunction<Int32 Function(VTablePointer this$, Pointer<Pointer> phwnd)>
  >
  GetSwitchToHWND;
