...
final IID_IUIAutomation2 = GUID.fromComponents(
  ...
  0xc9d,
  0x49d0,
  .fromList(const [0x98, 0x96, 0x7a, 0xb5, 0x2d, 0xf8, 0xcd, 0x8a]),
);
...
class IUIAutomation2 extends IUIAutomation implements ComInterface {
  ...
  factory IUIAutomation2.from(IUnknown interface) => interface.queryInterface();
  ...
  bool get autoSetFocus {
    final autoSetFocus = adaptiveCalloc<Int32>();
  ...
  int get connectionTimeout {
    final timeout = adaptiveCalloc<Uint32>();
...
base class IUIAutomation2Vtbl extends Struct {
  ...
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Pointer<Int32> autoSetFocus)
    >
  >
  get_AutoSetFocus;
  external Pointer<
    NativeFunction<Int32 Function(VTablePointer this$, Int32 autoSetFocus)>
  >
  put_AutoSetFocus;
  external Pointer<
