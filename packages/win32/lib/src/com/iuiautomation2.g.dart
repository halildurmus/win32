...
class IUIAutomation2 extends IUIAutomation implements ComInterface {
  ...
  late final _get_AutoSetFocusFn =
      _vtable.get_AutoSetFocus
          .asFunction<int Function(VTablePointer, Pointer<BOOL>)>();
  late final _put_AutoSetFocusFn =
      _vtable.put_AutoSetFocus.asFunction<int Function(VTablePointer, int)>();
  late final _get_ConnectionTimeoutFn =
      _vtable.get_ConnectionTimeout
          .asFunction<int Function(VTablePointer, Pointer<Uint32>)>();
  late final _put_ConnectionTimeoutFn =
      _vtable.put_ConnectionTimeout
          .asFunction<int Function(VTablePointer, int)>();
  late final _get_TransactionTimeoutFn =
      _vtable.get_TransactionTimeout
          .asFunction<int Function(VTablePointer, Pointer<Uint32>)>();
  late final _put_TransactionTimeoutFn =
      _vtable.put_TransactionTimeout
          .asFunction<int Function(VTablePointer, int)>();
