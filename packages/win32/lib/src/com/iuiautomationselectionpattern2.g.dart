...
class IUIAutomationSelectionPattern2 extends IUIAutomationSelectionPattern
  ...
  late final _get_CurrentFirstSelectedItemFn =
      _vtable.get_CurrentFirstSelectedItem
          .asFunction<int Function(VTablePointer, Pointer<VTablePointer>)>();
  late final _get_CurrentLastSelectedItemFn =
      _vtable.get_CurrentLastSelectedItem
          .asFunction<int Function(VTablePointer, Pointer<VTablePointer>)>();
  late final _get_CurrentCurrentSelectedItemFn =
      _vtable.get_CurrentCurrentSelectedItem
          .asFunction<int Function(VTablePointer, Pointer<VTablePointer>)>();
  late final _get_CurrentItemCountFn =
      _vtable.get_CurrentItemCount
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_CachedFirstSelectedItemFn =
      _vtable.get_CachedFirstSelectedItem
          .asFunction<int Function(VTablePointer, Pointer<VTablePointer>)>();
  late final _get_CachedLastSelectedItemFn =
      _vtable.get_CachedLastSelectedItem
          .asFunction<int Function(VTablePointer, Pointer<VTablePointer>)>();
  late final _get_CachedCurrentSelectedItemFn =
      _vtable.get_CachedCurrentSelectedItem
          .asFunction<int Function(VTablePointer, Pointer<VTablePointer>)>();
  late final _get_CachedItemCountFn =
      _vtable.get_CachedItemCount
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
