...
class IUIAutomationProxyFactoryEntry extends IUnknown implements ComInterface {
  ...
  late final _get_ProxyFactoryFn =
      _vtable.get_ProxyFactory
          .asFunction<int Function(VTablePointer, Pointer<VTablePointer>)>();
  late final _get_ClassNameFn =
      _vtable.get_ClassName
          .asFunction<int Function(VTablePointer, Pointer<BSTR>)>();
  late final _get_ImageNameFn =
      _vtable.get_ImageName
          .asFunction<int Function(VTablePointer, Pointer<BSTR>)>();
  late final _get_AllowSubstringMatchFn =
      _vtable.get_AllowSubstringMatch
          .asFunction<int Function(VTablePointer, Pointer<BOOL>)>();
  late final _get_CanCheckBaseClassFn =
      _vtable.get_CanCheckBaseClass
          .asFunction<int Function(VTablePointer, Pointer<BOOL>)>();
  late final _get_NeedsAdviseEventsFn =
      _vtable.get_NeedsAdviseEvents
          .asFunction<int Function(VTablePointer, Pointer<BOOL>)>();
  late final _put_ClassNameFn =
      _vtable.put_ClassName.asFunction<int Function(VTablePointer, PCWSTR)>();
  late final _put_ImageNameFn =
      _vtable.put_ImageName.asFunction<int Function(VTablePointer, PCWSTR)>();
  late final _put_AllowSubstringMatchFn =
      _vtable.put_AllowSubstringMatch
          .asFunction<int Function(VTablePointer, int)>();
  late final _put_CanCheckBaseClassFn =
      _vtable.put_CanCheckBaseClass
          .asFunction<int Function(VTablePointer, int)>();
  late final _put_NeedsAdviseEventsFn =
      _vtable.put_NeedsAdviseEvents
          .asFunction<int Function(VTablePointer, int)>();
