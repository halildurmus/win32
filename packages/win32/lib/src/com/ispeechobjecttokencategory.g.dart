...
class ISpeechObjectTokenCategory extends IDispatch implements ComInterface {
  ...
  late final _get_IdFn =
      _vtable.get_Id.asFunction<int Function(VTablePointer, Pointer<BSTR>)>();
  late final _put_DefaultFn =
      _vtable.put_Default.asFunction<int Function(VTablePointer, BSTR)>();
  late final _get_DefaultFn =
      _vtable.get_Default
