...
/// @nodoc
final IID_IDCompositionDevice2 = GUID.fromComponents(
  0x75f6468d,
  0x1b8e,
  0x447c,
  Uint8List.fromList(const [0x9b, 0xc6, 0x75, 0xfe, 0xa8, 0xb, 0x5b, 0x25]),
);
...
///
/// {@category com}
class IDCompositionDevice2 extends IUnknown implements ComInterface {
  /// Creates a new instance of [IDCompositionDevice2] from a [VTablePointer].
  ///
  /// This constructor requires a valid pointer to the [IDCompositionDevice2]
  /// interface. The [ptr] must not be [nullptr]; otherwise, an assertion error
  /// is thrown.
  IDCompositionDevice2(super.ptr)
    : _vtable = ptr.value.cast<IDCompositionDevice2Vtbl>().ref;

  /// Creates a new instance of [IDCompositionDevice2] from an existing
  /// [interface].
  ///
  /// This factory constructor calls the [queryInterface] method to obtain a
  /// reference to the [IDCompositionDevice2] interface.
  ///
  /// Throws a [WindowsException] if the [queryInterface] call fails.
  @pragma('vm:prefer-inline')
  factory IDCompositionDevice2.from(IUnknown interface) =>
      interface.queryInterface();

  final IDCompositionDevice2Vtbl _vtable;
  ...
  late final _CreateVisualFn =
      ...
      >();
  late final _CreateSurfaceFactoryFn =
      _vtable.CreateSurfaceFactory.asFunction<
  ...
  /// the `IDCompositionDevice2.commit` method.
  ///
  /// Throws a [WindowsException] on failure.
  ///
  /// To learn more, see
  ...
  IDCompositionVisual2? createVisual() {
    ...
    return IDCompositionVisual2(result$);
  }

  /// Creates a Microsoft DirectComposition surface factory object, which can be
  /// used to create other DirectComposition surface or virtual surface objects.
  ///
  /// Throws a [WindowsException] on failure.
  ///
  /// To learn more, see
  ...
  IDCompositionSurfaceFactory? createSurfaceFactory(IUnknown? renderingDevice) {
    final surfaceFactory = adaptiveCalloc<VTablePointer>();
    final hr$ = HRESULT(
      _CreateSurfaceFactoryFn(
        ptr,
    ...
    final result$ = surfaceFactory.value;
    free(surfaceFactory);
    if (result$.isNull) return null;
    return IDCompositionSurfaceFactory(result$);
  }

  /// Creates an updateable surface object that can be associated with one or
  ...
  @override
  String toString() => 'IDCompositionDevice2(ptr: $ptr)';
}

/// @nodoc
base class IDCompositionDevice2Vtbl extends Struct {
  ...
  external Pointer<
    NativeFunction<
      Int32 Function(
        ...
        Pointer<VTablePointer> surfaceFactory,
      )
    >
  >
...
@internal
final class IDCompositionDevice2Companion
    extends ComCompanion<IDCompositionDevice2> {
  const IDCompositionDevice2Companion();

  @pragma('vm:prefer-inline')
  @override
  IDCompositionDevice2 Function(VTablePointer) get fromPointer =>
      IDCompositionDevice2.new;

  @pragma('vm:prefer-inline')
  @override
  GUID get iid => IID_IDCompositionDevice2;
}
