...
class ISpellingError extends IUnknown implements ComInterface {
  ...
  late final _get_StartIndexFn =
      _vtable.get_StartIndex
          .asFunction<int Function(VTablePointer, Pointer<Uint32>)>();
  late final _get_LengthFn =
      _vtable.get_Length
          .asFunction<int Function(VTablePointer, Pointer<Uint32>)>();
  late final _get_CorrectiveActionFn =
      _vtable.get_CorrectiveAction
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_ReplacementFn =
      _vtable.get_Replacement
