...
final IID_ISpStreamFormat = GUID.fromComponents(
  ...
  0x2606,
  0x4f4d,
  .fromList(const [0xa1, 0xc0, 0x54, 0xc5, 0xcd, 0xa5, 0x56, 0x6f]),
);
...
class ISpStreamFormat extends IStream implements ComInterface {
  ...
  factory ISpStreamFormat.from(IUnknown interface) =>
  ...
  Pointer<WAVEFORMATEX> getFormat(Pointer<GUID> pguidFormatId) {
    final ppCoMemWaveFormatEx = adaptiveCalloc<Pointer<WAVEFORMATEX>>();
