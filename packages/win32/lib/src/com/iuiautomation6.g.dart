...
class IUIAutomation6 extends IUIAutomation5 implements ComInterface {
  ...
  late final _RemoveEventHandlerGroupFn =
      _vtable.RemoveEventHandlerGroup.asFunction<
        int Function(VTablePointer, VTablePointer, VTablePointer)
      >();
  late final _get_ConnectionRecoveryBehaviorFn =
      _vtable.get_ConnectionRecoveryBehavior
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _put_ConnectionRecoveryBehaviorFn =
      _vtable.put_ConnectionRecoveryBehavior
          .asFunction<int Function(VTablePointer, int)>();
  late final _get_CoalesceEventsFn =
      _vtable.get_CoalesceEvents
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _put_CoalesceEventsFn =
      _vtable.put_CoalesceEvents.asFunction<int Function(VTablePointer, int)>();
