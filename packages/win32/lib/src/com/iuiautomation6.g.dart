...
class IUIAutomation6 extends IUIAutomation5 implements ComInterface {
  ...
  factory IUIAutomation6.from(IUnknown interface) => interface.queryInterface();
  ...
  IUIAutomationEventHandlerGroup? createEventHandlerGroup() {
    final handlerGroup = adaptiveCalloc<VTablePointer>();
  ...
  ConnectionRecoveryBehaviorOptions get connectionRecoveryBehavior {
    final connectionRecoveryBehaviorOptions = adaptiveCalloc<Int32>();
    final hr$ = HRESULT(
  ...
  CoalesceEventsOptions get coalesceEvents {
    final coalesceEventsOptions = adaptiveCalloc<Int32>();
