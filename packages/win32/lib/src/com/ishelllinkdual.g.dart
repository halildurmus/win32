...
class IShellLinkDual extends IDispatch implements ComInterface {
  ...
  late final _get_PathFn =
      _vtable.get_Path.asFunction<int Function(VTablePointer, Pointer<BSTR>)>();
  late final _put_PathFn =
      _vtable.put_Path.asFunction<int Function(VTablePointer, BSTR)>();
  late final _get_DescriptionFn =
      _vtable.get_Description
          .asFunction<int Function(VTablePointer, Pointer<BSTR>)>();
  late final _put_DescriptionFn =
      _vtable.put_Description.asFunction<int Function(VTablePointer, BSTR)>();
  late final _get_WorkingDirectoryFn =
      _vtable.get_WorkingDirectory
          .asFunction<int Function(VTablePointer, Pointer<BSTR>)>();
  late final _put_WorkingDirectoryFn =
      _vtable.put_WorkingDirectory
          .asFunction<int Function(VTablePointer, BSTR)>();
  late final _get_ArgumentsFn =
      _vtable.get_Arguments
          .asFunction<int Function(VTablePointer, Pointer<BSTR>)>();
  late final _put_ArgumentsFn =
      _vtable.put_Arguments.asFunction<int Function(VTablePointer, BSTR)>();
  late final _get_HotkeyFn =
      _vtable.get_Hotkey
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _put_HotkeyFn =
      _vtable.put_Hotkey.asFunction<int Function(VTablePointer, int)>();
  late final _get_ShowCommandFn =
      _vtable.get_ShowCommand
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _put_ShowCommandFn =
      _vtable.put_ShowCommand.asFunction<int Function(VTablePointer, int)>();
