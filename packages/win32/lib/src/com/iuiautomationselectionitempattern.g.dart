...
class IUIAutomationSelectionItemPattern extends IUnknown
  ...
  late final _get_CurrentIsSelectedFn =
      _vtable.get_CurrentIsSelected
          .asFunction<int Function(VTablePointer, Pointer<BOOL>)>();
  late final _get_CurrentSelectionContainerFn =
      _vtable.get_CurrentSelectionContainer
          .asFunction<int Function(VTablePointer, Pointer<VTablePointer>)>();
  late final _get_CachedIsSelectedFn =
      _vtable.get_CachedIsSelected
          .asFunction<int Function(VTablePointer, Pointer<BOOL>)>();
  late final _get_CachedSelectionContainerFn =
      _vtable.get_CachedSelectionContainer
          .asFunction<int Function(VTablePointer, Pointer<VTablePointer>)>();
