...
class IUIAutomationScrollPattern extends IUnknown implements ComInterface {
  ...
  late final _SetScrollPercentFn =
      ...
      >();
  late final _get_CurrentHorizontalScrollPercentFn =
      _vtable.get_CurrentHorizontalScrollPercent
          .asFunction<int Function(VTablePointer, Pointer<Double>)>();
  late final _get_CurrentVerticalScrollPercentFn =
      _vtable.get_CurrentVerticalScrollPercent
          .asFunction<int Function(VTablePointer, Pointer<Double>)>();
  late final _get_CurrentHorizontalViewSizeFn =
      _vtable.get_CurrentHorizontalViewSize
          .asFunction<int Function(VTablePointer, Pointer<Double>)>();
  late final _get_CurrentVerticalViewSizeFn =
      _vtable.get_CurrentVerticalViewSize
          .asFunction<int Function(VTablePointer, Pointer<Double>)>();
  late final _get_CurrentHorizontallyScrollableFn =
      _vtable.get_CurrentHorizontallyScrollable
          .asFunction<int Function(VTablePointer, Pointer<BOOL>)>();
  late final _get_CurrentVerticallyScrollableFn =
      _vtable.get_CurrentVerticallyScrollable
          .asFunction<int Function(VTablePointer, Pointer<BOOL>)>();
  late final _get_CachedHorizontalScrollPercentFn =
      _vtable.get_CachedHorizontalScrollPercent
          .asFunction<int Function(VTablePointer, Pointer<Double>)>();
  late final _get_CachedVerticalScrollPercentFn =
      _vtable.get_CachedVerticalScrollPercent
          .asFunction<int Function(VTablePointer, Pointer<Double>)>();
  late final _get_CachedHorizontalViewSizeFn =
      _vtable.get_CachedHorizontalViewSize
          .asFunction<int Function(VTablePointer, Pointer<Double>)>();
  late final _get_CachedVerticalViewSizeFn =
      _vtable.get_CachedVerticalViewSize
          .asFunction<int Function(VTablePointer, Pointer<Double>)>();
  late final _get_CachedHorizontallyScrollableFn =
      _vtable.get_CachedHorizontallyScrollable
          .asFunction<int Function(VTablePointer, Pointer<BOOL>)>();
  late final _get_CachedVerticallyScrollableFn =
