...
class IUIAutomationDropTargetPattern extends IUnknown implements ComInterface {
  ...
  late final _get_CurrentDropTargetEffectFn =
      _vtable.get_CurrentDropTargetEffect
          .asFunction<int Function(VTablePointer, Pointer<BSTR>)>();
  late final _get_CachedDropTargetEffectFn =
      _vtable.get_CachedDropTargetEffect
          .asFunction<int Function(VTablePointer, Pointer<BSTR>)>();
  late final _get_CurrentDropTargetEffectsFn =
      _vtable.get_CurrentDropTargetEffects
          .asFunction<
            int Function(VTablePointer, Pointer<Pointer<SAFEARRAY>>)
          >();
  late final _get_CachedDropTargetEffectsFn =
      _vtable.get_CachedDropTargetEffects
          .asFunction<
            int Function(VTablePointer, Pointer<Pointer<SAFEARRAY>>)
          >();
