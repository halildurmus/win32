...
class ISensor extends IUnknown implements ComInterface {
  ...
  factory ISensor.from(IUnknown interface) => interface.queryInterface();
  ...
  late final _SupportsDataFieldFn =
      _vtable.SupportsDataField.asFunction<
        int Function(VTablePointer, Pointer<PROPERTYKEY>, Pointer<Int16>)
      >();
  ...
  late final _SupportsEventFn =
      _vtable.SupportsEvent.asFunction<
        int Function(VTablePointer, Pointer<GUID>, Pointer<Int16>)
      >();
  ...
  Pointer<GUID> getCategory() {
    final pSensorCategory = adaptiveCalloc<GUID>();
  ...
  Pointer<GUID> getType() {
    final pSensorType = adaptiveCalloc<GUID>();
  ...
  BSTR getFriendlyName() {
    final pFriendlyName = adaptiveCalloc<Pointer<Utf16>>();
  ...
  Pointer<PROPVARIANT> getProperty(Pointer<PROPERTYKEY> key) {
    final pProperty = adaptiveCalloc<PROPVARIANT>();
  ...
  IPortableDeviceKeyCollection? getSupportedDataFields() {
    final ppDataFields = adaptiveCalloc<VTablePointer>();
  ...
  IPortableDeviceValues? setProperties(IPortableDeviceValues? pProperties) {
    final ppResults = adaptiveCalloc<VTablePointer>();
    final hr$ = HRESULT(
  ...
  bool supportsDataField(Pointer<PROPERTYKEY> key) {
    final pIsSupported = adaptiveCalloc<Int16>();
  ...
  ISensorDataReport? getData() {
    final ppDataReport = adaptiveCalloc<VTablePointer>();
...
base class ISensorVtbl extends Struct {
  ...
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Pointer<Pointer<Utf16>> pFriendlyName)
    >
  >
  GetFriendlyName;
  external Pointer<
