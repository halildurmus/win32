...
class IUIAutomationAnnotationPattern extends IUnknown implements ComInterface {
  ...
  late final _get_CurrentAnnotationTypeIdFn =
      _vtable.get_CurrentAnnotationTypeId
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_CurrentAnnotationTypeNameFn =
      _vtable.get_CurrentAnnotationTypeName
          .asFunction<int Function(VTablePointer, Pointer<BSTR>)>();
  late final _get_CurrentAuthorFn =
      _vtable.get_CurrentAuthor
          .asFunction<int Function(VTablePointer, Pointer<BSTR>)>();
  late final _get_CurrentDateTimeFn =
      _vtable.get_CurrentDateTime
          .asFunction<int Function(VTablePointer, Pointer<BSTR>)>();
  late final _get_CurrentTargetFn =
      _vtable.get_CurrentTarget
          .asFunction<int Function(VTablePointer, Pointer<VTablePointer>)>();
  late final _get_CachedAnnotationTypeIdFn =
      _vtable.get_CachedAnnotationTypeId
          .asFunction<int Function(VTablePointer, Pointer<Int32>)>();
  late final _get_CachedAnnotationTypeNameFn =
      _vtable.get_CachedAnnotationTypeName
          .asFunction<int Function(VTablePointer, Pointer<BSTR>)>();
  late final _get_CachedAuthorFn =
      _vtable.get_CachedAuthor
          .asFunction<int Function(VTablePointer, Pointer<BSTR>)>();
  late final _get_CachedDateTimeFn =
      _vtable.get_CachedDateTime
          .asFunction<int Function(VTablePointer, Pointer<BSTR>)>();
  late final _get_CachedTargetFn =
      _vtable.get_CachedTarget
          .asFunction<int Function(VTablePointer, Pointer<VTablePointer>)>();
