...
class IWbemContext extends IUnknown implements ComInterface {
  ...
  factory IWbemContext.from(IUnknown interface) => interface.queryInterface();
  ...
  late final _SetValueFn =
      _vtable.SetValue.asFunction<
        int Function(VTablePointer, Pointer<Utf16>, int, Pointer<VARIANT>)
      >();
  ...
  IWbemContext? clone() {
    final ppNewCopy = adaptiveCalloc<VTablePointer>();
  ...
  Pointer<VARIANT> getValue(PCWSTR wszName, int lFlags) {
    final pValue = adaptiveCalloc<VARIANT>();
...
base class IWbemContextVtbl extends Struct {
  ...
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Pointer<Utf16> wszName, Int32 lFlags)
    >
  >
  DeleteValue;
  external Pointer<NativeFunction<Int32 Function(VTablePointer this$)>>
