...
class IUIAutomation extends IUnknown {
  ...
  int compareElements(
    ...
    Pointer<Int32> areSame,
      ...
      >()(ptr.ref.lpVtbl, el1, el2, areSame);
  ...
  int elementFromHandle(int hwnd, Pointer<Pointer<COMObject>> element) =>
      (ptr.ref.vtable + 6)
          ...
          .value
          .asFunction<
            int Function(Pointer, int hwnd, Pointer<Pointer<COMObject>> element)
  ...
  int createCacheRequest(Pointer<Pointer<COMObject>> cacheRequest) =>
      (ptr.ref.vtable + 20)
          ...
          .value
          .asFunction<
            int Function(Pointer, Pointer<Pointer<COMObject>> cacheRequest)
  ...
  int createTrueCondition(Pointer<Pointer<COMObject>> newCondition) =>
      (ptr.ref.vtable + 21)
          ...
          .value
          .asFunction<
            int Function(Pointer, Pointer<Pointer<COMObject>> newCondition)
  ...
  int getPropertyProgrammaticName(int property, Pointer<Pointer<Utf16>> name) =>
      (ptr.ref.vtable + 49)
          ...
          .value
          .asFunction<
            int Function(Pointer, int property, Pointer<Pointer<Utf16>> name)
  ...
  int getPatternProgrammaticName(int pattern, Pointer<Pointer<Utf16>> name) =>
      (ptr.ref.vtable + 50)
          ...
          .value
          .asFunction<
            int Function(Pointer, int pattern, Pointer<Pointer<Utf16>> name)
  ...
  int checkNotSupported(VARIANT value, Pointer<Int32> isNotSupported) =>
      (ptr.ref.vtable + 53)
          ...
          .value
          .asFunction<
            int Function(Pointer, VARIANT value, Pointer<Int32> isNotSupported)
