...
class IAppxBlockMapFile extends IUnknown implements ComInterface {
  ...
  factory IAppxBlockMapFile.from(IUnknown interface) =>
  ...
  IAppxBlockMapBlocksEnumerator? getBlocks() {
    final blocks = adaptiveCalloc<VTablePointer>();
  ...
  int getLocalFileHeaderSize() {
    final lfhSize = adaptiveCalloc<Uint32>();
  ...
  bool validateFileHash(IStream? fileStream) {
    final isValid = adaptiveCalloc<Int32>();
    final hr$ = HRESULT(
