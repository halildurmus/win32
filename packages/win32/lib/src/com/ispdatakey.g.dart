...
class ISpDataKey extends IUnknown implements ComInterface {
  ...
  factory ISpDataKey.from(IUnknown interface) => interface.queryInterface();

  final ISpDataKeyVtbl _vtable;
  late final _SetDataFn =
      _vtable.SetData.asFunction<
        int Function(VTablePointer, Pointer<Utf16>, int, Pointer<Uint8>)
      >();
  ...
  late final _GetStringValueFn =
      ...
      >();
  late final _SetDWORDFn = _vtable
      .SetDWORD.asFunction<int Function(VTablePointer, Pointer<Utf16>, int)>();
  late final _GetDWORDFn =
      _vtable.GetDWORD.asFunction<
        int Function(VTablePointer, Pointer<Utf16>, Pointer<Uint32>)
      >();
  ...
  PWSTR getStringValue(PCWSTR? pszValueName) {
    final ppszValue = adaptiveCalloc<Pointer<Utf16>>();
    final hr$ = HRESULT(
  ...
  ISpDataKey? openKey(PCWSTR pszSubKeyName) {
    final ppSubKey = adaptiveCalloc<VTablePointer>();
  ...
  PWSTR enumKeys(int index) {
    final ppszSubKeyName = adaptiveCalloc<Pointer<Utf16>>();
  ...
  PWSTR enumValues(int index) {
    final ppszValueName = adaptiveCalloc<Pointer<Utf16>>();
...
base class ISpDataKeyVtbl extends Struct {
  ...
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Pointer<Utf16> pszSubKey)
    >
  >
  DeleteKey;
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Pointer<Utf16> pszValueName)
    >
  >
  DeleteValue;
  external Pointer<
