...
class IUIAutomationTransformPattern2 extends IUIAutomationTransformPattern
  ...
  late final _get_CurrentCanZoomFn =
      _vtable.get_CurrentCanZoom
          .asFunction<int Function(VTablePointer, Pointer<BOOL>)>();
  late final _get_CachedCanZoomFn =
      _vtable.get_CachedCanZoom
          .asFunction<int Function(VTablePointer, Pointer<BOOL>)>();
  late final _get_CurrentZoomLevelFn =
      _vtable.get_CurrentZoomLevel
          .asFunction<int Function(VTablePointer, Pointer<Double>)>();
  late final _get_CachedZoomLevelFn =
      _vtable.get_CachedZoomLevel
          .asFunction<int Function(VTablePointer, Pointer<Double>)>();
  late final _get_CurrentZoomMinimumFn =
      _vtable.get_CurrentZoomMinimum
          .asFunction<int Function(VTablePointer, Pointer<Double>)>();
  late final _get_CachedZoomMinimumFn =
      _vtable.get_CachedZoomMinimum
          .asFunction<int Function(VTablePointer, Pointer<Double>)>();
  late final _get_CurrentZoomMaximumFn =
      _vtable.get_CurrentZoomMaximum
          .asFunction<int Function(VTablePointer, Pointer<Double>)>();
  late final _get_CachedZoomMaximumFn =
      _vtable.get_CachedZoomMaximum
          .asFunction<int Function(VTablePointer, Pointer<Double>)>();
