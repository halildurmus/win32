...
class IWbemClassObject extends IUnknown implements ComInterface {
  ...
  late final _PutFn =
      _vtable.Put.asFunction<
        int Function(VTablePointer, Pointer<Utf16>, int, Pointer<VARIANT>, int)
      >();
  late final _DeleteFn =
      _vtable.Delete.asFunction<int Function(VTablePointer, Pointer<Utf16>)>();
  ...
  late final _GetPropertyOriginFn =
      ...
      >();
  late final _InheritsFromFn = _vtable
      .InheritsFrom.asFunction<int Function(VTablePointer, Pointer<Utf16>)>();
  ...
  late final _PutMethodFn =
      ...
      >();
  late final _DeleteMethodFn = _vtable
      .DeleteMethod.asFunction<int Function(VTablePointer, Pointer<Utf16>)>();
  ...
  IWbemQualifierSet? getQualifierSet() {
    final ppQualSet = adaptiveCalloc<VTablePointer>();
  ...
  Pointer<SAFEARRAY> getNames(
    ...
    final pNames = adaptiveCalloc<Pointer<SAFEARRAY>>();
    final hr$ = HRESULT(
  ...
  IWbemClassObject? clone() {
    final ppCopy = adaptiveCalloc<VTablePointer>();
  ...
  BSTR getObjectText(int lFlags) {
    final pstrObjectText = adaptiveCalloc<Pointer<Utf16>>();
  ...
  IWbemClassObject? spawnDerivedClass(int lFlags) {
    final ppNewClass = adaptiveCalloc<VTablePointer>();
  ...
  IWbemClassObject? spawnInstance(int lFlags) {
    final ppNewInstance = adaptiveCalloc<VTablePointer>();
  ...
  BSTR getPropertyOrigin(PCWSTR wszName) {
    final pstrClassName = adaptiveCalloc<Pointer<Utf16>>();
...
base class IWbemClassObjectVtbl extends Struct {
  ...
  Put;
  external Pointer<
    NativeFunction<Int32 Function(VTablePointer this$, Pointer<Utf16> wszName)>
  >
  Delete;
  external Pointer<
    NativeFunction<
  ...
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Pointer<Utf16> strAncestor)
    >
  >
  InheritsFrom;
  external Pointer<
