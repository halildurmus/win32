...
final IID_IFileDialog2 = GUID.fromComponents(
  ...
  0x85b5,
  0x4791,
  .fromList(const [0xa9, 0xb0, 0x27, 0x22, 0x76, 0x30, 0x9b, 0x13]),
);
...
class IFileDialog2 extends IFileDialog implements ComInterface {
  ...
  factory IFileDialog2.from(IUnknown interface) => interface.queryInterface();

  final IFileDialog2Vtbl _vtable;
  late final _SetCancelButtonLabelFn =
