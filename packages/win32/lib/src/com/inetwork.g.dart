...
class INetwork extends IDispatch implements ComInterface {
  ...
  factory INetwork.from(IUnknown interface) => interface.queryInterface();
  ...
  late final _SetNameFn =
      _vtable.SetName.asFunction<int Function(VTablePointer, Pointer<Utf16>)>();
  ...
  BSTR getName() {
    final pszNetworkName = adaptiveCalloc<Pointer<Utf16>>();
  ...
  Pointer<GUID> getNetworkId() {
    final pgdGuidNetworkId = adaptiveCalloc<GUID>();
  ...
  NLM_DOMAIN_TYPE getDomainType() {
    final pNetworkType = adaptiveCalloc<Int32>();
  ...
  IEnumNetworkConnections? getNetworkConnections() {
    final ppEnumNetworkConnection = adaptiveCalloc<VTablePointer>();
...
base class INetworkVtbl extends Struct {
  ...
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Pointer<Utf16> szNetworkNewName)
    >
  >
  SetName;
  external Pointer<
  ...
  external Pointer<
    NativeFunction<
      Int32 Function(VTablePointer this$, Pointer<Utf16> szDescription)
    >
  >
  SetDescription;
  external Pointer<
