...
class IAppxBlockMapReader extends IUnknown implements ComInterface {
  ...
  factory IAppxBlockMapReader.from(IUnknown interface) =>
  ...
  IAppxBlockMapFilesEnumerator? getFiles() {
    final enumerator = adaptiveCalloc<VTablePointer>();
  ...
  IUri? getHashMethod() {
    final hashMethod = adaptiveCalloc<VTablePointer>();
  ...
  IStream? getStream() {
    final blockMapStream = adaptiveCalloc<VTablePointer>();
