// Defines inline Win32 functions that cannot be wrapped with FFI.
...
bool IsPropVariantString(Pointer<PROPVARIANT> propvar) =>
    PropVariantToStringWithDefault(propvar, null).isNotNull;
...
void SetWindowThemeNonClientAttributes(
  HWND hwnd,
  int dwMask,
  int dwAttributes,
) {
  final wta = adaptiveCalloc<WTA_OPTIONS>();
  wta.ref
