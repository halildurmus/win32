...
/// {@category callback}
typedef BFFCALLBACK =
    Int32 Function(Pointer hwnd, Uint32 uMsg, IntPtr lParam, IntPtr lpData);
...
typedef ENUMRESTYPEPROC =
    Int32 Function(Pointer hModule, Pointer<Utf16> lpType, IntPtr lParam);
...
typedef LPOCNCHKPROC =
    Int32 Function(IntPtr param0, IntPtr param1, Pointer param2);
...
typedef PFN_DEVICE_CALLBACK =
    Int32 Function(Pointer pvParam, Pointer<BLUETOOTH_DEVICE_INFO> pDevice);
...
typedef SENDASYNCPROC =
    Void Function(Pointer param0, Uint32 param1, IntPtr param2, IntPtr param3);

/// {@category callback}
typedef SPNOTIFYCALLBACK = Void Function(IntPtr wParam, IntPtr lParam);
...
///
/// {@category callback}
typedef WNDENUMPROC = Int32 Function(Pointer param0, IntPtr param1);
