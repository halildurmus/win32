...
/// {@category struct}
sealed class _EVT_VARIANT__Anonymous_e__Union extends Union {
  @Int32()
...
extension EVT_VARIANT_Extension on EVT_VARIANT {
  ...
  Pointer get SidVal => this.Anonymous.SidVal;
  set SidVal(Pointer value) => this.Anonymous.SidVal = value;
