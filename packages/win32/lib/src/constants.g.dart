...
final DPI_AWARENESS_CONTEXT_PER_MONITOR_AWARE = DPI_AWARENESS_CONTEXT(
  Pointer.fromAddress(-3),
);

final DPI_AWARENESS_CONTEXT_PER_MONITOR_AWARE_V2 = DPI_AWARENESS_CONTEXT(
  Pointer.fromAddress(-4),
);

final DPI_AWARENESS_CONTEXT_SYSTEM_AWARE = DPI_AWARENESS_CONTEXT(
  Pointer.fromAddress(-2),
);

final DPI_AWARENESS_CONTEXT_UNAWARE = DPI_AWARENESS_CONTEXT(
  Pointer.fromAddress(-1),
);

final DPI_AWARENESS_CONTEXT_UNAWARE_GDISCALED = DPI_AWARENESS_CONTEXT(
...
/// Notifies a rich edit control's parent window that the current selection has
/// changed.
///
/// A rich edit control sends this notification code in the form of a WM_NOTIFY
/// message.
///
/// To learn more, see
/// <https://learn.microsoft.com/windows/win32/Controls/en-selchange>.
...
final HKEY_CLASSES_ROOT = HKEY(Pointer.fromAddress(-2147483648));

final HKEY_CURRENT_CONFIG = HKEY(Pointer.fromAddress(-2147483643));

final HKEY_CURRENT_USER = HKEY(Pointer.fromAddress(-2147483647));

final HKEY_CURRENT_USER_LOCAL_SETTINGS = HKEY(Pointer.fromAddress(-2147483641));

final HKEY_DYN_DATA = HKEY(Pointer.fromAddress(-2147483642));

final HKEY_LOCAL_MACHINE = HKEY(Pointer.fromAddress(-2147483646));

final HKEY_PERFORMANCE_DATA = HKEY(Pointer.fromAddress(-2147483644));

final HKEY_PERFORMANCE_NLSTEXT = HKEY(Pointer.fromAddress(-2147483552));

final HKEY_PERFORMANCE_TEXT = HKEY(Pointer.fromAddress(-2147483568));

final HKEY_USERS = HKEY(Pointer.fromAddress(-2147483645));
...
final HWND_BOTTOM = HWND(Pointer.fromAddress(1));

final HWND_BROADCAST = HWND(Pointer.fromAddress(65535));

final HWND_DESKTOP = HWND(Pointer.fromAddress(0));

final HWND_MESSAGE = HWND(Pointer.fromAddress(-3));
...
/// To learn more, see
/// <https://learn.microsoft.com/windows/win32/api/winuser/nf-winuser-deferwindowpos>.
final HWND_NOTOPMOST = HWND(Pointer.fromAddress(-2));

/// Places the window at the top of the Z order.
///
/// To learn more, see
/// <https://learn.microsoft.com/windows/win32/api/winuser/nf-winuser-deferwindowpos>.
final HWND_TOP = HWND(Pointer.fromAddress(0));
...
final IDC_APPSTARTING = PCWSTR(Pointer.fromAddress(32650));

/// Standard arrow cursor.
///
/// To learn more, see
/// <https://learn.microsoft.com/windows/win32/api/winuser/nf-winuser-geticoninfo>.
final IDC_ARROW = PCWSTR(Pointer.fromAddress(32512));

/// Crosshair cursor.
///
/// To learn more, see
/// <https://learn.microsoft.com/windows/win32/api/winuser/nf-winuser-geticoninfo>.
final IDC_CROSS = PCWSTR(Pointer.fromAddress(32515));

/// Hand cursor.
///
/// To learn more, see
/// <https://learn.microsoft.com/windows/win32/api/winuser/nf-winuser-geticoninfo>.
final IDC_HAND = PCWSTR(Pointer.fromAddress(32649));

/// Arrow and question mark cursor.
///
/// To learn more, see
/// <https://learn.microsoft.com/windows/win32/api/winuser/nf-winuser-geticoninfo>.
final IDC_HELP = PCWSTR(Pointer.fromAddress(32651));

/// I-beam cursor.
///
/// To learn more, see
/// <https://learn.microsoft.com/windows/win32/api/winuser/nf-winuser-geticoninfo>.
final IDC_IBEAM = PCWSTR(Pointer.fromAddress(32513));

/// Slashed circle cursor.
///
/// To learn more, see
/// <https://learn.microsoft.com/windows/win32/api/winuser/nf-winuser-geticoninfo>.
final IDC_NO = PCWSTR(Pointer.fromAddress(32648));

/// Four-pointed arrow cursor pointing north, south, east, and west.
///
/// To learn more, see
/// <https://learn.microsoft.com/windows/win32/api/winuser/nf-winuser-geticoninfo>.
final IDC_SIZEALL = PCWSTR(Pointer.fromAddress(32646));

/// Double-pointed arrow cursor pointing northeast and southwest.
///
/// To learn more, see
/// <https://learn.microsoft.com/windows/win32/api/winuser/nf-winuser-geticoninfo>.
final IDC_SIZENESW = PCWSTR(Pointer.fromAddress(32643));

/// Double-pointed arrow cursor pointing north and south.
///
/// To learn more, see
/// <https://learn.microsoft.com/windows/win32/api/winuser/nf-winuser-geticoninfo>.
final IDC_SIZENS = PCWSTR(Pointer.fromAddress(32645));

/// Double-pointed arrow cursor pointing northwest and southeast.
///
/// To learn more, see
/// <https://learn.microsoft.com/windows/win32/api/winuser/nf-winuser-geticoninfo>.
final IDC_SIZENWSE = PCWSTR(Pointer.fromAddress(32642));

/// Double-pointed arrow cursor pointing west and east.
///
/// To learn more, see
/// <https://learn.microsoft.com/windows/win32/api/winuser/nf-winuser-geticoninfo>.
final IDC_SIZEWE = PCWSTR(Pointer.fromAddress(32644));

/// Vertical arrow cursor.
///
/// To learn more, see
/// <https://learn.microsoft.com/windows/win32/api/winuser/nf-winuser-geticoninfo>.
final IDC_UPARROW = PCWSTR(Pointer.fromAddress(32516));

/// Hourglass cursor.
///
/// To learn more, see
/// <https://learn.microsoft.com/windows/win32/api/winuser/nf-winuser-geticoninfo>.
final IDC_WAIT = PCWSTR(Pointer.fromAddress(32514));

final IDI_APPLICATION = PCWSTR(Pointer.fromAddress(32512));

final IDI_ASTERISK = PCWSTR(Pointer.fromAddress(32516));

/// Hand-shaped icon.
///
/// To learn more, see
/// <https://learn.microsoft.com/windows/win32/api/winuser/nf-winuser-loadicona>.
final IDI_ERROR = PCWSTR(Pointer.fromAddress(32513));

final IDI_EXCLAMATION = PCWSTR(Pointer.fromAddress(32515));

final IDI_HAND = PCWSTR(Pointer.fromAddress(32513));

/// Asterisk icon.
///
/// To learn more, see
/// <https://learn.microsoft.com/windows/win32/api/winuser/nf-winuser-loadicona>.
final IDI_INFORMATION = PCWSTR(Pointer.fromAddress(32516));

final IDI_QUESTION = PCWSTR(Pointer.fromAddress(32514));

/// Security Shield icon.
///
/// To learn more, see
/// <https://learn.microsoft.com/windows/win32/api/winuser/nf-winuser-loadicona>.
final IDI_SHIELD = PCWSTR(Pointer.fromAddress(32518));

/// Exclamation point icon.
///
/// To learn more, see
/// <https://learn.microsoft.com/windows/win32/api/winuser/nf-winuser-loadicona>.
final IDI_WARNING = PCWSTR(Pointer.fromAddress(32515));

final IDI_WINLOGO = PCWSTR(Pointer.fromAddress(32517));
...
final INVALID_HANDLE_VALUE = HANDLE(Pointer.fromAddress(-1));
...
final PROPERTYKEY PKEY_DeviceClass_Characteristics =
...
final PROPERTYKEY PKEY_DeviceClass_ClassCoInstallers =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x713d1703,
        0xa2e2,
...
final PROPERTYKEY PKEY_DeviceClass_ClassInstaller = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x259abffc,
    0x50a7,
    0x47ce,
...
final PROPERTYKEY PKEY_DeviceClass_ClassName = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x259abffc,
    0x50a7,
    0x47ce,
...
final PROPERTYKEY PKEY_DeviceClass_DefaultService = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x259abffc,
    0x50a7,
    0x47ce,
...
final PROPERTYKEY PKEY_DeviceClass_Exclusive = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x4321918b,
    0xf69e,
    0x470d,
...
final PROPERTYKEY PKEY_DeviceClass_Icon = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x259abffc,
    0x50a7,
    0x47ce,
...
final PROPERTYKEY PKEY_DeviceClass_IconPath = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x259abffc,
    0x50a7,
    0x47ce,
...
final PROPERTYKEY PKEY_DeviceClass_LowerFilters = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x4321918b,
    0xf69e,
    0x470d,
...
final PROPERTYKEY PKEY_DeviceClass_Name = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x259abffc,
    0x50a7,
    0x47ce,
...
final PROPERTYKEY PKEY_DeviceClass_NoDisplayClass = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x259abffc,
    0x50a7,
    0x47ce,
...
final PROPERTYKEY PKEY_DeviceClass_NoInstallClass = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x259abffc,
    0x50a7,
    0x47ce,
...
final PROPERTYKEY PKEY_DeviceClass_NoUseClass = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x259abffc,
    0x50a7,
    0x47ce,
...
final PROPERTYKEY PKEY_DeviceClass_PropPageProvider =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x259abffc,
        0x50a7,
...
final PROPERTYKEY PKEY_DeviceClass_Security = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x4321918b,
    0xf69e,
    0x470d,
...
final PROPERTYKEY PKEY_DeviceClass_SecuritySDS = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x4321918b,
    0xf69e,
    0x470d,
...
final PROPERTYKEY PKEY_DeviceClass_SilentInstall = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x259abffc,
    0x50a7,
    0x47ce,
...
final PROPERTYKEY PKEY_DeviceClass_UpperFilters = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x4321918b,
    0xf69e,
    0x470d,
...
final PROPERTYKEY PKEY_DeviceDisplay_Address = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x78c34fc8,
    0x104a,
    0x4aca,
...
final PROPERTYKEY PKEY_DeviceDisplay_AlwaysShowDeviceAsConnected =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x78c34fc8,
        0x104a,
...
final PROPERTYKEY PKEY_DeviceDisplay_AssociationArray =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x78c34fc8,
        0x104a,
...
final PROPERTYKEY PKEY_DeviceDisplay_BaselineExperienceId =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x78c34fc8,
        0x104a,
...
final PROPERTYKEY PKEY_DeviceDisplay_Category = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x78c34fc8,
    0x104a,
    0x4aca,
...
final PROPERTYKEY PKEY_DeviceDisplay_CategoryGroup_Desc =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x78c34fc8,
        0x104a,
...
final PROPERTYKEY PKEY_DeviceDisplay_CategoryGroup_Icon =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x78c34fc8,
        0x104a,
...
final PROPERTYKEY PKEY_DeviceDisplay_Category_Desc_Plural =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x78c34fc8,
        0x104a,
...
final PROPERTYKEY PKEY_DeviceDisplay_Category_Desc_Singular =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x78c34fc8,
        0x104a,
...
final PROPERTYKEY PKEY_DeviceDisplay_Category_Icon =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x78c34fc8,
        0x104a,
...
final PROPERTYKEY PKEY_DeviceDisplay_DeviceDescription1 =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x78c34fc8,
        0x104a,
...
final PROPERTYKEY PKEY_DeviceDisplay_DeviceDescription2 =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x78c34fc8,
        0x104a,
...
final PROPERTYKEY PKEY_DeviceDisplay_DeviceFunctionSubRank =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x78c34fc8,
        0x104a,
...
final PROPERTYKEY PKEY_DeviceDisplay_DiscoveryMethod =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x78c34fc8,
        0x104a,
...
final PROPERTYKEY PKEY_DeviceDisplay_ExperienceId = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x78c34fc8,
    0x104a,
    0x4aca,
...
final PROPERTYKEY PKEY_DeviceDisplay_FriendlyName = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_DeviceDisplay_Icon = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x78c34fc8,
    0x104a,
    0x4aca,
...
final PROPERTYKEY PKEY_DeviceDisplay_InstallInProgress =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x83da6326,
        0x97a6,
...
final PROPERTYKEY PKEY_DeviceDisplay_IsAuthenticated =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x78c34fc8,
        0x104a,
...
final PROPERTYKEY PKEY_DeviceDisplay_IsConnected = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x78c34fc8,
    0x104a,
    0x4aca,
...
final PROPERTYKEY PKEY_DeviceDisplay_IsDefaultDevice =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x78c34fc8,
        0x104a,
...
final PROPERTYKEY PKEY_DeviceDisplay_IsDeviceUniquelyIdentifiable =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x78c34fc8,
        0x104a,
...
final PROPERTYKEY PKEY_DeviceDisplay_IsEncrypted = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x78c34fc8,
    0x104a,
    0x4aca,
...
final PROPERTYKEY PKEY_DeviceDisplay_IsLocalMachine =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x78c34fc8,
        0x104a,
...
final PROPERTYKEY PKEY_DeviceDisplay_IsMetadataSearchInProgress =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x78c34fc8,
        0x104a,
...
final PROPERTYKEY PKEY_DeviceDisplay_IsNotInterestingForDisplay =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x78c34fc8,
        0x104a,
...
final PROPERTYKEY PKEY_DeviceDisplay_IsNotWorkingProperly =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x78c34fc8,
        0x104a,
...
final PROPERTYKEY PKEY_DeviceDisplay_IsPaired = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x78c34fc8,
    0x104a,
    0x4aca,
...
final PROPERTYKEY PKEY_DeviceDisplay_IsSharedDevice =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x78c34fc8,
        0x104a,
...
final PROPERTYKEY PKEY_DeviceDisplay_IsShowInDisconnectedState =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x78c34fc8,
        0x104a,
...
final PROPERTYKEY PKEY_DeviceDisplay_Last_Connected =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x78c34fc8,
        0x104a,
...
final PROPERTYKEY PKEY_DeviceDisplay_Last_Seen = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x78c34fc8,
    0x104a,
    0x4aca,
...
final PROPERTYKEY PKEY_DeviceDisplay_LaunchDeviceStageFromExplorer =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x78c34fc8,
        0x104a,
...
final PROPERTYKEY PKEY_DeviceDisplay_LaunchDeviceStageOnDeviceConnect =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x78c34fc8,
        0x104a,
...
final PROPERTYKEY PKEY_DeviceDisplay_Manufacturer = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_DeviceDisplay_MetadataCabinet =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x78c34fc8,
        0x104a,
...
final PROPERTYKEY PKEY_DeviceDisplay_MetadataChecksum =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x78c34fc8,
        0x104a,
...
final PROPERTYKEY PKEY_DeviceDisplay_MetadataPath = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x78c34fc8,
    0x104a,
    0x4aca,
...
final PROPERTYKEY PKEY_DeviceDisplay_ModelName = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_DeviceDisplay_ModelNumber = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_DeviceDisplay_PrimaryCategory =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x78c34fc8,
        0x104a,
...
final PROPERTYKEY PKEY_DeviceDisplay_RequiresPairingElevation =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x78c34fc8,
        0x104a,
...
final PROPERTYKEY PKEY_DeviceDisplay_RequiresUninstallElevation =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x78c34fc8,
        0x104a,
...
final PROPERTYKEY PKEY_DeviceDisplay_UnpairUninstall =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x78c34fc8,
        0x104a,
...
final PROPERTYKEY PKEY_DeviceDisplay_Version = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x78c34fc8,
    0x104a,
    0x4aca,
...
final PROPERTYKEY PKEY_DeviceInterfaceClass_DefaultInterface =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x14c83a99,
        0xb3f,
...
final PROPERTYKEY PKEY_DeviceInterface_ClassGuid = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x26e516e,
    0xb814,
    0x414b,
...
final PROPERTYKEY PKEY_DeviceInterface_Enabled = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x26e516e,
    0xb814,
    0x414b,
...
final PROPERTYKEY PKEY_DeviceInterface_FriendlyName =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x26e516e,
        0xb814,
...
final PROPERTYKEY PKEY_Device_AdditionalSoftwareRequested =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0xa8b865dd,
        0x2e3d,
...
final PROPERTYKEY PKEY_Device_Address = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa45c254e,
    0xdf1c,
    0x4efd,
...
final PROPERTYKEY PKEY_Device_BIOSVersion = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xeaee7f1d,
    0x6a33,
    0x44d1,
...
final PROPERTYKEY PKEY_Device_BaseContainerId = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa45c254e,
    0xdf1c,
    0x4efd,
...
final PROPERTYKEY PKEY_Device_BusNumber = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa45c254e,
    0xdf1c,
    0x4efd,
...
final PROPERTYKEY PKEY_Device_BusRelations = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x4340a6c5,
    0x93fa,
    0x4706,
...
final PROPERTYKEY PKEY_Device_BusReportedDeviceDesc =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x540b947e,
        0x8b40,
...
final PROPERTYKEY PKEY_Device_BusTypeGuid = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa45c254e,
    0xdf1c,
    0x4efd,
...
final PROPERTYKEY PKEY_Device_Capabilities = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa45c254e,
    0xdf1c,
    0x4efd,
...
final PROPERTYKEY PKEY_Device_Characteristics = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa45c254e,
    0xdf1c,
    0x4efd,
...
final PROPERTYKEY PKEY_Device_Children = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x4340a6c5,
    0x93fa,
    0x4706,
...
final PROPERTYKEY PKEY_Device_Class = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa45c254e,
    0xdf1c,
    0x4efd,
...
final PROPERTYKEY PKEY_Device_ClassGuid = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa45c254e,
    0xdf1c,
    0x4efd,
...
final PROPERTYKEY PKEY_Device_CompatibleIds = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa45c254e,
    0xdf1c,
    0x4efd,
...
final PROPERTYKEY PKEY_Device_ConfigFlags = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa45c254e,
    0xdf1c,
    0x4efd,
...
final PROPERTYKEY PKEY_Device_ContainerId = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x8c7ed206,
    0x3f8a,
    0x4827,
...
final PROPERTYKEY PKEY_Device_DHP_Rebalance_Policy =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x540b947e,
        0x8b40,
...
final PROPERTYKEY PKEY_Device_DevNodeStatus = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x4340a6c5,
    0x93fa,
    0x4706,
...
final PROPERTYKEY PKEY_Device_DevType = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa45c254e,
    0xdf1c,
    0x4efd,
...
final PROPERTYKEY PKEY_Device_DeviceDesc = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa45c254e,
    0xdf1c,
    0x4efd,
...
final PROPERTYKEY PKEY_Device_Driver = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa45c254e,
    0xdf1c,
    0x4efd,
...
final PROPERTYKEY PKEY_Device_DriverCoInstallers = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa8b865dd,
    0x2e3d,
    0x4094,
...
final PROPERTYKEY PKEY_Device_DriverDate = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa8b865dd,
    0x2e3d,
    0x4094,
...
final PROPERTYKEY PKEY_Device_DriverDesc = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa8b865dd,
    0x2e3d,
    0x4094,
...
final PROPERTYKEY PKEY_Device_DriverInfPath = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa8b865dd,
    0x2e3d,
    0x4094,
...
final PROPERTYKEY PKEY_Device_DriverInfSection = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa8b865dd,
    0x2e3d,
    0x4094,
...
final PROPERTYKEY PKEY_Device_DriverInfSectionExt = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa8b865dd,
    0x2e3d,
    0x4094,
...
final PROPERTYKEY PKEY_Device_DriverLogoLevel = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa8b865dd,
    0x2e3d,
    0x4094,
...
final PROPERTYKEY PKEY_Device_DriverPropPageProvider =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0xa8b865dd,
        0x2e3d,
...
final PROPERTYKEY PKEY_Device_DriverProvider = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa8b865dd,
    0x2e3d,
    0x4094,
...
final PROPERTYKEY PKEY_Device_DriverRank = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa8b865dd,
    0x2e3d,
    0x4094,
...
final PROPERTYKEY PKEY_Device_DriverVersion = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa8b865dd,
    0x2e3d,
    0x4094,
...
final PROPERTYKEY PKEY_Device_EjectionRelations = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x4340a6c5,
    0x93fa,
    0x4706,
...
final PROPERTYKEY PKEY_Device_EnumeratorName = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa45c254e,
    0xdf1c,
    0x4efd,
...
final PROPERTYKEY PKEY_Device_Exclusive = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa45c254e,
    0xdf1c,
    0x4efd,
...
final PROPERTYKEY PKEY_Device_FriendlyName = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa45c254e,
    0xdf1c,
    0x4efd,
...
final PROPERTYKEY PKEY_Device_FriendlyNameAttributes =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x80d81ea6,
        0x7473,
...
final PROPERTYKEY PKEY_Device_HardwareIds = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa45c254e,
    0xdf1c,
    0x4efd,
...
final PROPERTYKEY PKEY_Device_InstallInProgress = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x83da6326,
    0x97a6,
    0x4088,
...
final PROPERTYKEY PKEY_Device_InstallState = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa45c254e,
    0xdf1c,
    0x4efd,
...
final PROPERTYKEY PKEY_Device_InstanceId = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x78c34fc8,
    0x104a,
    0x4aca,
...
final PROPERTYKEY PKEY_Device_IsAssociateableByUserAction =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x80d81ea6,
        0x7473,
...
final PROPERTYKEY PKEY_Device_Legacy = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x80497100,
    0x8c73,
    0x48b9,
...
final PROPERTYKEY PKEY_Device_LegacyBusType = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa45c254e,
    0xdf1c,
    0x4efd,
...
final PROPERTYKEY PKEY_Device_LocationInfo = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa45c254e,
    0xdf1c,
    0x4efd,
...
final PROPERTYKEY PKEY_Device_LocationPaths = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa45c254e,
    0xdf1c,
    0x4efd,
...
final PROPERTYKEY PKEY_Device_LowerFilters = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa45c254e,
    0xdf1c,
    0x4efd,
...
final PROPERTYKEY PKEY_Device_Manufacturer = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa45c254e,
    0xdf1c,
    0x4efd,
...
final PROPERTYKEY PKEY_Device_ManufacturerAttributes =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x80d81ea6,
        0x7473,
...
final PROPERTYKEY PKEY_Device_MatchingDeviceId = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa8b865dd,
    0x2e3d,
    0x4094,
...
final PROPERTYKEY PKEY_Device_ModelId = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x80d81ea6,
    0x7473,
    0x4b0c,
...
final PROPERTYKEY PKEY_Device_NoConnectSound = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa8b865dd,
    0x2e3d,
    0x4094,
...
final PROPERTYKEY PKEY_Device_Numa_Node = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x540b947e,
    0x8b40,
    0x45bc,
...
final PROPERTYKEY PKEY_Device_PDOName = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa45c254e,
    0xdf1c,
    0x4efd,
...
final PROPERTYKEY PKEY_Device_Parent = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x4340a6c5,
    0x93fa,
    0x4706,
...
final PROPERTYKEY PKEY_Device_PowerData = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa45c254e,
    0xdf1c,
    0x4efd,
...
final PROPERTYKEY PKEY_Device_PowerRelations = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x4340a6c5,
    0x93fa,
    0x4706,
...
final PROPERTYKEY PKEY_Device_PresenceNotForDevice =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x80d81ea6,
        0x7473,
...
final PROPERTYKEY PKEY_Device_ProblemCode = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x4340a6c5,
    0x93fa,
    0x4706,
...
final PROPERTYKEY PKEY_Device_RemovalPolicy = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa45c254e,
    0xdf1c,
    0x4efd,
...
final PROPERTYKEY PKEY_Device_RemovalPolicyDefault =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0xa45c254e,
        0xdf1c,
...
final PROPERTYKEY PKEY_Device_RemovalPolicyOverride =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0xa45c254e,
        0xdf1c,
...
final PROPERTYKEY PKEY_Device_RemovalRelations = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x4340a6c5,
    0x93fa,
    0x4706,
...
final PROPERTYKEY PKEY_Device_Reported = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x80497100,
    0x8c73,
    0x48b9,
...
final PROPERTYKEY PKEY_Device_ResourcePickerExceptions =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0xa8b865dd,
        0x2e3d,
...
final PROPERTYKEY PKEY_Device_ResourcePickerTags = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa8b865dd,
    0x2e3d,
    0x4094,
...
final PROPERTYKEY PKEY_Device_SafeRemovalRequired = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xafd97640,
    0x86a3,
    0x4210,
...
final PROPERTYKEY PKEY_Device_SafeRemovalRequiredOverride =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0xafd97640,
        0x86a3,
...
final PROPERTYKEY PKEY_Device_Security = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa45c254e,
    0xdf1c,
    0x4efd,
...
final PROPERTYKEY PKEY_Device_SecuritySDS = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa45c254e,
    0xdf1c,
    0x4efd,
...
final PROPERTYKEY PKEY_Device_Service = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa45c254e,
    0xdf1c,
    0x4efd,
...
final PROPERTYKEY PKEY_Device_Siblings = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x4340a6c5,
    0x93fa,
    0x4706,
...
final PROPERTYKEY PKEY_Device_SignalStrength = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x80d81ea6,
    0x7473,
    0x4b0c,
...
final PROPERTYKEY PKEY_Device_TransportRelations = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x4340a6c5,
    0x93fa,
    0x4706,
...
final PROPERTYKEY PKEY_Device_UINumber = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa45c254e,
    0xdf1c,
    0x4efd,
...
final PROPERTYKEY PKEY_Device_UINumberDescFormat = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa45c254e,
    0xdf1c,
    0x4efd,
...
final PROPERTYKEY PKEY_Device_UpperFilters = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xa45c254e,
    0xdf1c,
    0x4efd,
...
final PROPERTYKEY PKEY_DrvPkg_BrandingIcon = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xcf73bb51,
    0x3abf,
    0x44a2,
...
final PROPERTYKEY PKEY_DrvPkg_DetailedDescription = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xcf73bb51,
    0x3abf,
    0x44a2,
...
final PROPERTYKEY PKEY_DrvPkg_DocumentationLink = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xcf73bb51,
    0x3abf,
    0x44a2,
...
final PROPERTYKEY PKEY_DrvPkg_Icon = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xcf73bb51,
    0x3abf,
    0x44a2,
...
final PROPERTYKEY PKEY_DrvPkg_Model = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xcf73bb51,
    0x3abf,
    0x44a2,
...
final PROPERTYKEY PKEY_DrvPkg_VendorWebSite = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xcf73bb51,
    0x3abf,
    0x44a2,
...
final PROPERTYKEY PKEY_Hardware_Devinst = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x5eaf3ef2,
    0xe0ca,
    0x4598,
...
final PROPERTYKEY PKEY_Hardware_DisplayAttribute = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x5eaf3ef2,
    0xe0ca,
    0x4598,
...
final PROPERTYKEY PKEY_Hardware_DriverDate = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x5eaf3ef2,
    0xe0ca,
    0x4598,
...
final PROPERTYKEY PKEY_Hardware_DriverProvider = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x5eaf3ef2,
    0xe0ca,
    0x4598,
...
final PROPERTYKEY PKEY_Hardware_DriverVersion = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x5eaf3ef2,
    0xe0ca,
    0x4598,
...
final PROPERTYKEY PKEY_Hardware_Function = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x5eaf3ef2,
    0xe0ca,
    0x4598,
...
final PROPERTYKEY PKEY_Hardware_Icon = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x5eaf3ef2,
    0xe0ca,
    0x4598,
...
final PROPERTYKEY PKEY_Hardware_Image = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x5eaf3ef2,
    0xe0ca,
    0x4598,
...
final PROPERTYKEY PKEY_Hardware_Manufacturer = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x5eaf3ef2,
    0xe0ca,
    0x4598,
...
final PROPERTYKEY PKEY_Hardware_Model = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x5eaf3ef2,
    0xe0ca,
    0x4598,
...
final PROPERTYKEY PKEY_Hardware_Name = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x5eaf3ef2,
    0xe0ca,
    0x4598,
...
final PROPERTYKEY PKEY_Hardware_SerialNumber = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x5eaf3ef2,
    0xe0ca,
    0x4598,
...
final PROPERTYKEY PKEY_Hardware_ShellAttributes = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x5eaf3ef2,
    0xe0ca,
    0x4598,
...
final PROPERTYKEY PKEY_Hardware_Status = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x5eaf3ef2,
    0xe0ca,
    0x4598,
...
final PROPERTYKEY PKEY_NAME = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xb725f130,
    0x47ef,
    0x101a,
...
final PROPERTYKEY PKEY_Numa_Proximity_Domain = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x540b947e,
    0x8b40,
    0x45bc,
...
final PROPERTYKEY PKEY_PNPX_Associated = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x4fc5077e,
    0xb686,
    0x44be,
...
final PROPERTYKEY PKEY_PNPX_Category_Desc_NonPlural =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x656a3bb3,
        0xecc0,
...
final PROPERTYKEY PKEY_PNPX_CompactSignature = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_PNPX_CompatibleTypes = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x4fc5077e,
    0xb686,
    0x44be,
...
final PROPERTYKEY PKEY_PNPX_DeviceCategory = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_PNPX_DeviceCategory_Desc = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_PNPX_DeviceCertHash = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_PNPX_DomainName = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_PNPX_FirmwareVersion = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_PNPX_GlobalIdentity = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_PNPX_ID = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_PNPX_IPBusEnumerated = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_PNPX_InstallState = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x4fc5077e,
    0xb686,
    0x44be,
...
final PROPERTYKEY PKEY_PNPX_Installable = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x4fc5077e,
    0xb686,
    0x44be,
...
final PROPERTYKEY PKEY_PNPX_IpAddress = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_PNPX_ManufacturerUrl = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_PNPX_MetadataVersion = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_PNPX_ModelUrl = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_PNPX_NetworkInterfaceGuid = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_PNPX_NetworkInterfaceLuid = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_PNPX_PhysicalAddress = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_PNPX_PresentationUrl = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_PNPX_RemoteAddress = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_PNPX_Removable = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_PNPX_RootProxy = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_PNPX_Scopes = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_PNPX_SecureChannel = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_PNPX_SerialNumber = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_PNPX_ServiceAddress = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_PNPX_ServiceControlUrl = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_PNPX_ServiceDescUrl = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_PNPX_ServiceEventSubUrl = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_PNPX_ServiceId = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_PNPX_ServiceTypes = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_PNPX_ShareName = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_PNPX_Types = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_PNPX_Upc = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_PNPX_XAddrs = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_Pairing_IsWifiOnlyDevice = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x8807cae6,
    0x7db6,
    0x4f10,
...
final PROPERTYKEY PKEY_Pairing_ListItemDefault = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x8807cae6,
    0x7db6,
    0x4f10,
...
final PROPERTYKEY PKEY_Pairing_ListItemDescription =
    Struct.create<PROPERTYKEY>()
      ..fmtid = GUID.fromComponents(
        0x8807cae6,
        0x7db6,
...
final PROPERTYKEY PKEY_Pairing_ListItemIcon = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x8807cae6,
    0x7db6,
    0x4f10,
...
final PROPERTYKEY PKEY_Pairing_ListItemText = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x8807cae6,
    0x7db6,
    0x4f10,
...
final PROPERTYKEY PKEY_SSDP_AltLocationInfo = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_SSDP_DevLifeTime = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_SSDP_NetworkInterface = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x656a3bb3,
    0xecc0,
    0x43fd,
...
final PROPERTYKEY PKEY_WCN_AssocState = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x88190b88,
    0x4684,
    0x11da,
...
final PROPERTYKEY PKEY_WCN_AuthType = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x88190b82,
    0x4684,
    0x11da,
...
final PROPERTYKEY PKEY_WCN_ConfigError = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x88190b89,
    0x4684,
    0x11da,
...
final PROPERTYKEY PKEY_WCN_ConfigMethods = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x88190b85,
    0x4684,
    0x11da,
...
final PROPERTYKEY PKEY_WCN_ConfigState = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x88190b89,
    0x4684,
    0x11da,
...
final PROPERTYKEY PKEY_WCN_ConnType = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x88190b84,
    0x4684,
    0x11da,
...
final PROPERTYKEY PKEY_WCN_DevicePasswordId = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x88190b89,
    0x4684,
    0x11da,
...
final PROPERTYKEY PKEY_WCN_EncryptType = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x88190b83,
    0x4684,
    0x11da,
...
final PROPERTYKEY PKEY_WCN_OSVersion = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x88190b89,
    0x4684,
    0x11da,
...
final PROPERTYKEY PKEY_WCN_RegistrarType = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x88190b8b,
    0x4684,
    0x11da,
...
final PROPERTYKEY PKEY_WCN_RequestType = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x88190b81,
    0x4684,
    0x11da,
...
final PROPERTYKEY PKEY_WCN_RfBand = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x88190b87,
    0x4684,
    0x11da,
...
final PROPERTYKEY PKEY_WCN_VendorExtension = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x88190b8a,
    0x4684,
    0x11da,
...
final PROPERTYKEY PKEY_WCN_Version = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0x88190b80,
    0x4684,
    0x11da,
...
final PROPERTYKEY PKEY_WNET_Comment = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xdebda43a,
    0x37b3,
    0x4383,
...
final PROPERTYKEY PKEY_WNET_DisplayType = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xdebda43a,
    0x37b3,
    0x4383,
...
final PROPERTYKEY PKEY_WNET_LocalName = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xdebda43a,
    0x37b3,
    0x4383,
...
final PROPERTYKEY PKEY_WNET_Provider = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xdebda43a,
    0x37b3,
    0x4383,
...
final PROPERTYKEY PKEY_WNET_RemoteName = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xdebda43a,
    0x37b3,
    0x4383,
...
final PROPERTYKEY PKEY_WNET_Scope = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xdebda43a,
    0x37b3,
    0x4383,
...
final PROPERTYKEY PKEY_WNET_Type = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xdebda43a,
    0x37b3,
    0x4383,
...
final PROPERTYKEY PKEY_WNET_Usage = Struct.create<PROPERTYKEY>()
  ..fmtid = GUID.fromComponents(
    0xdebda43a,
    0x37b3,
    0x4383,
...
final RT_ACCELERATOR = PCWSTR(Pointer.fromAddress(9));

final RT_ANICURSOR = PCWSTR(Pointer.fromAddress(21));

final RT_ANIICON = PCWSTR(Pointer.fromAddress(22));

final RT_BITMAP = PCWSTR(Pointer.fromAddress(2));

final RT_CURSOR = PCWSTR(Pointer.fromAddress(1));

final RT_DIALOG = PCWSTR(Pointer.fromAddress(5));

final RT_DLGINCLUDE = PCWSTR(Pointer.fromAddress(17));

final RT_FONT = PCWSTR(Pointer.fromAddress(8));

final RT_FONTDIR = PCWSTR(Pointer.fromAddress(7));

final RT_GROUP_CURSOR = PCWSTR(Pointer.fromAddress(12));

final RT_GROUP_ICON = PCWSTR(Pointer.fromAddress(14));

final RT_HTML = PCWSTR(Pointer.fromAddress(23));

final RT_ICON = PCWSTR(Pointer.fromAddress(3));

final RT_MANIFEST = PCWSTR(Pointer.fromAddress(24));

final RT_MENU = PCWSTR(Pointer.fromAddress(4));

final RT_MESSAGETABLE = PCWSTR(Pointer.fromAddress(11));

final RT_PLUGPLAY = PCWSTR(Pointer.fromAddress(19));

final RT_RCDATA = PCWSTR(Pointer.fromAddress(10));

final RT_STRING = PCWSTR(Pointer.fromAddress(6));

final RT_VERSION = PCWSTR(Pointer.fromAddress(16));

final RT_VXD = PCWSTR(Pointer.fromAddress(20));
...
///
/// To learn more, see
/// <https://learn.microsoft.com/windows/win32/Controls/sb-setparts>.
const SB_SETPARTS = 1028;

/// Sets the text in the specified part of a status window.
///
/// To learn more, see
/// <https://learn.microsoft.com/windows/win32/Controls/sb-settext>.
const SB_SETTEXT = 1035;
...
const SO_DONTLINGER = -129;

const SO_DONTROUTE = 16;

const SO_ERROR = 4103;

/// Is designed to allow an application to enable keep-alive packets for a
/// socket connection.
///
/// To learn more, see
/// <https://learn.microsoft.com/windows/win32/WinSock/so-keepalive>.
...
/// An application sends an STM_SETIMAGE message to associate a new image with a
/// static control.
///
/// To learn more, see
/// <https://learn.microsoft.com/windows/win32/Controls/stm-setimage>.
...
final TD_ERROR_ICON = PCWSTR(Pointer.fromAddress(65534));

final TD_INFORMATION_ICON = PCWSTR(Pointer.fromAddress(65533));

final TD_SHIELD_ICON = PCWSTR(Pointer.fromAddress(65532));

final TD_WARNING_ICON = PCWSTR(Pointer.fromAddress(65535));
...
///
/// To learn more, see
/// <https://learn.microsoft.com/windows/win32/shell/wm-dropfiles>.
