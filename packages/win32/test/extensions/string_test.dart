    ...
    group('setString', () {
      ...
      test('overwrites existing memory contents', () {
        for (var i = 0; i < testRuns; i++) {
          ...
          final ptr =
              loggingCalloc<BYTE>(string.length + 1).cast<Utf8>()
                ..setString(string);
  ...
  group('PWSTRExtension', () {
    group('setString', () {
      ...
      test('overwrites existing memory contents', () {
        for (var i = 0; i < testRuns; i++) {
          final ptr =
              loggingMalloc<WCHAR>(20).cast<Utf16>()..setString('OldData');
          const string = 'New';
    ...
    group('toDartStringList', () {
      ...
      test('reads multiple strings', () {
        for (var i = 0; i < testRuns; i++) {
          ...
          final ptr =
              loggingMalloc<WCHAR>(arraySize).cast<Utf16>()
      ...
      test('returns empty list for empty memory block', () {
        for (var i = 0; i < testRuns; i++) {
          final ptr =
              loggingMalloc<WCHAR>(2).cast<Utf16>()..setString('\x00\x00');
