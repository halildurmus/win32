...
void main() {
  ...
  group('Test ws2_32 functions', () {
    if (windowsBuildNumber >= 9600) {
      test('Can instantiate accept', () {
        ...
        final accept = ws2_32.lookupFunction<
          ...
          int Function(int s, Pointer<SOCKADDR> addr, Pointer<Int32> addrlen)
        >('accept');
    ...
    if (windowsBuildNumber >= 9600) {
      test('Can instantiate getpeername', () {
        ...
        final getpeername = ws2_32.lookupFunction<
          ...
          int Function(int s, Pointer<SOCKADDR> name, Pointer<Int32> namelen)
        >('getpeername');
    ...
    if (windowsBuildNumber >= 9600) {
      test('Can instantiate htonl', () {
        final ws2_32 = DynamicLibrary.open('ws2_32.dll');
        final htonl = ws2_32.lookupFunction<
    ...
    if (windowsBuildNumber >= 9600) {
      test('Can instantiate htons', () {
        final ws2_32 = DynamicLibrary.open('ws2_32.dll');
        final htons = ws2_32.lookupFunction<
    ...
    if (windowsBuildNumber >= 9600) {
      test('Can instantiate ntohl', () {
        final ws2_32 = DynamicLibrary.open('ws2_32.dll');
        final ntohl = ws2_32.lookupFunction<
    ...
    if (windowsBuildNumber >= 9600) {
      test('Can instantiate ntohs', () {
        final ws2_32 = DynamicLibrary.open('ws2_32.dll');
        final ntohs = ws2_32.lookupFunction<
  ...
  group('Test kernel32 functions', () {
    ...
    test('Can instantiate CancelIo', () {
      final kernel32 = DynamicLibrary.open('kernel32.dll');
      final CancelIo = kernel32.lookupFunction<
    ...
    test('Can instantiate DosDateTimeToFileTime', () {
      ...
      final DosDateTimeToFileTime = kernel32.lookupFunction<
        ...
        int Function(int wFatDate, int wFatTime, Pointer<FILETIME> lpFileTime)
    ...
    test('Can instantiate GetCompressedFileSize', () {
      ...
      final GetCompressedFileSize = kernel32.lookupFunction<
        ...
        int Function(Pointer<Utf16> lpFileName, Pointer<Uint32> lpFileSizeHigh)
    ...
    test('Can instantiate K32GetDeviceDriverBaseName', () {
      ...
      final K32GetDeviceDriverBaseName = kernel32.lookupFunction<
        ...
        int Function(Pointer ImageBase, Pointer<Utf16> lpBaseName, int nSize)
    ...
    test('Can instantiate K32GetDeviceDriverFileName', () {
      ...
      final K32GetDeviceDriverFileName = kernel32.lookupFunction<
        ...
        int Function(Pointer ImageBase, Pointer<Utf16> lpFilename, int nSize)
    ...
    test('Can instantiate GetFileType', () {
      final kernel32 = DynamicLibrary.open('kernel32.dll');
      final GetFileType = kernel32.lookupFunction<
    ...
    test('Can instantiate K32GetProcessImageFileName', () {
      ...
      final K32GetProcessImageFileName = kernel32.lookupFunction<
        ...
        int Function(int hProcess, Pointer<Utf16> lpImageFileName, int nSize)
    ...
    test('Can instantiate GlobalSize', () {
      final kernel32 = DynamicLibrary.open('kernel32.dll');
      final GlobalSize = kernel32.lookupFunction<
    ...
    test('Can instantiate HeapDestroy', () {
      final kernel32 = DynamicLibrary.open('kernel32.dll');
      final HeapDestroy = kernel32.lookupFunction<
    ...
    test('Can instantiate HeapLock', () {
      final kernel32 = DynamicLibrary.open('kernel32.dll');
      final HeapLock = kernel32.lookupFunction<
        Int32 Function(IntPtr hHeap),
        int Function(int hHeap)
      >('HeapLock');
    ...
    test('Can instantiate HeapUnlock', () {
      final kernel32 = DynamicLibrary.open('kernel32.dll');
      final HeapUnlock = kernel32.lookupFunction<
        Int32 Function(IntPtr hHeap),
        int Function(int hHeap)
      >('HeapUnlock');
    ...
    test('Can instantiate IsProcessInJob', () {
      ...
      final IsProcessInJob = kernel32.lookupFunction<
        ...
        int Function(int ProcessHandle, int JobHandle, Pointer<Int32> Result)
      >('IsProcessInJob');
    ...
    test('Can instantiate ResetEvent', () {
      final kernel32 = DynamicLibrary.open('kernel32.dll');
      final ResetEvent = kernel32.lookupFunction<
    ...
    test('Can instantiate SetCommBreak', () {
      final kernel32 = DynamicLibrary.open('kernel32.dll');
      final SetCommBreak = kernel32.lookupFunction<
        Int32 Function(IntPtr hFile),
        int Function(int hFile)
      >('SetCommBreak');
    ...
    test('Can instantiate SetEndOfFile', () {
      final kernel32 = DynamicLibrary.open('kernel32.dll');
      final SetEndOfFile = kernel32.lookupFunction<
        Int32 Function(IntPtr hFile),
        int Function(int hFile)
      >('SetEndOfFile');
    ...
    test('Can instantiate SetEvent', () {
      final kernel32 = DynamicLibrary.open('kernel32.dll');
      final SetEvent = kernel32.lookupFunction<
        Int32 Function(IntPtr hEvent),
        int Function(int hEvent)
      >('SetEvent');
    ...
    test('Can instantiate SetVolumeLabel', () {
      ...
      final SetVolumeLabel = kernel32.lookupFunction<
        ...
        int Function(Pointer<Utf16> lpRootPathName, Pointer<Utf16> lpVolumeName)
      >('SetVolumeLabelW');
  ...
  group('Test user32 functions', () {
    ...
    test('Can instantiate BlockInput', () {
      final user32 = DynamicLibrary.open('user32.dll');
      final BlockInput = user32.lookupFunction<
    ...
    test('Can instantiate DrawFrameControl', () {
      ...
      final DrawFrameControl = user32.lookupFunction<
        ...
        int Function(int param0, Pointer<RECT> param1, int param2, int param3)
      >('DrawFrameControl');
    ...
    test('Can instantiate GetKeyState', () {
      final user32 = DynamicLibrary.open('user32.dll');
      final GetKeyState = user32.lookupFunction<
    ...
    test('Can instantiate IsGUIThread', () {
      final user32 = DynamicLibrary.open('user32.dll');
      final IsGUIThread = user32.lookupFunction<
    ...
    test('Can instantiate IsMenu', () {
      final user32 = DynamicLibrary.open('user32.dll');
      final IsMenu = user32.lookupFunction<
        Int32 Function(IntPtr hMenu),
        int Function(int hMenu)
      >('IsMenu');
    ...
    test('Can instantiate OemKeyScan', () {
      final user32 = DynamicLibrary.open('user32.dll');
      final OemKeyScan = user32.lookupFunction<
    ...
    test('Can instantiate RegisterDeviceNotification', () {
      ...
      final RegisterDeviceNotification = user32.lookupFunction<
        ...
        Pointer Function(int hRecipient, Pointer NotificationFilter, int Flags)
    ...
    test('Can instantiate SetCursor', () {
      final user32 = DynamicLibrary.open('user32.dll');
      final SetCursor = user32.lookupFunction<
  ...
  group('Test advapi32 functions', () {
    test('Can instantiate ChangeServiceConfig2', () {
      ...
      final ChangeServiceConfig2 = advapi32.lookupFunction<
    ...
    test('Can instantiate CloseServiceHandle', () {
      final advapi32 = DynamicLibrary.open('advapi32.dll');
      final CloseServiceHandle = advapi32.lookupFunction<
    ...
    test('Can instantiate ControlService', () {
      final advapi32 = DynamicLibrary.open('advapi32.dll');
      final ControlService = advapi32.lookupFunction<
        Int32 Function(
          IntPtr hService,
          Uint32 dwControl,
    ...
    test('Can instantiate ControlServiceEx', () {
      final advapi32 = DynamicLibrary.open('advapi32.dll');
      final ControlServiceEx = advapi32.lookupFunction<
        Int32 Function(
          IntPtr hService,
          Uint32 dwControl,
          Uint32 dwInfoLevel,
    ...
    test('Can instantiate DeleteService', () {
      final advapi32 = DynamicLibrary.open('advapi32.dll');
      final DeleteService = advapi32.lookupFunction<
    ...
    test('Can instantiate EnumDependentServices', () {
      final advapi32 = DynamicLibrary.open('advapi32.dll');
      final EnumDependentServices = advapi32.lookupFunction<
        Int32 Function(
          IntPtr hService,
    ...
    test('Can instantiate EnumServicesStatus', () {
      final advapi32 = DynamicLibrary.open('advapi32.dll');
      final EnumServicesStatus = advapi32.lookupFunction<
        Int32 Function(
          IntPtr hSCManager,
    ...
    test('Can instantiate EnumServicesStatusEx', () {
      final advapi32 = DynamicLibrary.open('advapi32.dll');
      final EnumServicesStatusEx = advapi32.lookupFunction<
        Int32 Function(
          IntPtr hSCManager,
          Int32 InfoLevel,
          Uint32 dwServiceType,
    ...
    test('Can instantiate GetServiceDisplayName', () {
      final advapi32 = DynamicLibrary.open('advapi32.dll');
      final GetServiceDisplayName = advapi32.lookupFunction<
        Int32 Function(
          IntPtr hSCManager,
    ...
    test('Can instantiate GetServiceKeyName', () {
      final advapi32 = DynamicLibrary.open('advapi32.dll');
      final GetServiceKeyName = advapi32.lookupFunction<
        Int32 Function(
          IntPtr hSCManager,
          Pointer<Utf16> lpDisplayName,
          Pointer<Utf16> lpServiceName,
    ...
    test('Can instantiate NotifyBootConfigStatus', () {
      final advapi32 = DynamicLibrary.open('advapi32.dll');
      final NotifyBootConfigStatus = advapi32.lookupFunction<
    ...
    test('Can instantiate NotifyServiceStatusChange', () {
      final advapi32 = DynamicLibrary.open('advapi32.dll');
      final NotifyServiceStatusChange = advapi32.lookupFunction<
        Uint32 Function(
          IntPtr hService,
          Uint32 dwNotifyMask,
    ...
    test('Can instantiate OpenSCManager', () {
      final advapi32 = DynamicLibrary.open('advapi32.dll');
      final OpenSCManager = advapi32.lookupFunction<
        IntPtr Function(
          Pointer<Utf16> lpMachineName,
    ...
    test('Can instantiate OpenService', () {
      final advapi32 = DynamicLibrary.open('advapi32.dll');
      final OpenService = advapi32.lookupFunction<
        IntPtr Function(
          IntPtr hSCManager,
          Pointer<Utf16> lpServiceName,
          Uint32 dwDesiredAccess,
    ...
    test('Can instantiate QueryServiceConfig', () {
      final advapi32 = DynamicLibrary.open('advapi32.dll');
      final QueryServiceConfig = advapi32.lookupFunction<
        Int32 Function(
          IntPtr hService,
    ...
    test('Can instantiate QueryServiceConfig2', () {
      final advapi32 = DynamicLibrary.open('advapi32.dll');
      final QueryServiceConfig2 = advapi32.lookupFunction<
        Int32 Function(
          IntPtr hService,
          Uint32 dwInfoLevel,
          Pointer<Uint8> lpBuffer,
    ...
    test('Can instantiate QueryServiceDynamicInformation', () {
      final advapi32 = DynamicLibrary.open('advapi32.dll');
      final QueryServiceDynamicInformation = advapi32.lookupFunction<
        Int32 Function(
    ...
    test('Can instantiate QueryServiceObjectSecurity', () {
      final advapi32 = DynamicLibrary.open('advapi32.dll');
      final QueryServiceObjectSecurity = advapi32.lookupFunction<
        Int32 Function(
          IntPtr hService,
    ...
    test('Can instantiate QueryServiceStatus', () {
      final advapi32 = DynamicLibrary.open('advapi32.dll');
      final QueryServiceStatus = advapi32.lookupFunction<
        Int32 Function(
          IntPtr hService,
          Pointer<SERVICE_STATUS> lpServiceStatus,
        ),
    ...
    test('Can instantiate QueryServiceStatusEx', () {
      final advapi32 = DynamicLibrary.open('advapi32.dll');
      final QueryServiceStatusEx = advapi32.lookupFunction<
        Int32 Function(
          IntPtr hService,
          Int32 InfoLevel,
          Pointer<Uint8> lpBuffer,
    ...
    test('Can instantiate SetServiceObjectSecurity', () {
      final advapi32 = DynamicLibrary.open('advapi32.dll');
      final SetServiceObjectSecurity = advapi32.lookupFunction<
        Int32 Function(
          IntPtr hService,
          Uint32 dwSecurityInformation,
          Pointer lpSecurityDescriptor,
    ...
    test('Can instantiate SetServiceStatus', () {
      final advapi32 = DynamicLibrary.open('advapi32.dll');
      final SetServiceStatus = advapi32.lookupFunction<
        Int32 Function(
          IntPtr hServiceStatus,
          Pointer<SERVICE_STATUS> lpServiceStatus,
        ),
    ...
    test('Can instantiate StartService', () {
      final advapi32 = DynamicLibrary.open('advapi32.dll');
      final StartService = advapi32.lookupFunction<
        Int32 Function(
          IntPtr hService,
    ...
    test('Can instantiate StartServiceCtrlDispatcher', () {
      final advapi32 = DynamicLibrary.open('advapi32.dll');
      final StartServiceCtrlDispatcher = advapi32.lookupFunction<
  ...
  group('Test ole32 functions', () {
    ...
    test('Can instantiate CoTaskMemAlloc', () {
      final ole32 = DynamicLibrary.open('ole32.dll');
      final CoTaskMemAlloc = ole32.lookupFunction<
  ...
  group('Test oleaut32 functions', () {
    ...
    test('Can instantiate SafeArrayAddRef', () {
      final oleaut32 = DynamicLibrary.open('oleaut32.dll');
      final SafeArrayAddRef = oleaut32.lookupFunction<
        Int32 Function(
    ...
    test('Can instantiate SafeArrayAllocData', () {
      final oleaut32 = DynamicLibrary.open('oleaut32.dll');
      final SafeArrayAllocData = oleaut32.lookupFunction<
    ...
    test('Can instantiate SafeArrayAllocDescriptor', () {
      final oleaut32 = DynamicLibrary.open('oleaut32.dll');
      final SafeArrayAllocDescriptor = oleaut32.lookupFunction<
    ...
    test('Can instantiate SafeArrayAllocDescriptorEx', () {
      final oleaut32 = DynamicLibrary.open('oleaut32.dll');
      final SafeArrayAllocDescriptorEx = oleaut32.lookupFunction<
        Int32 Function(
          Uint16 vt,
          Uint32 cDims,
    ...
    test('Can instantiate SafeArrayCopy', () {
      final oleaut32 = DynamicLibrary.open('oleaut32.dll');
      final SafeArrayCopy = oleaut32.lookupFunction<
        Int32 Function(
          Pointer<SAFEARRAY> psa,
          Pointer<Pointer<SAFEARRAY>> ppsaOut,
        ),
    ...
    test('Can instantiate SafeArrayCopyData', () {
      final oleaut32 = DynamicLibrary.open('oleaut32.dll');
      final SafeArrayCopyData = oleaut32.lookupFunction<
        Int32 Function(
    ...
    test('Can instantiate SafeArrayCreate', () {
      final oleaut32 = DynamicLibrary.open('oleaut32.dll');
      final SafeArrayCreate = oleaut32.lookupFunction<
    ...
    test('Can instantiate SafeArrayCreateEx', () {
      final oleaut32 = DynamicLibrary.open('oleaut32.dll');
      final SafeArrayCreateEx = oleaut32.lookupFunction<
        Pointer<SAFEARRAY> Function(
          Uint16 vt,
          Uint32 cDims,
          Pointer<SAFEARRAYBOUND> rgsabound,
    ...
    test('Can instantiate SafeArrayCreateVectorEx', () {
      final oleaut32 = DynamicLibrary.open('oleaut32.dll');
      final SafeArrayCreateVectorEx = oleaut32.lookupFunction<
        Pointer<SAFEARRAY> Function(
          Uint16 vt,
          Int32 lLbound,
          Uint32 cElements,
    ...
    test('Can instantiate SafeArrayDestroyData', () {
      final oleaut32 = DynamicLibrary.open('oleaut32.dll');
      final SafeArrayDestroyData = oleaut32.lookupFunction<
        Int32 Function(Pointer<SAFEARRAY> psa),
        int Function(Pointer<SAFEARRAY> psa)
    ...
    test('Can instantiate SafeArrayDestroyDescriptor', () {
      final oleaut32 = DynamicLibrary.open('oleaut32.dll');
      final SafeArrayDestroyDescriptor = oleaut32.lookupFunction<
        Int32 Function(Pointer<SAFEARRAY> psa),
        int Function(Pointer<SAFEARRAY> psa)
    ...
    test('Can instantiate SafeArrayGetDim', () {
      final oleaut32 = DynamicLibrary.open('oleaut32.dll');
      final SafeArrayGetDim = oleaut32.lookupFunction<
    ...
    test('Can instantiate SafeArrayGetElement', () {
      final oleaut32 = DynamicLibrary.open('oleaut32.dll');
      final SafeArrayGetElement = oleaut32.lookupFunction<
        Int32 Function(
          Pointer<SAFEARRAY> psa,
    ...
    test('Can instantiate SafeArrayGetElemsize', () {
      final oleaut32 = DynamicLibrary.open('oleaut32.dll');
      final SafeArrayGetElemsize = oleaut32.lookupFunction<
        Uint32 Function(Pointer<SAFEARRAY> psa),
        int Function(Pointer<SAFEARRAY> psa)
    ...
    test('Can instantiate SafeArrayGetIID', () {
      final oleaut32 = DynamicLibrary.open('oleaut32.dll');
      final SafeArrayGetIID = oleaut32.lookupFunction<
    ...
    test('Can instantiate SafeArrayGetLBound', () {
      final oleaut32 = DynamicLibrary.open('oleaut32.dll');
      final SafeArrayGetLBound = oleaut32.lookupFunction<
        Int32 Function(
          Pointer<SAFEARRAY> psa,
          Uint32 nDim,
    ...
    test('Can instantiate SafeArrayGetRecordInfo', () {
      final oleaut32 = DynamicLibrary.open('oleaut32.dll');
      final SafeArrayGetRecordInfo = oleaut32.lookupFunction<
        Int32 Function(
          Pointer<SAFEARRAY> psa,
    ...
    test('Can instantiate SafeArrayGetUBound', () {
      final oleaut32 = DynamicLibrary.open('oleaut32.dll');
      final SafeArrayGetUBound = oleaut32.lookupFunction<
        Int32 Function(
          Pointer<SAFEARRAY> psa,
          Uint32 nDim,
    ...
    test('Can instantiate SafeArrayGetVartype', () {
      final oleaut32 = DynamicLibrary.open('oleaut32.dll');
      final SafeArrayGetVartype = oleaut32.lookupFunction<
    ...
    test('Can instantiate SafeArrayLock', () {
      final oleaut32 = DynamicLibrary.open('oleaut32.dll');
      final SafeArrayLock = oleaut32.lookupFunction<
        Int32 Function(Pointer<SAFEARRAY> psa),
        int Function(Pointer<SAFEARRAY> psa)
      >('SafeArrayLock');
    ...
    test('Can instantiate SafeArrayPtrOfIndex', () {
      final oleaut32 = DynamicLibrary.open('oleaut32.dll');
      final SafeArrayPtrOfIndex = oleaut32.lookupFunction<
        Int32 Function(
          Pointer<SAFEARRAY> psa,
          Pointer<Int32> rgIndices,
    ...
    test('Can instantiate SafeArrayPutElement', () {
      final oleaut32 = DynamicLibrary.open('oleaut32.dll');
      final SafeArrayPutElement = oleaut32.lookupFunction<
        Int32 Function(
          Pointer<SAFEARRAY> psa,
          Pointer<Int32> rgIndices,
          Pointer pv,
    ...
    test('Can instantiate SafeArrayRedim', () {
      final oleaut32 = DynamicLibrary.open('oleaut32.dll');
      final SafeArrayRedim = oleaut32.lookupFunction<
        Int32 Function(
          Pointer<SAFEARRAY> psa,
    ...
    test('Can instantiate SafeArrayReleaseData', () {
      final oleaut32 = DynamicLibrary.open('oleaut32.dll');
      final SafeArrayReleaseData = oleaut32.lookupFunction<
    ...
    test('Can instantiate SafeArrayReleaseDescriptor', () {
      final oleaut32 = DynamicLibrary.open('oleaut32.dll');
      final SafeArrayReleaseDescriptor = oleaut32.lookupFunction<
    ...
    test('Can instantiate SafeArraySetIID', () {
      final oleaut32 = DynamicLibrary.open('oleaut32.dll');
      final SafeArraySetIID = oleaut32.lookupFunction<
    ...
    test('Can instantiate SafeArraySetRecordInfo', () {
      final oleaut32 = DynamicLibrary.open('oleaut32.dll');
      final SafeArraySetRecordInfo = oleaut32.lookupFunction<
    ...
    test('Can instantiate SafeArrayUnlock', () {
      final oleaut32 = DynamicLibrary.open('oleaut32.dll');
      final SafeArrayUnlock = oleaut32.lookupFunction<
        Int32 Function(Pointer<SAFEARRAY> psa),
        int Function(Pointer<SAFEARRAY> psa)
      >('SafeArrayUnlock');
  ...
  group('Test winmm functions', () {
    ...
    test('Can instantiate midiOutCacheDrumPatches', () {
      ...
      final midiOutCacheDrumPatches = winmm.lookupFunction<
        ...
        int Function(int hmo, int uPatch, Pointer<Uint16> pwkya, int fuCache)
  ...
  group('Test dbghelp functions', () {
    test('Can instantiate SymCleanup', () {
      ...
      final SymCleanup = dbghelp.lookupFunction<
        Int32 Function(IntPtr hProcess),
        int Function(int hProcess)
      >('SymCleanup');
