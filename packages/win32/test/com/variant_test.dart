  ...
  group('Variant', () {
    ...
    test('converts DOS date/time to Variant time and back', () {
      using((arena) {
        ...
        final dosDate = arena<USHORT>();
        final dosTime = arena<USHORT>();
        check(
    ...
    test('creates an IDispatch VARIANT', () {
      ...
      final variant = Variant.dispatch(dispatch..addRef());
    ...
    test('creates an IUnknown VARIANT', () {
      ...
      final variant = Variant.unknown(unknown..addRef());
    ...
    test('throws ArgumentError for unsupported type', () {
      ...
      check(() => variant.value = DateTime.now())
          ...
          .equals('Unsupported VARIANT value type.');
      variant.free();
    });
  });
}
