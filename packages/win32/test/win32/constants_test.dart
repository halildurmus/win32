  ...
  group('Win32 constants tests', () {
    ...
    group('HKEY', () {
      test('HKEY_CURRENT_USER', () {
        check(HKEY_CURRENT_USER.address).equals(-2147483647);
      });

      test('HKEY_LOCAL_MACHINE', () {
        check(HKEY_LOCAL_MACHINE.address).equals(-2147483646);
      });
    });
    ...
    group('HWND', () {
      test('HWND_BROADCAST', () {
        check(HWND_BROADCAST.address).equals(65535);
      });

      test('HWND_MESSAGE', () {
        check(HWND_MESSAGE.address).equals(-3);
      });
    });
