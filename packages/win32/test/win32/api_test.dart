  ...
  group('Win32 API tests', () {
    ...
    group('CLSIDFromString', () {
      test('converts a string to a CLSID', () {
        final guid = CLSIDFromString(
          w('{42a8b9b0-6b6b-4e3a-8e4a-5b6d9d7b9fe3}').ptr,
        );
        check(
          guid.ref.toString(),
    ...
    group('GetLastError', () {
      test('returns ERROR_SUCCESS when no error', () {
        check(GetLastError()).equals(ERROR_SUCCESS);
      });

      test('returns ERROR_ACCESS_DENIED after setting error', () {
        SetLastError(ERROR_ACCESS_DENIED);
        check(GetLastError()).equals(ERROR_ACCESS_DENIED);
      });
    });
    ...
    group('IIDFromString', () {
      test('converts a string to an IID', () {
        final guid = IIDFromString(
          w('{317e71c4-e85b-4ecd-a5c8-12e0c7d92d0d}').ptr,
        );
        check(
          guid.ref.toString(),
