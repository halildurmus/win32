...
Clone your fork of **win32_runner** to your local machine:

```cmd
git clone https://github.com/<your-username>/win32_runner.git
```
...
- `feat: add support for system theme changes`
...
[create a pull request]: https://github.com/halildurmus/win32_runner/compare
[Dart style guide]: https://dart.dev/effective-dart/style
[fork the repository]: https://github.com/halildurmus/win32_runner/fork
[GitHub]: https://github.com/halildurmus/win32_runner
[GitHub Discussions]: https://github.com/halildurmus/win32_runner/discussions
[GitHub Issues]: https://github.com/halildurmus/win32_runner/issues
