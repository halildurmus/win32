...
- **📢 Share `win32_registry`**: Spread the word about this project to reach
  more users.
...
- `feat: add RegistryKey.getBinary() method`
- `fix: resolve an issue with the RegistryKey.setValue() method`
...
Thank you for contributing to `package:win32_registry`! 🎉
