...
class WSManCallbackFlags {
  ...
  static const WSMAN_FLAG_CALLBACK_RECONNECTED_AFTER_NETWORK_FAILURE =
      0x00000400;
  static const WSMAN_FLAG_CALLBACK_SHELL_AUTODISCONNECTING = 0x00000800;
  static const WSMAN_FLAG_CALLBACK_RETRY_ABORTED_DUE_TO_INTERNAL_ERROR =
      0x00001000;
  static const WSMAN_FLAG_CALLBACK_RECEIVE_DELAY_STREAM_REQUEST_PROCESSED =
      0x00002000;
}
