...
class FLOWSPEC extends Struct {
  @Uint32() external int TokenRate;
  @Uint32() external int TokenBucketSize;
  @Uint32() external int PeakBandwidth;
  @Uint32() external int Latency;
  @Uint32() external int DelayVariation;
  @Uint32() external int ServiceType;
  @Uint32() external int MaxSduSize;
  @Uint32() external int MinimumPolicedSize;
}

class QOS_OBJECT_HDR extends Struct {
  @Uint32() external int ObjectType;
  @Uint32() external int ObjectLength;
}

class QOS_SD_MODE extends Struct {
  external QOS_OBJECT_HDR ObjectHdr;
  @Uint32() external int ShapeDiscardMode;
}

class QOS_SHAPING_RATE extends Struct {
  external QOS_OBJECT_HDR ObjectHdr;
  @Uint32() external int ShapingRate;
}

class RsvpObjHdr extends Struct {
  @Uint16() external int obj_length;
  @Uint8() external int obj_class;
  @Uint8() external int obj_ctype;
}
...
class RESV_STYLE extends Struct {
  ...
  @Uint32() external int style_word;
}
...
class POLICY_DATA extends Struct {
  ...
  @Uint16() external int usPeOffset;
...
class IntServMainHdr extends Struct {
  @Uint8() external int ismh_version;
  @Uint8() external int ismh_unused;
  @Uint16() external int ismh_len32b;
}

class IntServServiceHdr extends Struct {
  @Uint8() external int issh_service;
  @Uint8() external int issh_flags;
  @Uint16() external int issh_len32b;
}

class IntServParmHdr extends Struct {
  @Uint8() external int isph_parm_num;
  @Uint8() external int isph_flags;
  @Uint16() external int isph_len32b;
}

class GenTspecParms extends Struct {
  @Float() external double TB_Tspec_r;
  @Float() external double TB_Tspec_b;
  @Float() external double TB_Tspec_p;
  @Uint32() external int TB_Tspec_m;
  @Uint32() external int TB_Tspec_M;
}
...
class GuarRspec extends Struct {
  @Float() external double Guar_R;
  @Uint32() external int Guar_S;
}
...
class ID_ERROR_OBJECT extends Struct {
  @Uint16() external int usIdErrLength;
  @Uint8() external int ucAType;
...
class RSVP_MSG_OBJS extends Struct {
  @Int32() external int RsvpMsgType;
  ...
  @Int32() external int FlowDescCount;
  external Pointer<flow_desc> pFlowDescs;
  @Int32() external int PdObjectCount;
...
class policy_decision extends Struct {
  @Uint32() external int lpvResult;
  @Uint16() external int wPolicyErrCode;
  @Uint16() external int wPolicyErrValue;
}

class LPM_INIT_INFO extends Struct {
  @Uint32() external int PcmVersionNumber;
  @Uint32() external int ResultTimeLimit;
  @Int32() external int ConfiguredLpmCount;
...
class QOS_PACKET_PRIORITY extends Struct {
  @Uint32() external int ConformantDSCPValue;
  @Uint32() external int NonConformantDSCPValue;
  @Uint32() external int ConformantL2Value;
  @Uint32() external int NonConformantL2Value;
}

class QOS_FLOW_FUNDAMENTALS extends Struct {
  @Int32() external int BottleneckBandwidthSet;
  @Uint64() external int BottleneckBandwidth;
  @Int32() external int AvailableBandwidthSet;
  @Uint64() external int AvailableBandwidth;
  @Int32() external int RTTSet;
  @Uint32() external int RTT;
}

class QOS_FLOWRATE_OUTGOING extends Struct {
  @Uint64() external int Bandwidth;
  @Uint32() external int ShapingBehavior;
...
class QOS_TRAFFIC_CLASS extends Struct {
  external QOS_OBJECT_HDR ObjectHdr;
  @Uint32() external int TrafficClass;
}

class QOS_DS_CLASS extends Struct {
  external QOS_OBJECT_HDR ObjectHdr;
  @Uint32() external int DSField;
}
...
class QOS_DIFFSERV_RULE extends Struct {
  @Uint8() external int InboundDSField;
  @Uint8() external int ConformingOutboundDSField;
  @Uint8() external int NonConformingOutboundDSField;
  @Uint8() external int ConformingUserPriority;
  @Uint8() external int NonConformingUserPriority;
}
