// IX509ExtensionSmimeCapabilities.dart
...
import '../../../security/cryptography/certificates/ISmimeCapabilities.dart';
import '../../../foundation/structs.g.dart';
import '../../../security/cryptography/certificates/structs.g.dart';

/// @nodoc
const IID_IX509ExtensionSmimeCapabilities =
    '{728AB31B-217D-11DA-B2A4-000E7BBB2B09}';

/// {@category Interface}
/// {@category com}
class IX509ExtensionSmimeCapabilities extends IX509Extension {
  // vtable begins at 12, is 3 entries long.
  IX509ExtensionSmimeCapabilities(Pointer<COMObject> ptr) : super(ptr);
  ...
  Pointer<COMObject> get SmimeCapabilities {
