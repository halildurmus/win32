...
import '../../../security/cryptography/certificates/ICryptAttribute.dart';
...
/// @nodoc
const IID_ICryptAttributes = '{728AB32D-217D-11DA-B2A4-000E7BBB2B09}';

/// {@category Interface}
/// {@category com}
class ICryptAttributes extends IDispatch {
  // vtable begins at 7, is 8 entries long.
  ICryptAttributes(Pointer<COMObject> ptr) : super(ptr);
