...
import '../../../security/cryptography/certificates/ISmimeCapability.dart';
import '../../../foundation/structs.g.dart';
import '../../../specialTypes.dart';
import '../../../security/cryptography/certificates/ICspInformation.dart';

/// @nodoc
const IID_ISmimeCapabilities = '{728AB31A-217D-11DA-B2A4-000E7BBB2B09}';

/// {@category Interface}
/// {@category com}
class ISmimeCapabilities extends IDispatch {
  // vtable begins at 7, is 8 entries long.
  ISmimeCapabilities(Pointer<COMObject> ptr) : super(ptr);
  ...
  int AddAvailableSmimeCapabilities(
    int MachineContext,
  ) =>
      ptr.ref.lpVtbl.value
          .elementAt(14)
