// IX509ExtensionMSApplicationPolicies.dart
...
import '../../../security/cryptography/certificates/ICertificatePolicies.dart';
import '../../../foundation/structs.g.dart';
import '../../../security/cryptography/certificates/structs.g.dart';

/// @nodoc
const IID_IX509ExtensionMSApplicationPolicies =
    '{728AB321-217D-11DA-B2A4-000E7BBB2B09}';

/// {@category Interface}
/// {@category com}
class IX509ExtensionMSApplicationPolicies extends IX509Extension {
  // vtable begins at 12, is 3 entries long.
  IX509ExtensionMSApplicationPolicies(Pointer<COMObject> ptr) : super(ptr);
  ...
  Pointer<COMObject> get Policies {
