...
/// @nodoc
const IID_ICspInformation = '{728AB307-217D-11DA-B2A4-000E7BBB2B09}';

/// {@category Interface}
/// {@category com}
class ICspInformation extends IDispatch {
  // vtable begins at 7, is 17 entries long.
  ICspInformation(Pointer<COMObject> ptr) : super(ptr);
  ...
  Pointer<COMObject> get CspAlgorithms {
  ...
  int get HasHardwareRandomNumberGenerator {
  ...
  int get MaxKeyContainerNameLength {
  ...
  int GetDefaultSecurityDescriptor(
    int MachineContext,
    Pointer<Pointer<Utf16>> pValue,
  ) =>
      ptr.ref.lpVtbl.value
  ...
  int GetCspStatusFromOperations(
    Pointer<COMObject> pAlgorithm,
    int Operations,
    Pointer<Pointer<COMObject>> ppValue,
  ) =>
