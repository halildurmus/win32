...
/// @nodoc
const IID_ICertPropertyEnrollment = '{728AB339-217D-11DA-B2A4-000E7BBB2B09}';

/// {@category Interface}
/// {@category com}
class ICertPropertyEnrollment extends ICertProperty {
  // vtable begins at 14, is 5 entries long.
  ICertPropertyEnrollment(Pointer<COMObject> ptr) : super(ptr);

  int Initialize(
    int RequestId,
    Pointer<Utf16> strCADnsName,
