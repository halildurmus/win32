...
/// @nodoc
const IID_ICspStatus = '{728AB309-217D-11DA-B2A4-000E7BBB2B09}';

/// {@category Interface}
/// {@category com}
class ICspStatus extends IDispatch {
  // vtable begins at 7, is 7 entries long.
  ICspStatus(Pointer<COMObject> ptr) : super(ptr);

  int Initialize(
    Pointer<COMObject> pCsp,
  ...
  Pointer<COMObject> get CspAlgorithm {
  ...
  Pointer<COMObject> get CspInformation {
    final retValuePtr = calloc<Pointer<COMObject>>();
  ...
  Pointer<COMObject> get EnrollmentStatus {
    final retValuePtr = calloc<Pointer<COMObject>>();
