// IX509ExtensionAuthorityKeyIdentifier.dart
...
/// @nodoc
const IID_IX509ExtensionAuthorityKeyIdentifier =
    '{728AB318-217D-11DA-B2A4-000E7BBB2B09}';

/// {@category Interface}
/// {@category com}
class IX509ExtensionAuthorityKeyIdentifier extends IX509Extension {
  // vtable begins at 12, is 3 entries long.
  IX509ExtensionAuthorityKeyIdentifier(Pointer<COMObject> ptr) : super(ptr);
  ...
  int get_AuthorityKeyIdentifier(
    int Encoding,
