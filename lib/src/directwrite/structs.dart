...
class DWRITE_FONT_METRICS extends Struct {
  ...
  @Uint16() external int descent;
  @Int16() external int lineGap;
  @Uint16() external int capHeight;
  @Uint16() external int xHeight;
  @Int16() external int underlinePosition;
  @Uint16() external int underlineThickness;
  @Int16() external int strikethroughPosition;
  @Uint16() external int strikethroughThickness;
}

class DWRITE_GLYPH_METRICS extends Struct {
  @Int32() external int leftSideBearing;
  @Uint32() external int advanceWidth;
  @Int32() external int rightSideBearing;
  @Int32() external int topSideBearing;
  @Uint32() external int advanceHeight;
  @Int32() external int bottomSideBearing;
  @Int32() external int verticalOriginY;
}

class DWRITE_GLYPH_OFFSET extends Struct {
  @Float() external double advanceOffset;
  @Float() external double ascenderOffset;
}
...
class DWRITE_GLYPH_RUN extends Struct {
  ...
  @Float() external double fontEmSize;
  @Uint32() external int glyphCount;
  ...
  @Int32() external int isSideways;
  @Uint32() external int bidiLevel;
}

class DWRITE_GLYPH_RUN_DESCRIPTION extends Struct {
  external Pointer<Utf16> localeName;
  external Pointer<Utf16> string;
  @Uint32() external int stringLength;
  external Pointer<Uint16> clusterMap;
  @Uint32() external int textPosition;
}

class DWRITE_UNDERLINE extends Struct {
  @Float() external double width;
  @Float() external double thickness;
  @Float() external double offset;
  @Float() external double runHeight;
  @Uint32() external int readingDirection;
  @Uint32() external int flowDirection;
  external Pointer<Utf16> localeName;
  @Uint32() external int measuringMode;
}
...
class DWRITE_LINE_METRICS extends Struct {
  @Uint32() external int length;
  @Uint32() external int trailingWhitespaceLength;
  @Uint32() external int newlineLength;
  @Float() external double height;
  @Float() external double baseline;
  @Int32() external int isTrimmed;
}
...
class DWRITE_TEXT_METRICS extends Struct {
  ...
  @Float() external double width;
  @Float() external double widthIncludingTrailingWhitespace;
  @Float() external double height;
  @Float() external double layoutWidth;
  @Float() external double layoutHeight;
  @Uint32() external int maxBidiReorderingDepth;
  @Uint32() external int lineCount;
}
...
class DWRITE_INLINE_OBJECT_METRICS extends Struct {
  ...
  @Float() external double height;
  @Float() external double baseline;
  @Int32() external int supportsSideways;
}
...
class DWRITE_HIT_TEST_METRICS extends Struct {
  ...
  @Float() external double height;
  @Uint32() external int bidiLevel;
  @Int32() external int isText;
  @Int32() external int isTrimmed;
}

class DWRITE_FONT_METRICS1 extends Struct {
  external DWRITE_FONT_METRICS __AnonymousBase_DWrite_1_L627_C38;
  @Int16() external int glyphBoxLeft;
  @Int16() external int glyphBoxTop;
  @Int16() external int glyphBoxRight;
  @Int16() external int glyphBoxBottom;
  @Int16() external int subscriptPositionX;
  @Int16() external int subscriptPositionY;
  @Int16() external int subscriptSizeX;
  @Int16() external int subscriptSizeY;
  @Int16() external int superscriptPositionX;
  @Int16() external int superscriptPositionY;
  @Int16() external int superscriptSizeX;
  @Int16() external int superscriptSizeY;
  @Int32() external int hasTypographicMetrics;
}

class DWRITE_CARET_METRICS extends Struct {
  @Int16() external int slopeRise;
  @Int16() external int slopeRun;
...
class DWRITE_SCRIPT_PROPERTIES extends Struct {
  @Uint32() external int isoScriptCode;
  @Uint32() external int isoScriptNumber;
  @Uint32() external int clusterLookahead;
  @Uint32() external int justificationCharacter;
  @Uint32() external int _bitfield;
}

class DWRITE_JUSTIFICATION_OPPORTUNITY extends Struct {
  @Float() external double expansionMinimum;
  @Float() external double expansionMaximum;
  @Float() external double compressionMaximum;
  @Uint32() external int _bitfield;
}

class DWRITE_TEXT_METRICS1 extends Struct {
  external DWRITE_TEXT_METRICS Base;
  @Float() external double heightIncludingTrailingWhitespace;
}
...
class DWRITE_LINE_METRICS1 extends Struct {
  ...
  @Float() external double leadingBefore;
  @Float() external double leadingAfter;
}
...
class DWRITE_LINE_SPACING extends Struct {
  ...
  @Float() external double baseline;
  @Float() external double leadingBefore;
  @Uint32() external int fontLineGapUsage;
}

class DWRITE_COLOR_GLYPH_RUN1 extends Struct {
  external DWRITE_COLOR_GLYPH_RUN Base;
  @Uint32() external int glyphImageFormat;
  @Uint32() external int measuringMode;
}

class DWRITE_GLYPH_IMAGE_DATA extends Struct {
  external Pointer imageData;
  @Uint32() external int imageDataSize;
  @Uint32() external int uniqueDataId;
  @Uint32() external int pixelsPerEm;
...
class DWRITE_FILE_FRAGMENT extends Struct {
  ...
  @Uint64() external int fragmentSize;
}

class DWRITE_FONT_AXIS_VALUE extends Struct {
  @Uint32() external int axisTag;
