...
class SWbemQueryQualifiedName extends Struct {
  @Uint32() external int m_uVersion;
  @Uint32() external int m_uTokenType;
  @Uint32() external int m_uNameListSize;
  external Pointer<Pointer<Utf16>> m_ppszNameList;
  @Int32() external int m_bArraysUsed;
...
class SWbemRpnConst extends Struct {
  ...
  @Int32() external int m_bBoolVal;
  @Int32() external int m_lLongVal;
  @Uint32() external int m_uLongVal;
  @Double() external double m_dblVal;
  @Int64() external int m_lVal64;
  @Int64() external int m_uVal64;
}

class SWbemRpnQueryToken extends Struct {
  @Uint32() external int m_uVersion;
  @Uint32() external int m_uTokenType;
  @Uint32() external int m_uSubexpressionShape;
  @Uint32() external int m_uOperator;
  external Pointer<SWbemQueryQualifiedName> m_pRightIdent;
  external Pointer<SWbemQueryQualifiedName> m_pLeftIdent;
  @Uint32() external int m_uConstApparentType;
  external SWbemRpnConst m_Const;
  @Uint32() external int m_uConst2ApparentType;
...
class SWbemRpnTokenList extends Struct {
  @Uint32() external int m_uVersion;
  @Uint32() external int m_uTokenType;
  @Uint32() external int m_uNumTokens;
}

class SWbemRpnEncodedQuery extends Struct {
  @Uint32() external int m_uVersion;
  @Uint32() external int m_uTokenType;
  @Uint64() external int m_uParsedFeatureMask;
  @Uint32() external int m_uDetectedArraySize;
  external Pointer<Uint32> m_puDetectedFeatures;
  @Uint32() external int m_uSelectListSize;
  external Pointer<Pointer<SWbemQueryQualifiedName>> m_ppSelectList;
  @Uint32() external int m_uFromTargetType;
  external Pointer<Utf16> m_pszOptionalFromPath;
  @Uint32() external int m_uFromListSize;
  external Pointer<Pointer<Utf16>> m_ppszFromList;
  @Uint32() external int m_uWhereClauseSize;
  external Pointer<Pointer<SWbemRpnQueryToken>> m_ppRpnWhereClause;
  @Double() external double m_dblWithinPolling;
  @Double() external double m_dblWithinWindow;
  @Uint32() external int m_uOrderByListSize;
...
class SWbemAnalysisMatrix extends Struct {
  @Uint32() external int m_uVersion;
  @Uint32() external int m_uMatrixType;
  external Pointer<Utf16> m_pszProperty;
  @Uint32() external int m_uPropertyType;
  @Uint32() external int m_uEntries;
...
class SWbemAnalysisMatrixList extends Struct {
  @Uint32() external int m_uVersion;
  @Uint32() external int m_uMatrixType;
  @Uint32() external int m_uNumMatrices;
  external Pointer<SWbemAnalysisMatrix> m_pMatrices;
}

class SWbemAssocQueryInf extends Struct {
  @Uint32() external int m_uVersion;
  @Uint32() external int m_uAnalysisType;
  @Uint32() external int m_uFeatureMask;
...
class WBEM_COMPILE_STATUS_INFO extends Struct {
  @Int32() external int lPhaseError;
  @Int32() external int hRes;
  @Int32() external int ObjectNum;
  @Int32() external int FirstLine;
  @Int32() external int LastLine;
