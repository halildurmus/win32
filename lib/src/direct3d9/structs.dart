...
class D3DCLIPSTATUS9 extends Struct {
  @Uint32() external int ClipUnion;
  @Uint32() external int ClipIntersection;
}
...
class D3DLIGHT9 extends Struct {
  ...
  @Float() external double Falloff;
  @Float() external double Attenuation0;
  @Float() external double Attenuation1;
  @Float() external double Attenuation2;
  @Float() external double Theta;
  @Float() external double Phi;
}

class D3DVERTEXELEMENT9 extends Struct {
  @Uint16() external int Stream;
  @Uint16() external int Offset;
  @Uint8() external int Type;
  @Uint8() external int Method;
  @Uint8() external int Usage;
  @Uint8() external int UsageIndex;
}

class D3DDISPLAYMODE extends Struct {
  @Uint32() external int Width;
  @Uint32() external int Height;
  @Uint32() external int RefreshRate;
  @Uint32() external int Format;
}

class D3DDEVICE_CREATION_PARAMETERS extends Struct {
  @Uint32() external int AdapterOrdinal;
  @Uint32() external int DeviceType;
  @IntPtr() external int hFocusWindow;
  @Uint32() external int BehaviorFlags;
}

class D3DPRESENT_PARAMETERS extends Struct {
  @Uint32() external int BackBufferWidth;
  @Uint32() external int BackBufferHeight;
  @Uint32() external int BackBufferFormat;
  @Uint32() external int BackBufferCount;
  @Uint32() external int MultiSampleType;
  @Uint32() external int MultiSampleQuality;
  @Uint32() external int SwapEffect;
  @IntPtr() external int hDeviceWindow;
  @Int32() external int Windowed;
  @Int32() external int EnableAutoDepthStencil;
  @Uint32() external int AutoDepthStencilFormat;
  @Uint32() external int Flags;
  @Uint32() external int FullScreen_RefreshRateInHz;
  @Uint32() external int PresentationInterval;
}
...
class D3DLOCKED_BOX extends Struct {
  @Int32() external int RowPitch;
  @Int32() external int SlicePitch;
  external Pointer pBits;
}
...
class D3DRECTPATCH_INFO extends Struct {
  @Uint32() external int StartVertexOffsetWidth;
  @Uint32() external int StartVertexOffsetHeight;
  @Uint32() external int Width;
  @Uint32() external int Height;
  @Uint32() external int Stride;
  @Uint32() external int Basis;
  @Uint32() external int Degree;
}

class D3DTRIPATCH_INFO extends Struct {
  @Uint32() external int StartVertexOffset;
  @Uint32() external int NumVertices;
  @Uint32() external int Basis;
  @Uint32() external int Degree;
}
...
class D3DADAPTER_IDENTIFIER9 extends Struct {
  ...
  @Uint32() external int WHQLLevel;
}

class D3DRASTER_STATUS extends Struct {
  @Int32() external int InVBlank;
  @Uint32() external int ScanLine;
}

class D3DRESOURCESTATS extends Struct {
  @Int32() external int bThrashing;
  @Uint32() external int ApproxBytesDownloaded;
  @Uint32() external int NumEvicts;
  @Uint32() external int NumVidCreates;
  @Uint32() external int LastPri;
  @Uint32() external int NumUsed;
  @Uint32() external int NumUsedInVidMem;
  @Uint32() external int WorkingSet;
  @Uint32() external int WorkingSetBytes;
  @Uint32() external int TotalManaged;
  @Uint32() external int TotalBytes;
}
...
class D3DDEVINFO_D3DVERTEXSTATS extends Struct {
  @Uint32() external int NumRenderedTriangles;
  @Uint32() external int NumExtraClippingTriangles;
}

class D3DDEVINFO_VCACHE extends Struct {
  @Uint32() external int Pattern;
  @Uint32() external int OptMethod;
  @Uint32() external int CacheSize;
  @Uint32() external int MagicNumber;
}

class D3DDEVINFO_D3D9PIPELINETIMINGS extends Struct {
  @Float() external double VertexProcessingTimePercent;
  @Float() external double PixelProcessingTimePercent;
  @Float() external double OtherGPUProcessingTimePercent;
  @Float() external double GPUIdleTimePercent;
}

class D3DDEVINFO_D3D9INTERFACETIMINGS extends Struct {
  @Float() external double WaitingForGPUToUseApplicationResourceTimePercent;
  @Float() external double WaitingForGPUToAcceptMoreCommandsTimePercent;
  @Float() external double WaitingForGPUToStayWithinLatencyTimePercent;
  @Float() external double WaitingForGPUExclusiveResourceTimePercent;
  @Float() external double WaitingForGPUOtherTimePercent;
}

class D3DDEVINFO_D3D9STAGETIMINGS extends Struct {
  @Float() external double MemoryProcessingPercent;
  @Float() external double ComputationProcessingPercent;
}

class D3DDEVINFO_D3D9BANDWIDTHTIMINGS extends Struct {
  @Float() external double MaxBandwidthUtilized;
  @Float() external double FrontEndUploadMemoryUtilizedPercent;
  @Float() external double VertexRateUtilizedPercent;
  @Float() external double TriangleSetupRateUtilizedPercent;
  @Float() external double FillRateUtilizedPercent;
}

class D3DDEVINFO_D3D9CACHEUTILIZATION extends Struct {
  @Float() external double TextureCacheHitRate;
  @Float() external double PostTransformVertexCacheHitRate;
}

class D3DMEMORYPRESSURE extends Struct {
  @Uint64() external int BytesEvictedFromProcess;
  @Uint64() external int SizeOfInefficientAllocation;
  @Uint32() external int LevelOfEfficiency;
}
...
class D3DCOMPOSERECTDESTINATION extends Struct {
  @Uint16() external int SrcRectIndex;
...
class D3DAUTHENTICATEDCHANNEL_QUERYCRYPTOSESSION_INPUT extends Struct {
  ...
  @IntPtr() external int DXVA2DecodeHandle;
}
...
class D3DAUTHENTICATEDCHANNEL_QUERYRESTRICTEDSHAREDRESOURCEPROCESSCOUNT_OUTPUT extends Struct {
  external D3DAUTHENTICATEDCHANNEL_QUERY_OUTPUT Output;
  @Uint32() external int NumRestrictedSharedResourceProcesses;
}

class D3DAUTHENTICATEDCHANNEL_QUERYRESTRICTEDSHAREDRESOURCEPROCESS_INPUT extends Struct {
  external D3DAUTHENTICATEDCHANNEL_QUERY_INPUT Input;
  @Uint32() external int ProcessIndex;
}

class D3DAUTHENTICATEDCHANNEL_QUERYRESTRICTEDSHAREDRESOURCEPROCESS_OUTPUT extends Struct {
  external D3DAUTHENTICATEDCHANNEL_QUERY_OUTPUT Output;
  @Uint32() external int ProcessIndex;
  @Uint32() external int ProcessIdentifer;
  @IntPtr() external int ProcessHandle;
}

class D3DAUTHENTICATEDCHANNEL_QUERYUNRESTRICTEDPROTECTEDSHAREDRESOURCECOUNT_OUTPUT extends Struct {
  external D3DAUTHENTICATEDCHANNEL_QUERY_OUTPUT Output;
  @Uint32() external int NumUnrestrictedProtectedSharedResources;
}
...
class D3DAUTHENTICATEDCHANNEL_QUERYOUTPUTIDCOUNT_OUTPUT extends Struct {
  ...
  @IntPtr() external int DeviceHandle;
  @IntPtr() external int CryptoSessionHandle;
  @Uint32() external int NumOutputIDs;
}
...
class D3DAUTHENTICATEDCHANNEL_QUERYINFOBUSTYPE_OUTPUT extends Struct {
  ...
  @Int32() external int bAccessibleInContiguousBlocks;
  @Int32() external int bAccessibleInNonContiguousBlocks;
}

class D3DAUTHENTICATEDCHANNEL_QUERYEVICTIONENCRYPTIONGUIDCOUNT_OUTPUT extends Struct {
  external D3DAUTHENTICATEDCHANNEL_QUERY_OUTPUT Output;
  @Uint32() external int NumEncryptionGuids;
}
...
class D3DAUTHENTICATEDCHANNEL_QUERYEVICTIONENCRYPTIONGUID_OUTPUT extends Struct {
  external D3DAUTHENTICATEDCHANNEL_QUERY_OUTPUT Output;
  @Uint32() external int EncryptionGuidIndex;
  external GUID EncryptionGuid;
}

class D3DAUTHENTICATEDCHANNEL_QUERYUNCOMPRESSEDENCRYPTIONLEVEL_OUTPUT extends Struct {
  external D3DAUTHENTICATEDCHANNEL_QUERY_OUTPUT Output;
  external GUID EncryptionGuid;
}
...
class D3DAUTHENTICATEDCHANNEL_CONFIGURESHAREDRESOURCE extends Struct {
  external D3DAUTHENTICATEDCHANNEL_CONFIGURE_INPUT Parameters;
  @Uint32() external int ProcessIdentiferType;
  @IntPtr() external int ProcessHandle;
...
class D3DVSHADERCAPS2_0 extends Struct {
  ...
  @Int32() external int DynamicFlowControlDepth;
  @Int32() external int NumTemps;
  @Int32() external int StaticFlowControlDepth;
}
...
class D3DPSHADERCAPS2_0 extends Struct {
  ...
  @Int32() external int NumTemps;
  @Int32() external int StaticFlowControlDepth;
  @Int32() external int NumInstructionSlots;
}
...
class D3DCAPS9 extends Struct {
  ...
  @Uint32() external int AdapterOrdinal;
  @Uint32() external int Caps;
  @Uint32() external int Caps2;
  @Uint32() external int Caps3;
  @Uint32() external int PresentationIntervals;
  @Uint32() external int CursorCaps;
  @Uint32() external int DevCaps;
  @Uint32() external int PrimitiveMiscCaps;
  @Uint32() external int RasterCaps;
  @Uint32() external int ZCmpCaps;
  @Uint32() external int SrcBlendCaps;
  @Uint32() external int DestBlendCaps;
  @Uint32() external int AlphaCmpCaps;
  @Uint32() external int ShadeCaps;
  @Uint32() external int TextureCaps;
  @Uint32() external int TextureFilterCaps;
  @Uint32() external int CubeTextureFilterCaps;
  @Uint32() external int VolumeTextureFilterCaps;
  @Uint32() external int TextureAddressCaps;
  @Uint32() external int VolumeTextureAddressCaps;
  @Uint32() external int LineCaps;
  @Uint32() external int MaxTextureWidth;
  @Uint32() external int MaxTextureHeight;
  @Uint32() external int MaxVolumeExtent;
  @Uint32() external int MaxTextureRepeat;
  @Uint32() external int MaxTextureAspectRatio;
  @Uint32() external int MaxAnisotropy;
  @Float() external double MaxVertexW;
  @Float() external double GuardBandLeft;
  @Float() external double GuardBandTop;
  @Float() external double GuardBandRight;
  @Float() external double GuardBandBottom;
  @Float() external double ExtentsAdjust;
  @Uint32() external int StencilCaps;
  @Uint32() external int FVFCaps;
  @Uint32() external int TextureOpCaps;
  @Uint32() external int MaxTextureBlendStages;
  @Uint32() external int MaxSimultaneousTextures;
  @Uint32() external int VertexProcessingCaps;
  @Uint32() external int MaxActiveLights;
  @Uint32() external int MaxUserClipPlanes;
  @Uint32() external int MaxVertexBlendMatrices;
  @Uint32() external int MaxVertexBlendMatrixIndex;
  @Float() external double MaxPointSize;
  @Uint32() external int MaxPrimitiveCount;
  @Uint32() external int MaxVertexIndex;
  @Uint32() external int MaxStreams;
  @Uint32() external int MaxStreamStride;
  @Uint32() external int VertexShaderVersion;
  @Uint32() external int MaxVertexShaderConst;
  @Uint32() external int PixelShaderVersion;
  @Float() external double PixelShader1xMaxValue;
  @Uint32() external int DevCaps2;
  @Float() external double MaxNpatchTessellationLevel;
  @Uint32() external int Reserved5;
  @Uint32() external int MasterAdapterOrdinal;
  @Uint32() external int AdapterOrdinalInGroup;
  @Uint32() external int NumberOfAdaptersInGroup;
  @Uint32() external int DeclTypes;
  @Uint32() external int NumSimultaneousRTs;
  @Uint32() external int StretchRectFilterCaps;
  external D3DVSHADERCAPS2_0 VS20Caps;
  external D3DPSHADERCAPS2_0 PS20Caps;
  @Uint32() external int VertexTextureFilterCaps;
  @Uint32() external int MaxVShaderInstructionsExecuted;
  @Uint32() external int MaxPShaderInstructionsExecuted;
  @Uint32() external int MaxVertexShader30InstructionSlots;
  @Uint32() external int MaxPixelShader30InstructionSlots;
}
