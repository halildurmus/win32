...
/// @nodoc
const IID_IDiscFormat2RawCD = '{27354155-8F64-5B0F-8F00-5D77AFBE261E}';

/// {@category Interface}
/// {@category com}
class IDiscFormat2RawCD extends IDiscFormat2 {
  // vtable begins at 12, is 24 entries long.
  IDiscFormat2RawCD(Pointer<COMObject> ptr) : super(ptr);

  int PrepareMedia() => ptr.ref.lpVtbl.value
          .elementAt(12)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int ReleaseMedia() => ptr.ref.lpVtbl.value
          .elementAt(16)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int get LastPossibleStartOfLeadout {
    final retValuePtr = calloc<Int32>();
  ...
  Pointer<SAFEARRAY> get SupportedSectorTypes {
  ...
  set RequestedSectorType(int value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(26)
        .cast<
            Pointer<
