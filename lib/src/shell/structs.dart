...
class SHDRAGIMAGE extends Struct {
  ...
  @IntPtr() external int hbmpDragImage;
  @Uint32() external int crColorKey;
}
...
class NT_CONSOLE_PROPS extends Struct {
  ...
  @Int32() external int bInsertMode;
  @Int32() external int bAutoPosition;
...
class EXP_SPECIAL_FOLDER extends Struct {
  @Uint32() external int cbSize;
  @Uint32() external int dwSignature;
  @Uint32() external int idSpecialFolder;
...
class DROPFILES extends Struct {
  @Uint32() external int pFiles;
  external POINT pt;
  @Int32() external int fNC;
  @Int32() external int fWide;
}
...
class SHChangeDWORDAsIDList extends Struct {
  @Uint16() external int cb;
  @Uint32() external int dwItem1;
  @Uint32() external int dwItem2;
...
class SHDESCRIPTIONID extends Struct {
  @Uint32() external int dwDescriptionId;
  external GUID clsid;
}
...
class QCMINFO extends Struct {
  @IntPtr() external int hmenu;
  @Uint32() external int indexMenu;
  @Uint32() external int idCmdFirst;
  @Uint32() external int idCmdLast;
...
class ITEMSPACING extends Struct {
  @Int32() external int cxSmall;
  @Int32() external int cySmall;
  @Int32() external int cxLarge;
  @Int32() external int cyLarge;
}
...
class SHELLSTATEA extends Struct {
  @Int32() external int _bitfield1;
  @Uint32() external int dwWin95Unused;
  @Uint32() external int uWin95Unused;
  @Int32() external int lParamSort;
  @Int32() external int iSortDirection;
  @Uint32() external int version;
  @Uint32() external int uNotUsed;
  @Int32() external int _bitfield2;
}
...
class BANDINFOSFB extends Struct {
  ...
  @Uint32() external int dwState;
  @Uint32() external int crBkgnd;
  @Uint32() external int crBtnLt;
  @Uint32() external int crBtnDk;
...
class PARSEDURLA extends Struct {
  ...
  @Uint32() external int cchProtocol;
  external Pointer<Utf8> pszSuffix;
  @Uint32() external int cchSuffix;
...
class DLLVERSIONINFO2 extends Struct {
  ...
  @Uint32() external int dwFlags;
  @Uint64() external int ullVersion;
}
...
class CREDENTIAL_PROVIDER_FIELD_DESCRIPTOR extends Struct {
  @Uint32() external int dwFieldID;
  @Uint32() external int cpft;
...
class CREDENTIAL_PROVIDER_CREDENTIAL_SERIALIZATION extends Struct {
  @Uint32() external int ulAuthenticationPackage;
  external GUID clsidCredentialProvider;
  @Uint32() external int cbSerialization;
...
class CONFIRM_CONFLICT_RESULT_INFO extends Struct {
  ...
  @Uint32() external int iItemIndex;
}
...
class SYNCMGRPROGRESSITEM extends Struct {
  ...
  @Uint32() external int dwStatusType;
  @Int32() external int iProgValue;
  @Int32() external int iMaxValue;
}

class SYNCMGRLOGERRORINFO extends Struct {
  @Uint32() external int cbSize;
  @Uint32() external int mask;
  @Uint32() external int dwSyncMgrErrorFlags;
...
class BASEBROWSERDATAXP extends Struct {
  ...
  @Int32() external int _fIsViewMSHTML;
  @Int32() external int _fPrivacyImpacted;
  external GUID _clsidView;
  external GUID _clsidViewPending;
  @IntPtr() external int _hwndFrame;
}
...
class CPLINFO extends Struct {
  @Int32() external int idIcon;
  @Int32() external int idName;
  @Int32() external int idInfo;
