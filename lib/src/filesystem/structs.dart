...
class TRANSACTION_NOTIFICATION extends Struct {
  ...
  @Int64() external int TmVirtualClock;
  @Uint32() external int ArgumentLength;
}
...
class TRANSACTION_NOTIFICATION_SAVEPOINT_ARGUMENT extends Struct {
  @Uint32() external int SavepointId;
}

class TRANSACTION_NOTIFICATION_PROPAGATE_ARGUMENT extends Struct {
  @Uint32() external int PropagationCookie;
  external GUID UOW;
  external GUID TmIdentity;
...
class TRANSACTION_NOTIFICATION_MARSHAL_ARGUMENT extends Struct {
  @Uint32() external int MarshalCookie;
  external GUID UOW;
}
...
class KCRM_MARSHAL_HEADER extends Struct {
  ...
  @Uint32() external int NumProtocols;
...
class KCRM_PROTOCOL_BLOB extends Struct {
  ...
  @Uint32() external int StaticInfoLength;
  @Uint32() external int TransactionIdInfoLength;
  @Uint32() external int Unused1;
  @Uint32() external int Unused2;
}

class DISK_SPACE_INFORMATION extends Struct {
  @Uint64() external int ActualTotalAllocationUnits;
  @Uint64() external int ActualAvailableAllocationUnits;
  @Uint64() external int ActualPoolUnavailableAllocationUnits;
  @Uint64() external int CallerTotalAllocationUnits;
  @Uint64() external int CallerAvailableAllocationUnits;
  @Uint64() external int CallerPoolUnavailableAllocationUnits;
  @Uint64() external int UsedAllocationUnits;
  @Uint64() external int TotalReservedAllocationUnits;
  @Uint64() external int VolumeStorageReserveAllocationUnits;
  @Uint64() external int AvailableCommittedAllocationUnits;
  @Uint64() external int PoolAvailableAllocationUnits;
  @Uint32() external int SectorsPerAllocationUnit;
...
class BY_HANDLE_FILE_INFORMATION extends Struct {
  ...
  external FILETIME ftLastAccessTime;
  external FILETIME ftLastWriteTime;
  @Uint32() external int dwVolumeSerialNumber;
  @Uint32() external int nFileSizeHigh;
  @Uint32() external int nFileSizeLow;
  @Uint32() external int nNumberOfLinks;
  @Uint32() external int nFileIndexHigh;
  @Uint32() external int nFileIndexLow;
}
...
class CREATEFILE2_EXTENDED_PARAMETERS extends Struct {
  ...
  @Uint32() external int dwSecurityQosFlags;
  external Pointer<SECURITY_ATTRIBUTES> lpSecurityAttributes;
  @IntPtr() external int hTemplateFile;
}
...
class NTMS_ASYNC_IO extends Struct {
  ...
  @Uint32() external int dwOperationType;
  @Uint32() external int dwResult;
  @Uint32() external int dwAsyncState;
  @IntPtr() external int hEvent;
  @Int32() external int bOnStateChange;
}
...
class NTMS_DRIVEINFORMATIONA extends Struct {
  ...
  external __byte__ szSerialNumber;
  external __byte__ szRevision;
  @Uint16() external int ScsiPort;
  @Uint16() external int ScsiBus;
  @Uint16() external int ScsiTarget;
  @Uint16() external int ScsiLun;
  @Uint32() external int dwMountCount;
  external SYSTEMTIME LastCleanedTs;
  external GUID SavedPartitionId;
  external GUID Library;
  external GUID Reserved;
  @Uint32() external int dwDeferDismountDelay;
}
...
class NTMS_DRIVEINFORMATIONW extends Struct {
  ...
  external __ushort__ szSerialNumber;
  external __ushort__ szRevision;
  @Uint16() external int ScsiPort;
  @Uint16() external int ScsiBus;
  @Uint16() external int ScsiTarget;
  @Uint16() external int ScsiLun;
...
class NTMS_LIBRARYINFORMATION extends Struct {
  ...
  @Int32() external int LibrarySupportsDriveCleaning;
  @Int32() external int BarCodeReaderInstalled;
  @Uint32() external int InventoryMethod;
  @Uint32() external int dwCleanerUsesRemaining;
  @Uint32() external int FirstDriveNumber;
  @Uint32() external int dwNumberOfDrives;
  @Uint32() external int FirstSlotNumber;
  @Uint32() external int dwNumberOfSlots;
  @Uint32() external int FirstDoorNumber;
  @Uint32() external int dwNumberOfDoors;
  @Uint32() external int FirstPortNumber;
  @Uint32() external int dwNumberOfPorts;
  @Uint32() external int FirstChangerNumber;
  @Uint32() external int dwNumberOfChangers;
  @Uint32() external int dwNumberOfMedia;
  @Uint32() external int dwNumberOfMediaTypes;
  @Uint32() external int dwNumberOfLibRequests;
  external GUID Reserved;
  @Int32() external int AutoRecovery;
...
class NTMS_IEDOORINFORMATION extends Struct {
  @Uint32() external int Number;
  @Uint32() external int State;
  @Uint16() external int MaxOpenSecs;
  external GUID Library;
}

class NTMS_IEPORTINFORMATION extends Struct {
  @Uint32() external int Number;
  @Uint32() external int Content;
  @Uint32() external int Position;
  @Uint16() external int MaxExtendSecs;
  external GUID Library;
}
...
class NTMS_PMIDINFORMATIONA extends Struct {
  ...
  @Uint32() external int LocationType;
  external GUID MediaType;
  external GUID HomeSlot;
  external __byte__ szBarCode;
  @Uint32() external int BarCodeState;
  external __byte__ szSequenceNumber;
  @Uint32() external int MediaState;
  @Uint32() external int dwNumberOfPartitions;
  @Uint32() external int dwMediaTypeCode;
  @Uint32() external int dwDensityCode;
...
class NTMS_PMIDINFORMATIONW extends Struct {
  ...
  external GUID MediaType;
  external GUID HomeSlot;
  external __ushort__ szBarCode;
  @Uint32() external int BarCodeState;
  external __ushort__ szSequenceNumber;
  @Uint32() external int MediaState;
  @Uint32() external int dwNumberOfPartitions;
  @Uint32() external int dwMediaTypeCode;
  @Uint32() external int dwDensityCode;
...
class NTMS_PARTITIONINFORMATIONA extends Struct {
  ...
  @Uint32() external int State;
  @Uint16() external int Side;
  @Uint32() external int dwOmidLabelIdLength;
  external __ubyte__ OmidLabelId;
  external __byte__ szOmidLabelType;
  external __byte__ szOmidLabelInfo;
  @Uint32() external int dwMountCount;
  @Uint32() external int dwAllocateCount;
...
class NTMS_PARTITIONINFORMATIONW extends Struct {
  ...
  @Uint32() external int dwOmidLabelIdLength;
  external __ubyte__ OmidLabelId;
  external __ushort__ szOmidLabelType;
  external __ushort__ szOmidLabelInfo;
  @Uint32() external int dwMountCount;
  @Uint32() external int dwAllocateCount;
  @Int64() external int Capacity;
}
...
class NTMS_MEDIAPOOLINFORMATION extends Struct {
  ...
  @Uint32() external int AllocationPolicy;
  @Uint32() external int DeallocationPolicy;
  @Uint32() external int dwMaxAllocates;
  @Uint32() external int dwNumberOfPhysicalMedia;
  @Uint32() external int dwNumberOfLogicalMedia;
  @Uint32() external int dwNumberOfMediaPools;
}

class NTMS_MEDIATYPEINFORMATION extends Struct {
  @Uint32() external int MediaType;
  @Uint32() external int NumberOfSides;
  @Uint32() external int ReadWriteCharacteristics;
  @Uint32() external int DeviceType;
}

class NTMS_DRIVETYPEINFORMATIONA extends Struct {
  external __byte__ szVendor;
  external __byte__ szProduct;
  @Uint32() external int NumberOfHeads;
  @Uint32() external int DeviceType;
}

class NTMS_DRIVETYPEINFORMATIONW extends Struct {
  external __ushort__ szVendor;
  external __ushort__ szProduct;
  @Uint32() external int NumberOfHeads;
  @Uint32() external int DeviceType;
}
...
class NTMS_LIBREQUESTINFORMATIONA extends Struct {
  @Uint32() external int OperationCode;
  @Uint32() external int OperationOption;
  @Uint32() external int State;
  ...
  external __byte__ szApplication;
  external __byte__ szUser;
  external __byte__ szComputer;
...
class NTMS_LIBREQUESTINFORMATIONW extends Struct {
  ...
  external SYSTEMTIME TimeQueued;
  external SYSTEMTIME TimeCompleted;
  external __ushort__ szApplication;
  external __ushort__ szUser;
...
class NTMS_OPREQUESTINFORMATIONA extends Struct {
  ...
  @Uint32() external int State;
  external __byte__ szMessage;
  @Uint32() external int Arg1Type;
  external GUID Arg1;
  @Uint32() external int Arg2Type;
  external GUID Arg2;
  external __byte__ szApplication;
  external __byte__ szUser;
  external __byte__ szComputer;
...
class NTMS_COMPUTERINFORMATION extends Struct {
  @Uint32() external int dwLibRequestPurgeTime;
  @Uint32() external int dwOpRequestPurgeTime;
  @Uint32() external int dwLibRequestFlags;
  @Uint32() external int dwOpRequestFlags;
...
class MediaLabelInfo extends Struct {
  external __ushort__ LabelType;
  @Uint32() external int LabelIDSize;
  external __ubyte__ LabelID;
  external __ushort__ LabelAppDescr;
}

class CLS_LSN extends Struct {
  @Uint64() external int Internal;
}

class CLFS_NODE_ID extends Struct {
  @Uint32() external int cType;
  @Uint32() external int cbNode;
}
...
class CLS_INFORMATION extends Struct {
  @Int64() external int TotalAvailable;
  @Int64() external int CurrentAvailable;
  @Int64() external int TotalReservation;
  @Uint64() external int BaseFileSize;
  @Uint64() external int ContainerSize;
  @Uint32() external int TotalContainers;
  @Uint32() external int FreeContainers;
  @Uint32() external int TotalClients;
  @Uint32() external int Attributes;
  @Uint32() external int FlushThreshold;
  @Uint32() external int SectorSize;
...
class CLFS_LOG_NAME_INFORMATION extends Struct {
  @Uint16() external int NameLengthInBytes;
  external __ushort__ Name;
}

class CLFS_STREAM_ID_INFORMATION extends Struct {
  @Uint8() external int StreamIdentifier;
}
...
class CLS_CONTAINER_INFORMATION extends Struct {
  @Uint32() external int FileAttributes;
  @Uint64() external int CreationTime;
  @Uint64() external int LastAccessTime;
  @Uint64() external int LastWriteTime;
  @Int64() external int ContainerSize;
  @Uint32() external int FileNameActualLength;
  @Uint32() external int FileNameLength;
  external __ushort__ FileName;
  @Uint32() external int State;
  @Uint32() external int PhysicalContainerId;
  @Uint32() external int LogicalContainerId;
}

class CLS_IO_STATISTICS_HEADER extends Struct {
  @Uint8() external int ubMajorVersion;
  @Uint8() external int ubMinorVersion;
  @Uint32() external int eStatsClass;
  @Uint16() external int cbLength;
  @Uint32() external int coffData;
}

class CLS_IO_STATISTICS extends Struct {
  external CLS_IO_STATISTICS_HEADER hdrIoStats;
  @Uint64() external int cFlush;
  @Uint64() external int cbFlush;
  @Uint64() external int cMetaFlush;
  @Uint64() external int cbMetaFlush;
}

class CLS_SCAN_CONTEXT extends Struct {
  external CLFS_NODE_ID cidNode;
  @IntPtr() external int hLog;
  @Uint32() external int cIndex;
  @Uint32() external int cContainers;
  @Uint32() external int cContainersReturned;
  @Uint8() external int eScanMode;
  external Pointer<CLS_CONTAINER_INFORMATION> pinfoContainer;
}

class CLS_ARCHIVE_DESCRIPTOR extends Struct {
  @Uint64() external int coffLow;
  @Uint64() external int coffHigh;
...
class CLFS_MGMT_NOTIFICATION extends Struct {
  ...
  @Uint16() external int LogIsPinned;
}
...
class WIM_ENTRY_INFO extends Struct {
  @Uint32() external int WimEntryInfoSize;
...
class TXF_LOG_RECORD_BASE extends Struct {
  ...
  @Uint32() external int RecordType;
  @Uint32() external int RecordLength;
}

class TXF_LOG_RECORD_WRITE extends Struct {
  @Uint16() external int Version;
  @Uint16() external int RecordType;
  @Uint32() external int RecordLength;
  @Uint32() external int Flags;
  external TXF_ID TxfFileId;
  external GUID KtmGuid;
  @Int64() external int ByteOffsetInFile;
  @Uint32() external int NumBytesWritten;
  @Uint32() external int ByteOffsetInStructure;
  @Uint32() external int FileNameLength;
  @Uint32() external int FileNameByteOffsetInStructure;
}
...
class TXF_LOG_RECORD_TRUNCATE extends Struct {
  ...
  external TXF_ID TxfFileId;
  external GUID KtmGuid;
  @Int64() external int NewFileSize;
  @Uint32() external int FileNameLength;
  @Uint32() external int FileNameByteOffsetInStructure;
}
...
class VOLUME_FAILOVER_SET extends Struct {
  @Uint32() external int NumberOfDisks;
  external __uint__ DiskNumbers;
}

class VOLUME_NUMBER extends Struct {
  @Uint32() external int VolumeNumber;
  external __ushort__ VolumeManagerName;
}

class VOLUME_LOGICAL_OFFSET extends Struct {
  @Int64() external int LogicalOffset;
}
...
class VOLUME_PHYSICAL_OFFSETS extends Struct {
  @Uint32() external int NumberOfPhysicalOffsets;
  external VOLUME_PHYSICAL_OFFSET PhysicalOffset;
}

class VOLUME_READ_PLEX_INPUT extends Struct {
  @Int64() external int ByteOffset;
  @Uint32() external int Length;
  @Uint32() external int PlexNumber;
}

class VOLUME_SET_GPT_ATTRIBUTES_INFORMATION extends Struct {
  @Uint64() external int GptAttributes;
  @Uint8() external int RevertOnClose;
  @Uint8() external int ApplyToAllConnectedVolumes;
...
class VOLUME_GET_BC_PROPERTIES_INPUT extends Struct {
  ...
  @Uint64() external int LowestByteOffset;
  @Uint64() external int HighestByteOffset;
...
class FILE_EXTENT extends Struct {
  ...
  @Uint64() external int ExtentLength;
}

class VOLUME_CRITICAL_IO extends Struct {
  @Uint32() external int AccessType;
  @Uint32() external int ExtentsCount;
  external FILE_EXTENT Extents;
}

class VOLUME_ALLOCATION_HINT_INPUT extends Struct {
  @Uint32() external int ClusterSize;
  @Uint32() external int NumberOfClusters;
  @Int64() external int StartingClusterNumber;
}
...
class VOLUME_SHRINK_INFO extends Struct {
  @Uint64() external int VolumeSize;
}
...
class SHARE_INFO_1 extends Struct {
  ...
  @Uint32() external int shi1_type;
  external Pointer<Utf16> shi1_remark;
}

class SHARE_INFO_2 extends Struct {
  external Pointer<Utf16> shi2_netname;
  @Uint32() external int shi2_type;
  external Pointer<Utf16> shi2_remark;
  @Uint32() external int shi2_permissions;
  @Uint32() external int shi2_max_uses;
  @Uint32() external int shi2_current_uses;
...
class SHARE_INFO_501 extends Struct {
  ...
  @Uint32() external int shi501_type;
  external Pointer<Utf16> shi501_remark;
  @Uint32() external int shi501_flags;
}

class SHARE_INFO_502 extends Struct {
  external Pointer<Utf16> shi502_netname;
  @Uint32() external int shi502_type;
  external Pointer<Utf16> shi502_remark;
  @Uint32() external int shi502_permissions;
  @Uint32() external int shi502_max_uses;
  @Uint32() external int shi502_current_uses;
...
class SHARE_INFO_503 extends Struct {
  ...
  @Uint32() external int shi503_type;
  external Pointer<Utf16> shi503_remark;
  @Uint32() external int shi503_permissions;
  @Uint32() external int shi503_max_uses;
  @Uint32() external int shi503_current_uses;
...
class SHARE_INFO_1005 extends Struct {
  @Uint32() external int shi1005_flags;
}

class SHARE_INFO_1006 extends Struct {
  @Uint32() external int shi1006_max_uses;
}
...
class SERVER_ALIAS_INFO_0 extends Struct {
  ...
  @Uint8() external int srvai0_default;
  @Uint32() external int srvai0_reserved;
}
...
class SESSION_INFO_1 extends Struct {
  ...
  @Uint32() external int sesi1_num_opens;
  @Uint32() external int sesi1_time;
  @Uint32() external int sesi1_idle_time;
  @Uint32() external int sesi1_user_flags;
}

class SESSION_INFO_2 extends Struct {
  external Pointer<Utf16> sesi2_cname;
  external Pointer<Utf16> sesi2_username;
  @Uint32() external int sesi2_num_opens;
  @Uint32() external int sesi2_time;
  @Uint32() external int sesi2_idle_time;
  @Uint32() external int sesi2_user_flags;
...
class SESSION_INFO_10 extends Struct {
  ...
  @Uint32() external int sesi10_time;
  @Uint32() external int sesi10_idle_time;
}

class SESSION_INFO_502 extends Struct {
  external Pointer<Utf16> sesi502_cname;
  external Pointer<Utf16> sesi502_username;
  @Uint32() external int sesi502_num_opens;
  @Uint32() external int sesi502_time;
  @Uint32() external int sesi502_idle_time;
  @Uint32() external int sesi502_user_flags;
  external Pointer<Utf16> sesi502_cltype_name;
  external Pointer<Utf16> sesi502_transport;
}

class CONNECTION_INFO_0 extends Struct {
  @Uint32() external int coni0_id;
}

class CONNECTION_INFO_1 extends Struct {
  @Uint32() external int coni1_id;
  @Uint32() external int coni1_type;
  @Uint32() external int coni1_num_opens;
  @Uint32() external int coni1_num_users;
  @Uint32() external int coni1_time;
  external Pointer<Utf16> coni1_username;
  external Pointer<Utf16> coni1_netname;
}

class FILE_INFO_2 extends Struct {
  @Uint32() external int fi2_id;
}

class FILE_INFO_3 extends Struct {
  @Uint32() external int fi3_id;
  @Uint32() external int fi3_permissions;
  @Uint32() external int fi3_num_locks;
...
class SERVER_CERTIFICATE_INFO_0 extends Struct {
  ...
  @Uint32() external int srvci0_type;
}

class STAT_WORKSTATION_0 extends Struct {
  @Int64() external int StatisticsStartTime;
  @Int64() external int BytesReceived;
  @Int64() external int SmbsReceived;
  @Int64() external int PagingReadBytesRequested;
  @Int64() external int NonPagingReadBytesRequested;
  @Int64() external int CacheReadBytesRequested;
  @Int64() external int NetworkReadBytesRequested;
  @Int64() external int BytesTransmitted;
  @Int64() external int SmbsTransmitted;
  @Int64() external int PagingWriteBytesRequested;
  @Int64() external int NonPagingWriteBytesRequested;
  @Int64() external int CacheWriteBytesRequested;
  @Int64() external int NetworkWriteBytesRequested;
  @Uint32() external int InitiallyFailedOperations;
  @Uint32() external int FailedCompletionOperations;
  @Uint32() external int ReadOperations;
  @Uint32() external int RandomReadOperations;
  @Uint32() external int ReadSmbs;
  @Uint32() external int LargeReadSmbs;
  @Uint32() external int SmallReadSmbs;
  @Uint32() external int WriteOperations;
  @Uint32() external int RandomWriteOperations;
  @Uint32() external int WriteSmbs;
  @Uint32() external int LargeWriteSmbs;
  @Uint32() external int SmallWriteSmbs;
  @Uint32() external int RawReadsDenied;
  @Uint32() external int RawWritesDenied;
  @Uint32() external int NetworkErrors;
  @Uint32() external int Sessions;
  @Uint32() external int FailedSessions;
  @Uint32() external int Reconnects;
  @Uint32() external int CoreConnects;
  @Uint32() external int Lanman20Connects;
  @Uint32() external int Lanman21Connects;
  @Uint32() external int LanmanNtConnects;
  @Uint32() external int ServerDisconnects;
  @Uint32() external int HungSessions;
  @Uint32() external int UseCount;
  @Uint32() external int FailedUseCount;
  @Uint32() external int CurrentCommands;
}

class STAT_SERVER_0 extends Struct {
  @Uint32() external int sts0_start;
  @Uint32() external int sts0_fopens;
  @Uint32() external int sts0_devopens;
  @Uint32() external int sts0_jobsqueued;
  @Uint32() external int sts0_sopens;
  @Uint32() external int sts0_stimedout;
  @Uint32() external int sts0_serrorout;
  @Uint32() external int sts0_pwerrors;
  @Uint32() external int sts0_permerrors;
  @Uint32() external int sts0_syserrors;
  @Uint32() external int sts0_bytessent_low;
  @Uint32() external int sts0_bytessent_high;
  @Uint32() external int sts0_bytesrcvd_low;
  @Uint32() external int sts0_bytesrcvd_high;
...
class OVERLAPPED_ENTRY extends Struct {
  @IntPtr() external int lpCompletionKey;
  external Pointer<OVERLAPPED> lpOverlapped;
  @IntPtr() external int Internal;
  @Uint32() external int dwNumberOfBytesTransferred;
}
...
class WIN32_FIND_DATAA extends Struct {
  ...
  external __byte__ cAlternateFileName;
}
...
class WIN32_FIND_DATAW extends Struct {
  ...
  external __ushort__ cAlternateFileName;
}
...
class STORAGE_DEVICE_DESCRIPTOR extends Struct {
  ...
  @Uint8() external int DeviceTypeModifier;
  @Uint8() external int RemovableMedia;
  @Uint8() external int CommandQueueing;
  @Uint32() external int VendorIdOffset;
  @Uint32() external int ProductIdOffset;
  @Uint32() external int ProductRevisionOffset;
  @Uint32() external int SerialNumberOffset;
  @Uint32() external int BusType;
  @Uint32() external int RawPropertiesLength;
  external __ubyte__ RawDeviceProperties;
}
...
class STORAGE_ADAPTER_DESCRIPTOR extends Struct {
  ...
  @Uint8() external int CommandQueueing;
  @Uint8() external int AcceleratedTransfer;
  @Uint8() external int BusType;
  @Uint16() external int BusMajorVersion;
  @Uint16() external int BusMinorVersion;
  @Uint8() external int SrbType;
...
class STORAGE_ACCESS_ALIGNMENT_DESCRIPTOR extends Struct {
  @Uint32() external int Version;
  @Uint32() external int Size;
  @Uint32() external int BytesPerCacheLine;
  @Uint32() external int BytesOffsetForCacheAlignment;
  @Uint32() external int BytesPerLogicalSector;
  @Uint32() external int BytesPerPhysicalSector;
  @Uint32() external int BytesOffsetForSectorAlignment;
}

class STORAGE_MEDIUM_PRODUCT_TYPE_DESCRIPTOR extends Struct {
  @Uint32() external int Version;
  @Uint32() external int Size;
  @Uint32() external int MediumProductType;
}

class STORAGE_MINIPORT_DESCRIPTOR extends Struct {
  @Uint32() external int Version;
  @Uint32() external int Size;
  @Uint32() external int Portdriver;
  @Uint8() external int LUNResetSupported;
  @Uint8() external int TargetResetSupported;
  @Uint16() external int IoTimeoutValue;
  @Uint8() external int ExtraIoInfoSupported;
...
class STORAGE_DEVICE_ID_DESCRIPTOR extends Struct {
  @Uint32() external int Version;
  @Uint32() external int Size;
  @Uint32() external int NumberOfIdentifiers;
  external __ubyte__ Identifiers;
}

class DEVICE_SEEK_PENALTY_DESCRIPTOR extends Struct {
  @Uint32() external int Version;
  @Uint32() external int Size;
  @Uint8() external int IncursSeekPenalty;
}

class DEVICE_WRITE_AGGREGATION_DESCRIPTOR extends Struct {
  @Uint32() external int Version;
  @Uint32() external int Size;
  @Uint8() external int BenefitsFromWriteAggregation;
}

class DEVICE_TRIM_DESCRIPTOR extends Struct {
  @Uint32() external int Version;
  @Uint32() external int Size;
  @Uint8() external int TrimEnabled;
}
...
class DEVICE_LB_PROVISIONING_DESCRIPTOR extends Struct {
  ...
  external __ubyte__ Reserved1;
  @Uint64() external int OptimalUnmapGranularity;
  @Uint64() external int UnmapGranularityAlignment;
  @Uint32() external int MaxUnmapLbaCount;
  @Uint32() external int MaxUnmapBlockDescriptorCount;
}

class DEVICE_POWER_DESCRIPTOR extends Struct {
  @Uint32() external int Version;
  @Uint32() external int Size;
  @Uint8() external int DeviceAttentionSupported;
  @Uint8() external int AsynchronousNotificationSupported;
  @Uint8() external int IdlePowerManagementEnabled;
  @Uint8() external int D3ColdEnabled;
  @Uint8() external int D3ColdSupported;
  @Uint8() external int NoVerifyDuringIdlePower;
  external __ubyte__ Reserved;
  @Uint32() external int IdleTimeoutInMS;
}

class DEVICE_COPY_OFFLOAD_DESCRIPTOR extends Struct {
  @Uint32() external int Version;
  @Uint32() external int Size;
  @Uint32() external int MaximumTokenLifetime;
  @Uint32() external int DefaultTokenLifetime;
  @Uint64() external int MaximumTransferSize;
  @Uint64() external int OptimalTransferCount;
  @Uint32() external int MaximumDataDescriptors;
  @Uint32() external int MaximumTransferLengthPerDescriptor;
  @Uint32() external int OptimalTransferLengthPerDescriptor;
  @Uint16() external int OptimalTransferLengthGranularity;
  external __ubyte__ Reserved;
}
...
class STORAGE_DEVICE_RESILIENCY_DESCRIPTOR extends Struct {
  ...
  @Uint32() external int NumberOfLogicalCopies;
  @Uint32() external int NumberOfPhysicalCopies;
  @Uint32() external int PhysicalDiskRedundancy;
  @Uint32() external int NumberOfColumns;
  @Uint32() external int Interleave;
}

class STORAGE_PROTOCOL_SPECIFIC_DATA extends Struct {
  @Uint32() external int ProtocolType;
  @Uint32() external int DataType;
  @Uint32() external int ProtocolDataRequestValue;
  @Uint32() external int ProtocolDataRequestSubValue;
  @Uint32() external int ProtocolDataOffset;
  @Uint32() external int ProtocolDataLength;
  @Uint32() external int FixedProtocolReturnData;
  @Uint32() external int ProtocolDataRequestSubValue2;
  @Uint32() external int ProtocolDataRequestSubValue3;
...
class STORAGE_TEMPERATURE_INFO extends Struct {
  ...
  @Int16() external int Temperature;
  @Int16() external int OverThreshold;
  @Int16() external int UnderThreshold;
  @Uint8() external int OverThresholdChangable;
  @Uint8() external int UnderThresholdChangable;
  @Uint8() external int EventGenerated;
...
class STORAGE_TEMPERATURE_DATA_DESCRIPTOR extends Struct {
  @Uint32() external int Version;
  @Uint32() external int Size;
  @Int16() external int CriticalTemperature;
  @Int16() external int WarningTemperature;
  @Uint16() external int InfoCount;
  external __ubyte__ Reserved0;
  external __uint__ Reserved1;
  external STORAGE_TEMPERATURE_INFO TemperatureInfo;
}
...
class STORAGE_TEMPERATURE_THRESHOLD extends Struct {
  ...
  @Uint16() external int Index;
  @Int16() external int Threshold;
  @Uint8() external int OverThreshold;
...
class STORAGE_PHYSICAL_DEVICE_DATA extends Struct {
  ...
  @Uint32() external int HealthStatus;
  @Uint32() external int CommandProtocol;
  external STORAGE_SPEC_VERSION SpecVersion;
  @Uint32() external int FormFactor;
  external __ubyte__ Vendor;
  external __ubyte__ Model;
  external __ubyte__ FirmwareRevision;
  @Uint64() external int Capacity;
  external __ubyte__ PhysicalLocation;
  external __uint__ Reserved;
}

class STORAGE_PHYSICAL_ADAPTER_DATA extends Struct {
  @Uint32() external int AdapterId;
  @Uint32() external int HealthStatus;
  @Uint32() external int CommandProtocol;
  external STORAGE_SPEC_VERSION SpecVersion;
  external __ubyte__ Vendor;
  ...
  external __ubyte__ FirmwareRevision;
  external __ubyte__ PhysicalLocation;
  @Uint8() external int ExpanderConnected;
  external __ubyte__ Reserved0;
  external __uint__ Reserved1;
}
...
class STORAGE_PHYSICAL_NODE_DATA extends Struct {
  ...
  @Uint32() external int AdapterCount;
  @Uint32() external int AdapterDataLength;
  @Uint32() external int AdapterDataOffset;
  @Uint32() external int DeviceCount;
  @Uint32() external int DeviceDataLength;
  @Uint32() external int DeviceDataOffset;
  external __uint__ Reserved;
}
...
class STORAGE_PHYSICAL_TOPOLOGY_DESCRIPTOR extends Struct {
  @Uint32() external int Version;
  @Uint32() external int Size;
  @Uint32() external int NodeCount;
  @Uint32() external int Reserved;
  external STORAGE_PHYSICAL_NODE_DATA Node;
}

class STORAGE_DEVICE_IO_CAPABILITY_DESCRIPTOR extends Struct {
  @Uint32() external int Version;
  @Uint32() external int Size;
  @Uint32() external int LunMaxIoCount;
  @Uint32() external int AdapterMaxIoCount;
}

class STORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR extends Struct {
  @Uint32() external int Version;
  @Uint32() external int Size;
  @Uint64() external int Attributes;
}
...
class STORAGE_WRITE_CACHE_PROPERTY extends Struct {
  @Uint32() external int Version;
  @Uint32() external int Size;
  @Uint32() external int WriteCacheType;
  @Uint32() external int WriteCacheEnabled;
  @Uint32() external int WriteCacheChangeable;
  @Uint32() external int WriteThroughSupported;
  @Uint8() external int FlushCacheSupported;
  @Uint8() external int UserDefinedPowerProtection;
  @Uint8() external int NVCacheEnabled;
}
...
class STORAGE_PROTOCOL_COMMAND extends Struct {
  ...
  @Uint32() external int CommandLength;
  @Uint32() external int ErrorInfoLength;
  @Uint32() external int DataToDeviceTransferLength;
  @Uint32() external int DataFromDeviceTransferLength;
  @Uint32() external int TimeOutValue;
  @Uint32() external int ErrorInfoOffset;
  @Uint32() external int DataToDeviceBufferOffset;
  @Uint32() external int DataFromDeviceBufferOffset;
  @Uint32() external int CommandSpecific;
...
class FORMAT_PARAMETERS extends Struct {
  @Uint32() external int MediaType;
  @Uint32() external int StartCylinderNumber;
  @Uint32() external int EndCylinderNumber;
  @Uint32() external int StartHeadNumber;
  @Uint32() external int EndHeadNumber;
}
...
class FORMAT_EX_PARAMETERS extends Struct {
  ...
  @Uint32() external int StartHeadNumber;
  @Uint32() external int EndHeadNumber;
  @Uint16() external int FormatGapLength;
  @Uint16() external int SectorsPerTrack;
  external __ushort__ SectorNumber;
}

class DISK_GEOMETRY extends Struct {
  @Int64() external int Cylinders;
  @Uint32() external int MediaType;
  @Uint32() external int TracksPerCylinder;
  @Uint32() external int SectorsPerTrack;
  @Uint32() external int BytesPerSector;
}
...
class PARTITION_INFORMATION extends Struct {
  ...
  @Uint32() external int HiddenSectors;
  @Uint32() external int PartitionNumber;
  @Uint8() external int PartitionType;
  @Uint8() external int BootIndicator;
  @Uint8() external int RecognizedPartition;
...
class DRIVE_LAYOUT_INFORMATION extends Struct {
  ...
  external PARTITION_INFORMATION PartitionEntry;
}
...
class REASSIGN_BLOCKS extends Struct {
  ...
  external __uint__ BlockNumber;
}

class REASSIGN_BLOCKS_EX extends Struct {
  @Uint16() external int Reserved;
  @Uint16() external int Count;
  @Int64() external int BlockNumber;
}
...
class CREATE_DISK_GPT extends Struct {
  ...
  @Uint32() external int MaxPartitionCount;
}
...
class DRIVE_LAYOUT_INFORMATION_GPT extends Struct {
  external GUID DiskId;
  @Int64() external int StartingUsableOffset;
  @Int64() external int UsableLength;
  @Uint32() external int MaxPartitionCount;
}
...
class DISK_INT13_INFO extends Struct {
  @Uint16() external int DriveSelect;
  @Uint32() external int MaxCylinders;
  @Uint16() external int SectorsPerTrack;
  @Uint16() external int MaxHeads;
  @Uint16() external int NumberDrives;
}

class DISK_EX_INT13_INFO extends Struct {
  @Uint16() external int ExBufferSize;
  @Uint16() external int ExFlags;
  @Uint32() external int ExCylinders;
  @Uint32() external int ExHeads;
  @Uint32() external int ExSectorsPerTrack;
  @Uint64() external int ExSectorsPerDrive;
  @Uint16() external int ExSectorSize;
...
class DISK_GROW_PARTITION extends Struct {
  @Uint32() external int PartitionNumber;
  @Int64() external int BytesToGrow;
}

class DISK_PERFORMANCE extends Struct {
  @Int64() external int BytesRead;
  @Int64() external int BytesWritten;
  @Int64() external int ReadTime;
  @Int64() external int WriteTime;
  @Int64() external int IdleTime;
  @Uint32() external int ReadCount;
  @Uint32() external int WriteCount;
  @Uint32() external int QueueDepth;
  @Uint32() external int SplitCount;
  @Int64() external int QueryTime;
  @Uint32() external int StorageDeviceNumber;
  external __ushort__ StorageManagerName;
}
...
class SET_DISK_ATTRIBUTES extends Struct {
  @Uint32() external int Version;
  @Uint8() external int Persist;
  external __ubyte__ Reserved1;
  @Uint64() external int Attributes;
  @Uint64() external int AttributesMask;
...
class NTFS_VOLUME_DATA_BUFFER extends Struct {
  ...
  @Uint32() external int BytesPerFileRecordSegment;
  @Uint32() external int ClustersPerFileRecordSegment;
  @Int64() external int MftValidDataLength;
  @Int64() external int MftStartLcn;
  @Int64() external int Mft2StartLcn;
  @Int64() external int MftZoneStart;
  @Int64() external int MftZoneEnd;
}
...
class NTFS_EXTENDED_VOLUME_DATA extends Struct {
  ...
  @Uint32() external int BytesPerPhysicalSector;
  @Uint16() external int LfsMajorVersion;
  @Uint16() external int LfsMinorVersion;
  @Uint32() external int MaxDeviceTrimExtentCount;
  @Uint32() external int MaxDeviceTrimByteCount;
  @Uint32() external int MaxVolumeTrimExtentCount;
  @Uint32() external int MaxVolumeTrimByteCount;
}
...
class NTFS_FILE_RECORD_INPUT_BUFFER extends Struct {
  @Int64() external int FileReferenceNumber;
}

class NTFS_FILE_RECORD_OUTPUT_BUFFER extends Struct {
  @Int64() external int FileReferenceNumber;
  @Uint32() external int FileRecordLength;
  external __ubyte__ FileRecordBuffer;
}
...
class MOVE_FILE_DATA extends Struct {
  ...
  @Int64() external int StartingVcn;
  @Int64() external int StartingLcn;
  @Uint32() external int ClusterCount;
}

class FIND_BY_SID_DATA extends Struct {
  @Uint32() external int Restart;
  external SID Sid;
}
...
class MFT_ENUM_DATA_V0 extends Struct {
  @Uint64() external int StartFileReferenceNumber;
  @Int64() external int LowUsn;
  @Int64() external int HighUsn;
}
...
class MFT_ENUM_DATA_V1 extends Struct {
  ...
  @Int64() external int LowUsn;
  @Int64() external int HighUsn;
  @Uint16() external int MinMajorVersion;
  @Uint16() external int MaxMajorVersion;
}

class CREATE_USN_JOURNAL_DATA extends Struct {
  @Uint64() external int MaximumSize;
  @Uint64() external int AllocationDelta;
}
...
class READ_USN_JOURNAL_DATA_V0 extends Struct {
  @Int64() external int StartUsn;
  @Uint32() external int ReasonMask;
  @Uint32() external int ReturnOnlyOnClose;
  @Uint64() external int Timeout;
  @Uint64() external int BytesToWaitFor;
  @Uint64() external int UsnJournalID;
}
...
class USN_TRACK_MODIFIED_RANGES extends Struct {
  @Uint32() external int Flags;
  @Uint32() external int Unused;
  @Uint64() external int ChunkSize;
  @Int64() external int FileSizeThreshold;
}

class USN_RANGE_TRACK_OUTPUT extends Struct {
  @Int64() external int Usn;
}
...
class USN_RECORD_V2 extends Struct {
  ...
  @Uint32() external int SourceInfo;
  @Uint32() external int SecurityId;
  @Uint32() external int FileAttributes;
  @Uint16() external int FileNameLength;
  @Uint16() external int FileNameOffset;
  external __ushort__ FileName;
}
...
class USN_RECORD_V4 extends Struct {
  ...
  @Uint32() external int Reason;
  @Uint32() external int SourceInfo;
  @Uint32() external int RemainingExtents;
  @Uint16() external int NumberOfExtents;
  @Uint16() external int ExtentSize;
  external USN_RECORD_EXTENT Extents;
}

class USN_JOURNAL_DATA_V0 extends Struct {
  @Uint64() external int UsnJournalID;
  @Int64() external int FirstUsn;
  @Int64() external int NextUsn;
  @Int64() external int LowestValidUsn;
  @Int64() external int MaxUsn;
  @Uint64() external int MaximumSize;
  @Uint64() external int AllocationDelta;
}
...
class USN_JOURNAL_DATA_V1 extends Struct {
  ...
  @Uint64() external int MaximumSize;
  @Uint64() external int AllocationDelta;
  @Uint16() external int MinSupportedMajorVersion;
  @Uint16() external int MaxSupportedMajorVersion;
}
...
class USN_JOURNAL_DATA_V2 extends Struct {
  ...
  @Uint16() external int MaxSupportedMajorVersion;
  @Uint32() external int Flags;
  @Uint64() external int RangeTrackChunkSize;
  @Int64() external int RangeTrackFileSizeThreshold;
}
...
class FILESYSTEM_STATISTICS extends Struct {
  ...
  @Uint16() external int Version;
  @Uint32() external int SizeOfCompleteStructure;
  @Uint32() external int UserFileReads;
  @Uint32() external int UserFileReadBytes;
  @Uint32() external int UserDiskReads;
  @Uint32() external int UserFileWrites;
  @Uint32() external int UserFileWriteBytes;
  @Uint32() external int UserDiskWrites;
  @Uint32() external int MetaDataReads;
  @Uint32() external int MetaDataReadBytes;
  @Uint32() external int MetaDataDiskReads;
  @Uint32() external int MetaDataWrites;
  @Uint32() external int MetaDataWriteBytes;
  @Uint32() external int MetaDataDiskWrites;
}

class FAT_STATISTICS extends Struct {
  @Uint32() external int CreateHits;
  @Uint32() external int SuccessfulCreates;
  @Uint32() external int FailedCreates;
  @Uint32() external int NonCachedReads;
  @Uint32() external int NonCachedReadBytes;
  @Uint32() external int NonCachedWrites;
  @Uint32() external int NonCachedWriteBytes;
  @Uint32() external int NonCachedDiskReads;
...
class FILESYSTEM_STATISTICS_EX extends Struct {
  ...
  @Uint16() external int Version;
  @Uint32() external int SizeOfCompleteStructure;
  @Uint64() external int UserFileReads;
  @Uint64() external int UserFileReadBytes;
  @Uint64() external int UserDiskReads;
  @Uint64() external int UserFileWrites;
  @Uint64() external int UserFileWriteBytes;
  @Uint64() external int UserDiskWrites;
  @Uint64() external int MetaDataReads;
  @Uint64() external int MetaDataReadBytes;
  @Uint64() external int MetaDataDiskReads;
...
class FILE_MAKE_COMPATIBLE_BUFFER extends Struct {
  @Uint8() external int CloseDisc;
}

class FILE_SET_DEFECT_MGMT_BUFFER extends Struct {
  @Uint8() external int Disable;
}

class FILE_QUERY_SPARING_BUFFER extends Struct {
  @Uint32() external int SparingUnitBytes;
  @Uint8() external int SoftwareSparing;
  @Uint32() external int TotalSpareBlocks;
  @Uint32() external int FreeSpareBlocks;
}

class FILE_QUERY_ON_DISK_VOL_INFO_BUFFER extends Struct {
  @Int64() external int DirectoryCount;
  @Int64() external int FileCount;
  @Uint16() external int FsFormatMajVersion;
  @Uint16() external int FsFormatMinVersion;
  external __ushort__ FsFormatName;
  @Int64() external int FormatTime;
  @Int64() external int LastUpdateTime;
  external __ushort__ CopyrightInfo;
  external __ushort__ AbstractInfo;
  external __ushort__ FormattingImplementationInfo;
  external __ushort__ LastModifyingImplementationInfo;
}

class SHRINK_VOLUME_INFORMATION extends Struct {
  @Uint32() external int ShrinkRequestType;
  @Uint64() external int Flags;
  @Int64() external int NewNumberOfSectors;
}
...
class TXFS_MODIFY_RM extends Struct {
  ...
  @Uint32() external int LogContainerCount;
...
class TXFS_QUERY_RM_INFORMATION extends Struct {
  @Uint32() external int BytesRequired;
  @Uint64() external int TailLsn;
  @Uint64() external int CurrentLsn;
  @Uint64() external int ArchiveTailLsn;
  @Uint64() external int LogContainerSize;
  @Int64() external int HighestVirtualClock;
  @Uint32() external int LogContainerCount;
  @Uint32() external int LogContainerCountMax;
  @Uint32() external int LogContainerCountMin;
  @Uint32() external int LogGrowthIncrement;
  ...
  @Uint16() external int LoggingMode;
  @Uint16() external int Reserved;
  @Uint32() external int RmState;
  @Uint64() external int LogCapacity;
  @Uint64() external int LogFree;
  @Uint64() external int TopsSize;
  @Uint64() external int TopsUsed;
  @Uint64() external int TransactionCount;
  @Uint64() external int OnePCCount;
  @Uint64() external int TwoPCCount;
  @Uint64() external int NumberLogFileFull;
  @Uint64() external int OldestTransactionAge;
...
class TXFS_LIST_TRANSACTION_LOCKED_FILES extends Struct {
  ...
  @Uint64() external int NumberOfFiles;
...
class TXFS_LIST_TRANSACTIONS extends Struct {
  @Uint64() external int NumberOfTransactions;
  @Uint64() external int BufferSizeRequired;
}
...
class TXFS_GET_TRANSACTED_VERSION extends Struct {
  @Uint32() external int ThisBaseVersion;
  @Uint32() external int LatestVersion;
  @Uint16() external int ThisMiniVersion;
  @Uint16() external int FirstMiniVersion;
  @Uint16() external int LatestMiniVersion;
}

class TXFS_SAVEPOINT_INFORMATION extends Struct {
  @IntPtr() external int KtmTransaction;
...
class TXFS_CREATE_MINIVERSION_INFO extends Struct {
  ...
  @Uint16() external int StructureLength;
  @Uint32() external int BaseVersion;
  @Uint16() external int MiniVersion;
}
...
class REQUEST_OPLOCK_OUTPUT_BUFFER extends Struct {
  @Uint16() external int StructureVersion;
  @Uint16() external int StructureLength;
  @Uint32() external int OriginalOplockLevel;
  @Uint32() external int NewOplockLevel;
  @Uint32() external int Flags;
  @Uint32() external int AccessMode;
  @Uint16() external int ShareMode;
}

class LOOKUP_STREAM_FROM_CLUSTER_INPUT extends Struct {
  @Uint32() external int Flags;
  @Uint32() external int NumberOfClusters;
  @Int64() external int Cluster;
}

class LOOKUP_STREAM_FROM_CLUSTER_OUTPUT extends Struct {
  @Uint32() external int Offset;
  @Uint32() external int NumberOfMatches;
  @Uint32() external int BufferSizeRequired;
}

class LOOKUP_STREAM_FROM_CLUSTER_ENTRY extends Struct {
  @Uint32() external int OffsetToNext;
  @Uint32() external int Flags;
...
class CSV_QUERY_MDS_PATH extends Struct {
  ...
  external __ushort__ Path;
}

class CSV_QUERY_VETO_FILE_DIRECT_IO_OUTPUT extends Struct {
  @Uint64() external int VetoedFromAltitudeIntegral;
  @Uint64() external int VetoedFromAltitudeDecimal;
  external __ushort__ Reason;
}

class CSV_IS_OWNED_BY_CSVFS extends Struct {
  @Uint8() external int OwnedByCSVFS;
}
...
class FILE_LEVEL_TRIM extends Struct {
  ...
  external FILE_LEVEL_TRIM_RANGE Ranges;
}

class FILE_LEVEL_TRIM_OUTPUT extends Struct {
  @Uint32() external int NumRangesProcessed;
}

class FSCTL_GET_INTEGRITY_INFORMATION_BUFFER extends Struct {
  @Uint16() external int ChecksumAlgorithm;
  @Uint16() external int Reserved;
  @Uint32() external int Flags;
  @Uint32() external int ChecksumChunkSizeInBytes;
  @Uint32() external int ClusterSizeInBytes;
}
...
class REPAIR_COPIES_OUTPUT extends Struct {
  ...
  @Int64() external int ResumeFileOffset;
}
...
class FSCTL_QUERY_STORAGE_CLASSES_OUTPUT extends Struct {
  ...
  external FILE_STORAGE_TIER Tiers;
}
...
class FSCTL_QUERY_REGION_INFO_OUTPUT extends Struct {
  ...
  external FILE_STORAGE_TIER_REGION Regions;
}
...
class DISK_EXTENT extends Struct {
  @Uint32() external int DiskNumber;
  @Int64() external int StartingOffset;
  @Int64() external int ExtentLength;
}

class VOLUME_DISK_EXTENTS extends Struct {
  @Uint32() external int NumberOfDiskExtents;
  external DISK_EXTENT Extents;
}
