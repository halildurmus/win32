...
class SPEVENT extends Struct {
  ...
  @Uint32() external int ulStreamNum;
  @Uint64() external int ullAudioStreamOffset;
...
class SPSERIALIZEDEVENT extends Struct {
  ...
  @Uint32() external int ulStreamNum;
  @Uint64() external int ullAudioStreamOffset;
  @Uint32() external int SerializedwParam;
  @Int32() external int SerializedlParam;
}
...
class SPSERIALIZEDEVENT64 extends Struct {
  ...
  @Uint32() external int ulStreamNum;
  @Uint64() external int ullAudioStreamOffset;
  @Uint64() external int SerializedwParam;
  @Int64() external int SerializedlParam;
}
...
class SPEVENTEX extends Struct {
  ...
  @IntPtr() external int wParam;
  @IntPtr() external int lParam;
  @Uint64() external int ullAudioTimeOffset;
}

class SPEVENTSOURCEINFO extends Struct {
  @Uint64() external int ullEventInterest;
  @Uint64() external int ullQueuedInterest;
  @Uint32() external int ulCount;
}

class SPAUDIOSTATUS extends Struct {
  @Int32() external int cbFreeBuffSpace;
  @Uint32() external int cbNonBlockingIO;
  @Uint32() external int State;
  @Uint64() external int CurSeekPos;
  @Uint64() external int CurDevicePos;
  @Uint32() external int dwAudioLevel;
  @Uint32() external int dwReserved2;
}

class SPAUDIOBUFFERINFO extends Struct {
  @Uint32() external int ulMsMinNotification;
  @Uint32() external int ulMsBufferSize;
  @Uint32() external int ulMsEventBias;
}

class SPPHRASEELEMENT extends Struct {
  @Uint32() external int ulAudioTimeOffset;
  @Uint32() external int ulAudioSizeTime;
  @Uint32() external int ulAudioStreamOffset;
  @Uint32() external int ulAudioSizeBytes;
  @Uint32() external int ulRetainedStreamOffset;
  @Uint32() external int ulRetainedSizeBytes;
  external Pointer<Utf16> pszDisplayText;
  external Pointer<Utf16> pszLexicalForm;
  external Pointer<Uint16> pszPronunciation;
  @Uint8() external int bDisplayAttributes;
  @Int8() external int RequiredConfidence;
  @Int8() external int ActualConfidence;
  @Uint8() external int Reserved;
  @Float() external double SREngineConfidence;
}

class SPPHRASERULE extends Struct {
  external Pointer<Utf16> pszName;
  @Uint32() external int ulId;
  @Uint32() external int ulFirstElement;
  @Uint32() external int ulCountOfElements;
  external Pointer<SPPHRASERULE> pNextSibling;
  external Pointer<SPPHRASERULE> pFirstChild;
  @Float() external double SREngineConfidence;
  @Int8() external int Confidence;
}
...
class SPSEMANTICERRORINFO extends Struct {
  @Uint32() external int ulLineNumber;
  external Pointer<Utf16> pszScriptLine;
  external Pointer<Utf16> pszSource;
  external Pointer<Utf16> pszDescription;
  @Int32() external int hrResultCode;
}

class SPPHRASE_50 extends Struct {
  @Uint32() external int cbSize;
  @Uint16() external int LangID;
  @Uint16() external int wHomophoneGroupId;
  @Uint64() external int ullGrammarID;
  @Uint64() external int ftStartTime;
  @Uint64() external int ullAudioStreamPosition;
  @Uint32() external int ulAudioSizeBytes;
  @Uint32() external int ulRetainedSizeBytes;
  @Uint32() external int ulAudioSizeTime;
  ...
  @Uint32() external int cReplacements;
  external Pointer<SPPHRASEREPLACEMENT> pReplacements;
  external GUID SREngineID;
  @Uint32() external int ulSREnginePrivateDataSize;
...
class SPWORDPRONUNCIATION extends Struct {
  ...
  @Uint32() external int eLexiconType;
  @Uint16() external int LangID;
...
class SPVPITCH extends Struct {
  @Int32() external int MiddleAdj;
  @Int32() external int RangeAdj;
}
...
class SPVSTATE extends Struct {
  ...
  @Uint16() external int LangID;
  @Uint16() external int wReserved;
  @Int32() external int EmphAdj;
  @Int32() external int RateAdj;
  @Uint32() external int Volume;
  external SPVPITCH PitchAdj;
  @Uint32() external int SilenceMSecs;
...
class SPVOICESTATUS extends Struct {
  @Uint32() external int ulCurrentStream;
  @Uint32() external int ulLastStreamQueued;
  @Int32() external int hrLastResult;
  @Uint32() external int dwRunningState;
  @Uint32() external int ulInputWordPos;
  @Uint32() external int ulInputWordLen;
  @Uint32() external int ulInputSentPos;
  @Uint32() external int ulInputSentLen;
  @Int32() external int lBookmarkId;
  @Uint16() external int PhonemeId;
  @Uint32() external int VisemeId;
...
class SPRECORESULTTIMES extends Struct {
  ...
  @Uint64() external int ullLength;
  @Uint32() external int dwTickCount;
  @Uint64() external int ullStart;
}
...
class SPTEXTSELECTIONINFO extends Struct {
  @Uint32() external int ulStartActiveOffset;
  @Uint32() external int cchActiveChars;
  @Uint32() external int ulStartSelection;
  @Uint32() external int cchSelection;
}
...
class SPRECOGNIZERSTATUS extends Struct {
  ...
  @Uint64() external int ullRecognitionStreamPos;
  @Uint32() external int ulStreamNumber;
...
class SPDISPLAYPHRASE extends Struct {
  @Uint32() external int ulNumTokens;
