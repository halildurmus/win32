...
class MCI_SYSINFO_PARMSA extends Struct {
  ...
  @Uint32() external int wDeviceType;
}
...
class MCI_WAVE_OPEN_PARMSA extends Struct {
  ...
  external Pointer<Utf8> lpstrElementName;
  external Pointer<Utf8> lpstrAlias;
  @Uint32() external int dwBufferSeconds;
}
...
class MCI_WAVE_SET_PARMS extends Struct {
  ...
  @Uint32() external int dwTimeFormat;
  @Uint32() external int dwAudio;
  @Uint32() external int wInput;
  @Uint32() external int wOutput;
  ...
  @Uint16() external int wReserved4;
  @Uint16() external int wBitsPerSample;
  @Uint16() external int wReserved5;
}
...
class MCI_SEQ_SET_PARMS extends Struct {
  ...
  @Uint32() external int dwSlave;
  @Uint32() external int dwMaster;
...
class KSPROPERTY_DESCRIPTION extends Struct {
  @Uint32() external int AccessFlags;
  @Uint32() external int DescriptionSize;
  external KSIDENTIFIER PropTypeSet;
  @Uint32() external int MembersListCount;
  @Uint32() external int Reserved;
}

class KSPROPERTY_MEMBERSHEADER extends Struct {
  @Uint32() external int MembersFlags;
  @Uint32() external int MembersSize;
  @Uint32() external int MembersCount;
...
class KSPROPERTY_STEPPING_LONGLONG extends Struct {
  @Uint64() external int SteppingDelta;
...
class KSEVENT_TIME_MARK extends Struct {
  ...
  @Int64() external int MarkTime;
}

class KSEVENT_TIME_INTERVAL extends Struct {
  external KSEVENTDATA EventData;
  @Int64() external int TimeBase;
  @Int64() external int Interval;
}
...
class KSPROPERTY_POSITIONS extends Struct {
  @Int64() external int Current;
  @Int64() external int Stop;
  @Uint32() external int CurrentFlags;
  @Uint32() external int StopFlags;
}

class KSPROPERTY_MEDIAAVAILABLE extends Struct {
  @Int64() external int Earliest;
  @Int64() external int Latest;
}
...
class KSTOPOLOGY extends Struct {
  @Uint32() external int CategoriesCount;
  external Pointer<GUID> Categories;
  @Uint32() external int TopologyNodesCount;
  external Pointer<GUID> TopologyNodes;
  @Uint32() external int TopologyConnectionsCount;
...
class KSNODE_CREATE extends Struct {
  @Uint32() external int CreateFlags;
  @Uint32() external int Node;
}
...
class KSPIN_CONNECT extends Struct {
  ...
  @Uint32() external int PinId;
  @IntPtr() external int PinToHandle;
...
class KS_FRAMING_RANGE extends Struct {
  ...
  @Uint32() external int Stepping;
}

class KS_FRAMING_RANGE_WEIGHTED extends Struct {
  external KS_FRAMING_RANGE Range;
  @Uint32() external int InPlaceWeight;
  @Uint32() external int NotInPlaceWeight;
}
...
class KSALLOCATOR_FRAMING_EX extends Struct {
  @Uint32() external int CountItems;
...
class KSSTREAMALLOCATOR_STATUS extends Struct {
  ...
  @Uint32() external int AllocatedFrames;
  @Uint32() external int Reserved;
}
...
class KSSTREAM_HEADER extends Struct {
  @Uint32() external int Size;
  @Uint32() external int TypeSpecificFlags;
  external KSTIME PresentationTime;
  @Int64() external int Duration;
  @Uint32() external int FrameExtent;
...
class KSQUALITY_MANAGER extends Struct {
  @IntPtr() external int QualityManager;
  external Pointer Context;
}

class KSFRAMETIME extends Struct {
  @Int64() external int Duration;
  @Uint32() external int FrameFlags;
  @Uint32() external int Reserved;
}

class KSRATE extends Struct {
  @Int64() external int PresentationStart;
  @Int64() external int Duration;
  external KSIDENTIFIER Interface;
...
class KSRESOLUTION extends Struct {
  @Int64() external int Granularity;
  @Int64() external int Error;
}
...
class KSQUALITY extends Struct {
  external Pointer Context;
  @Uint32() external int Proportion;
  @Int64() external int DeltaTime;
}
...
class WAVEFORMATEXTENSIBLE_IEC61937 extends Struct {
  ...
  @Uint32() external int dwEncodedSamplesPerSec;
  @Uint32() external int dwEncodedChannelCount;
  @Uint32() external int dwAverageBytesPerSec;
}
...
class KSAUDIO_POSITION extends Struct {
  @Uint64() external int PlayOffset;
  @Uint64() external int WriteOffset;
}

class KSAUDIO_PRESENTATION_POSITION extends Struct {
  @Uint64() external int u64PositionInBlocks;
  @Uint64() external int u64QPCPosition;
}

class _KSAUDIO_PACKETSIZE_SIGNALPROCESSINGMODE_CONSTRAINT extends Struct {
  external GUID ProcessingMode;
  @Uint32() external int SamplesPerProcessingPacket;
  @Uint32() external int ProcessingPacketDurationInHns;
}

class KSAUDIO_PACKETSIZE_CONSTRAINTS extends Struct {
  @Uint32() external int MinPacketPeriodInHns;
...
class KSAUDIO_MICROPHONE_COORDINATES extends Struct {
  @Uint16() external int usType;
  @Int16() external int wXCoord;
  @Int16() external int wYCoord;
  @Int16() external int wZCoord;
  @Int16() external int wVerticalAngle;
  @Int16() external int wHorizontalAngle;
}

class KSAUDIO_MIC_ARRAY_GEOMETRY extends Struct {
  @Uint16() external int usVersion;
  @Uint16() external int usMicArrayType;
  @Int16() external int wVerticalAngleBegin;
  @Int16() external int wVerticalAngleEnd;
  @Int16() external int wHorizontalAngleBegin;
  @Int16() external int wHorizontalAngleEnd;
...
class KSDS3D_LISTENER_ALL extends Struct {
  ...
  @Float() external double DistanceFactor;
  @Float() external double RolloffFactor;
  @Float() external double DopplerFactor;
}
...
class KSDS3D_BUFFER_ALL extends Struct {
  external DS3DVECTOR Position;
  external DS3DVECTOR Velocity;
  @Uint32() external int InsideConeAngle;
  @Uint32() external int OutsideConeAngle;
  external DS3DVECTOR ConeOrientation;
  @Int32() external int ConeOutsideVolume;
  @Float() external double MinDistance;
  @Float() external double MaxDistance;
...
class KSDS3D_HRTF_PARAMS_MSG extends Struct {
  @Uint32() external int Size;
  @Uint32() external int Enabled;
  @Int32() external int SwapChannels;
  @Int32() external int ZeroAzimuth;
  @Int32() external int CrossFadeOutput;
  @Uint32() external int FilterSize;
}

class KSDS3D_HRTF_INIT_MSG extends Struct {
  @Uint32() external int Size;
  @Uint32() external int Quality;
  @Float() external double SampleRate;
  @Uint32() external int MaxFilterSize;
  @Uint32() external int FilterTransientMuteLength;
  @Uint32() external int FilterOverlapBufferLength;
  @Uint32() external int OutputOverlapBufferLength;
  @Uint32() external int Reserved;
}

class KSDS3D_HRTF_FILTER_FORMAT_MSG extends Struct {
  @Uint32() external int FilterMethod;
  @Uint32() external int CoeffFormat;
  @Uint32() external int Version;
  @Uint32() external int Reserved;
}
...
class KSDS3D_ITD_PARAMS extends Struct {
  @Int32() external int Channel;
  @Float() external double VolSmoothScale;
  @Float() external double TotalDryAttenuation;
  @Float() external double TotalWetAttenuation;
  @Int32() external int SmoothFrequency;
  @Int32() external int Delay;
}
...
class KSRTAUDIO_BUFFER_PROPERTY extends Struct {
  ...
  @Uint32() external int RequestedBufferSize;
}
...
class KSRTAUDIO_BUFFER_PROPERTY_WITH_NOTIFICATION extends Struct {
  ...
  external Pointer BaseAddress;
  @Uint32() external int RequestedBufferSize;
  @Uint32() external int NotificationCount;
}
...
class KSRTAUDIO_BUFFER extends Struct {
  ...
  @Uint32() external int ActualBufferSize;
  @Int32() external int CallMemoryBarrier;
}

class KSRTAUDIO_BUFFER32 extends Struct {
  @Uint32() external int BufferAddress;
  @Uint32() external int ActualBufferSize;
  @Int32() external int CallMemoryBarrier;
}

class KSRTAUDIO_HWLATENCY extends Struct {
  @Uint32() external int FifoSize;
  @Uint32() external int ChipsetDelay;
  @Uint32() external int CodecDelay;
}
...
class KSRTAUDIO_HWREGISTER extends Struct {
  ...
  @Uint64() external int Numerator;
  @Uint64() external int Denominator;
  @Uint32() external int Accuracy;
}
...
class KSRTAUDIO_NOTIFICATION_EVENT_PROPERTY extends Struct {
  external KSIDENTIFIER Property;
  @IntPtr() external int NotificationEvent;
}

class KSRTAUDIO_NOTIFICATION_EVENT_PROPERTY32 extends Struct {
  external KSIDENTIFIER Property;
  @Uint32() external int NotificationEvent;
}

class KSRTAUDIO_GETREADPACKET_INFO extends Struct {
  @Uint32() external int PacketNumber;
  @Uint32() external int Flags;
  @Uint64() external int PerformanceCounterValue;
  @Int32() external int MoreData;
}

class KSRTAUDIO_SETWRITEPACKET_INFO extends Struct {
  @Uint32() external int PacketNumber;
  @Uint32() external int Flags;
  @Uint32() external int EosPacketLength;
}
...
class INTERLEAVED_AUDIO_FORMAT_INFORMATION extends Struct {
  @Uint32() external int Size;
  @Uint32() external int PrimaryChannelCount;
  @Uint32() external int PrimaryChannelStartPosition;
  @Uint32() external int PrimaryChannelMask;
  @Uint32() external int InterleavedChannelCount;
  @Uint32() external int InterleavedChannelStartPosition;
  @Uint32() external int InterleavedChannelMask;
}
...
class KSAUDIO_COPY_PROTECTION extends Struct {
  @Int32() external int fCopyrighted;
  @Int32() external int fOriginal;
}

class KSAUDIO_CHANNEL_CONFIG extends Struct {
  @Int32() external int ActiveSpeakerPositions;
}

class KSAUDIO_DYNAMIC_RANGE extends Struct {
  @Uint32() external int QuietCompression;
  @Uint32() external int LoudCompression;
}
...
class KSAUDIO_POSITIONEX extends Struct {
  @Int64() external int TimerFrequency;
  @Int64() external int TimeStamp1;
  external KSAUDIO_POSITION Position;
  @Int64() external int TimeStamp2;
}
...
class KSTELEPHONY_CALLCONTROL extends Struct {
  @Uint32() external int CallType;
  @Uint32() external int CallControlOp;
}

class KSTELEPHONY_PROVIDERCHANGE extends Struct {
  @Uint32() external int CallType;
  @Uint32() external int ProviderChangeOp;
}

class KSTELEPHONY_CALLINFO extends Struct {
  @Uint32() external int CallType;
  @Uint32() external int CallState;
}
...
class KSWAVETABLE_WAVE_DESC extends Struct {
  ...
  @Uint32() external int Size;
  @Int32() external int Looped;
  @Uint32() external int LoopPoint;
  @Int32() external int InROM;
...
class KSWAVE_COMPATCAPS extends Struct {
  @Uint32() external int ulDeviceType;
}

class KSWAVE_INPUT_CAPABILITIES extends Struct {
  @Uint32() external int MaximumChannelsPerConnection;
  @Uint32() external int MinimumBitsPerSample;
  @Uint32() external int MaximumBitsPerSample;
  @Uint32() external int MinimumSampleFrequency;
  @Uint32() external int MaximumSampleFrequency;
  @Uint32() external int TotalConnections;
  @Uint32() external int ActiveConnections;
}
...
class KSWAVE_OUTPUT_CAPABILITIES extends Struct {
  ...
  @Uint32() external int MaximumSampleFrequency;
  @Uint32() external int TotalConnections;
  @Uint32() external int StaticConnections;
  @Uint32() external int StreamingConnections;
  @Uint32() external int ActiveConnections;
  @Uint32() external int ActiveStaticConnections;
  @Uint32() external int ActiveStreamingConnections;
  @Uint32() external int Total3DConnections;
  @Uint32() external int Static3DConnections;
  @Uint32() external int Streaming3DConnections;
  @Uint32() external int Active3DConnections;
  @Uint32() external int ActiveStatic3DConnections;
  @Uint32() external int ActiveStreaming3DConnections;
  @Uint32() external int TotalSampleMemory;
  @Uint32() external int FreeSampleMemory;
  @Uint32() external int LargestFreeContiguousSampleMemory;
}

class KSWAVE_VOLUME extends Struct {
  @Int32() external int LeftAttenuation;
  @Int32() external int RightAttenuation;
}
...
class KSDATARANGE_MUSIC extends Struct {
  ...
  @Uint32() external int Channels;
  @Uint32() external int Notes;
...
class KSNODEPROPERTY_AUDIO_DEV_SPECIFIC extends Struct {
  external KSNODEPROPERTY NodeProperty;
  @Uint32() external int DevSpecificId;
  @Uint32() external int DeviceInfo;
...
class KSMUSICFORMAT extends Struct {
  @Uint32() external int TimeDeltaMs;
...
class KSMPEGVID_RECT extends Struct {
  @Uint32() external int StartX;
  @Uint32() external int StartY;
  @Uint32() external int EndX;
  @Uint32() external int EndY;
}
...
class KS_COLCON extends Struct {
  ...
  @Uint8() external int _bitfield3;
  @Uint8() external int _bitfield4;
}
...
class KS_RGBQUAD extends Struct {
  ...
  @Uint8() external int rgbReserved;
}
...
class KS_VBIINFOHEADER extends Struct {
  ...
  @Uint32() external int SamplingFrequency;
  @Uint32() external int MinLineStartTime;
  @Uint32() external int MaxLineStartTime;
  @Uint32() external int ActualLineStartTime;
  @Uint32() external int ActualLineEndTime;
  @Uint32() external int VideoStandard;
  @Uint32() external int SamplesPerLine;
...
class KS_H264VIDEOINFO extends Struct {
  ...
  @Uint16() external int wSARwidth;
  @Uint16() external int wSARheight;
  @Uint16() external int wProfile;
  @Uint8() external int bLevelIDC;
  @Uint16() external int wConstrainedToolset;
  @Uint32() external int bmSupportedUsages;
  @Uint16() external int bmCapabilities;
  @Uint32() external int bmSVCCapabilities;
  @Uint32() external int bmMVCCapabilities;
  @Uint32() external int dwFrameInterval;
  @Uint8() external int bMaxCodecConfigDelay;
  @Uint8() external int bmSupportedSliceModes;
  @Uint8() external int bmSupportedSyncFrameTypes;
  @Uint8() external int bResolutionScaling;
  @Uint8() external int bSimulcastSupport;
  @Uint8() external int bmSupportedRateControlModes;
  @Uint16() external int wMaxMBperSecOneResolutionNoScalability;
  @Uint16() external int wMaxMBperSecTwoResolutionsNoScalability;
  @Uint16() external int wMaxMBperSecThreeResolutionsNoScalability;
  @Uint16() external int wMaxMBperSecFourResolutionsNoScalability;
  @Uint16() external int wMaxMBperSecOneResolutionTemporalScalability;
  @Uint16() external int wMaxMBperSecTwoResolutionsTemporalScalablility;
  @Uint16() external int wMaxMBperSecThreeResolutionsTemporalScalability;
  @Uint16() external int wMaxMBperSecFourResolutionsTemporalScalability;
  @Uint16() external int wMaxMBperSecOneResolutionTemporalQualityScalability;
  @Uint16() external int wMaxMBperSecTwoResolutionsTemporalQualityScalability;
  @Uint16() external int wMaxMBperSecThreeResolutionsTemporalQualityScalablity;
  @Uint16() external int wMaxMBperSecFourResolutionsTemporalQualityScalability;
  @Uint16() external int wMaxMBperSecOneResolutionTemporalSpatialScalability;
  @Uint16() external int wMaxMBperSecTwoResolutionsTemporalSpatialScalability;
  @Uint16() external int wMaxMBperSecThreeResolutionsTemporalSpatialScalablity;
  @Uint16() external int wMaxMBperSecFourResolutionsTemporalSpatialScalability;
  @Uint16() external int wMaxMBperSecOneResolutionFullScalability;
  @Uint16() external int wMaxMBperSecTwoResolutionsFullScalability;
  @Uint16() external int wMaxMBperSecThreeResolutionsFullScalability;
  @Uint16() external int wMaxMBperSecFourResolutionsFullScalability;
}
...
class KS_DATARANGE_VIDEO extends Struct {
  ...
  @Uint32() external int StreamDescriptionFlags;
  @Uint32() external int MemoryAllocationFlags;
...
class VBICAP_PROPERTIES_PROTECTION_S extends Struct {
  external KSIDENTIFIER Property;
  @Uint32() external int StreamIndex;
  @Uint32() external int Status;
}
...
class VBICODECFILTERING_CC_SUBSTREAMS extends Struct {
  @Uint32() external int SubstreamMask;
}
...
class VBICODECFILTERING_STATISTICS_COMMON extends Struct {
  @Uint32() external int InputSRBsProcessed;
  @Uint32() external int OutputSRBsProcessed;
  @Uint32() external int SRBsIgnored;
  @Uint32() external int InputSRBsMissing;
  @Uint32() external int OutputSRBsMissing;
  @Uint32() external int OutputFailures;
  @Uint32() external int InternalErrors;
  @Uint32() external int ExternalErrors;
  @Uint32() external int InputDiscontinuities;
  @Uint32() external int DSPFailures;
  @Uint32() external int TvTunerChanges;
  @Uint32() external int VBIHeaderChanges;
  @Uint32() external int LineConfidenceAvg;
  @Uint32() external int BytesOutput;
}

class VBICODECFILTERING_STATISTICS_COMMON_PIN extends Struct {
  @Uint32() external int SRBsProcessed;
  @Uint32() external int SRBsIgnored;
  @Uint32() external int SRBsMissing;
  @Uint32() external int InternalErrors;
  @Uint32() external int ExternalErrors;
  @Uint32() external int Discontinuities;
  @Uint32() external int LineConfidenceAvg;
  @Uint32() external int BytesOutput;
}
...
class VBICODECFILTERING_STATISTICS_NABTS extends Struct {
  ...
  @Uint32() external int FECBundleBadLines;
  @Uint32() external int FECQueueOverflows;
  @Uint32() external int FECCorrectedLines;
  @Uint32() external int FECUncorrectableLines;
  @Uint32() external int BundlesProcessed;
  @Uint32() external int BundlesSent2IP;
  @Uint32() external int FilteredLines;
}
...
class VRAM_SURFACE_INFO extends Struct {
  @IntPtr() external int hSurface;
  @Int64() external int VramPhysicalAddress;
...
class KS_VBI_FRAME_INFO extends Struct {
  ...
  @Uint32() external int dwSamplingFrequency;
...
class KSPROPERTY_ALLOCATOR_CONTROL_CAPTURE_CAPS_S extends Struct {
  @Uint32() external int InterleavedCapSupported;
}

class KSPROPERTY_ALLOCATOR_CONTROL_CAPTURE_INTERLEAVE_S extends Struct {
  @Uint32() external int InterleavedCapPossible;
}
...
class KSPROPERTY_VIDEOPROCAMP_S2 extends Struct {
  external KSIDENTIFIER Property;
  @Int32() external int Value1;
  @Uint32() external int Flags;
  @Uint32() external int Capabilities;
  @Int32() external int Value2;
}
...
class KSPROPERTY_TUNER_CAPS_S extends Struct {
  external KSIDENTIFIER Property;
  @Uint32() external int ModesSupported;
...
class KSPROPERTY_TUNER_MODE_CAPS_S extends Struct {
  external KSIDENTIFIER Property;
  @Uint32() external int Mode;
  @Uint32() external int StandardsSupported;
  @Uint32() external int MinFrequency;
  @Uint32() external int MaxFrequency;
  @Uint32() external int TuningGranularity;
  @Uint32() external int NumberOfInputs;
...
class KSPROPERTY_TUNER_FREQUENCY_S extends Struct {
  ...
  @Uint32() external int LastFrequency;
  @Uint32() external int TuningFlags;
  @Uint32() external int VideoSubChannel;
  @Uint32() external int AudioSubChannel;
  @Uint32() external int Channel;
  @Uint32() external int Country;
}

class KSPROPERTY_TUNER_STANDARD_S extends Struct {
  external KSIDENTIFIER Property;
  @Uint32() external int Standard;
}
...
class KSPROPERTY_TUNER_STATUS_S extends Struct {
  ...
  @Uint32() external int PLLOffset;
  @Uint32() external int SignalStrength;
  @Uint32() external int Busy;
}
...
class TUNER_ANALOG_CAPS_S extends Struct {
  ...
  @Uint32() external int TuningGranularity;
  @Uint32() external int SettlingTime;
  @Uint32() external int ScanSensingRange;
  @Uint32() external int FineTuneSensingRange;
}
...
class KSPROPERTY_TUNER_SCAN_CAPS_S extends Struct {
  external KSIDENTIFIER Property;
  @Int32() external int fSupportsHardwareAssistedScanning;
  @Uint32() external int SupportedBroadcastStandards;
  external Pointer GUIDBucket;
  @Uint32() external int lengthofBucket;
}
...
class KSPROPERTY_TUNER_SCAN_STATUS_S extends Struct {
  external KSIDENTIFIER Property;
  @Uint32() external int LockStatus;
  @Uint32() external int CurrentFrequency;
}
...
class KSPROPERTY_VIDEODECODER_CAPS_S extends Struct {
  ...
  @Uint32() external int Capabilities;
  @Uint32() external int SettlingTime;
  @Uint32() external int HSyncPerVSync;
}

class KSPROPERTY_VIDEODECODER_STATUS_S extends Struct {
  external KSIDENTIFIER Property;
  @Uint32() external int NumberOfLines;
  @Uint32() external int SignalLocked;
}
...
class KSPROPERTY_VIDEODECODER_STATUS2_S extends Struct {
  ...
  @Uint32() external int NumberOfLines;
  @Uint32() external int SignalLocked;
  @Uint32() external int ChromaLock;
}
...
class KSPROPERTY_CAMERACONTROL_FOCAL_LENGTH_S extends Struct {
  external KSIDENTIFIER Property;
  @Int32() external int lOcularFocalLength;
  @Int32() external int lObjectiveFocalLengthMin;
  @Int32() external int lObjectiveFocalLengthMax;
}
...
class KSPROPERTY_CAMERACONTROL_VIDEOSTABILIZATION_MODE_S extends Struct {
  @Uint32() external int VideoStabilizationMode;
  @Uint32() external int Capabilities;
}
...
class KSCAMERA_MAXVIDEOFPS_FORPHOTORES extends Struct {
  ...
  @Uint32() external int PreviewFPSNum;
  @Uint32() external int PreviewFPSDenom;
  @Uint32() external int CaptureFPSNum;
  @Uint32() external int CaptureFPSDenom;
}

class KSCAMERA_EXTENDEDPROP_PHOTOMODE extends Struct {
  @Uint32() external int RequestedHistoryFrames;
  @Uint32() external int MaxHistoryFrames;
  @Uint32() external int SubMode;
  @Uint32() external int Reserved;
}
...
class KSCAMERA_EXTENDEDPROP_FIELDOFVIEW extends Struct {
  @Uint32() external int NormalizedFocalLengthX;
  @Uint32() external int NormalizedFocalLengthY;
  @Uint32() external int Flag;
  @Uint32() external int Reserved;
}

class KSCAMERA_EXTENDEDPROP_CAMERAOFFSET extends Struct {
  @Int32() external int PitchAngle;
  @Int32() external int YawAngle;
  @Uint32() external int Flag;
  @Uint32() external int Reserved;
}

class KSCAMERA_EXTENDEDPROP_METADATAINFO extends Struct {
  @Int32() external int BufferAlignment;
  @Uint32() external int MaxMetadataBufferSize;
}

class KSCAMERA_METADATA_ITEMHEADER extends Struct {
  @Uint32() external int MetadataId;
  @Uint32() external int Size;
}

class KSCAMERA_METADATA_PHOTOCONFIRMATION extends Struct {
  external KSCAMERA_METADATA_ITEMHEADER Header;
  @Uint32() external int PhotoConfirmationIndex;
  @Uint32() external int Reserved;
}
...
class KSCAMERA_METADATA_CAPTURESTATS extends Struct {
  ...
  @Uint32() external int Flags;
  @Uint32() external int Reserved;
  @Uint64() external int ExposureTime;
  @Uint64() external int ExposureCompensationFlags;
  @Int32() external int ExposureCompensationValue;
  @Uint32() external int IsoSpeed;
  @Uint32() external int FocusState;
  @Uint32() external int LensPosition;
  @Uint32() external int WhiteBalance;
  @Uint32() external int Flash;
  @Uint32() external int FlashPower;
  @Uint32() external int ZoomFactor;
  @Uint64() external int SceneMode;
  @Uint64() external int SensorFramerate;
}

class KSCAMERA_EXTENDEDPROP_ROI_CONFIGCAPSHEADER extends Struct {
  @Uint32() external int Size;
  @Uint32() external int ConfigCapCount;
  @Uint64() external int Reserved;
}

class KSCAMERA_EXTENDEDPROP_ROI_CONFIGCAPS extends Struct {
  @Uint32() external int ControlId;
  @Uint32() external int MaxNumberOfROIs;
  @Uint64() external int Capability;
}

class KSCAMERA_EXTENDEDPROP_ROI_ISPCONTROLHEADER extends Struct {
  @Uint32() external int Size;
  @Uint32() external int ControlCount;
  @Uint64() external int Reserved;
}

class KSCAMERA_EXTENDEDPROP_ROI_ISPCONTROL extends Struct {
  @Uint32() external int ControlId;
  @Uint32() external int ROICount;
  @Uint32() external int Result;
  @Uint32() external int Reserved;
}
...
class KSCAMERA_EXTENDEDPROP_ROI_INFO extends Struct {
  ...
  @Uint64() external int Flags;
  @Int32() external int Weight;
  @Int32() external int RegionOfInterestType;
}
...
class WNF_KSCAMERA_STREAMSTATE_INFO extends Struct {
  ...
  @Uint32() external int StreamState;
  @Uint32() external int Reserved;
}
...
class DEVCAPS extends Struct {
  @Int32() external int CanRecord;
  @Int32() external int CanRecordStrobe;
  @Int32() external int HasAudio;
  @Int32() external int HasVideo;
  @Int32() external int UsesFiles;
  @Int32() external int CanSave;
  @Int32() external int DeviceType;
  @Int32() external int TCRead;
  @Int32() external int TCWrite;
  @Int32() external int CTLRead;
  @Int32() external int IndexRead;
  @Int32() external int Preroll;
  @Int32() external int Postroll;
  @Int32() external int SyncAcc;
  @Int32() external int NormRate;
  @Int32() external int CanPreview;
  @Int32() external int CanMonitorSrc;
  @Int32() external int CanTest;
  @Int32() external int VideoIn;
  @Int32() external int AudioIn;
...
class TRANSPORTSTATUS extends Struct {
  @Int32() external int Mode;
  @Int32() external int LastError;
  @Int32() external int RecordInhibit;
  @Int32() external int ServoLock;
  @Int32() external int MediaPresent;
  @Int32() external int MediaLength;
  @Int32() external int MediaSize;
  @Int32() external int MediaTrackCount;
  @Int32() external int MediaTrackLength;
  @Int32() external int MediaTrackSide;
  @Int32() external int MediaType;
  @Int32() external int LinkMode;
  @Int32() external int NotifyOn;
}

class TRANSPORTBASICPARMS extends Struct {
  @Int32() external int TimeFormat;
  @Int32() external int TimeReference;
  @Int32() external int Superimpose;
  @Int32() external int EndStopAction;
  @Int32() external int RecordFormat;
  @Int32() external int StepFrames;
  @Int32() external int SetpField;
  @Int32() external int Preroll;
  @Int32() external int RecPreroll;
  @Int32() external int Postroll;
  @Int32() external int EditDelay;
  @Int32() external int PlayTCDelay;
  @Int32() external int RecTCDelay;
  @Int32() external int EditField;
  @Int32() external int FrameServo;
  @Int32() external int ColorFrameServo;
  ...
  @Int32() external int TunerNumber;
  @Int32() external int TimerEvent;
  @Int32() external int TimerStartDay;
  @Int32() external int TimerStartTime;
  @Int32() external int TimerStopDay;
  @Int32() external int TimerStopTime;
}

class TRANSPORTVIDEOPARMS extends Struct {
  @Int32() external int OutputMode;
  @Int32() external int Input;
}

class TRANSPORTAUDIOPARMS extends Struct {
  @Int32() external int EnableOutput;
  @Int32() external int EnableRecord;
  @Int32() external int EnableSelsync;
  @Int32() external int Input;
  @Int32() external int MonitorSource;
}
...
class KSPROPERTY_CROSSBAR_CAPS_S extends Struct {
  external KSIDENTIFIER Property;
  @Uint32() external int NumberOfInputs;
  @Uint32() external int NumberOfOutputs;
}
...
class KSPROPERTY_CROSSBAR_PININFO_S extends Struct {
  ...
  @Uint32() external int RelatedPinIndex;
  external KSIDENTIFIER Medium;
}

class KSPROPERTY_CROSSBAR_ROUTE_S extends Struct {
  external KSIDENTIFIER Property;
  @Uint32() external int IndexInputPin;
  @Uint32() external int IndexOutputPin;
  @Uint32() external int CanRoute;
}

class KSPROPERTY_CROSSBAR_ACTIVE_S extends Struct {
  external KSIDENTIFIER Property;
  @Uint32() external int IndexInputPin;
  @Uint32() external int Active;
}
...
class KSPROPERTY_VIDEOCOMPRESSION_GETINFO_S extends Struct {
  external KSIDENTIFIER Property;
  @Uint32() external int StreamIndex;
  @Int32() external int DefaultKeyFrameRate;
  @Int32() external int DefaultPFrameRate;
  @Int32() external int DefaultQuality;
  @Int32() external int NumberOfQualitySettings;
  @Int32() external int Capabilities;
}
...
class KSPROPERTY_VIDEOCONTROL_CAPS_S extends Struct {
  external KSIDENTIFIER Property;
  @Uint32() external int StreamIndex;
  @Uint32() external int VideoControlCaps;
}
...
class KSPROPERTY_VIDEOCONTROL_ACTUAL_FRAME_RATE_S extends Struct {
  external KSIDENTIFIER Property;
  @Uint32() external int StreamIndex;
  @Uint32() external int RangeIndex;
  external SIZE Dimensions;
  @Int64() external int CurrentActualFrameRate;
  @Int64() external int CurrentMaxAvailableFrameRate;
}
...
class KSPROPERTY_DROPPEDFRAMES_CURRENT_S extends Struct {
  ...
  @Int64() external int PictureNumber;
  @Int64() external int DropCount;
  @Uint32() external int AverageFrameSize;
}
...
class DDVIDEOPORTCONNECT extends Struct {
  ...
  @Uint32() external int dwPortWidth;
...
class KSVPMAXPIXELRATE extends Struct {
  ...
  @Uint32() external int MaxPixelsPerSecond;
  @Uint32() external int Reserved;
}
...
class KSVPSURFACEPARAMS extends Struct {
  @Uint32() external int dwPitch;
  @Uint32() external int dwXOrigin;
  @Uint32() external int dwYOrigin;
}
...
class KSJACK_DESCRIPTION extends Struct {
  @Uint32() external int ChannelMapping;
  @Uint32() external int Color;
  @Uint32() external int ConnectionType;
  @Uint32() external int GeoLocation;
  @Uint32() external int GenLocation;
  @Uint32() external int PortConnection;
  @Int32() external int IsConnected;
}

class KSJACK_SINK_INFORMATION extends Struct {
  @Uint32() external int ConnType;
  @Uint16() external int ManufacturerId;
  @Uint16() external int ProductId;
  @Uint16() external int AudioLatency;
...
class KSJACK_DESCRIPTION2 extends Struct {
  @Uint32() external int DeviceStateInfo;
  @Uint32() external int JackCapabilities;
}
...
class KSAUDIOENGINE_DESCRIPTOR extends Struct {
  @Uint32() external int nHostPinId;
  @Uint32() external int nOffloadPinId;
  @Uint32() external int nLoopbackPinId;
}

class KSAUDIOENGINE_BUFFER_SIZE_RANGE extends Struct {
  @Uint32() external int MinBufferBytes;
  @Uint32() external int MaxBufferBytes;
}

class KSAUDIOENGINE_VOLUMELEVEL extends Struct {
  @Int32() external int TargetVolume;
  @Uint32() external int CurveType;
  @Uint64() external int CurveDuration;
}
...
class AudioClientProperties extends Struct {
  @Uint32() external int cbSize;
  @Int32() external int bIsOffload;
  @Uint32() external int eCategory;
...
class AMBISONICS_PARAMS extends Struct {
  @Uint32() external int u32Size;
  @Uint32() external int u32Version;
  @Uint32() external int u32Type;
  @Uint32() external int u32ChannelOrdering;
  @Uint32() external int u32Normalization;
  @Uint32() external int u32Order;
  @Uint32() external int u32NumChannels;
...
class SpatialAudioObjectRenderStreamActivationParams extends Struct {
  ...
  @Uint32() external int StaticObjectTypeMask;
  @Uint32() external int MinDynamicObjectCount;
  @Uint32() external int MaxDynamicObjectCount;
...
class SpatialAudioClientActivationParams extends Struct {
  external GUID tracingContextId;
  external GUID appId;
  @Int32() external int majorVersion;
  @Int32() external int minorVersion1;
  @Int32() external int minorVersion2;
  @Int32() external int minorVersion3;
}
...
class DIRECTX_AUDIO_ACTIVATION_PARAMS extends Struct {
  @Uint32() external int cbDirectXAudioActivationParams;
  external GUID guidAudioSession;
  @Uint32() external int dwAudioStreamFlags;
}

class AudioExtensionParams extends Struct {
  @IntPtr() external int AddPageParam;
...
class AUDIO_ENDPOINT_SHARED_CREATE_PARAMS extends Struct {
  @Uint32() external int u32Size;
  @Uint32() external int u32TSSessionId;
  @Uint32() external int targetEndpointConnectorType;
...
class SpatialAudioMetadataItemsInfo extends Struct {
  @Uint16() external int FrameCount;
  @Uint16() external int ItemCount;
  @Uint16() external int MaxItemCount;
  @Uint32() external int MaxValueBufferLength;
}
...
class SpatialAudioObjectRenderStreamForMetadataActivationParams extends Struct {
  ...
  @Uint16() external int MaxMetadataItemCount;
