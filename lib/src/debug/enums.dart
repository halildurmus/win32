...
class PROFILER_HEAP_OBJECT_OPTIONAL_INFO_TYPE {
  ...
  static const PROFILER_HEAP_OBJECT_OPTIONAL_INFO_INTERNAL_PROPERTY = 0x00000004;
  ...
  static const PROFILER_HEAP_OBJECT_OPTIONAL_INFO_ELEMENT_ATTRIBUTES_SIZE = 0x00000007;
  static const PROFILER_HEAP_OBJECT_OPTIONAL_INFO_ELEMENT_TEXT_CHILDREN_SIZE = 0x00000008;
  ...
  static const PROFILER_HEAP_OBJECT_OPTIONAL_INFO_WEAKMAP_COLLECTION_LIST = 0x0000000b;
  static const PROFILER_HEAP_OBJECT_OPTIONAL_INFO_MAP_COLLECTION_LIST = 0x0000000c;
  static const PROFILER_HEAP_OBJECT_OPTIONAL_INFO_SET_COLLECTION_LIST = 0x0000000d;
...
class PROFILER_HEAP_OBJECT_RELATIONSHIP_FLAGS {
  ...
  static const PROFILER_HEAP_OBJECT_RELATIONSHIP_FLAGS_IS_GET_ACCESSOR = 0x00010000;
  static const PROFILER_HEAP_OBJECT_RELATIONSHIP_FLAGS_IS_SET_ACCESSOR = 0x00020000;
  static const PROFILER_HEAP_OBJECT_RELATIONSHIP_FLAGS_LET_VARIABLE = 0x00040000;
  static const PROFILER_HEAP_OBJECT_RELATIONSHIP_FLAGS_CONST_VARIABLE = 0x00080000;
}
...
/// {@category Enum}
class SetThreadErrorMode_dwNewModeFlags {
...
/// {@category Enum}
class RtlVirtualUnwind_HandlerTypeFlags {
...
/// {@category Enum}
class ImageGetDigestStream_DigestLevelFlags {
  static const CERT_PE_IMAGE_DIGEST_ALL_IMPORT_INFO = 0x00000004;
  static const CERT_PE_IMAGE_DIGEST_DEBUG_INFO = 0x00000001;
  static const CERT_PE_IMAGE_DIGEST_RESOURCES = 0x00000002;
}

/// {@category Enum}
class OpenThreadWaitChainSession_Flags {
  static const WCT_ASYNC_OPEN_FLAG = 0x00000001;
}

/// {@category Enum}
class SymSrvStoreFile_Flags {
...
/// {@category Enum}
class SetUnhandledExceptionFilter_lpTopLevelExceptionFilterFlags {
  static const EXCEPTION_EXECUTE_HANDLER = 0x00000001;
  static const EXCEPTION_CONTINUE_EXECUTION = 0xffffffff;
  static const EXCEPTION_CONTINUE_SEARCH = 0x00000000;
}

/// {@category Enum}
class SymGetHomeDirectory_type {
...
/// {@category Enum}
class SplitSymbols_Flags {
  static const SPLITSYM_EXTRACT_ALL = 0x00000002;
  static const SPLITSYM_REMOVE_PRIVATE = 0x00000001;
  static const SPLITSYM_SYMBOLPATH_IS_SRC = 0x00000004;
}

/// {@category Enum}
class SymLoadModuleEx_Flags {
  static const SLMFLAG_NO_SYMBOLS = 0x00000004;
  static const SLMFLAG_VIRTUAL = 0x00000001;
}

/// {@category Enum}
class GetThreadWaitChain_Flags {
...
/// {@category Enum}
class BindImageEx_Flags {
  static const BIND_ALL_IMAGES = 0x00000004;
  static const BIND_CACHE_IMPORT_DLLS = 0x00000008;
  static const BIND_NO_BOUND_IMPORTS = 0x00000001;
  static const BIND_NO_UPDATE = 0x00000002;
}

/// {@category Enum}
class IMAGE_OPTIONAL_HEADER64_Magic {
...
/// {@category Enum}
class IMAGE_FILE_HEADER_CharacteristicsFlags {
...
/// {@category Enum}
class MINIDUMP_SYSTEM_INFO_SuiteMaskFlags {
  static const VER_SUITE_BACKOFFICE = 0x00000004;
  static const VER_SUITE_BLADE = 0x00000400;
  static const VER_SUITE_COMPUTE_SERVER = 0x00004000;
  static const VER_SUITE_DATACENTER = 0x00000080;
  static const VER_SUITE_ENTERPRISE = 0x00000002;
  static const VER_SUITE_EMBEDDEDNT = 0x00000040;
  static const VER_SUITE_PERSONAL = 0x00000200;
  static const VER_SUITE_SINGLEUSERTS = 0x00000100;
  static const VER_SUITE_SMALLBUSINESS = 0x00000001;
  static const VER_SUITE_SMALLBUSINESS_RESTRICTED = 0x00000020;
  static const VER_SUITE_STORAGE_SERVER = 0x00002000;
  static const VER_SUITE_TERMINAL = 0x00000010;
}
...
/// {@category Enum}
class MINIDUMP_SYSTEM_INFO_PlatformIdFlags {
...
/// {@category Enum}
class IMAGE_DEBUG_DIRECTORY_TypeFlags {
...
/// {@category Enum}
class MINIDUMP_THREAD_INFOFlags {
...
/// {@category Enum}
class DEBUG_EVENT_dwDebugEventCodeFlags {
...
class IMAGE_FILE_MACHINE {
  static const IMAGE_FILE_MACHINE_I386 = 0x0000014c;
  static const IMAGE_FILE_MACHINE_IA64 = 0x00000200;
  static const IMAGE_FILE_MACHINE_AMD64 = 0x00008664;
}

/// {@category Enum}
class MODLOAD_DATA_ssigFlags {
