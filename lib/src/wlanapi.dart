...
/// Displays the wireless profile user interface (UI). This UI is used to
/// view and edit advanced settings of a wireless network profile.
///
/// ```c
...
int WlanUIEditProfile(
    ...
    _WlanUIEditProfile(dwClientVersion, wstrProfileName, pInterfaceGuid, hWnd,
        wlStartPage, pReserved, pWlanReasonCode);

late final _WlanUIEditProfile = _wlanapi.lookupFunction<
    Uint32 Function(
