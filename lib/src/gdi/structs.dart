...
class RGBTRIPLE extends Struct {
  @Uint8() external int rgbtBlue;
  @Uint8() external int rgbtGreen;
  @Uint8() external int rgbtRed;
}
...
class BITMAPCOREHEADER extends Struct {
  @Uint32() external int bcSize;
  @Uint16() external int bcWidth;
...
class BITMAPV4HEADER extends Struct {
  @Uint32() external int bV4Size;
  @Int32() external int bV4Width;
  @Int32() external int bV4Height;
  @Uint16() external int bV4Planes;
  @Uint16() external int bV4BitCount;
  @Uint32() external int bV4V4Compression;
  @Uint32() external int bV4SizeImage;
  @Int32() external int bV4XPelsPerMeter;
  @Int32() external int bV4YPelsPerMeter;
  @Uint32() external int bV4ClrUsed;
  @Uint32() external int bV4ClrImportant;
  @Uint32() external int bV4RedMask;
  @Uint32() external int bV4GreenMask;
  @Uint32() external int bV4BlueMask;
  @Uint32() external int bV4AlphaMask;
  @Uint32() external int bV4CSType;
  external CIEXYZTRIPLE bV4Endpoints;
  @Uint32() external int bV4GammaRed;
  @Uint32() external int bV4GammaGreen;
  @Uint32() external int bV4GammaBlue;
}

class BITMAPV5HEADER extends Struct {
  @Uint32() external int bV5Size;
  @Int32() external int bV5Width;
  @Int32() external int bV5Height;
  @Uint16() external int bV5Planes;
  @Uint16() external int bV5BitCount;
  @Uint32() external int bV5Compression;
  @Uint32() external int bV5SizeImage;
  @Int32() external int bV5XPelsPerMeter;
  @Int32() external int bV5YPelsPerMeter;
  @Uint32() external int bV5ClrUsed;
  @Uint32() external int bV5ClrImportant;
  @Uint32() external int bV5RedMask;
  @Uint32() external int bV5GreenMask;
  @Uint32() external int bV5BlueMask;
  @Uint32() external int bV5AlphaMask;
  @Uint32() external int bV5CSType;
  external CIEXYZTRIPLE bV5Endpoints;
  @Uint32() external int bV5GammaRed;
  @Uint32() external int bV5GammaGreen;
  @Uint32() external int bV5GammaBlue;
  @Uint32() external int bV5Intent;
  @Uint32() external int bV5ProfileData;
  @Uint32() external int bV5ProfileSize;
  @Uint32() external int bV5Reserved;
}
...
class BITMAPFILEHEADER extends Struct {
  @Uint16() external int bfType;
  @Uint32() external int bfSize;
  @Uint16() external int bfReserved1;
  @Uint16() external int bfReserved2;
  @Uint32() external int bfOffBits;
}
...
class METAHEADER extends Struct {
  @Uint16() external int mtType;
  @Uint16() external int mtHeaderSize;
  @Uint16() external int mtVersion;
  @Uint32() external int mtSize;
  @Uint16() external int mtNoObjects;
  @Uint32() external int mtMaxRecord;
  @Uint16() external int mtNoParameters;
}
...
class ENHMETAHEADER extends Struct {
  ...
  @Uint32() external int dSignature;
  @Uint32() external int nVersion;
  @Uint32() external int nBytes;
  @Uint32() external int nRecords;
  @Uint16() external int nHandles;
  @Uint16() external int sReserved;
  @Uint32() external int nDescription;
  @Uint32() external int offDescription;
  @Uint32() external int nPalEntries;
  external SIZE szlDevice;
  external SIZE szlMillimeters;
  @Uint32() external int cbPixelFormat;
  @Uint32() external int offPixelFormat;
  @Uint32() external int bOpenGL;
  external SIZE szlMicrometers;
}

class TEXTMETRICA extends Struct {
  @Int32() external int tmHeight;
  @Int32() external int tmAscent;
  @Int32() external int tmDescent;
  @Int32() external int tmInternalLeading;
  @Int32() external int tmExternalLeading;
  @Int32() external int tmAveCharWidth;
  @Int32() external int tmMaxCharWidth;
  @Int32() external int tmWeight;
  @Int32() external int tmOverhang;
  @Int32() external int tmDigitizedAspectX;
  @Int32() external int tmDigitizedAspectY;
  @Uint8() external int tmFirstChar;
  @Uint8() external int tmLastChar;
  @Uint8() external int tmDefaultChar;
  @Uint8() external int tmBreakChar;
  @Uint8() external int tmItalic;
  @Uint8() external int tmUnderlined;
  @Uint8() external int tmStruckOut;
  @Uint8() external int tmPitchAndFamily;
  @Uint8() external int tmCharSet;
}
...
class TEXTMETRICW extends Struct {
  ...
  @Int32() external int tmDigitizedAspectX;
  @Int32() external int tmDigitizedAspectY;
  @Uint16() external int tmFirstChar;
  @Uint16() external int tmLastChar;
  @Uint16() external int tmDefaultChar;
  @Uint16() external int tmBreakChar;
  @Uint8() external int tmItalic;
  @Uint8() external int tmUnderlined;
  @Uint8() external int tmStruckOut;
  @Uint8() external int tmPitchAndFamily;
...
class NEWTEXTMETRICA extends Struct {
  ...
  @Uint8() external int tmPitchAndFamily;
  @Uint8() external int tmCharSet;
  @Uint32() external int ntmFlags;
  @Uint32() external int ntmSizeEM;
  @Uint32() external int ntmCellHeight;
  @Uint32() external int ntmAvgWidth;
}
...
class PELARRAY extends Struct {
  @Int32() external int paXCount;
  @Int32() external int paYCount;
  @Int32() external int paXExt;
  @Int32() external int paYExt;
  @Uint8() external int paRGBs;
}

class LOGBRUSH extends Struct {
  @Uint32() external int lbStyle;
  @Uint32() external int lbColor;
  @IntPtr() external int lbHatch;
}

class LOGBRUSH32 extends Struct {
  @Uint32() external int lbStyle;
  @Uint32() external int lbColor;
  @Uint32() external int lbHatch;
}

class LOGPEN extends Struct {
  @Uint32() external int lopnStyle;
  external POINT lopnWidth;
  @Uint32() external int lopnColor;
}

class EXTLOGPEN extends Struct {
  @Uint32() external int elpPenStyle;
  @Uint32() external int elpWidth;
  @Uint32() external int elpBrushStyle;
...
class PALETTEENTRY extends Struct {
  @Uint8() external int peRed;
  @Uint8() external int peGreen;
  @Uint8() external int peBlue;
  @Uint8() external int peFlags;
}
...
class PANOSE extends Struct {
  @Uint8() external int bFamilyType;
  @Uint8() external int bSerifStyle;
  @Uint8() external int bWeight;
  @Uint8() external int bProportion;
  @Uint8() external int bContrast;
  @Uint8() external int bStrokeVariation;
  @Uint8() external int bArmStyle;
  @Uint8() external int bLetterform;
  @Uint8() external int bMidline;
  @Uint8() external int bXHeight;
}
...
class RGNDATAHEADER extends Struct {
  ...
  @Uint32() external int iType;
  @Uint32() external int nCount;
  @Uint32() external int nRgnSize;
...
class ABC extends Struct {
  @Int32() external int abcA;
  @Uint32() external int abcB;
  @Int32() external int abcC;
}

class ABCFLOAT extends Struct {
  @Float() external double abcfA;
  @Float() external double abcfB;
  @Float() external double abcfC;
}

class OUTLINETEXTMETRICA extends Struct {
  @Uint32() external int otmSize;
  external TEXTMETRICA otmTextMetrics;
  @Uint8() external int otmFiller;
  external PANOSE otmPanoseNumber;
  @Uint32() external int otmfsSelection;
  @Uint32() external int otmfsType;
  @Int32() external int otmsCharSlopeRise;
  @Int32() external int otmsCharSlopeRun;
  @Int32() external int otmItalicAngle;
  @Uint32() external int otmEMSquare;
  @Int32() external int otmAscent;
  @Int32() external int otmDescent;
  @Uint32() external int otmLineGap;
  @Uint32() external int otmsCapEmHeight;
  @Uint32() external int otmsXHeight;
  external RECT otmrcFontBox;
  @Int32() external int otmMacAscent;
  @Int32() external int otmMacDescent;
  @Uint32() external int otmMacLineGap;
  @Uint32() external int otmusMinimumPPEM;
  ...
  @Uint32() external int otmsStrikeoutSize;
  @Int32() external int otmsStrikeoutPosition;
  @Int32() external int otmsUnderscoreSize;
  @Int32() external int otmsUnderscorePosition;
...
class GLYPHMETRICS extends Struct {
  @Uint32() external int gmBlackBoxX;
  @Uint32() external int gmBlackBoxY;
  external POINT gmptGlyphOrigin;
  @Int16() external int gmCellIncX;
  @Int16() external int gmCellIncY;
}
...
class GCP_RESULTSA extends Struct {
  @Uint32() external int lStructSize;
...
class RASTERIZER_STATUS extends Struct {
  @Int16() external int nSize;
  @Int16() external int wFlags;
  @Int16() external int nLanguageID;
}
...
class GRADIENT_TRIANGLE extends Struct {
  @Uint32() external int Vertex1;
  @Uint32() external int Vertex2;
  @Uint32() external int Vertex3;
}

class GRADIENT_RECT extends Struct {
  @Uint32() external int UpperLeft;
  @Uint32() external int LowerRight;
}
...
class COLORADJUSTMENT extends Struct {
  @Uint16() external int caSize;
  @Uint16() external int caFlags;
  @Uint16() external int caIlluminantIndex;
  @Uint16() external int caRedGamma;
  @Uint16() external int caGreenGamma;
  @Uint16() external int caBlueGamma;
  @Uint16() external int caReferenceBlack;
  @Uint16() external int caReferenceWhite;
  @Int16() external int caContrast;
  @Int16() external int caBrightness;
  @Int16() external int caColorfulness;
  @Int16() external int caRedGreenTint;
}

class KERNINGPAIR extends Struct {
  @Uint16() external int wFirst;
  @Uint16() external int wSecond;
  @Int32() external int iKernAmount;
}
...
class EMRTEXT extends Struct {
  ...
  @Uint32() external int nChars;
  @Uint32() external int offString;
  @Uint32() external int fOptions;
  external RECTL rcl;
  @Uint32() external int offDx;
}
...
class EMRRESTOREDC extends Struct {
  external EMR emr;
  @Int32() external int iRelative;
}

class EMRSETARCDIRECTION extends Struct {
  external EMR emr;
  @Uint32() external int iArcDirection;
}
...
class EMRSETTEXTCOLOR extends Struct {
  external EMR emr;
  @Uint32() external int crColor;
}

class EMRSELECTOBJECT extends Struct {
  external EMR emr;
  @Uint32() external int ihObject;
}
...
class EMREOF extends Struct {
  external EMR emr;
  @Uint32() external int nPalEntries;
  @Uint32() external int offPalEntries;
  @Uint32() external int nSizeLast;
}
...
class EMRSCALEVIEWPORTEXTEX extends Struct {
  external EMR emr;
  @Int32() external int xNum;
  @Int32() external int xDenom;
  @Int32() external int yNum;
  @Int32() external int yDenom;
}
...
class EMRANGLEARC extends Struct {
  ...
  @Uint32() external int nRadius;
  @Float() external double eStartAngle;
  @Float() external double eSweepAngle;
}
...
class EMREXTTEXTOUTA extends Struct {
  external EMR emr;
  external RECTL rclBounds;
  @Uint32() external int iGraphicsMode;
...
class EMRBITBLT extends Struct {
  external EMR emr;
  external RECTL rclBounds;
  @Int32() external int xDest;
  @Int32() external int yDest;
  @Int32() external int cxDest;
  @Int32() external int cyDest;
  @Uint32() external int dwRop;
  @Int32() external int xSrc;
  @Int32() external int ySrc;
  external XFORM xformSrc;
  @Uint32() external int crBkColorSrc;
  @Uint32() external int iUsageSrc;
  @Uint32() external int offBmiSrc;
  @Uint32() external int cbBmiSrc;
  @Uint32() external int offBitsSrc;
  @Uint32() external int cbBitsSrc;
}
...
class EMRMASKBLT extends Struct {
  ...
  @Uint32() external int offBitsSrc;
  @Uint32() external int cbBitsSrc;
  @Int32() external int xMask;
  @Int32() external int yMask;
  @Uint32() external int iUsageMask;
  @Uint32() external int offBmiMask;
  @Uint32() external int cbBmiMask;
  @Uint32() external int offBitsMask;
  @Uint32() external int cbBitsMask;
}
...
class EMRSETDIBITSTODEVICE extends Struct {
  ...
  @Uint32() external int cbBitsSrc;
  @Uint32() external int iUsageSrc;
  @Uint32() external int iStartScan;
  @Uint32() external int cScans;
}
...
class EMREXTCREATEPEN extends Struct {
  external EMR emr;
  @Uint32() external int ihPen;
  @Uint32() external int offBmi;
  @Uint32() external int cbBmi;
  @Uint32() external int offBits;
  @Uint32() external int cbBits;
...
class COLORCORRECTPALETTE extends Struct {
  external EMR emr;
  @Uint32() external int ihPalette;
  @Uint32() external int nFirstEntry;
  @Uint32() external int nPalEntries;
  @Uint32() external int nReserved;
}
...
class TTLOADINFO extends Struct {
  @Uint16() external int usStructSize;
  @Uint16() external int usRefStrSize;
  external Pointer<Uint16> pusRefStr;
}

class TTEMBEDINFO extends Struct {
  @Uint16() external int usStructSize;
  @Uint16() external int usRootStrSize;
  external Pointer<Uint16> pusRootStr;
}

class TTVALIDATIONTESTSPARAMS extends Struct {
  @Uint32() external int ulStructSize;
  @Int32() external int lTestFromSize;
  @Int32() external int lTestToSize;
  @Uint32() external int ulCharSet;
  @Uint16() external int usReserved1;
  @Uint16() external int usCharCodeCount;
...
class DRAWTEXTPARAMS extends Struct {
  ...
  @Int32() external int iTabLength;
  @Int32() external int iLeftMargin;
  @Int32() external int iRightMargin;
  @Uint32() external int uiLengthDrawn;
}
