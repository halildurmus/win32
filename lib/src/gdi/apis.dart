...
int CreateDCW(Pointer<Utf16> pwszDriver, Pointer<Utf16> pwszDevice,
...
int CreateEnhMetaFileW(int hdc, Pointer<Utf16> lpFilename, Pointer<RECT> lprc,
...
int CreateICW(Pointer<Utf16> pszDriver, Pointer<Utf16> pszDevice,
    Pointer<Utf16> pszPort, Pointer<DEVMODE> pdm) {
...
int CreateMetaFileW(Pointer<Utf16> pszFile) {
...
int CreateScalableFontResourceW(int fdwHidden, Pointer<Utf16> lpszFont,
...
int EnumEnhMetaFile(int hdc, int hmf, ENHMFENUMPROC proc, Pointer param3,
    Pointer<RECT> lpRect) {
  final _EnumEnhMetaFile = _gdi32.lookupFunction<
      Int32 Function(IntPtr hdc, IntPtr hmf, ENHMFENUMPROC proc, Pointer param3,
          Pointer<RECT> lpRect),
      int Function(int hdc, int hmf, ENHMFENUMPROC proc, Pointer param3,
          Pointer<RECT> lpRect)>('EnumEnhMetaFile');
...
int EnumFontFamiliesW(int hdc, Pointer<Utf16> lpLogfont,
    Pointer<NativeFunction<EnumFontFamExProc>> lpProc, int lParam) {
  final _EnumFontFamiliesW = _gdi32.lookupFunction<
      Int32 Function(IntPtr hdc, Pointer<Utf16> lpLogfont,
          Pointer<NativeFunction<EnumFontFamExProc>> lpProc, IntPtr lParam),
      int Function(
          int hdc,
...
int EnumFontsW(int hdc, Pointer<Utf16> lpLogfont,
    Pointer<NativeFunction<EnumFontFamExProc>> lpProc, int lParam) {
...
int EnumMetaFile(int hdc, int hmf, MFENUMPROC proc, int param3) {
  final _EnumMetaFile = _gdi32.lookupFunction<
      ...
      int Function(
          int hdc, int hmf, MFENUMPROC proc, int param3)>('EnumMetaFile');
...
int EnumObjects(int hdc, int nType, GOBJENUMPROC lpFunc, int lParam) {
  final _EnumObjects = _gdi32.lookupFunction<
      Int32 Function(
          IntPtr hdc, Uint32 nType, GOBJENUMPROC lpFunc, IntPtr lParam),
      int Function(
          int hdc, int nType, GOBJENUMPROC lpFunc, int lParam)>('EnumObjects');
...
int ExtCreateRegion(Pointer<XFORM> lpx, int nCount, Pointer<RGNDATA> lpData) {
  final _ExtCreateRegion = _gdi32.lookupFunction<
      IntPtr Function(
          Pointer<XFORM> lpx, Uint32 nCount, Pointer<RGNDATA> lpData),
      int Function(Pointer<XFORM> lpx, int nCount,
          Pointer<RGNDATA> lpData)>('ExtCreateRegion');
...
int ExtTextOutW(int hdc, int x, int y, int options, Pointer<RECT> lprect,
...
int GdiAlphaBlend(
  ...
  return _GdiAlphaBlend(hdcDest, xoriginDest, yoriginDest, wDest, hDest, hdcSrc,
...
int GdiGetBatchLimit() {
  final _GdiGetBatchLimit = _gdi32
...
int GdiTransparentBlt(
  ...
  return _GdiTransparentBlt(hdcDest, xoriginDest, yoriginDest, wDest, hDest,
      hdcSrc, xoriginSrc, yoriginSrc, wSrc, hSrc, crTransparent);
}

int GetArcDirection(int hdc) {
  final _GetArcDirection =
      _gdi32.lookupFunction<Int32 Function(IntPtr hdc), int Function(int hdc)>(
          'GetArcDirection');
...
int GetCharABCWidthsI(
    int hdc, int giFirst, int cgi, Pointer<Uint16> pgi, Pointer<ABC> pabc) {
  final _GetCharABCWidthsI = _gdi32.lookupFunction<
      Int32 Function(IntPtr hdc, Uint32 giFirst, Uint32 cgi,
          Pointer<Uint16> pgi, Pointer<ABC> pabc),
...
int GetCharABCWidthsW(int hdc, int wFirst, int wLast, Pointer<ABC> lpABC) {
  final _GetCharABCWidthsW = _gdi32.lookupFunction<
      Int32 Function(
          IntPtr hdc, Uint32 wFirst, Uint32 wLast, Pointer<ABC> lpABC),
...
int GetCharWidthI(int hdc, int giFirst, int cgi, Pointer<Uint16> pgi,
  ...
  final _GetCharWidthI = _gdi32.lookupFunction<
      Int32 Function(IntPtr hdc, Uint32 giFirst, Uint32 cgi,
          Pointer<Uint16> pgi, Pointer<Int32> piWidths),
      int Function(int hdc, int giFirst, int cgi, Pointer<Uint16> pgi,
...
int GetCharacterPlacementW(int hdc, Pointer<Utf16> lpString, int nCount,
  ...
  final _GetCharacterPlacementW = _gdi32.lookupFunction<
      ...
      int Function(
          ...
          int dwFlags)>('GetCharacterPlacementW');
...
int GetColorAdjustment(int hdc, Pointer<COLORADJUSTMENT> lpca) {
  final _GetColorAdjustment = _gdi32.lookupFunction<
      ...
      int Function(
          int hdc, Pointer<COLORADJUSTMENT> lpca)>('GetColorAdjustment');
...
int GetEnhMetaFilePaletteEntries(
  ...
  final _GetEnhMetaFilePaletteEntries = _gdi32.lookupFunction<
          ...
          int Function(int hemf, int nNumEntries,
              Pointer<PALETTEENTRY> lpPaletteEntries)>(
...
int GetKerningPairsW(int hdc, int nPairs, Pointer<KERNINGPAIR> lpKernPair) {
  final _GetKerningPairsW = _gdi32.lookupFunction<
      Uint32 Function(
          IntPtr hdc, Uint32 nPairs, Pointer<KERNINGPAIR> lpKernPair),
...
int GetOutlineTextMetricsW(
  ...
  final _GetOutlineTextMetricsW = _gdi32.lookupFunction<
      Uint32 Function(
          IntPtr hdc, Uint32 cjCopy, Pointer<OUTLINETEXTMETRIC> potm),
...
int GetPaletteEntries(
    int hpal, int iStart, int cEntries, Pointer<PALETTEENTRY> pPalEntries) {
...
int GetWinMetaFileBits(
    int hemf, int cbData16, Pointer<Uint8> pData16, int iMapMode, int hdcRef) {
...
int MaskBlt(
  ...
  final _MaskBlt = _gdi32.lookupFunction<
      ...
      int Function(
          ...
          int yMask,
          int rop)>('MaskBlt');
  return _MaskBlt(hdcDest, xDest, yDest, width, height, hdcSrc, xSrc, ySrc,
...
int PatBlt(int hdc, int x, int y, int w, int h, int rop) {
  final _PatBlt = _gdi32.lookupFunction<
      Int32 Function(
          IntPtr hdc, Int32 x, Int32 y, Int32 w, Int32 h, Uint32 rop),
...
int PlayEnhMetaFileRecord(
    int hdc, Pointer<HANDLETABLE> pht, Pointer<ENHMETARECORD> pmr, int cht) {
  final _PlayEnhMetaFileRecord = _gdi32.lookupFunction<
      ...
      int Function(int hdc, Pointer<HANDLETABLE> pht,
          Pointer<ENHMETARECORD> pmr, int cht)>('PlayEnhMetaFileRecord');
...
int PlgBlt(int hdcDest, Pointer<POINT> lpPoint, int hdcSrc, int xSrc, int ySrc,
  ...
  final _PlgBlt = _gdi32.lookupFunction<
      ...
      int Function(
          ...
          int xMask,
          int yMask)>('PlgBlt');
  return _PlgBlt(hdcDest, lpPoint, hdcSrc, xSrc, ySrc, width, height, hbmMask,
      xMask, yMask);
}
...
int PolyTextOutW(int hdc, Pointer<POLYTEXT> ppt, int nstrings) {
  final _PolyTextOutW = _gdi32.lookupFunction<
      ...
      int Function(
          int hdc, Pointer<POLYTEXT> ppt, int nstrings)>('PolyTextOutW');
...
int RemoveFontMemResourceEx(int h) {
  final _RemoveFontMemResourceEx =
...
int ResetDCW(int hdc, Pointer<DEVMODE> lpdm) {
  final _ResetDCW = _gdi32.lookupFunction<
      ...
      int Function(int hdc, Pointer<DEVMODE> lpdm)>('ResetDCW');
...
int ScaleViewportExtEx(
  ...
  final _ScaleViewportExtEx = _gdi32.lookupFunction<
      Int32 Function(IntPtr hdc, Int32 xn, Int32 dx, Int32 yn, Int32 yd,
          Pointer<SIZE> lpsz),
...
int ScaleWindowExtEx(
  ...
  final _ScaleWindowExtEx = _gdi32.lookupFunction<
      Int32 Function(IntPtr hdc, Int32 xn, Int32 xd, Int32 yn, Int32 yd,
          Pointer<SIZE> lpsz),
...
int SetBrushOrgEx(int hdc, int x, int y, Pointer<POINT> lppt) {
  final _SetBrushOrgEx = _gdi32.lookupFunction<
      Int32 Function(IntPtr hdc, Int32 x, Int32 y, Pointer<POINT> lppt),
      int Function(
          int hdc, int x, int y, Pointer<POINT> lppt)>('SetBrushOrgEx');
...
int SetColorAdjustment(int hdc, Pointer<COLORADJUSTMENT> lpca) {
  final _SetColorAdjustment = _gdi32.lookupFunction<
      Int32 Function(IntPtr hdc, Pointer<COLORADJUSTMENT> lpca),
      int Function(
          int hdc, Pointer<COLORADJUSTMENT> lpca)>('SetColorAdjustment');
...
int SetDIBitsToDevice(
  ...
  return _SetDIBitsToDevice(hdc, xDest, yDest, w, h, xSrc, ySrc, StartScan,
      cLines, lpvBits, lpbmi, ColorUse);
}
...
int SetWinMetaFileBits(int nSize, Pointer<Uint8> lpMeta16Data, int hdcRef,
    Pointer<METAFILEPICT> lpMFP) {
  final _SetWinMetaFileBits = _gdi32.lookupFunction<
      IntPtr Function(Uint32 nSize, Pointer<Uint8> lpMeta16Data, IntPtr hdcRef,
          Pointer<METAFILEPICT> lpMFP),
      int Function(int nSize, Pointer<Uint8> lpMeta16Data, int hdcRef,
          Pointer<METAFILEPICT> lpMFP)>('SetWinMetaFileBits');
...
int SetWindowOrgEx(int hdc, int x, int y, Pointer<POINT> lppt) {
  final _SetWindowOrgEx = _gdi32.lookupFunction<
      Int32 Function(IntPtr hdc, Int32 x, Int32 y, Pointer<POINT> lppt),
      int Function(
          int hdc, int x, int y, Pointer<POINT> lppt)>('SetWindowOrgEx');
