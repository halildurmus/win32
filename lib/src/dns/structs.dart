...
class DNS_ADDR_ARRAY extends Struct {
  @Uint32() external int MaxCount;
  @Uint32() external int AddrCount;
  @Uint32() external int Tag;
  @Uint16() external int Family;
  @Uint16() external int WordReserved;
...
class DNS_HEADER extends Struct {
  @Uint16() external int Xid;
  @Uint8() external int _bitfield1;
  @Uint8() external int _bitfield2;
  @Uint16() external int QuestionCount;
  @Uint16() external int AnswerCount;
  @Uint16() external int NameServerCount;
  @Uint16() external int AdditionalCount;
}

class DNS_HEADER_EXT extends Struct {
  @Uint16() external int _bitfield;
  @Uint8() external int chRcode;
  @Uint8() external int chVersion;
}

class DNS_WIRE_QUESTION extends Struct {
  @Uint16() external int QuestionType;
  @Uint16() external int QuestionClass;
}

class DNS_WIRE_RECORD extends Struct {
  @Uint16() external int RecordType;
  @Uint16() external int RecordClass;
...
class DNS_SOA_DATAW extends Struct {
  ...
  @Uint32() external int dwSerialNo;
  @Uint32() external int dwRefresh;
  @Uint32() external int dwRetry;
  @Uint32() external int dwExpire;
...
class DNS_MX_DATAW extends Struct {
  ...
  @Uint16() external int wPreference;
  @Uint16() external int Pad;
}
...
class DNS_SIG_DATAW extends Struct {
  @Uint16() external int wTypeCovered;
  @Uint8() external int chAlgorithm;
  @Uint8() external int chLabelCount;
  @Uint32() external int dwOriginalTtl;
  @Uint32() external int dwExpiration;
  @Uint32() external int dwTimeSigned;
...
class DNS_LOC_DATA extends Struct {
  ...
  @Uint16() external int wSize;
  @Uint16() external int wHorPrec;
  @Uint16() external int wVerPrec;
  @Uint32() external int dwLatitude;
  @Uint32() external int dwLongitude;
  @Uint32() external int dwAltitude;
}
...
class DNS_TKEY_DATAW extends Struct {
  ...
  @Uint32() external int dwCreateTime;
  @Uint32() external int dwExpireTime;
  @Uint16() external int wMode;
  @Uint16() external int wError;
  @Uint16() external int wKeyLength;
  @Uint16() external int wOtherLength;
  @Uint8() external int cAlgNameLength;
  @Int32() external int bPacketPointers;
}
...
class DNS_TSIG_DATAW extends Struct {
  ...
  external Pointer<Uint8> pOtherData;
  @Int64() external int i64CreateTime;
  @Uint16() external int wFudgeTime;
  @Uint16() external int wOriginalXid;
  @Uint16() external int wError;
  @Uint16() external int wSigLength;
  @Uint16() external int wOtherLength;
  @Uint8() external int cAlgNameLength;
  @Int32() external int bPacketPointers;
}
...
class DNS_WINS_DATA extends Struct {
  @Uint32() external int dwMappingFlag;
...
class DNS_PROXY_INFORMATION extends Struct {
  ...
  @Uint32() external int proxyInformationType;
  external Pointer<Utf16> proxyName;
}

class DNS_QUERY_RESULT extends Struct {
  @Uint32() external int Version;
  @Int32() external int QueryStatus;
  @Uint64() external int QueryOptions;
...
class DNS_CONNECTION_PROXY_INFO_EX extends Struct {
  ...
  @Uint32() external int dwInterfaceIndex;
  external Pointer<Utf16> pwszConnectionName;
  @Int32() external int fDirectConfiguration;
...
class DNS_SERVICE_INSTANCE extends Struct {
  ...
  @Uint16() external int wPriority;
  @Uint16() external int wWeight;
  @Uint32() external int dwPropertyCount;
...
class DNS_SERVICE_REGISTER_REQUEST extends Struct {
  ...
  external Pointer pQueryContext;
  @IntPtr() external int hCredentials;
  @Int32() external int unicastEnabled;
}
...
class MDNS_QUERY_REQUEST extends Struct {
  @Uint32() external int Version;
  @Uint32() external int ulRefCount;
  ...
  external Pointer pQueryContext;
  @Int32() external int fAnswerReceived;
  @Uint32() external int ulResendCount;
}
