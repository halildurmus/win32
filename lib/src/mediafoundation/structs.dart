...
class DXVAHDSW_CALLBACKS extends Struct {
  ...
  external PDXVAHDSW_GetVideoProcessorOutputFormats
      GetVideoProcessorOutputFormats;
  external PDXVAHDSW_GetVideoProcessorInputFormats
