...
class WHV_PROCESSOR_FEATURES_BANKS extends Struct {
  @Uint32() external int BanksCount;
...
class WHV_PARTITION_PROPERTY extends Struct {
  ...
  external WHV_PROCESSOR_XSAVE_FEATURES ProcessorXsaveFeatures;
  @Uint8() external int ProcessorClFlushSize;
  @Uint32() external int ProcessorCount;
  @Array(1)
  external Array<Uint32> CpuidExitList;
  @Array(1)
  external Array<WHV_X64_CPUID_RESULT> CpuidResultList;
  @Uint64() external int ExceptionExitBitmap;
  @Uint32() external int LocalApicEmulationMode;
  @Int32() external int SeparateSecurityDomain;
  @Int32() external int NestedVirtualization;
  external WHV_X64_MSR_EXIT_BITMAP X64MsrExitBitmap;
  @Uint64() external int ProcessorClockFrequency;
  @Uint64() external int InterruptClockFrequency;
  @Int32() external int ApicRemoteRead;
  external WHV_PROCESSOR_FEATURES_BANKS ProcessorFeaturesBanks;
  @Uint64() external int ReferenceTime;
}

class WHV_TRANSLATE_GVA_RESULT extends Struct {
  @Uint32() external int ResultCode;
...
class WHV_X64_SEGMENT_REGISTER extends Struct {
  @Uint64() external int Base;
  @Uint32() external int Limit;
...
class WHV_REGISTER_VALUE extends Struct {
  ...
  @Uint64() external int Reg64;
  @Uint32() external int Reg32;
  @Uint16() external int Reg16;
  @Uint8() external int Reg8;
  ...
  external WHV_X64_DELIVERABILITY_NOTIFICATIONS_REGISTER DeliverabilityNotifications;
...
class WHV_X64_CPUID_ACCESS_CONTEXT extends Struct {
  ...
  @Uint64() external int DefaultResultRax;
  @Uint64() external int DefaultResultRcx;
  @Uint64() external int DefaultResultRdx;
  @Uint64() external int DefaultResultRbx;
}
...
class WHV_X64_RDTSC_CONTEXT extends Struct {
  @Uint64() external int TscAux;
  @Uint64() external int VirtualOffset;
  @Uint64() external int Tsc;
  @Uint64() external int ReferenceTime;
  external WHV_X64_RDTSC_INFO RdtscInfo;
}

class WHV_X64_APIC_SMI_CONTEXT extends Struct {
  @Uint64() external int ApicIcr;
}
...
class WHV_RUN_VP_EXIT_CONTEXT extends Struct {
  @Uint32() external int ExitReason;
  @Uint32() external int Reserved;
...
class WHV_INTERRUPT_CONTROL extends Struct {
  @Uint64() external int _bitfield;
  @Uint32() external int Destination;
  @Uint32() external int Vector;
}

class WHV_DOORBELL_MATCH_DATA extends Struct {
  @Uint64() external int GuestAddress;
...
class WHV_PARTITION_MEMORY_COUNTERS extends Struct {
  @Uint64() external int Mapped4KPageCount;
  @Uint64() external int Mapped2MPageCount;
  @Uint64() external int Mapped1GPageCount;
}

class WHV_PROCESSOR_RUNTIME_COUNTERS extends Struct {
  @Uint64() external int TotalRuntime100ns;
  @Uint64() external int HypervisorRuntime100ns;
}

class WHV_PROCESSOR_INTERCEPT_COUNTER extends Struct {
  @Uint64() external int Count;
  @Uint64() external int Time100ns;
}
...
class WHV_PROCESSOR_EVENT_COUNTERS extends Struct {
  @Uint64() external int PageFaultCount;
  @Uint64() external int ExceptionCount;
  @Uint64() external int InterruptCount;
}

class WHV_PROCESSOR_APIC_COUNTERS extends Struct {
  @Uint64() external int MmioAccessCount;
  @Uint64() external int EoiAccessCount;
  @Uint64() external int TprAccessCount;
  @Uint64() external int SentIpiCount;
  @Uint64() external int SelfIpiCount;
}
...
class WHV_EMULATOR_MEMORY_ACCESS_INFO extends Struct {
  @Uint64() external int GpaAddress;
  @Uint8() external int Direction;
  @Uint8() external int AccessSize;
  @Array(8)
...
class WHV_EMULATOR_IO_ACCESS_INFO extends Struct {
  ...
  @Uint16() external int AccessSize;
...
class WHV_EMULATOR_CALLBACKS extends Struct {
  ...
  external WHV_EMULATOR_GET_VIRTUAL_PROCESSOR_REGISTERS_CALLBACK WHvEmulatorGetVirtualProcessorRegisters;
  external WHV_EMULATOR_SET_VIRTUAL_PROCESSOR_REGISTERS_CALLBACK WHvEmulatorSetVirtualProcessorRegisters;
