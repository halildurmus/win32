...
class WSAMSG extends Struct {
  ...
  @Int32() external int namelen;
  external Pointer<WSABUF> lpBuffers;
  @Uint32() external int dwBufferCount;
  external WSABUF Control;
  @Uint32() external int dwFlags;
}

class cmsghdr extends Struct {
  @IntPtr() external int cmsg_len;
  @Int32() external int cmsg_level;
  @Int32() external int cmsg_type;
}

class ADDRINFOA extends Struct {
  @Int32() external int ai_flags;
  @Int32() external int ai_family;
...
class addrinfoex3 extends Struct {
  ...
  @Int32() external int ai_version;
  external Pointer<Utf16> ai_fqdn;
  @Int32() external int ai_interfaceindex;
}
...
class addrinfoex4 extends Struct {
  ...
  external Pointer<Utf16> ai_fqdn;
  @Int32() external int ai_interfaceindex;
  @IntPtr() external int ai_resolutionhandle;
}
...
class sockproto extends Struct {
  @Uint16() external int sp_family;
  @Uint16() external int sp_protocol;
}

class linger extends Struct {
  @Uint16() external int l_onoff;
  @Uint16() external int l_linger;
}
...
class WSAPROTOCOL_INFOA extends Struct {
  @Uint32() external int dwServiceFlags1;
  @Uint32() external int dwServiceFlags2;
  @Uint32() external int dwServiceFlags3;
  @Uint32() external int dwServiceFlags4;
  @Uint32() external int dwProviderFlags;
  external GUID ProviderId;
  @Uint32() external int dwCatalogEntryId;
  external WSAPROTOCOLCHAIN ProtocolChain;
  @Int32() external int iVersion;
  @Int32() external int iAddressFamily;
  @Int32() external int iMaxSockAddr;
  @Int32() external int iMinSockAddr;
  @Int32() external int iSocketType;
  @Int32() external int iProtocol;
  @Int32() external int iProtocolMaxOffset;
  @Int32() external int iNetworkByteOrder;
...
class WSANSCLASSINFOA extends Struct {
  ...
  @Uint32() external int dwValueSize;
...
class RM_SEND_WINDOW extends Struct {
  @Uint32() external int RateKbitsPerSec;
  @Uint32() external int WindowSizeInMSecs;
  @Uint32() external int WindowSizeInBytes;
}

class RM_SENDER_STATS extends Struct {
  @Uint64() external int DataBytesSent;
  @Uint64() external int TotalBytesSent;
  @Uint64() external int NaksReceived;
  @Uint64() external int NaksReceivedTooLate;
  @Uint64() external int NumOutstandingNaks;
  @Uint64() external int NumNaksAfterRData;
  @Uint64() external int RepairPacketsSent;
  @Uint64() external int BufferSpaceAvailable;
  @Uint64() external int TrailingEdgeSeqId;
  @Uint64() external int LeadingEdgeSeqId;
  @Uint64() external int RateKBitsPerSecOverall;
  @Uint64() external int RateKBitsPerSecLast;
  @Uint64() external int TotalODataPacketsSent;
}

class RM_RECEIVER_STATS extends Struct {
  @Uint64() external int NumODataPacketsReceived;
  @Uint64() external int NumRDataPacketsReceived;
  @Uint64() external int NumDuplicateDataPackets;
  @Uint64() external int DataBytesReceived;
  @Uint64() external int TotalBytesReceived;
  @Uint64() external int RateKBitsPerSecOverall;
  @Uint64() external int RateKBitsPerSecLast;
  @Uint64() external int TrailingEdgeSeqId;
  @Uint64() external int LeadingEdgeSeqId;
  @Uint64() external int AverageSequencesInWindow;
  @Uint64() external int MinSequencesInWindow;
  @Uint64() external int MaxSequencesInWindow;
  @Uint64() external int FirstNakSequenceNumber;
  @Uint64() external int NumPendingNaks;
  @Uint64() external int NumOutstandingNaks;
  @Uint64() external int NumDataPacketsBuffered;
  @Uint64() external int TotalSelectiveNaksSent;
  @Uint64() external int TotalParityNaksSent;
}

class RM_FEC_INFO extends Struct {
  @Uint16() external int FECBlockSize;
  @Uint16() external int FECProActivePackets;
  @Uint8() external int FECGroupSize;
  @Uint8() external int fFECOnDemandParityEnabled;
}
...
class IPX_SPXCONNSTATUS_DATA extends Struct {
  @Uint8() external int ConnectionState;
  @Uint8() external int WatchDogActive;
  @Uint16() external int LocalConnectionId;
  @Uint16() external int RemoteConnectionId;
  @Uint16() external int LocalSequenceNumber;
  @Uint16() external int LocalAckNumber;
  @Uint16() external int LocalAllocNumber;
  ...
  @Uint16() external int RetransmittedPackets;
  @Uint16() external int SuppressedPacket;
}

class LM_IRPARMS extends Struct {
  @Uint32() external int nTXDataBytes;
  @Uint32() external int nRXDataBytes;
  @Uint32() external int nBaudRate;
  @Uint32() external int thresholdTime;
  @Uint32() external int discTime;
  @Uint16() external int nMSLinkTurn;
  @Uint8() external int nTXPackets;
  @Uint8() external int nRXPackets;
}
...
class tcp_keepalive extends Struct {
  @Uint32() external int onoff;
  @Uint32() external int keepalivetime;
  @Uint32() external int keepaliveinterval;
}
...
class RCVALL_IF extends Struct {
  ...
  @Uint32() external int Interface;
}

class TCP_INITIAL_RTO_PARAMETERS extends Struct {
  @Uint16() external int Rtt;
  @Uint8() external int MaxSynRetransmissions;
}
...
class TCP_ACK_FREQUENCY_PARAMETERS extends Struct {
  @Uint8() external int TcpDelayedAckFrequency;
}

class TCP_INFO_v0 extends Struct {
  @Uint32() external int State;
  @Uint32() external int Mss;
  @Uint64() external int ConnectionTimeMs;
  @Uint8() external int TimestampsEnabled;
  @Uint32() external int RttUs;
  @Uint32() external int MinRttUs;
  @Uint32() external int BytesInFlight;
  @Uint32() external int Cwnd;
  @Uint32() external int SndWnd;
  @Uint32() external int RcvWnd;
  @Uint32() external int RcvBuf;
  @Uint64() external int BytesOut;
  @Uint64() external int BytesIn;
  @Uint32() external int BytesReordered;
  @Uint32() external int BytesRetrans;
  @Uint32() external int FastRetrans;
  @Uint32() external int DupAcksIn;
  @Uint32() external int TimeoutEpisodes;
  @Uint8() external int SynRetrans;
}
...
class SOCKET_SECURITY_QUERY_INFO extends Struct {
  @Uint32() external int SecurityProtocol;
  @Uint32() external int Flags;
  @Uint64() external int PeerApplicationAccessTokenHandle;
  @Uint64() external int PeerMachineAccessTokenHandle;
}
...
class SOCKET_SECURITY_QUERY_INFO_IPSEC2 extends Struct {
  ...
  @Uint64() external int QmSaId;
  @Uint32() external int NegotiationWinerr;
  external GUID SaLookupContext;
}

class RSS_SCALABILITY_INFO extends Struct {
  @Uint8() external int RssEnabled;
}

class WSA_COMPATIBILITY_MODE extends Struct {
  @Uint32() external int BehaviorId;
  @Uint32() external int TargetOsVersion;
}
...
class RIORESULT extends Struct {
  ...
  @Uint32() external int BytesTransferred;
  @Uint64() external int SocketContext;
  @Uint64() external int RequestContext;
}
...
class RIO_CMSG_BUFFER extends Struct {
  @Uint32() external int TotalLength;
}
...
class ATM_BLLI extends Struct {
  @Uint32() external int Layer2Protocol;
  @Uint32() external int Layer2UserSpecifiedProtocol;
...
class sockaddr_atm extends Struct {
  @Uint16() external int satm_family;
...
class AAL5_PARAMETERS extends Struct {
  @Uint32() external int ForwardMaxCPCSSDUSize;
  @Uint32() external int BackwardMaxCPCSSDUSize;
  @Uint8() external int Mode;
  @Uint8() external int SSCSType;
}
...
class ATM_TD extends Struct {
  ...
  @Uint32() external int SustainableCellRate_CLP0;
  @Uint32() external int SustainableCellRate_CLP01;
  @Uint32() external int MaxBurstSize_CLP0;
  @Uint32() external int MaxBurstSize_CLP01;
  @Int32() external int Tagging;
}

class ATM_TRAFFIC_DESCRIPTOR_IE extends Struct {
  external ATM_TD Forward;
  external ATM_TD Backward;
  @Int32() external int BestEffort;
}

class ATM_BROADBAND_BEARER_CAPABILITY_IE extends Struct {
  @Uint8() external int BearerClass;
  @Uint8() external int TrafficType;
  @Uint8() external int TimingRequirements;
  @Uint8() external int ClippingSusceptability;
  @Uint8() external int UserPlaneConnectionConfig;
}

class ATM_BLLI_IE extends Struct {
  @Uint32() external int Layer2Protocol;
  @Uint8() external int Layer2Mode;
  @Uint8() external int Layer2WindowSize;
  @Uint32() external int Layer2UserSpecifiedProtocol;
  @Uint32() external int Layer3Protocol;
  @Uint8() external int Layer3Mode;
  @Uint8() external int Layer3DefaultPacketSize;
...
class ATM_CALLING_PARTY_NUMBER_IE extends Struct {
  ...
  @Uint8() external int Presentation_Indication;
  @Uint8() external int Screening_Indicator;
}
...
class ATM_QOS_CLASS_IE extends Struct {
  @Uint8() external int QOSClassForward;
  @Uint8() external int QOSClassBackward;
}
...
class ATM_CONNECTION_ID extends Struct {
  ...
  @Uint32() external int VPI;
  @Uint32() external int VCI;
}
...
class NAPI_DOMAIN_DESCRIPTION_BLOB extends Struct {
  @Uint32() external int AuthLevel;
  @Uint32() external int cchDomainName;
  @Uint32() external int OffsetNextDomainDescription;
  @Uint32() external int OffsetThisDomainName;
}

class NAPI_PROVIDER_INSTALLATION_BLOB extends Struct {
  @Uint32() external int dwVersion;
  @Uint32() external int dwProviderType;
  @Uint32() external int fSupportsWildCard;
  @Uint32() external int cDomains;
  @Uint32() external int OffsetFirstDomain;
}

class TRANSMIT_FILE_BUFFERS extends Struct {
  external Pointer Head;
  @Uint32() external int HeadLength;
...
class WSC_PROVIDER_AUDIT_INFO extends Struct {
  @Uint32() external int RecordSize;
...
class NS_INFOA extends Struct {
  @Uint32() external int dwNameSpace;
  @Uint32() external int dwNameSpaceFlags;
...
class SERVICE_TYPE_VALUE extends Struct {
  ...
  @Uint32() external int dwValueType;
  @Uint32() external int dwValueSize;
  @Uint32() external int dwValueNameOffset;
  @Uint32() external int dwValueOffset;
}
...
class SERVICE_ADDRESS extends Struct {
  @Uint32() external int dwAddressType;
  @Uint32() external int dwAddressFlags;
  @Uint32() external int dwAddressLength;
  @Uint32() external int dwPrincipalLength;
...
class SERVICE_INFOA extends Struct {
  ...
  @Uint32() external int dwDisplayHint;
  @Uint32() external int dwVersion;
