...
class D3D10_VIEWPORT extends Struct {
  @Int32() external int TopLeftX;
  @Int32() external int TopLeftY;
...
class D3D10_STATE_BLOCK_MASK extends Struct {
  ...
  @Uint8() external int OMRenderTargets;
  @Uint8() external int OMDepthStencilState;
  @Uint8() external int OMBlendState;
  @Uint8() external int RSViewports;
  @Uint8() external int RSScissorRects;
  @Uint8() external int RSRasterizerState;
  @Uint8() external int SOBuffers;
  @Uint8() external int Predication;
}
...
class D3D10_EFFECT_TYPE_DESC extends Struct {
  ...
  @Uint32() external int Rows;
  @Uint32() external int Columns;
  @Uint32() external int PackedSize;
  @Uint32() external int UnpackedSize;
...
class D3D10_EFFECT_VARIABLE_DESC extends Struct {
  ...
  @Uint32() external int Flags;
  @Uint32() external int Annotations;
  @Uint32() external int BufferOffset;
  @Uint32() external int ExplicitBindPoint;
}

class D3D10_EFFECT_SHADER_DESC extends Struct {
  external Pointer<Uint8> pInputSignature;
  @Int32() external int IsInline;
  external Pointer<Uint8> pBytecode;
  @Uint32() external int BytecodeLength;
  external Pointer<Utf8> SODecl;
  @Uint32() external int NumInputSignatureEntries;
  @Uint32() external int NumOutputSignatureEntries;
}
...
class D3D10_PASS_SHADER_DESC extends Struct {
  ...
  @Uint32() external int ShaderIndex;
}

class D3D10_TECHNIQUE_DESC extends Struct {
  external Pointer<Utf8> Name;
  @Uint32() external int Passes;
  @Uint32() external int Annotations;
}

class D3D10_EFFECT_DESC extends Struct {
  @Int32() external int IsChildEffect;
  @Uint32() external int ConstantBuffers;
  @Uint32() external int SharedConstantBuffers;
  @Uint32() external int GlobalVariables;
  @Uint32() external int SharedGlobalVariables;
  @Uint32() external int Techniques;
}
...
class D3D10_SHADER_DEBUG_VAR_INFO extends Struct {
  ...
  @Uint32() external int Type;
  @Uint32() external int Register;
  @Uint32() external int Component;
  @Uint32() external int ScopeVar;
  @Uint32() external int ScopeVarOffset;
}

class D3D10_SHADER_DEBUG_INPUT_INFO extends Struct {
  @Uint32() external int Var;
  @Uint32() external int InitialRegisterSet;
  @Uint32() external int InitialBank;
  @Uint32() external int InitialRegister;
  @Uint32() external int InitialComponent;
  @Uint32() external int InitialValue;
}

class D3D10_SHADER_DEBUG_SCOPEVAR_INFO extends Struct {
  @Uint32() external int TokenId;
  @Uint32() external int VarType;
  @Uint32() external int Class;
  @Uint32() external int Rows;
  @Uint32() external int Columns;
  @Uint32() external int StructMemberScope;
  @Uint32() external int uArrayIndices;
  @Uint32() external int ArrayElements;
  @Uint32() external int ArrayStrides;
  @Uint32() external int uVariables;
  @Uint32() external int uFirstVariable;
}

class D3D10_SHADER_DEBUG_SCOPE_INFO extends Struct {
  @Uint32() external int ScopeType;
  @Uint32() external int Name;
  @Uint32() external int uNameLen;
  @Uint32() external int uVariables;
  @Uint32() external int VariableData;
}

class D3D10_SHADER_DEBUG_OUTPUTVAR extends Struct {
  @Uint32() external int Var;
  @Uint32() external int uValueMin;
  @Uint32() external int uValueMax;
  @Int32() external int iValueMin;
  @Int32() external int iValueMax;
  @Float() external double fValueMin;
  @Float() external double fValueMax;
  @Int32() external int bNaNPossible;
  @Int32() external int bInfPossible;
}
...
class D3D10_SHADER_DEBUG_INST_INFO extends Struct {
  ...
  @Uint32() external int AccessedVars;
  @Uint32() external int AccessedVarsInfo;
}

class D3D10_SHADER_DEBUG_FILE_INFO extends Struct {
  @Uint32() external int FileName;
  @Uint32() external int FileNameLen;
  @Uint32() external int FileData;
  @Uint32() external int FileLen;
}

class D3D10_SHADER_DEBUG_INFO extends Struct {
  @Uint32() external int Size;
  @Uint32() external int Creator;
  @Uint32() external int EntrypointName;
  @Uint32() external int ShaderTarget;
  @Uint32() external int CompileFlags;
  @Uint32() external int Files;
  @Uint32() external int FileInfo;
  @Uint32() external int Instructions;
  @Uint32() external int InstructionInfo;
  @Uint32() external int Variables;
  @Uint32() external int VariableInfo;
  @Uint32() external int InputVariables;
  @Uint32() external int InputVariableInfo;
  @Uint32() external int Tokens;
  @Uint32() external int TokenInfo;
  @Uint32() external int Scopes;
  @Uint32() external int ScopeInfo;
  @Uint32() external int ScopeVariables;
  @Uint32() external int ScopeVariableInfo;
  @Uint32() external int UintOffset;
