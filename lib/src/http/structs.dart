...
class HTTP_PERFORMANCE_PARAM extends Struct {
  @Uint64()
  external int SendBufferingFlags;
  @Uint8()
  external int EnableAggressiveICW;
  @Uint32()
  external int MaxBufferedSendBytes;
  @Uint32()
  external int MaxConcurrentClientStreams;
}
