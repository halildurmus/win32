...
class PSS_PROCESS_INFORMATION extends Struct {
  ...
  @IntPtr() external int AffinityMask;
  @Int32() external int BasePriority;
  @Uint32() external int ProcessId;
  @Uint32() external int ParentProcessId;
...
class PSS_VA_CLONE_INFORMATION extends Struct {
  @IntPtr() external int VaCloneHandle;
}

class PSS_AUXILIARY_PAGES_INFORMATION extends Struct {
  @Uint32() external int AuxPagesCaptured;
}
...
class PSS_HANDLE_INFORMATION extends Struct {
  @Uint32() external int HandlesCaptured;
}

class PSS_THREAD_INFORMATION extends Struct {
  @Uint32() external int ThreadsCaptured;
  @Uint32() external int ContextLength;
}

class PSS_HANDLE_TRACE_INFORMATION extends Struct {
  @IntPtr() external int SectionHandle;
  @Uint32() external int Size;
}

class PSS_PERFORMANCE_COUNTERS extends Struct {
  @Uint64() external int TotalCycleCount;
  @Uint64() external int TotalWallClockPeriod;
  @Uint64() external int VaCloneCycleCount;
  @Uint64() external int VaCloneWallClockPeriod;
  @Uint64() external int VaSpaceCycleCount;
  @Uint64() external int VaSpaceWallClockPeriod;
  @Uint64() external int AuxPagesCycleCount;
  @Uint64() external int AuxPagesWallClockPeriod;
  @Uint64() external int HandlesCycleCount;
  @Uint64() external int HandlesWallClockPeriod;
  @Uint64() external int ThreadsCycleCount;
  @Uint64() external int ThreadsWallClockPeriod;
}
...
class PSS_VA_SPACE_ENTRY extends Struct {
  ...
  @Uint16() external int MappedFileNameLength;
...
class PSS_THREAD_ENTRY extends Struct {
  ...
  @Uint16() external int LastSyscallNumber;
  external FILETIME CreateTime;
  external FILETIME ExitTime;
  external FILETIME KernelTime;
  external FILETIME UserTime;
  ...
  external FILETIME CaptureTime;
  @Uint32() external int Flags;
  @Uint16() external int SuspendCount;
  @Uint16() external int SizeOfContextRecord;
  external Pointer<CONTEXT> ContextRecord;
}

class PSS_ALLOCATOR extends Struct {
  external Pointer Context;
  @IntPtr() external int AllocRoutine;
  @IntPtr() external int FreeRoutine;
}
