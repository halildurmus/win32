...
class PNRP_CLOUD_ID extends Struct {
  @Int32() external int AddressFamily;
...
class PNRPCLOUDINFO extends Struct {
  ...
  @Uint32() external int enCloudState;
  @Uint32() external int enCloudFlags;
}

class PEER_VERSION_DATA extends Struct {
  @Uint16() external int wVersion;
  @Uint16() external int wHighestVersion;
}
...
class PEER_CONNECTION_INFO extends Struct {
  @Uint32() external int dwSize;
  @Uint32() external int dwFlags;
  @Uint64() external int ullConnectionId;
  @Uint64() external int ullNodeId;
...
class PEER_EVENT_CONNECTION_CHANGE_DATA extends Struct {
  ...
  @Uint64() external int ullConnectionId;
  @Uint64() external int ullNodeId;
  @Uint64() external int ullNextConnectionId;
  @Int32() external int hrConnectionFailedReason;
}
...
class PEER_GRAPH_PROPERTIES extends Struct {
  ...
  @Uint32() external int dwMaxRecordSize;
  external Pointer<Utf16> pwzGraphId;
  external Pointer<Utf16> pwzCreatorId;
  external Pointer<Utf16> pwzFriendlyName;
  external Pointer<Utf16> pwzComment;
  @Uint32() external int ulPresenceLifetime;
  @Uint32() external int cPresenceMax;
}
...
class PEER_SECURITY_INTERFACE extends Struct {
  ...
  @Uint32() external int cbSecurityInfo;
...
class PEER_INVITATION_INFO extends Struct {
  ...
  @Uint32() external int dwScope;
  @Uint32() external int dwCloudFlags;
...
class PEER_GROUP_PROPERTIES extends Struct {
  ...
  external Pointer<Utf16> pwzFriendlyName;
  external Pointer<Utf16> pwzComment;
  @Uint32() external int ulMemberDataLifetime;
  @Uint32() external int ulPresenceLifetime;
  @Uint32() external int dwAuthenticationSchemes;
...
class PEER_OBJECT extends Struct {
  external GUID id;
  external PEER_DATA data;
  @Uint32() external int dwPublicationScope;
}
...
class PEER_CONTACT extends Struct {
  ...
  @Int32() external int fWatch;
  @Uint32() external int WatcherPermissions;
...
class PEER_INVITATION_RESPONSE extends Struct {
  ...
  external Pointer<Utf16> pwzMessage;
  @Int32() external int hrExtendedInfo;
}
...
class DRT_SETTINGS extends Struct {
  ...
  @Uint8() external int bProtocolMajorVersion;
  @Uint8() external int bProtocolMinorVersion;
  @Uint32() external int ulMaxRoutingAddresses;
  ...
  @Uint32() external int eSecurityMode;
}

class DRT_SEARCH_INFO extends Struct {
  @Uint32() external int dwSize;
  @Int32() external int fIterative;
  @Int32() external int fAllowCurrentInstanceMatch;
  @Int32() external int fAnyMatchInRange;
  @Uint32() external int cMaxEndpoints;
...
class PEERDIST_RETRIEVAL_OPTIONS extends Struct {
  ...
  @Uint32() external int dwContentInfoMinVersion;
  @Uint32() external int dwContentInfoMaxVersion;
...
class PEERDIST_STATUS_INFO extends Struct {
  @Uint32() external int cbSize;
  @Uint32() external int status;
  @Uint32() external int dwMinVer;
  @Uint32() external int dwMaxVer;
}

class PEERDIST_CLIENT_BASIC_INFO extends Struct {
  @Int32() external int fFlashCrowd;
}
