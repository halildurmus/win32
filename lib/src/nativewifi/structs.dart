...
class OFFLOAD_IPSEC_ADD_SA extends Struct {
  ...
  @Uint32()
  external int SrcMask;
  @Uint32()
  external int DestAddr;
  @Uint32()
  external int DestMask;
  @Uint32()
  ...
  @Uint32()
  external int SrcTunnelAddr;
  @Uint32()
  external int DestTunnelAddr;
  @Uint16()
  external int Flags;
  @Int16()
  external int NumSAs;
...
class OFFLOAD_IPSEC_ADD_UDPESP_SA extends Struct {
  ...
  @IntPtr()
  external int EncapTypeEntryOffldHandle;
  @Uint32()
  external int KeyLen;
  @Array(1)
  external Array<Uint8> KeyMat;
...
class NDIS_TCP_IP_CHECKSUM_OFFLOAD extends Struct {
  @Uint32()
  external int IPv4Transmit;
  @Uint32()
  external int IPv4Receive;
  @Uint32()
  external int IPv6Transmit;
  @Uint32()
  external int IPv6Receive;
}
...
class DOT11_PHY_ATTRIBUTES extends Struct {
  ...
  @Uint32()
  external int PhySpecificAttributes;
  @Uint32()
