...
class MESSAGE_RESOURCE_ENTRY extends Struct {
  ...
  external __ubyte__ Text;
}

class MESSAGE_RESOURCE_BLOCK extends Struct {
  @Uint32() external int LowId;
  @Uint32() external int HighId;
  @Uint32() external int OffsetToEntries;
}
...
class PRINTDLGA extends Struct {
  @Uint32() external int lStructSize;
  @IntPtr() external int hwndOwner;
  @IntPtr() external int hDevMode;
  @IntPtr() external int hDevNames;
  @IntPtr() external int hDC;
  @Uint32() external int Flags;
  @Uint16() external int nFromPage;
  @Uint16() external int nToPage;
  @Uint16() external int nMinPage;
  @Uint16() external int nMaxPage;
  @Uint16() external int nCopies;
  @IntPtr() external int hInstance;
  @IntPtr() external int lCustData;
  ...
  @IntPtr() external int hPrintTemplate;
  @IntPtr() external int hSetupTemplate;
}
...
class PRINTPAGERANGE extends Struct {
  @Uint32() external int nFromPage;
  @Uint32() external int nToPage;
}
...
class PRINTDLGEXA extends Struct {
  ...
  @IntPtr() external int hDC;
  @Uint32() external int Flags;
  @Uint32() external int Flags2;
  @Uint32() external int ExclusionFlags;
  @Uint32() external int nPageRanges;
  @Uint32() external int nMaxPageRanges;
  external Pointer<PRINTPAGERANGE> lpPageRanges;
  @Uint32() external int nMinPage;
  @Uint32() external int nMaxPage;
  @Uint32() external int nCopies;
  @IntPtr() external int hInstance;
  external Pointer<Utf8> lpPrintTemplateName;
  external Pointer lpCallback;
  @Uint32() external int nPropertyPages;
  external Pointer<HPROPSHEETPAGE> lphPropertyPages;
  @Uint32() external int nStartPage;
  @Uint32() external int dwResultAction;
}
...
class DEVNAMES extends Struct {
  @Uint16() external int wDriverOffset;
  @Uint16() external int wDeviceOffset;
  @Uint16() external int wOutputOffset;
  @Uint16() external int wDefault;
}
...
class PAGESETUPDLGA extends Struct {
  ...
  @IntPtr() external int hPageSetupTemplate;
}
...
class CBT_CREATEWNDA extends Struct {
  ...
  @IntPtr() external int hwndInsertAfter;
}
...
class EVENTMSG extends Struct {
  ...
  @Uint32() external int paramL;
  @Uint32() external int paramH;
...
class KBDLLHOOKSTRUCT extends Struct {
  @Uint32() external int vkCode;
  @Uint32() external int scanCode;
  @Uint32() external int flags;
  @Uint32() external int time;
...
class DEBUGHOOKINFO extends Struct {
  @Uint32() external int idThread;
  @Uint32() external int idThreadInstaller;
  @IntPtr() external int lParam;
  @IntPtr() external int wParam;
...
class MOUSEHOOKSTRUCT extends Struct {
  external POINT pt;
  @IntPtr() external int hwnd;
  @Uint32() external int wHitTestCode;
  @IntPtr() external int dwExtraInfo;
}
...
class MDINEXTMENU extends Struct {
  @IntPtr() external int hmenuIn;
  @IntPtr() external int hmenuNext;
  @IntPtr() external int hwndNext;
}
...
class DROPSTRUCT extends Struct {
  @IntPtr() external int hwndSource;
  @IntPtr() external int hwndSink;
  @Uint32() external int wFmt;
  @IntPtr() external int dwData;
  external POINT ptDrop;
  @Uint32() external int dwControlData;
}
...
class MSGBOXPARAMSA extends Struct {
  ...
  @IntPtr() external int dwContextHelpId;
  external MSGBOXCALLBACK lpfnMsgBoxCallback;
  @Uint32() external int dwLanguageId;
}
...
class CURSORSHAPE extends Struct {
  @Int32() external int xHotSpot;
  @Int32() external int yHotSpot;
  @Int32() external int cx;
  @Int32() external int cy;
  @Int32() external int cbWidth;
  @Uint8() external int Planes;
  @Uint8() external int BitsPixel;
}
...
class ICONINFOEXA extends Struct {
  ...
  external __byte__ szModName;
  external __byte__ szResName;
}
...
class ICONINFOEXW extends Struct {
  ...
  @IntPtr() external int hbmColor;
  @Uint16() external int wResID;
  external __ushort__ szModName;
  external __ushort__ szResName;
}
...
class CLIENTCREATESTRUCT extends Struct {
  @IntPtr() external int hWindowMenu;
  @Uint32() external int idFirstChild;
}

class TouchPredictionParameters extends Struct {
  @Uint32() external int cbSize;
  @Uint32() external int dwLatency;
  @Uint32() external int dwSampleTime;
  @Uint32() external int bUseHWTimeStamp;
}
...
class MINIMIZEDMETRICS extends Struct {
  ...
  @Int32() external int iHorzGap;
  @Int32() external int iVertGap;
  @Uint32() external int iArrange;
}

class ICONMETRICSA extends Struct {
  @Uint32() external int cbSize;
  @Int32() external int iHorzSpacing;
  @Int32() external int iVertSpacing;
  @Int32() external int iTitleWrap;
...
class ANIMATIONINFO extends Struct {
  @Uint32() external int cbSize;
  @Int32() external int iMinAnimate;
}
...
class MENUBARINFO extends Struct {
  ...
  external RECT rcBar;
  @IntPtr() external int hMenu;
  @IntPtr() external int hwndMenu;
  @Int32() external int _bitfield;
}

class ALTTABINFO extends Struct {
  @Uint32() external int cbSize;
  @Int32() external int cItems;
  @Int32() external int cColumns;
  @Int32() external int cRows;
  @Int32() external int iColFocus;
  @Int32() external int iRowFocus;
  @Int32() external int cxItem;
  @Int32() external int cyItem;
