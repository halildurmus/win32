...
/// {@category Enum}
class SetCoalescableTimer_uToleranceDelayFlags {
  static const TIMERV_DEFAULT_COALESCING = 0x00000000;
  static const TIMERV_NO_COALESCING = 0xffffffff;
}

/// {@category Enum}
class GetClassLong_nIndex {
...
/// {@category Enum}
class BroadcastSystemMessage_flags {
...
/// {@category Enum}
class String_dwFlags {
  static const STRSAFE_FILL_BEHIND_NULL = 0x00000200;
  static const STRSAFE_IGNORE_NULLS = 0x00000100;
  static const STRSAFE_FILL_ON_FAILURE = 0x00000400;
  static const STRSAFE_NULL_ON_FAILURE = 0x00000800;
  static const STRSAFE_NO_TRUNCATION = 0x00001000;
}

/// {@category Enum}
class GetIconInfo_hicon {
  static const IDI_APPLICATION = 0x00007f00;
  static const IDI_ASTERISK = 0x00007f04;
  static const IDI_EXCLAMATION = 0x00007f03;
  static const IDI_HAND = 0x00007f01;
  static const IDI_QUESTION = 0x00007f02;
  static const IDI_WINLOGO = 0x00007f05;
  static const IDI_ERROR = 0x00007f01;
  static const IDI_INFORMATION = 0x00007f04;
  static const IDI_SHIELD = 0x00007f06;
  static const IDI_WARNING = 0x00007f03;
}

/// {@category Enum}
class UpdateLayeredWindow_dwFlags {
...
/// {@category Enum}
class BroadcastSystemMessage_lpInfo {
...
/// {@category Enum}
class SystemParametersInfo_fWinIni {
...
/// {@category Enum}
class SetLayeredWindowAttributes_dwFlags {
  static const LWA_ALPHA = 0x00000002;
  static const LWA_COLORKEY = 0x00000001;
}

/// {@category Enum}
class SendMessageTimeout_fuFlags {
...
/// {@category Enum}
class GetSystemMetrics_nIndexFlags {
...
/// {@category Enum}
class CHANGEFILTERSTRUCT_ExtStatusFlags {
...
/// {@category Enum}
class MOUSEHOOKSTRUCTEX_mouseData {
  static const XBUTTON1 = 0x00000001;
  static const XBUTTON2 = 0x00000002;
}

/// {@category Enum}
class ACCEL_fVirtFlags {
  static const FALT = 0x00000010;
  static const FCONTROL = 0x00000008;
  static const FNOINVERT = 0x00000002;
  static const FSHIFT = 0x00000004;
  static const FVIRTKEY = 0x00000001;
}

/// {@category Enum}
class VS_FIXEDFILEINFO_dwFileTypeFlags {
...
/// {@category Enum}
class VS_FIXEDFILEINFO_dwFileOSFlags {
...
/// {@category Enum}
class MINIMIZEDMETRICS_iArrangeFlags {
