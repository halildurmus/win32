...
class ISchemaElement extends ISchemaParticle {
  // vtable begins at 16, is 11 entries long.
  ...
  Pointer<COMObject> get identityConstraints {
    final retValuePtr = calloc<Pointer<COMObject>>();
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
            Pointer,
            Pointer<Pointer<COMObject>> constraints,
          )>>>()
          .value
          .asFunction<
              int Function(
  ...
  Pointer<COMObject> get substitutionGroup {
    final retValuePtr = calloc<Pointer<COMObject>>();
