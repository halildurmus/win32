...
class JIT_DEBUG_INFO extends Struct {
  ...
  @Uint32() external int dwProcessorArchitecture;
  @Uint32() external int dwThreadID;
  @Uint32() external int dwReserved0;
  @Uint64() external int lpExceptionAddress;
  @Uint64() external int lpExceptionRecord;
  @Uint64() external int lpContextRecord;
}
...
class ACTCTX_SECTION_KEYED_DATA_ASSEMBLY_METADATA extends Struct {
  ...
  external Pointer lpSectionBase;
  @Uint32() external int ulSectionLength;
...
class pvalueA extends Struct {
  ...
  @Int32() external int pv_valuelen;
  external Pointer pv_value_context;
  @Uint32() external int pv_type;
}
...
class provider_info extends Struct {
  ...
  @Uint32() external int pi_flags;
  external Pointer pi_key_context;
}

class VALENTA extends Struct {
  external Pointer<Utf8> ve_valuename;
  @Uint32() external int ve_valuelen;
  @IntPtr() external int ve_valueptr;
  @Uint32() external int ve_type;
}
...
class XML_ERROR extends Struct {
  @Uint32() external int _nLine;
  external Pointer<Utf16> _pchBuf;
  @Uint32() external int _cchBuf;
  @Uint32() external int _ich;
  external Pointer<Utf16> _pszFound;
  external Pointer<Utf16> _pszExpected;
  @Uint32() external int _reserved1;
  @Uint32() external int _reserved2;
}

class CLIENT_ID extends Struct {
  @IntPtr() external int UniqueProcess;
...
class SYSTEM_PROCESS_INFORMATION extends Struct {
  ...
  external Pointer Reserved3;
  @IntPtr() external int PeakVirtualSize;
  @IntPtr() external int VirtualSize;
...
class SYSTEM_THREAD_INFORMATION extends Struct {
  ...
  @Uint32() external int ThreadState;
  @Uint32() external int WaitReason;
}

class SYSTEM_REGISTRY_QUOTA_INFORMATION extends Struct {
  @Uint32() external int RegistryQuotaAllowed;
  @Uint32() external int RegistryQuotaUsed;
  external Pointer Reserved1;
}
...
class SYSTEM_CODEINTEGRITY_INFORMATION extends Struct {
  @Uint32() external int Length;
  @Uint32() external int CodeIntegrityOptions;
}
...
class AVRF_HEAP_ALLOCATION extends Struct {
  @Uint64() external int HeapHandle;
  @Uint64() external int UserAllocation;
  @Uint64() external int UserAllocationSize;
  @Uint64() external int Allocation;
  @Uint64() external int AllocationSize;
  @Uint32() external int UserAllocationState;
  @Uint32() external int HeapState;
  @Uint64() external int HeapContext;
...
class AVRF_HANDLE_OPERATION extends Struct {
  ...
  @Uint32() external int OperationType;
...
class ERF extends Struct {
  @Int32() external int erfOper;
  @Int32() external int erfType;
  @Int32() external int fError;
}

class CCAB extends Struct {
  @Uint32() external int cb;
  @Uint32() external int cbFolderThresh;
  @Uint32() external int cbReserveCFHeader;
  @Uint32() external int cbReserveCFFolder;
  @Uint32() external int cbReserveCFData;
  @Int32() external int iCab;
...
class FDICABINETINFO extends Struct {
  @Int32() external int cbCabinet;
  @Uint16() external int cFolders;
  @Uint16() external int cFiles;
  @Uint16() external int setID;
  @Uint16() external int iCabinet;
  @Int32() external int fReserve;
  @Int32() external int hasprev;
...
class FDINOTIFICATION extends Struct {
  ...
  @Uint16() external int time;
  @Uint16() external int attribs;
  @Uint16() external int setID;
  @Uint16() external int iCabinet;
  @Uint16() external int iFolder;
  @Uint32() external int fdie;
}
...
class TEMP_BP_NOTE extends Struct {
  @Uint16() external int Seg;
  @Uint32() external int Offset;
  @Int32() external int bPM;
}

class VDM_SEGINFO extends Struct {
  @Uint16() external int Selector;
...
class GLOBALENTRY extends Struct {
  ...
  @Uint32() external int dwBlockSize;
  @IntPtr() external int hBlock;
  @Uint16() external int wcLock;
  @Uint16() external int wcPageLock;
  @Uint16() external int wFlags;
  @Int32() external int wHeapPresent;
  @IntPtr() external int hOwner;
  @Uint16() external int wType;
  @Uint16() external int wData;
  @Uint32() external int dwNext;
  @Uint32() external int dwNextAlt;
}
...
class DCICREATEINPUT extends Struct {
  ...
  @Uint32() external int dwBitCount;
...
class DCISURFACEINFO extends Struct {
  ...
  @Uint32() external int dwBitCount;
  @IntPtr() external int dwOffSurface;
  @Uint16() external int wSelSurface;
  ...
  @IntPtr() external int BeginAccess;
  @IntPtr() external int EndAccess;
  @IntPtr() external int DestroySurface;
}
...
class DCIENUMINPUT extends Struct {
  ...
  external RECT rSrc;
  external RECT rDst;
  @IntPtr() external int EnumCallback;
  external Pointer lpContext;
}

class DCIOFFSCREEN extends Struct {
  external DCISURFACEINFO dciInfo;
  @IntPtr() external int Draw;
  @IntPtr() external int SetClipList;
  @IntPtr() external int SetDestination;
}

class DCIOVERLAY extends Struct {
  external DCISURFACEINFO dciInfo;
  @Uint32() external int dwChromakeyValue;
  @Uint32() external int dwChromakeyMask;
}
...
class VMEML extends Struct {
  ...
  @Int32() external int bDiscardable;
}
...
class PROCESS_LIST extends Struct {
  ...
  @Uint32() external int dwAlphaDepth;
  @Uint32() external int dwZDepth;
}

class DDMONITORINFO extends Struct {
  @Uint16() external int Manufacturer;
  @Uint16() external int Product;
  @Uint32() external int SerialNumber;
  external GUID DeviceIdentifier;
  @Int32() external int Mode640x480;
  @Int32() external int Mode800x600;
  @Int32() external int Mode1024x768;
  @Int32() external int Mode1280x1024;
  @Int32() external int Mode1600x1200;
  @Int32() external int ModeReserved1;
  @Int32() external int ModeReserved2;
  @Int32() external int ModeReserved3;
}
...
class DDVERSIONDATA extends Struct {
  @Uint32() external int dwHALVersion;
...
class VIDMEMINFO extends Struct {
  ...
  @Uint32() external int dwNumHeaps;
...
class HEAPALIAS extends Struct {
  ...
  @Uint32() external int dwAliasSize;
}
...
class DDRAWI_DDRAWPALETTE_LCL extends Struct {
  @Uint32() external int lpPalMore;
  external Pointer<DDRAWI_DDRAWPALETTE_GBL> lpGbl;
  @IntPtr() external int dwUnused0;
  @Uint32() external int dwLocalRefCnt;
  external Pointer pUnkOuter;
  external Pointer<DDRAWI_DIRECTDRAW_LCL> lpDD_lcl;
  @IntPtr() external int dwReserved1;
  @IntPtr() external int dwDDRAWReserved1;
  @IntPtr() external int dwDDRAWReserved2;
  @IntPtr() external int dwDDRAWReserved3;
}
...
class DDRAWI_DDRAWCLIPPER_LCL extends Struct {
  @Uint32() external int lpClipMore;
...
class DDRAWI_DDRAWSURFACE_MORE extends Struct {
  ...
  external Pointer<DDRAWI_DIRECTDRAW_LCL> lpDD_lcl;
  @Uint32() external int dwPageLockCount;
  @Uint32() external int dwBytesAllocated;
  external Pointer<DDRAWI_DIRECTDRAW_INT> lpDD_int;
  ...
  @Uint32() external int dwDDrawReserved4;
...
class DDHALMODEINFO extends Struct {
  ...
  @Uint32() external int dwBPP;
  @Uint16() external int wFlags;
  @Uint16() external int wRefreshRate;
  @Uint32() external int dwRBitMask;
  @Uint32() external int dwGBitMask;
  @Uint32() external int dwBBitMask;
  @Uint32() external int dwAlphaBitMask;
}
...
class DDRAWI_DIRECTDRAW_GBL extends Struct {
  ...
  @Uint32() external int dwMaxOverlays;
  ...
  @Uint32() external int dwModeIndex;
  @Uint32() external int dwModeIndexOrig;
  @Uint32() external int dwNumFourCC;
  external Pointer<Uint32> lpdwFourCC;
  @Uint32() external int dwNumModes;
  external Pointer<DDHALMODEINFO> lpModeInfo;
  external PROCESS_LIST plProcessList;
  @Uint32() external int dwSurfaceLockCount;
  ...
  @Uint32() external int dwPDevice;
  @Uint32() external int dwWin16LockCnt;
  @Uint32() external int dwUnused3;
  @Uint32() external int hInstance;
  @Uint32() external int dwEvent16;
  @Uint32() external int dwSaveNumModes;
  @IntPtr() external int lpD3DGlobalDriverData;
  @IntPtr() external int lpD3DHALCallbacks;
  ...
  @IntPtr() external int lpD3DHALCallbacks2;
  external RECT rectDevice;
  @Uint32() external int cMonitors;
  external Pointer gpbmiSrc;
  external Pointer gpbmiDest;
  external Pointer<HEAPALIASINFO> phaiHeapAliases;
  @IntPtr() external int hKernelHandle;
  @IntPtr() external int pfnNotifyProc;
  ...
  @Uint32() external int hDDVxd;
  external DDSCAPSEX ddsCapsMore;
}

class DDRAWI_DIRECTDRAW_LCL extends Struct {
  @Uint32() external int lpDDMore;
  external Pointer<DDRAWI_DIRECTDRAW_GBL> lpGbl;
  @Uint32() external int dwUnused0;
  @Uint32() external int dwLocalFlags;
  @Uint32() external int dwLocalRefCnt;
  @Uint32() external int dwProcessId;
  external Pointer pUnkOuter;
  @Uint32() external int dwObsolete1;
  @IntPtr() external int hWnd;
  @IntPtr() external int hDC;
  @Uint32() external int dwErrorMode;
  external Pointer<DDRAWI_DDRAWSURFACE_INT> lpPrimary;
  external Pointer<DDRAWI_DDRAWSURFACE_INT> lpCB;
  @Uint32() external int dwPreferredMode;
  @IntPtr() external int hD3DInstance;
  external Pointer pD3DIUnknown;
  external Pointer<DDHAL_CALLBACKS> lpDDCB;
  @IntPtr() external int hDDVxd;
  @Uint32() external int dwAppHackFlags;
  @IntPtr() external int hFocusWnd;
  @Uint32() external int dwHotTracking;
  @Uint32() external int dwIMEState;
  @IntPtr() external int hWndPopup;
  @IntPtr() external int hDD;
  @IntPtr() external int hGammaCalibrator;
...
class DDRAWI_DDVIDEOPORT_LCL extends Struct {
  ...
  @Uint32() external int dwProcessID;
  @Uint32() external int dwStateFlags;
  @Uint32() external int dwFlags;
  @Uint32() external int dwRefCnt;
  @IntPtr() external int fpLastFlip;
  @IntPtr() external int dwReserved1;
  @IntPtr() external int dwReserved2;
  @IntPtr() external int hDDVideoPort;
  ...
  @Uint32() external int dwVBIProcessID;
...
class DDRAWI_DDMOTIONCOMP_LCL extends Struct {
  ...
  @Uint32() external int dwInternalFlags;
  @Uint32() external int dwRefCnt;
  @Uint32() external int dwProcessId;
  @IntPtr() external int hMoComp;
...
class DDHAL_SETMODEDATA extends Struct {
  ...
  @Int32() external int ddRVal;
  external Pointer<DDHAL_SETMODE> SetMode;
  @Int32() external int inexcl;
  @Int32() external int useRefreshRate;
}
...
class DDHAL_SYNCSURFACEDATA extends Struct {
  ...
  @Uint32() external int dwOverlaySrcWidth;
  @Uint32() external int dwOverlaySrcHeight;
  @Uint32() external int dwOverlayDestWidth;
  @Uint32() external int dwOverlayDestHeight;
  @IntPtr() external int dwDriverReserved1;
  @IntPtr() external int dwDriverReserved2;
  @IntPtr() external int dwDriverReserved3;
  @Int32() external int ddRVal;
}
...
class IMESTRUCT extends Struct {
  @Uint32() external int fnc;
  @IntPtr() external int wParam;
  @Uint32() external int wCount;
  @Uint32() external int dchSource;
  @Uint32() external int dchDest;
  @IntPtr() external int lParam1;
  @IntPtr() external int lParam2;
  @IntPtr() external int lParam3;
}

class UNDETERMINESTRUCT extends Struct {
  @Uint32() external int dwSize;
  @Uint32() external int uDefIMESize;
  @Uint32() external int uDefIMEPos;
  @Uint32() external int uUndetTextLen;
  @Uint32() external int uUndetTextPos;
  @Uint32() external int uUndetAttrPos;
  @Uint32() external int uCursorPos;
  @Uint32() external int uDeltaStart;
  @Uint32() external int uDetermineTextLen;
  @Uint32() external int uDetermineTextPos;
  @Uint32() external int uDetermineDelimPos;
  @Uint32() external int uYomiTextLen;
  @Uint32() external int uYomiTextPos;
  @Uint32() external int uYomiDelimPos;
}

class STRINGEXSTRUCT extends Struct {
  @Uint32() external int dwSize;
  @Uint32() external int uDeterminePos;
  @Uint32() external int uDetermineDelimPos;
  @Uint32() external int uYomiPos;
  @Uint32() external int uYomiDelimPos;
}
...
class DATETIME extends Struct {
  ...
  @Uint16() external int min;
  @Uint16() external int sec;
}
...
class JAVA_TRUST extends Struct {
  ...
  @Int32() external int fAllActiveXPermissions;
  @Int32() external int fAllPermissions;
  @Uint32() external int dwEncodingType;
  external Pointer<Uint8> pbJavaPermissions;
  @Uint32() external int cbJavaPermissions;
  external Pointer<Uint8> pbSigner;
  @Uint32() external int cbSigner;
  external Pointer<Utf16> pwszZone;
  external GUID guidZone;
  @Int32() external int hVerify;
}
...
class IsolatedAppLauncherTelemetryParameters extends Struct {
  @Int32() external int EnableForLaunch;
...
class FH_OVERLAPPED extends Struct {
  ...
  @IntPtr() external int InternalHigh;
  @Uint32() external int Offset;
  @Uint32() external int OffsetHigh;
...
class FIO_CONTEXT extends Struct {
  @Uint32() external int m_dwTempHack;
  @Uint32() external int m_dwSignature;
  @IntPtr() external int m_hFile;
  @Uint32() external int m_dwLinesOffset;
  @Uint32() external int m_dwHeaderLength;
}
...
class TDIEntityID extends Struct {
  @Uint32() external int tei_entity;
  @Uint32() external int tei_instance;
}

class TDIObjectID extends Struct {
  external TDIEntityID toi_entity;
  @Uint32() external int toi_class;
  @Uint32() external int toi_type;
  @Uint32() external int toi_id;
}
...
class PF_FILTER_DESCRIPTOR extends Struct {
  ...
  @Uint32() external int dwRule;
  @Uint32() external int pfatType;
  ...
  @Uint32() external int fLateBound;
  @Uint16() external int wSrcPort;
  @Uint16() external int wDstPort;
  @Uint16() external int wSrcPortHighRange;
  @Uint16() external int wDstPortHighRange;
}

class PF_FILTER_STATS extends Struct {
  @Uint32() external int dwNumPacketsFiltered;
...
class PF_INTERFACE_STATS extends Struct {
  ...
  @Uint32() external int dwFlags;
  @Uint32() external int dwInDrops;
  @Uint32() external int dwOutDrops;
  @Uint32() external int eaInAction;
  @Uint32() external int eaOutAction;
  @Uint32() external int dwNumInFilters;
  @Uint32() external int dwNumOutFilters;
  @Uint32() external int dwFrag;
  @Uint32() external int dwSpoof;
  @Uint32() external int dwReserved1;
  @Uint32() external int dwReserved2;
...
class _pfLogFrame extends Struct {
  ...
  @Uint32() external int dwFilterRule;
  @Uint16() external int wSizeOfAdditionalData;
