...
class RPC_IF_ID extends Struct {
  external GUID Uuid;
  @Uint16() external int VersMajor;
  @Uint16() external int VersMinor;
}
...
class RPC_POLICY extends Struct {
  ...
  @Uint32() external int EndpointFlags;
  @Uint32() external int NICFlags;
}
...
class RPC_HTTP_TRANSPORT_CREDENTIALS_W extends Struct {
  ...
  @Uint32() external int AuthenticationTarget;
  @Uint32() external int NumberOfAuthnSchemes;
...
class RPC_BINDING_HANDLE_SECURITY_V1_W extends Struct {
  ...
  @Uint32() external int AuthnLevel;
  @Uint32() external int AuthnSvc;
...
class RPC_BINDING_HANDLE_OPTIONS_V1 extends Struct {
  @Uint32() external int Version;
  @Uint32() external int Flags;
  @Uint32() external int ComTimeout;
  @Uint32() external int CallTimeout;
}

class RPC_CLIENT_INFORMATION1 extends Struct {
  external Pointer<Uint8> UserName;
  external Pointer<Uint8> ComputerName;
  @Uint16() external int Privilege;
  @Uint32() external int AuthFlags;
}
...
class RPC_INTERFACE_TEMPLATEA extends Struct {
  ...
  @Uint32() external int Flags;
  @Uint32() external int MaxCalls;
  @Uint32() external int MaxRpcSize;
...
class RPC_DISPATCH_TABLE extends Struct {
  @Uint32() external int DispatchTableCount;
...
class RPC_SERVER_INTERFACE extends Struct {
  ...
  @Uint32() external int RpcProtseqEndpointCount;
...
class RDR_CALLOUT_STATE extends Struct {
  ...
  @Uint8() external int ResourceTypePresent;
  @Uint8() external int SessionIdPresent;
  @Uint8() external int InterfacePresent;
...
class I_RpcProxyCallbackInterface extends Struct {
  ...
  external I_RpcProxyGetClientSessionAndResourceUUID GetClientSessionAndResourceUUIDFn;
...
class RPC_CALL_LOCAL_ADDRESS_V1 extends Struct {
  ...
  external Pointer Buffer;
  @Uint32() external int BufferSize;
  @Uint32() external int AddressFormat;
}

class RPC_CALL_ATTRIBUTES_V1_W extends Struct {
  @Uint32() external int Version;
  @Uint32() external int Flags;
  @Uint32() external int ServerPrincipalNameBufferLength;
  external Pointer<Uint16> ServerPrincipalName;
  @Uint32() external int ClientPrincipalNameBufferLength;
  external Pointer<Uint16> ClientPrincipalName;
  @Uint32() external int AuthenticationLevel;
  @Uint32() external int AuthenticationService;
  @Int32() external int NullSession;
}
...
class RPC_CALL_ATTRIBUTES_V2_W extends Struct {
  ...
  @Uint32() external int AuthenticationService;
  @Int32() external int NullSession;
  @Int32() external int KernelModeCaller;
  @Uint32() external int ProtocolSequence;
  @Uint32() external int IsClientLocal;
  @IntPtr() external int ClientPID;
  @Uint32() external int CallStatus;
  @Uint32() external int CallType;
  external Pointer<RPC_CALL_LOCAL_ADDRESS_V1> CallLocalAddress;
  @Uint16() external int OpNum;
...
class RPC_CALL_ATTRIBUTES_V3_W extends Struct {
  ...
  @Uint16() external int OpNum;
  external GUID InterfaceUuid;
  @Uint32() external int ClientIdentifierBufferLength;
...
class MIDL_STUB_MESSAGE extends Struct {
  ...
  @Uint32() external int BufferLength;
  @Uint32() external int MemorySize;
  external Pointer<Uint8> Memory;
  @Uint8() external int IsClient;
  @Uint8() external int Pad;
  @Uint16() external int uFlags2;
  @Int32() external int ReuseBuffer;
  ...
  @Int32() external int IgnoreEmbeddedPointers;
  external Pointer<Uint8> PointerBufferMark;
  @Uint8() external int CorrDespIncrement;
  @Uint8() external int uFlags;
  @Uint16() external int UniquePtrCount;
  @IntPtr() external int MaxCount;
  @Uint32() external int Offset;
  @Uint32() external int ActualCount;
  ...
  @Uint32() external int FullPtrRefId;
  @Uint32() external int PointerLength;
  ...
  @Int32() external int ParamNumber;
  ...
  @Uint32() external int dwStubPhase;
...
class COMM_FAULT_OFFSETS extends Struct {
  @Int16() external int CommOffset;
  @Int16() external int FaultOffset;
}
...
class MIDL_INTERFACE_METHOD_PROPERTIES extends Struct {
  @Uint16() external int MethodCount;
...
class MIDL_WINRT_TYPE_SERIALIZATION_INFO extends Struct {
  ...
  @Uint16() external int FormatStringSize;
  @Uint16() external int TypeOffset;
  external Pointer<MIDL_STUB_DESC> StubDesc;
}
