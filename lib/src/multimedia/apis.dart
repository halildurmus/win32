...
int CloseDriver(int hDriver, int lParam1, int lParam2) {
  final _CloseDriver = _winmm.lookupFunction<
    ...
    int Function(int hDriver, int lParam1, int lParam2)
  >('CloseDriver');
  return _CloseDriver(hDriver, lParam1, lParam2);
}

int DefDriverProc(int dwDriverIdentifier, int hdrvr, int uMsg, int lParam1, int lParam2) {
  final _DefDriverProc = _winmm.lookupFunction<
    IntPtr Function(IntPtr dwDriverIdentifier, IntPtr hdrvr, Uint32 uMsg, IntPtr lParam1, IntPtr lParam2), 
    int Function(int dwDriverIdentifier, int hdrvr, int uMsg, int lParam1, int lParam2)
  >('DefDriverProc');
  return _DefDriverProc(dwDriverIdentifier, hdrvr, uMsg, lParam1, lParam2);
}

int DriverCallback(int dwCallback, int dwFlags, int hDevice, int dwMsg, int dwUser, int dwParam1, int dwParam2) {
  final _DriverCallback = _winmm.lookupFunction<
    Int32 Function(IntPtr dwCallback, Uint32 dwFlags, IntPtr hDevice, Uint32 dwMsg, IntPtr dwUser, IntPtr dwParam1, IntPtr dwParam2), 
    int Function(int dwCallback, int dwFlags, int hDevice, int dwMsg, int dwUser, int dwParam1, int dwParam2)
  >('DriverCallback');
  return _DriverCallback(dwCallback, dwFlags, hDevice, dwMsg, dwUser, dwParam1, dwParam2);
}

int DrvGetModuleHandle(int hDriver) {
  final _DrvGetModuleHandle = _winmm.lookupFunction<
    IntPtr Function(IntPtr hDriver), 
    int Function(int hDriver)
  >('DrvGetModuleHandle');
...
int OpenDriver(Pointer<Utf16> szDriverName, Pointer<Utf16> szSectionName, int lParam2) {
  final _OpenDriver = _winmm.lookupFunction<
    IntPtr Function(Pointer<Utf16> szDriverName, Pointer<Utf16> szSectionName, IntPtr lParam2), 
    int Function(Pointer<Utf16> szDriverName, Pointer<Utf16> szSectionName, int lParam2)
  >('OpenDriver');
...
int SendDriverMessage(int hDriver, int message, int lParam1, int lParam2) {
  final _SendDriverMessage = _winmm.lookupFunction<
    IntPtr Function(IntPtr hDriver, Uint32 message, IntPtr lParam1, IntPtr lParam2), 
    int Function(int hDriver, int message, int lParam1, int lParam2)
  >('SendDriverMessage');
...
int auxGetDevCapsW(int uDeviceID, Pointer<AUXCAPS> pac, int cbac) {
  final _auxGetDevCapsW = _winmm.lookupFunction<
    ...
    int Function(int uDeviceID, Pointer<AUXCAPS> pac, int cbac)
  >('auxGetDevCapsW');
  return _auxGetDevCapsW(uDeviceID, pac, cbac);
}

int auxGetNumDevs() {
  final _auxGetNumDevs = _winmm.lookupFunction<
    Uint32 Function(), 
    int Function()
  >('auxGetNumDevs');
...
int auxGetVolume(int uDeviceID, Pointer<Uint32> pdwVolume) {
  final _auxGetVolume = _winmm.lookupFunction<
    ...
    int Function(int uDeviceID, Pointer<Uint32> pdwVolume)
  >('auxGetVolume');
...
int auxOutMessage(int uDeviceID, int uMsg, int dw1, int dw2) {
  final _auxOutMessage = _winmm.lookupFunction<
    ...
    int Function(int uDeviceID, int uMsg, int dw1, int dw2)
  >('auxOutMessage');
...
int auxSetVolume(int uDeviceID, int dwVolume) {
  final _auxSetVolume = _winmm.lookupFunction<
    ...
    int Function(int uDeviceID, int dwVolume)
  >('auxSetVolume');
...
int joyGetDevCapsW(int uJoyID, Pointer<JOYCAPS> pjc, int cbjc) {
  final _joyGetDevCapsW = _winmm.lookupFunction<
    ...
    int Function(int uJoyID, Pointer<JOYCAPS> pjc, int cbjc)
  >('joyGetDevCapsW');
  return _joyGetDevCapsW(uJoyID, pjc, cbjc);
}

int joyGetNumDevs() {
  final _joyGetNumDevs = _winmm.lookupFunction<
    Uint32 Function(), 
    int Function()
  >('joyGetNumDevs');
...
int joyGetPos(int uJoyID, Pointer<JOYINFO> pji) {
  final _joyGetPos = _winmm.lookupFunction<
    ...
    int Function(int uJoyID, Pointer<JOYINFO> pji)
  >('joyGetPos');
...
int joyGetPosEx(int uJoyID, Pointer<JOYINFOEX> pji) {
  final _joyGetPosEx = _winmm.lookupFunction<
    ...
    int Function(int uJoyID, Pointer<JOYINFOEX> pji)
  >('joyGetPosEx');
...
int joyGetThreshold(int uJoyID, Pointer<Uint32> puThreshold) {
  final _joyGetThreshold = _winmm.lookupFunction<
    ...
    int Function(int uJoyID, Pointer<Uint32> puThreshold)
  >('joyGetThreshold');
...
int joySetCapture(int hwnd, int uJoyID, int uPeriod, int fChanged) {
  final _joySetCapture = _winmm.lookupFunction<
    ...
    int Function(int hwnd, int uJoyID, int uPeriod, int fChanged)
  >('joySetCapture');
...
int joySetThreshold(int uJoyID, int uThreshold) {
  final _joySetThreshold = _winmm.lookupFunction<
    ...
    int Function(int uJoyID, int uThreshold)
  >('joySetThreshold');
...
int midiInClose(int hmi) {
  final _midiInClose = _winmm.lookupFunction<
    Uint32 Function(IntPtr hmi), 
    int Function(int hmi)
  >('midiInClose');
...
int midiInGetNumDevs() {
  final _midiInGetNumDevs = _winmm.lookupFunction<
    Uint32 Function(), 
    int Function()
  >('midiInGetNumDevs');
...
int midiInOpen(Pointer<IntPtr> phmi, int uDeviceID, int dwCallback, int dwInstance, int fdwOpen) {
  final _midiInOpen = _winmm.lookupFunction<
    Uint32 Function(Pointer<IntPtr> phmi, Uint32 uDeviceID, IntPtr dwCallback, IntPtr dwInstance, Uint32 fdwOpen), 
    int Function(Pointer<IntPtr> phmi, int uDeviceID, int dwCallback, int dwInstance, int fdwOpen)
  >('midiInOpen');
...
int midiInReset(int hmi) {
  final _midiInReset = _winmm.lookupFunction<
    Uint32 Function(IntPtr hmi), 
    int Function(int hmi)
  >('midiInReset');
...
int midiInStart(int hmi) {
  final _midiInStart = _winmm.lookupFunction<
    Uint32 Function(IntPtr hmi), 
    int Function(int hmi)
  >('midiInStart');
...
int midiInStop(int hmi) {
  final _midiInStop = _winmm.lookupFunction<
    Uint32 Function(IntPtr hmi), 
    int Function(int hmi)
  >('midiInStop');
...
int midiOutCacheDrumPatches(int hmo, int uPatch, Pointer<Uint16> pwkya, int fuCache) {
  final _midiOutCacheDrumPatches = _winmm.lookupFunction<
    Uint32 Function(IntPtr hmo, Uint32 uPatch, Pointer<Uint16> pwkya, Uint32 fuCache), 
...
int midiOutCachePatches(int hmo, int uBank, Pointer<Uint16> pwpa, int fuCache) {
  final _midiOutCachePatches = _winmm.lookupFunction<
    Uint32 Function(IntPtr hmo, Uint32 uBank, Pointer<Uint16> pwpa, Uint32 fuCache), 
...
int midiOutClose(int hmo) {
  final _midiOutClose = _winmm.lookupFunction<
    Uint32 Function(IntPtr hmo), 
    int Function(int hmo)
  >('midiOutClose');
...
int midiOutGetNumDevs() {
  final _midiOutGetNumDevs = _winmm.lookupFunction<
    Uint32 Function(), 
    int Function()
  >('midiOutGetNumDevs');
...
int midiOutOpen(Pointer<IntPtr> phmo, int uDeviceID, int dwCallback, int dwInstance, int fdwOpen) {
  final _midiOutOpen = _winmm.lookupFunction<
    Uint32 Function(Pointer<IntPtr> phmo, Uint32 uDeviceID, IntPtr dwCallback, IntPtr dwInstance, Uint32 fdwOpen), 
    int Function(Pointer<IntPtr> phmo, int uDeviceID, int dwCallback, int dwInstance, int fdwOpen)
  >('midiOutOpen');
...
int midiOutReset(int hmo) {
  final _midiOutReset = _winmm.lookupFunction<
    Uint32 Function(IntPtr hmo), 
    int Function(int hmo)
  >('midiOutReset');
...
int midiStreamClose(int hms) {
  final _midiStreamClose = _winmm.lookupFunction<
    Uint32 Function(IntPtr hms), 
    int Function(int hms)
  >('midiStreamClose');
  return _midiStreamClose(hms);
}

int midiStreamOpen(Pointer<IntPtr> phms, Pointer<Uint32> puDeviceID, int cMidi, int dwCallback, int dwInstance, int fdwOpen) {
  final _midiStreamOpen = _winmm.lookupFunction<
    Uint32 Function(Pointer<IntPtr> phms, Pointer<Uint32> puDeviceID, Uint32 cMidi, IntPtr dwCallback, IntPtr dwInstance, Uint32 fdwOpen), 
    int Function(Pointer<IntPtr> phms, Pointer<Uint32> puDeviceID, int cMidi, int dwCallback, int dwInstance, int fdwOpen)
  >('midiStreamOpen');
  return _midiStreamOpen(phms, puDeviceID, cMidi, dwCallback, dwInstance, fdwOpen);
}
...
int midiStreamOut(int hms, Pointer<MIDIHDR> pmh, int cbmh) {
  final _midiStreamOut = _winmm.lookupFunction<
    ...
    int Function(int hms, Pointer<MIDIHDR> pmh, int cbmh)
  >('midiStreamOut');
  return _midiStreamOut(hms, pmh, cbmh);
}

int midiStreamPause(int hms) {
  final _midiStreamPause = _winmm.lookupFunction<
    Uint32 Function(IntPtr hms), 
    int Function(int hms)
  >('midiStreamPause');
...
int midiStreamPosition(int hms, Pointer<MMTIME> lpmmt, int cbmmt) {
  final _midiStreamPosition = _winmm.lookupFunction<
    ...
    int Function(int hms, Pointer<MMTIME> lpmmt, int cbmmt)
  >('midiStreamPosition');
...
int midiStreamProperty(int hms, Pointer<Uint8> lppropdata, int dwProperty) {
  final _midiStreamProperty = _winmm.lookupFunction<
    ...
    int Function(int hms, Pointer<Uint8> lppropdata, int dwProperty)
  >('midiStreamProperty');
  return _midiStreamProperty(hms, lppropdata, dwProperty);
}

int midiStreamRestart(int hms) {
  final _midiStreamRestart = _winmm.lookupFunction<
    Uint32 Function(IntPtr hms), 
    int Function(int hms)
  >('midiStreamRestart');
...
int midiStreamStop(int hms) {
  final _midiStreamStop = _winmm.lookupFunction<
    Uint32 Function(IntPtr hms), 
    int Function(int hms)
  >('midiStreamStop');
...
int mixerClose(int hmx) {
  final _mixerClose = _winmm.lookupFunction<
    Uint32 Function(IntPtr hmx), 
    int Function(int hmx)
  >('mixerClose');
  return _mixerClose(hmx);
}

int mixerGetControlDetailsW(int hmxobj, Pointer<MIXERCONTROLDETAILS> pmxcd, int fdwDetails) {
  final _mixerGetControlDetailsW = _winmm.lookupFunction<
    Uint32 Function(IntPtr hmxobj, Pointer<MIXERCONTROLDETAILS> pmxcd, Uint32 fdwDetails), 
    int Function(int hmxobj, Pointer<MIXERCONTROLDETAILS> pmxcd, int fdwDetails)
...
int mixerGetDevCapsW(int uMxId, Pointer<MIXERCAPS> pmxcaps, int cbmxcaps) {
  final _mixerGetDevCapsW = _winmm.lookupFunction<
    ...
    int Function(int uMxId, Pointer<MIXERCAPS> pmxcaps, int cbmxcaps)
  >('mixerGetDevCapsW');
...
int mixerGetID(int hmxobj, Pointer<Uint32> puMxId, int fdwId) {
  final _mixerGetID = _winmm.lookupFunction<
    ...
    int Function(int hmxobj, Pointer<Uint32> puMxId, int fdwId)
  >('mixerGetID');
  return _mixerGetID(hmxobj, puMxId, fdwId);
}

int mixerGetLineControlsW(int hmxobj, Pointer<MIXERLINECONTROLS> pmxlc, int fdwControls) {
  final _mixerGetLineControlsW = _winmm.lookupFunction<
    Uint32 Function(IntPtr hmxobj, Pointer<MIXERLINECONTROLS> pmxlc, Uint32 fdwControls), 
    int Function(int hmxobj, Pointer<MIXERLINECONTROLS> pmxlc, int fdwControls)
...
int mixerGetLineInfoW(int hmxobj, Pointer<MIXERLINE> pmxl, int fdwInfo) {
  final _mixerGetLineInfoW = _winmm.lookupFunction<
    ...
    int Function(int hmxobj, Pointer<MIXERLINE> pmxl, int fdwInfo)
  >('mixerGetLineInfoW');
  return _mixerGetLineInfoW(hmxobj, pmxl, fdwInfo);
}

int mixerGetNumDevs() {
  final _mixerGetNumDevs = _winmm.lookupFunction<
    Uint32 Function(), 
    int Function()
  >('mixerGetNumDevs');
...
int mixerMessage(int hmx, int uMsg, int dwParam1, int dwParam2) {
  final _mixerMessage = _winmm.lookupFunction<
    ...
    int Function(int hmx, int uMsg, int dwParam1, int dwParam2)
  >('mixerMessage');
  return _mixerMessage(hmx, uMsg, dwParam1, dwParam2);
}

int mixerOpen(Pointer<IntPtr> phmx, int uMxId, int dwCallback, int dwInstance, int fdwOpen) {
  final _mixerOpen = _winmm.lookupFunction<
    Uint32 Function(Pointer<IntPtr> phmx, Uint32 uMxId, IntPtr dwCallback, IntPtr dwInstance, Uint32 fdwOpen), 
    int Function(Pointer<IntPtr> phmx, int uMxId, int dwCallback, int dwInstance, int fdwOpen)
  >('mixerOpen');
  return _mixerOpen(phmx, uMxId, dwCallback, dwInstance, fdwOpen);
}

int mixerSetControlDetails(int hmxobj, Pointer<MIXERCONTROLDETAILS> pmxcd, int fdwDetails) {
...
int mmDrvInstall(int hDriver, Pointer<Utf16> wszDrvEntry, DRIVERMSGPROC drvMessage, int wFlags) {
  final _mmDrvInstall = _winmm.lookupFunction<
    Uint32 Function(IntPtr hDriver, Pointer<Utf16> wszDrvEntry, DRIVERMSGPROC drvMessage, Uint32 wFlags), 
    int Function(int hDriver, Pointer<Utf16> wszDrvEntry, DRIVERMSGPROC drvMessage, int wFlags)
  >('mmDrvInstall');
  return _mmDrvInstall(hDriver, wszDrvEntry, drvMessage, wFlags);
}

int mmGetCurrentTask() {
  final _mmGetCurrentTask = _winmm.lookupFunction<
    Uint32 Function(), 
    int Function()
  >('mmGetCurrentTask');
...
void mmTaskBlock(int h) {
  final _mmTaskBlock = _winmm.lookupFunction<
    Void Function(Uint32 h), 
    void Function(int h)
  >('mmTaskBlock');
...
int mmTaskCreate(Pointer<TASKCALLBACK> lpfn, Pointer<IntPtr> lph, int dwInst) {
  final _mmTaskCreate = _winmm.lookupFunction<
    Uint32 Function(Pointer<TASKCALLBACK> lpfn, Pointer<IntPtr> lph, IntPtr dwInst), 
    int Function(Pointer<TASKCALLBACK> lpfn, Pointer<IntPtr> lph, int dwInst)
  >('mmTaskCreate');
  return _mmTaskCreate(lpfn, lph, dwInst);
}

int mmTaskSignal(int h) {
  final _mmTaskSignal = _winmm.lookupFunction<
    Int32 Function(Uint32 h), 
    int Function(int h)
  >('mmTaskSignal');
...
void mmTaskYield() {
  final _mmTaskYield = _winmm.lookupFunction<
    Void Function(), 
    void Function()
  >('mmTaskYield');
  return _mmTaskYield();
...
int mmioAdvance(int hmmio, Pointer<MMIOINFO> pmmioinfo, int fuAdvance) {
  final _mmioAdvance = _winmm.lookupFunction<
    Uint32 Function(IntPtr hmmio, Pointer<MMIOINFO> pmmioinfo, Uint32 fuAdvance), 
    int Function(int hmmio, Pointer<MMIOINFO> pmmioinfo, int fuAdvance)
  >('mmioAdvance');
...
int mmioAscend(int hmmio, Pointer<MMCKINFO> pmmcki, int fuAscend) {
  final _mmioAscend = _winmm.lookupFunction<
    ...
    int Function(int hmmio, Pointer<MMCKINFO> pmmcki, int fuAscend)
  >('mmioAscend');
...
int mmioClose(int hmmio, int fuClose) {
  final _mmioClose = _winmm.lookupFunction<
    ...
    int Function(int hmmio, int fuClose)
  >('mmioClose');
...
int mmioCreateChunk(int hmmio, Pointer<MMCKINFO> pmmcki, int fuCreate) {
  final _mmioCreateChunk = _winmm.lookupFunction<
    ...
    int Function(int hmmio, Pointer<MMCKINFO> pmmcki, int fuCreate)
  >('mmioCreateChunk');
  return _mmioCreateChunk(hmmio, pmmcki, fuCreate);
}

int mmioDescend(int hmmio, Pointer<MMCKINFO> pmmcki, Pointer<MMCKINFO> pmmckiParent, int fuDescend) {
  final _mmioDescend = _winmm.lookupFunction<
    Uint32 Function(IntPtr hmmio, Pointer<MMCKINFO> pmmcki, Pointer<MMCKINFO> pmmckiParent, Uint32 fuDescend), 
    int Function(int hmmio, Pointer<MMCKINFO> pmmcki, Pointer<MMCKINFO> pmmckiParent, int fuDescend)
  >('mmioDescend');
...
int mmioFlush(int hmmio, int fuFlush) {
  final _mmioFlush = _winmm.lookupFunction<
    ...
    int Function(int hmmio, int fuFlush)
  >('mmioFlush');
...
int mmioGetInfo(int hmmio, Pointer<MMIOINFO> pmmioinfo, int fuInfo) {
  final _mmioGetInfo = _winmm.lookupFunction<
    ...
    int Function(int hmmio, Pointer<MMIOINFO> pmmioinfo, int fuInfo)
  >('mmioGetInfo');
  return _mmioGetInfo(hmmio, pmmioinfo, fuInfo);
}

Pointer<MMIOPROC> mmioInstallIOProcW(int fccIOProc, Pointer<MMIOPROC> pIOProc, int dwFlags) {
  final _mmioInstallIOProcW = _winmm.lookupFunction<
    Pointer<MMIOPROC> Function(Uint32 fccIOProc, Pointer<MMIOPROC> pIOProc, Uint32 dwFlags), 
    Pointer<MMIOPROC> Function(int fccIOProc, Pointer<MMIOPROC> pIOProc, int dwFlags)
  >('mmioInstallIOProcW');
  return _mmioInstallIOProcW(fccIOProc, pIOProc, dwFlags);
}

int mmioOpenW(Pointer<Utf16> pszFileName, Pointer<MMIOINFO> pmmioinfo, int fdwOpen) {
  final _mmioOpenW = _winmm.lookupFunction<
    IntPtr Function(Pointer<Utf16> pszFileName, Pointer<MMIOINFO> pmmioinfo, Uint32 fdwOpen), 
    int Function(Pointer<Utf16> pszFileName, Pointer<MMIOINFO> pmmioinfo, int fdwOpen)
  >('mmioOpenW');
...
int mmioRead(int hmmio, Pointer<Int8> pch, int cch) {
  final _mmioRead = _winmm.lookupFunction<
    ...
    int Function(int hmmio, Pointer<Int8> pch, int cch)
  >('mmioRead');
  return _mmioRead(hmmio, pch, cch);
}

int mmioRenameW(Pointer<Utf16> pszFileName, Pointer<Utf16> pszNewFileName, Pointer<MMIOINFO> pmmioinfo, int fdwRename) {
  final _mmioRenameW = _winmm.lookupFunction<
    Uint32 Function(Pointer<Utf16> pszFileName, Pointer<Utf16> pszNewFileName, Pointer<MMIOINFO> pmmioinfo, Uint32 fdwRename), 
    int Function(Pointer<Utf16> pszFileName, Pointer<Utf16> pszNewFileName, Pointer<MMIOINFO> pmmioinfo, int fdwRename)
  >('mmioRenameW');
...
int mmioSeek(int hmmio, int lOffset, int iOrigin) {
  final _mmioSeek = _winmm.lookupFunction<
    ...
    int Function(int hmmio, int lOffset, int iOrigin)
  >('mmioSeek');
...
int mmioSendMessage(int hmmio, int uMsg, int lParam1, int lParam2) {
  final _mmioSendMessage = _winmm.lookupFunction<
    ...
    int Function(int hmmio, int uMsg, int lParam1, int lParam2)
  >('mmioSendMessage');
  return _mmioSendMessage(hmmio, uMsg, lParam1, lParam2);
}

int mmioSetBuffer(int hmmio, Pointer<Utf8> pchBuffer, int cchBuffer, int fuBuffer) {
  final _mmioSetBuffer = _winmm.lookupFunction<
    Uint32 Function(IntPtr hmmio, Pointer<Utf8> pchBuffer, Int32 cchBuffer, Uint32 fuBuffer), 
    int Function(int hmmio, Pointer<Utf8> pchBuffer, int cchBuffer, int fuBuffer)
  >('mmioSetBuffer');
...
int mmioStringToFOURCCW(Pointer<Utf16> sz, int uFlags) {
  final _mmioStringToFOURCCW = _winmm.lookupFunction<
    ...
    int Function(Pointer<Utf16> sz, int uFlags)
  >('mmioStringToFOURCCW');
...
int mmioWrite(int hmmio, Pointer<Utf8> pch, int cch) {
  final _mmioWrite = _winmm.lookupFunction<
    ...
    int Function(int hmmio, Pointer<Utf8> pch, int cch)
  >('mmioWrite');
...
int sndPlaySoundW(Pointer<Utf16> pszSound, int fuSound) {
  final _sndPlaySoundW = _winmm.lookupFunction<
    ...
    int Function(Pointer<Utf16> pszSound, int fuSound)
  >('sndPlaySoundW');
...
int timeBeginPeriod(int uPeriod) {
  final _timeBeginPeriod = _winmm.lookupFunction<
    ...
    int Function(int uPeriod)
  >('timeBeginPeriod');
  return _timeBeginPeriod(uPeriod);
}

int timeEndPeriod(int uPeriod) {
  final _timeEndPeriod = _winmm.lookupFunction<
    Uint32 Function(Uint32 uPeriod), 
    int Function(int uPeriod)
  >('timeEndPeriod');
...
int timeGetDevCaps(Pointer<TIMECAPS> ptc, int cbtc) {
  final _timeGetDevCaps = _winmm.lookupFunction<
    ...
    int Function(Pointer<TIMECAPS> ptc, int cbtc)
  >('timeGetDevCaps');
...
int timeGetSystemTime(Pointer<MMTIME> pmmt, int cbmmt) {
  final _timeGetSystemTime = _winmm.lookupFunction<
    ...
    int Function(Pointer<MMTIME> pmmt, int cbmmt)
  >('timeGetSystemTime');
  return _timeGetSystemTime(pmmt, cbmmt);
}

int timeGetTime() {
  final _timeGetTime = _winmm.lookupFunction<
    Uint32 Function(), 
    int Function()
  >('timeGetTime');
  return _timeGetTime();
...
int waveInClose(int hwi) {
  final _waveInClose = _winmm.lookupFunction<
    Uint32 Function(IntPtr hwi), 
    int Function(int hwi)
  >('waveInClose');
...
int waveInGetNumDevs() {
  final _waveInGetNumDevs = _winmm.lookupFunction<
    Uint32 Function(), 
    int Function()
  >('waveInGetNumDevs');
...
int waveInOpen(Pointer<HWAVEIN> phwi, int uDeviceID, Pointer<WAVEFORMATEX> pwfx, int dwCallback, int dwInstance, int fdwOpen) {
  final _waveInOpen = _winmm.lookupFunction<
    Uint32 Function(Pointer<HWAVEIN> phwi, Uint32 uDeviceID, Pointer<WAVEFORMATEX> pwfx, IntPtr dwCallback, IntPtr dwInstance, Uint32 fdwOpen), 
    int Function(Pointer<HWAVEIN> phwi, int uDeviceID, Pointer<WAVEFORMATEX> pwfx, int dwCallback, int dwInstance, int fdwOpen)
  >('waveInOpen');
...
int waveInReset(int hwi) {
  final _waveInReset = _winmm.lookupFunction<
    Uint32 Function(IntPtr hwi), 
    int Function(int hwi)
  >('waveInReset');
...
int waveInStart(int hwi) {
  final _waveInStart = _winmm.lookupFunction<
    Uint32 Function(IntPtr hwi), 
    int Function(int hwi)
  >('waveInStart');
...
int waveInStop(int hwi) {
  final _waveInStop = _winmm.lookupFunction<
    Uint32 Function(IntPtr hwi), 
    int Function(int hwi)
  >('waveInStop');
...
int waveOutBreakLoop(int hwo) {
  final _waveOutBreakLoop = _winmm.lookupFunction<
...
int waveOutGetNumDevs() {
  final _waveOutGetNumDevs = _winmm.lookupFunction<
    Uint32 Function(), 
    int Function()
  >('waveOutGetNumDevs');
...
int waveOutOpen(Pointer<IntPtr> phwo, int uDeviceID, Pointer<WAVEFORMATEX> pwfx, int dwCallback, int dwInstance, int fdwOpen) {
...
int waveOutPause(int hwo) {
  final _waveOutPause = _winmm.lookupFunction<
    Uint32 Function(IntPtr hwo), 
    int Function(int hwo)
  >('waveOutPause');
...
int waveOutRestart(int hwo) {
  final _waveOutRestart = _winmm.lookupFunction<
    Uint32 Function(IntPtr hwo), 
    int Function(int hwo)
  >('waveOutRestart');
