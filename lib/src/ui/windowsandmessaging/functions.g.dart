...
int ChangeMenu(int hMenu, int cmd, Pointer<Utf16> lpszNewItem, int cmdInsert,
        int flags) =>
    _ChangeMenu(hMenu, cmd, lpszNewItem, cmdInsert, flags);

late final _ChangeMenu = _user32.lookupFunction<
    Int32 Function(IntPtr hMenu, Uint32 cmd, Pointer<Utf16> lpszNewItem,
        Uint32 cmdInsert, Uint32 flags),
    int Function(int hMenu, int cmd, Pointer<Utf16> lpszNewItem, int cmdInsert,
        int flags)>('ChangeMenuW');
...
int CharLowerBuff(Pointer<Utf16> lpsz, int cchLength) =>
    _CharLowerBuff(lpsz, cchLength);

late final _CharLowerBuff = _user32.lookupFunction<
    Uint32 Function(Pointer<Utf16> lpsz, Uint32 cchLength),
    int Function(Pointer<Utf16> lpsz, int cchLength)>('CharLowerBuffW');

Pointer<Utf16> CharLower(Pointer<Utf16> lpsz) => _CharLower(lpsz);

late final _CharLower = _user32.lookupFunction<
    Pointer<Utf16> Function(Pointer<Utf16> lpsz),
    Pointer<Utf16> Function(Pointer<Utf16> lpsz)>('CharLowerW');

Pointer<Utf16> CharNext(Pointer<Utf16> lpsz) => _CharNext(lpsz);

late final _CharNext = _user32.lookupFunction<
    Pointer<Utf16> Function(Pointer<Utf16> lpsz),
    Pointer<Utf16> Function(Pointer<Utf16> lpsz)>('CharNextW');

Pointer<Utf16> CharPrev(Pointer<Utf16> lpszStart, Pointer<Utf16> lpszCurrent) =>
    _CharPrev(lpszStart, lpszCurrent);

late final _CharPrev = _user32.lookupFunction<
    Pointer<Utf16> Function(
        Pointer<Utf16> lpszStart, Pointer<Utf16> lpszCurrent),
    Pointer<Utf16> Function(
        Pointer<Utf16> lpszStart, Pointer<Utf16> lpszCurrent)>('CharPrevW');

int CharToOemBuff(
        Pointer<Utf16> lpszSrc, Pointer<Utf8> lpszDst, int cchDstLength) =>
    _CharToOemBuff(lpszSrc, lpszDst, cchDstLength);

late final _CharToOemBuff = _user32.lookupFunction<
    Int32 Function(
        Pointer<Utf16> lpszSrc, Pointer<Utf8> lpszDst, Uint32 cchDstLength),
    int Function(Pointer<Utf16> lpszSrc, Pointer<Utf8> lpszDst,
        int cchDstLength)>('CharToOemBuffW');

int CharToOem(Pointer<Utf16> pSrc, Pointer<Utf8> pDst) =>
    _CharToOem(pSrc, pDst);

late final _CharToOem = _user32.lookupFunction<
    Int32 Function(Pointer<Utf16> pSrc, Pointer<Utf8> pDst),
    int Function(Pointer<Utf16> pSrc, Pointer<Utf8> pDst)>('CharToOemW');

int CharUpperBuff(Pointer<Utf16> lpsz, int cchLength) =>
    _CharUpperBuff(lpsz, cchLength);

late final _CharUpperBuff = _user32.lookupFunction<
    Uint32 Function(Pointer<Utf16> lpsz, Uint32 cchLength),
    int Function(Pointer<Utf16> lpsz, int cchLength)>('CharUpperBuffW');

Pointer<Utf16> CharUpper(Pointer<Utf16> lpsz) => _CharUpper(lpsz);

late final _CharUpper = _user32.lookupFunction<
    Pointer<Utf16> Function(Pointer<Utf16> lpsz),
    Pointer<Utf16> Function(Pointer<Utf16> lpsz)>('CharUpperW');

int CheckMenuItem(int hMenu, int uIDCheckItem, int uCheck) =>
    _CheckMenuItem(hMenu, uIDCheckItem, uCheck);

late final _CheckMenuItem = _user32.lookupFunction<
    Uint32 Function(IntPtr hMenu, Uint32 uIDCheckItem, Uint32 uCheck),
    int Function(int hMenu, int uIDCheckItem, int uCheck)>('CheckMenuItem');

int CheckMenuRadioItem(int hmenu, int first, int last, int check, int flags) =>
    _CheckMenuRadioItem(hmenu, first, last, check, flags);

late final _CheckMenuRadioItem = _user32.lookupFunction<
    Int32 Function(
        IntPtr hmenu, Uint32 first, Uint32 last, Uint32 check, Uint32 flags),
    int Function(int hmenu, int first, int last, int check,
        int flags)>('CheckMenuRadioItem');
...
late final _CopyIcon = _user32.lookupFunction<IntPtr Function(IntPtr hIcon),
...
late final _CreateDialogParam = _user32.lookupFunction<
    ...
    int Function(
        ...
        int hWndParent,
        Pointer<NativeFunction<DLGPROC>> lpDialogFunc,
        int dwInitParam)>('CreateDialogParamW');
...
int DefDlgProc(int hDlg, int Msg, int wParam, int lParam) =>
    _DefDlgProc(hDlg, Msg, wParam, lParam);

late final _DefDlgProc = _user32.lookupFunction<
    IntPtr Function(IntPtr hDlg, Uint32 Msg, IntPtr wParam, IntPtr lParam),
    int Function(int hDlg, int Msg, int wParam, int lParam)>('DefDlgProcW');

int DefFrameProc(
        int hWnd, int hWndMDIClient, int uMsg, int wParam, int lParam) =>
    _DefFrameProc(hWnd, hWndMDIClient, uMsg, wParam, lParam);

late final _DefFrameProc = _user32.lookupFunction<
    IntPtr Function(IntPtr hWnd, IntPtr hWndMDIClient, Uint32 uMsg,
        IntPtr wParam, IntPtr lParam),
    int Function(int hWnd, int hWndMDIClient, int uMsg, int wParam,
        int lParam)>('DefFrameProcW');
...
int DeregisterShellHookWindow(int hwnd) => _DeregisterShellHookWindow(hwnd);
...
late final _DestroyCursor = _user32.lookupFunction<
    Int32 Function(IntPtr hCursor), int Function(int hCursor)>('DestroyCursor');

int DestroyIcon(int hIcon) => _DestroyIcon(hIcon);

late final _DestroyIcon = _user32.lookupFunction<Int32 Function(IntPtr hIcon),
    int Function(int hIcon)>('DestroyIcon');

int DestroyMenu(int hMenu) => _DestroyMenu(hMenu);

late final _DestroyMenu = _user32.lookupFunction<Int32 Function(IntPtr hMenu),
...
int DialogBoxParam(int hInstance, Pointer<Utf16> lpTemplateName, int hWndParent,
        Pointer<NativeFunction<DLGPROC>> lpDialogFunc, int dwInitParam) =>
    _DialogBoxParam(
        hInstance, lpTemplateName, hWndParent, lpDialogFunc, dwInitParam);
...
late final _DialogBoxParam = _user32.lookupFunction<
    ...
    int Function(
        ...
        int hWndParent,
        Pointer<NativeFunction<DLGPROC>> lpDialogFunc,
        int dwInitParam)>('DialogBoxParamW');
...
int DragObject(int hwndParent, int hwndFrom, int fmt, int data, int hcur) =>
    _DragObject(hwndParent, hwndFrom, fmt, data, hcur);

late final _DragObject = _user32.lookupFunction<
    Uint32 Function(IntPtr hwndParent, IntPtr hwndFrom, Uint32 fmt, IntPtr data,
        IntPtr hcur),
    int Function(int hwndParent, int hwndFrom, int fmt, int data,
        int hcur)>('DragObject');
...
int DrawIconEx(int hdc, int xLeft, int yTop, int hIcon, int cxWidth,
        int cyWidth, int istepIfAniCur, int hbrFlickerFreeDraw, int diFlags) =>
    _DrawIconEx(hdc, xLeft, yTop, hIcon, cxWidth, cyWidth, istepIfAniCur,
...
late final _DrawIconEx = _user32.lookupFunction<
    ...
    int Function(
        ...
        int diFlags)>('DrawIconEx');

int DrawMenuBar(int hWnd) => _DrawMenuBar(hWnd);

late final _DrawMenuBar =
    _user32.lookupFunction<Int32 Function(IntPtr hWnd), int Function(int hWnd)>(
        'DrawMenuBar');
...
int EnumPropsEx(int hWnd, Pointer<NativeFunction<PROPENUMPROCEXW>> lpEnumFunc,
        int lParam) =>
    _EnumPropsEx(hWnd, lpEnumFunc, lParam);

late final _EnumPropsEx = _user32.lookupFunction<
    Int32 Function(IntPtr hWnd,
        Pointer<NativeFunction<PROPENUMPROCEXW>> lpEnumFunc, IntPtr lParam),
    int Function(int hWnd, Pointer<NativeFunction<PROPENUMPROCEXW>> lpEnumFunc,
        int lParam)>('EnumPropsExW');

int EnumProps(int hWnd, Pointer<NativeFunction<PROPENUMPROCW>> lpEnumFunc) =>
    _EnumProps(hWnd, lpEnumFunc);

late final _EnumProps = _user32.lookupFunction<
    Int32 Function(
        IntPtr hWnd, Pointer<NativeFunction<PROPENUMPROCW>> lpEnumFunc),
    int Function(int hWnd,
        Pointer<NativeFunction<PROPENUMPROCW>> lpEnumFunc)>('EnumPropsW');
...
int GetClassLong(int hWnd, int nIndex) => _GetClassLong(hWnd, nIndex);

late final _GetClassLong = _user32.lookupFunction<
    Uint32 Function(IntPtr hWnd, Uint32 nIndex),
    int Function(int hWnd, int nIndex)>('GetClassLongW');
...
int GetClassWord(int hWnd, int nIndex) => _GetClassWord(hWnd, nIndex);

late final _GetClassWord = _user32.lookupFunction<
    Uint16 Function(IntPtr hWnd, Int32 nIndex),
    int Function(int hWnd, int nIndex)>('GetClassWord');
...
int GetDlgCtrlID(int hWnd) => _GetDlgCtrlID(hWnd);

late final _GetDlgCtrlID =
    _user32.lookupFunction<Int32 Function(IntPtr hWnd), int Function(int hWnd)>(
        'GetDlgCtrlID');
...
int GetDpiAwarenessContextForProcess(int hProcess) =>
    _GetDpiAwarenessContextForProcess(hProcess);

late final _GetDpiAwarenessContextForProcess = _user32.lookupFunction<
    IntPtr Function(IntPtr hProcess),
    int Function(int hProcess)>('GetDpiAwarenessContextForProcess');
...
int GetLastActivePopup(int hWnd) => _GetLastActivePopup(hWnd);

late final _GetLastActivePopup = _user32.lookupFunction<
    IntPtr Function(IntPtr hWnd), int Function(int hWnd)>('GetLastActivePopup');
...
late final _GetMenu = _user32.lookupFunction<IntPtr Function(IntPtr hWnd),
...
late final _GetMenuBarInfo = _user32.lookupFunction<
    Int32 Function(
        IntPtr hwnd, Uint32 idObject, Int32 idItem, Pointer<MENUBARINFO> pmbi),
...
late final _GetMenuItemCount = _user32.lookupFunction<
    Int32 Function(IntPtr hMenu), int Function(int hMenu)>('GetMenuItemCount');
...
late final _GetParent = _user32.lookupFunction<IntPtr Function(IntPtr hWnd),
...
int GetProcessDefaultLayout(Pointer<Uint32> pdwDefaultLayout) =>
    _GetProcessDefaultLayout(pdwDefaultLayout);

late final _GetProcessDefaultLayout = _user32.lookupFunction<
    Int32 Function(Pointer<Uint32> pdwDefaultLayout),
    int Function(Pointer<Uint32> pdwDefaultLayout)>('GetProcessDefaultLayout');
...
int GetQueueStatus(int flags) => _GetQueueStatus(flags);

late final _GetQueueStatus = _user32.lookupFunction<
    Uint32 Function(Uint32 flags), int Function(int flags)>('GetQueueStatus');
...
late final _GetSysColor = _user32.lookupFunction<Uint32 Function(Uint32 nIndex),
...
late final _GetTopWindow = _user32.lookupFunction<IntPtr Function(IntPtr hWnd),
...
late final _GetWindowLong = _user32.lookupFunction<
    Int32 Function(IntPtr hWnd, Uint32 nIndex),
...
late final _GetWindowTextLength =
    _user32.lookupFunction<Int32 Function(IntPtr hWnd), int Function(int hWnd)>(
...
int GetWindowWord(int hWnd, int nIndex) => _GetWindowWord(hWnd, nIndex);

late final _GetWindowWord = _user32.lookupFunction<
    Uint16 Function(IntPtr hWnd, Int32 nIndex),
    int Function(int hWnd, int nIndex)>('GetWindowWord');

int HideCaret(int hWnd) => _HideCaret(hWnd);

late final _HideCaret =
    _user32.lookupFunction<Int32 Function(IntPtr hWnd), int Function(int hWnd)>(
        'HideCaret');
...
int InheritWindowMonitor(int hwnd, int hwndInherit) =>
    _InheritWindowMonitor(hwnd, hwndInherit);

late final _InheritWindowMonitor = _user32.lookupFunction<
    Int32 Function(IntPtr hwnd, IntPtr hwndInherit),
    int Function(int hwnd, int hwndInherit)>('InheritWindowMonitor');
...
int InternalGetWindowText(int hWnd, Pointer<Utf16> pString, int cchMaxCount) =>
    _InternalGetWindowText(hWnd, pString, cchMaxCount);

late final _InternalGetWindowText = _user32.lookupFunction<
    Int32 Function(IntPtr hWnd, Pointer<Utf16> pString, Int32 cchMaxCount),
    int Function(int hWnd, Pointer<Utf16> pString,
        int cchMaxCount)>('InternalGetWindowText');

int IsCharAlphaNumeric(int ch) => _IsCharAlphaNumeric(ch);

late final _IsCharAlphaNumeric =
    _user32.lookupFunction<Int32 Function(Uint16 ch), int Function(int ch)>(
        'IsCharAlphaNumericW');

int IsCharAlpha(int ch) => _IsCharAlpha(ch);

late final _IsCharAlpha =
    _user32.lookupFunction<Int32 Function(Uint16 ch), int Function(int ch)>(
        'IsCharAlphaW');

int IsCharUpper(int ch) => _IsCharUpper(ch);

late final _IsCharUpper =
    _user32.lookupFunction<Int32 Function(Uint16 ch), int Function(int ch)>(
        'IsCharUpperW');
...
late final _IsGUIThread = _user32.lookupFunction<Int32 Function(Int32 bConvert),
...
late final _IsIconic =
    _user32.lookupFunction<Int32 Function(IntPtr hWnd), int Function(int hWnd)>(
        'IsIconic');

int IsMenu(int hMenu) => _IsMenu(hMenu);

late final _IsMenu = _user32.lookupFunction<Int32 Function(IntPtr hMenu),
...
int OemToCharBuff(
        Pointer<Utf8> lpszSrc, Pointer<Utf16> lpszDst, int cchDstLength) =>
    _OemToCharBuff(lpszSrc, lpszDst, cchDstLength);

late final _OemToCharBuff = _user32.lookupFunction<
    Int32 Function(
        Pointer<Utf8> lpszSrc, Pointer<Utf16> lpszDst, Uint32 cchDstLength),
    int Function(Pointer<Utf8> lpszSrc, Pointer<Utf16> lpszDst,
        int cchDstLength)>('OemToCharBuffW');

int OemToChar(Pointer<Utf8> pSrc, Pointer<Utf16> pDst) =>
    _OemToChar(pSrc, pDst);

late final _OemToChar = _user32.lookupFunction<
    Int32 Function(Pointer<Utf8> pSrc, Pointer<Utf16> pDst),
    int Function(Pointer<Utf8> pSrc, Pointer<Utf16> pDst)>('OemToCharW');

int OpenIcon(int hWnd) => _OpenIcon(hWnd);

late final _OpenIcon =
    _user32.lookupFunction<Int32 Function(IntPtr hWnd), int Function(int hWnd)>(
        'OpenIcon');
...
int RealChildWindowFromPoint(int hwndParent, POINT ptParentClientCoords) =>
    _RealChildWindowFromPoint(hwndParent, ptParentClientCoords);

late final _RealChildWindowFromPoint = _user32.lookupFunction<
    IntPtr Function(IntPtr hwndParent, POINT ptParentClientCoords),
    int Function(int hwndParent,
        POINT ptParentClientCoords)>('RealChildWindowFromPoint');

int RealGetWindowClass(
        int hwnd, Pointer<Utf16> ptszClassName, int cchClassNameMax) =>
    _RealGetWindowClass(hwnd, ptszClassName, cchClassNameMax);

late final _RealGetWindowClass = _user32.lookupFunction<
    Uint32 Function(
        IntPtr hwnd, Pointer<Utf16> ptszClassName, Uint32 cchClassNameMax),
    int Function(int hwnd, Pointer<Utf16> ptszClassName,
        int cchClassNameMax)>('RealGetWindowClassW');
...
int RegisterShellHookWindow(int hwnd) => _RegisterShellHookWindow(hwnd);
...
late final _ReplyMessage = _user32.lookupFunction<
    Int32 Function(IntPtr lResult), int Function(int lResult)>('ReplyMessage');
...
int SetClassLong(int hWnd, int nIndex, int dwNewLong) =>
    _SetClassLong(hWnd, nIndex, dwNewLong);

late final _SetClassLong = _user32.lookupFunction<
    Uint32 Function(IntPtr hWnd, Uint32 nIndex, Int32 dwNewLong),
    int Function(int hWnd, int nIndex, int dwNewLong)>('SetClassLongW');

int SetClassWord(int hWnd, int nIndex, int wNewWord) =>
    _SetClassWord(hWnd, nIndex, wNewWord);

late final _SetClassWord = _user32.lookupFunction<
    Uint16 Function(IntPtr hWnd, Int32 nIndex, Uint16 wNewWord),
    int Function(int hWnd, int nIndex, int wNewWord)>('SetClassWord');
...
late final _SetCursor = _user32.lookupFunction<IntPtr Function(IntPtr hCursor),
...
void SetDebugErrorLevel(int dwLevel) => _SetDebugErrorLevel(dwLevel);

late final _SetDebugErrorLevel = _user32.lookupFunction<
    Void Function(Uint32 dwLevel),
    void Function(int dwLevel)>('SetDebugErrorLevel');
...
int SetMessageQueue(int cMessagesMax) => _SetMessageQueue(cMessagesMax);

late final _SetMessageQueue = _user32.lookupFunction<
    Int32 Function(Int32 cMessagesMax),
    int Function(int cMessagesMax)>('SetMessageQueue');
...
int SetProcessDefaultLayout(int dwDefaultLayout) =>
    _SetProcessDefaultLayout(dwDefaultLayout);

late final _SetProcessDefaultLayout = _user32.lookupFunction<
    Int32 Function(Uint32 dwDefaultLayout),
    int Function(int dwDefaultLayout)>('SetProcessDefaultLayout');
...
late final _SetWindowLong = _user32.lookupFunction<
    Int32 Function(IntPtr hWnd, Uint32 nIndex, Int32 dwNewLong),
...
int SetWindowWord(int hWnd, int nIndex, int wNewWord) =>
    _SetWindowWord(hWnd, nIndex, wNewWord);

late final _SetWindowWord = _user32.lookupFunction<
    Uint16 Function(IntPtr hWnd, Int32 nIndex, Uint16 wNewWord),
    int Function(int hWnd, int nIndex, int wNewWord)>('SetWindowWord');
...
late final _SetWindowsHookEx = _user32.lookupFunction<
    IntPtr Function(Uint32 idHook, Pointer<NativeFunction<HOOKPROC>> lpfn,
...
int SetWindowsHook(
        int nFilterType, Pointer<NativeFunction<HOOKPROC>> pfnFilterProc) =>
    _SetWindowsHook(nFilterType, pfnFilterProc);

late final _SetWindowsHook = _user32.lookupFunction<
    IntPtr Function(
        Int32 nFilterType, Pointer<NativeFunction<HOOKPROC>> pfnFilterProc),
    int Function(int nFilterType,
        Pointer<NativeFunction<HOOKPROC>> pfnFilterProc)>('SetWindowsHookW');

int ShowCaret(int hWnd) => _ShowCaret(hWnd);

late final _ShowCaret =
    _user32.lookupFunction<Int32 Function(IntPtr hWnd), int Function(int hWnd)>(
        'ShowCaret');

int ShowCursor(int bShow) => _ShowCursor(bShow);

late final _ShowCursor = _user32.lookupFunction<Int32 Function(Int32 bShow),
...
int UnhookWindowsHook(
        int nCode, Pointer<NativeFunction<HOOKPROC>> pfnFilterProc) =>
    _UnhookWindowsHook(nCode, pfnFilterProc);

late final _UnhookWindowsHook = _user32.lookupFunction<
    Int32 Function(
        Int32 nCode, Pointer<NativeFunction<HOOKPROC>> pfnFilterProc),
    int Function(int nCode,
        Pointer<NativeFunction<HOOKPROC>> pfnFilterProc)>('UnhookWindowsHook');
...
late final _WindowFromPoint = _user32.lookupFunction<
    IntPtr Function(POINT Point), int Function(POINT Point)>('WindowFromPoint');

int wsprintf(Pointer<Utf16> param0, Pointer<Utf16> param1) =>
    _wsprintf(param0, param1);

late final _wsprintf = _user32.lookupFunction<
    Int32 Function(Pointer<Utf16> param0, Pointer<Utf16> param1),
    int Function(Pointer<Utf16> param0, Pointer<Utf16> param1)>('wsprintfW');

int wvsprintf(
        Pointer<Utf16> param0, Pointer<Utf16> param1, Pointer<Int8> arglist) =>
    _wvsprintf(param0, param1, arglist);

late final _wvsprintf = _user32.lookupFunction<
    Int32 Function(
        Pointer<Utf16> param0, Pointer<Utf16> param1, Pointer<Int8> arglist),
    int Function(Pointer<Utf16> param0, Pointer<Utf16> param1,
        Pointer<Int8> arglist)>('wvsprintfW');
...
int CreateResourceIndexer(Pointer<Utf16> projectRoot,
        Pointer<Utf16> extensionDllPath, Pointer<Pointer> ppResourceIndexer) =>
    _CreateResourceIndexer(projectRoot, extensionDllPath, ppResourceIndexer);

late final _CreateResourceIndexer = _mrmsupport.lookupFunction<
    Int32 Function(Pointer<Utf16> projectRoot, Pointer<Utf16> extensionDllPath,
        Pointer<Pointer> ppResourceIndexer),
    int Function(Pointer<Utf16> projectRoot, Pointer<Utf16> extensionDllPath,
        Pointer<Pointer> ppResourceIndexer)>('CreateResourceIndexer');

void DestroyIndexedResults(Pointer<Utf16> resourceUri, int qualifierCount,
        Pointer<IndexedResourceQualifier> qualifiers) =>
    _DestroyIndexedResults(resourceUri, qualifierCount, qualifiers);

late final _DestroyIndexedResults = _mrmsupport.lookupFunction<
    Void Function(Pointer<Utf16> resourceUri, Uint32 qualifierCount,
        Pointer<IndexedResourceQualifier> qualifiers),
    void Function(Pointer<Utf16> resourceUri, int qualifierCount,
        Pointer<IndexedResourceQualifier> qualifiers)>('DestroyIndexedResults');

void DestroyResourceIndexer(Pointer resourceIndexer) =>
    _DestroyResourceIndexer(resourceIndexer);

late final _DestroyResourceIndexer = _mrmsupport.lookupFunction<
    Void Function(Pointer resourceIndexer),
    void Function(Pointer resourceIndexer)>('DestroyResourceIndexer');
...
int IndexFilePath(
    ...
    _IndexFilePath(resourceIndexer, filePath, ppResourceUri, pQualifierCount,
        ppQualifiers);
...
int MrmCreateConfig(int platformVersion, Pointer<Utf16> defaultQualifiers,
        Pointer<Utf16> outputXmlFile) =>
    _MrmCreateConfig(platformVersion, defaultQualifiers, outputXmlFile);

late final _MrmCreateConfig = _mrmsupport.lookupFunction<
    Int32 Function(Uint32 platformVersion, Pointer<Utf16> defaultQualifiers,
        Pointer<Utf16> outputXmlFile),
    int Function(int platformVersion, Pointer<Utf16> defaultQualifiers,
        Pointer<Utf16> outputXmlFile)>('MrmCreateConfig');
...
int MrmCreateConfigInMemory(
    ...
    _MrmCreateConfigInMemory(
        platformVersion, defaultQualifiers, outputXmlData, outputXmlSize);

late final _MrmCreateConfigInMemory = _mrmsupport.lookupFunction<
    Int32 Function(Uint32 platformVersion, Pointer<Utf16> defaultQualifiers,
        Pointer<Pointer<Uint8>> outputXmlData, Pointer<Uint32> outputXmlSize),
    int Function(
        int platformVersion,
        Pointer<Utf16> defaultQualifiers,
        Pointer<Pointer<Uint8>> outputXmlData,
        Pointer<Uint32> outputXmlSize)>('MrmCreateConfigInMemory');

int MrmCreateResourceFile(MrmResourceIndexerHandle indexer, int packagingMode,
        int packagingOptions, Pointer<Utf16> outputDirectory) =>
    _MrmCreateResourceFile(
        indexer, packagingMode, packagingOptions, outputDirectory);

late final _MrmCreateResourceFile = _mrmsupport.lookupFunction<
    Int32 Function(MrmResourceIndexerHandle indexer, Uint32 packagingMode,
        Uint32 packagingOptions, Pointer<Utf16> outputDirectory),
    int Function(
        MrmResourceIndexerHandle indexer,
        int packagingMode,
        int packagingOptions,
        Pointer<Utf16> outputDirectory)>('MrmCreateResourceFile');
...
int MrmCreateResourceFileInMemory(
    ...
    _MrmCreateResourceFileInMemory(
        indexer, packagingMode, packagingOptions, outputPriData, outputPriSize);

late final _MrmCreateResourceFileInMemory = _mrmsupport.lookupFunction<
    Int32 Function(
        MrmResourceIndexerHandle indexer,
        Uint32 packagingMode,
        Uint32 packagingOptions,
        Pointer<Pointer<Uint8>> outputPriData,
        Pointer<Uint32> outputPriSize),
    int Function(
        MrmResourceIndexerHandle indexer,
        ...
        int packagingOptions,
        Pointer<Pointer<Uint8>> outputPriData,
        Pointer<Uint32> outputPriSize)>('MrmCreateResourceFileInMemory');
...
int MrmCreateResourceIndexer(
    ...
    _MrmCreateResourceIndexer(packageFamilyName, projectRoot, platformVersion,
        defaultQualifiers, indexer);
...
late final _MrmCreateResourceIndexer = _mrmsupport.lookupFunction<
    ...
    int Function(
        ...
        int platformVersion,
        Pointer<Utf16> defaultQualifiers,
        Pointer<MrmResourceIndexerHandle> indexer)>('MrmCreateResourceIndexer');
...
int MrmCreateResourceIndexerFromPreviousPriData(
        ...
        int priSize,
        Pointer<MrmResourceIndexerHandle> indexer) =>
    _MrmCreateResourceIndexerFromPreviousPriData(projectRoot, platformVersion,
        defaultQualifiers, priData, priSize, indexer);
...
int MrmDestroyIndexerAndMessages(MrmResourceIndexerHandle indexer) =>
    _MrmDestroyIndexerAndMessages(indexer);

late final _MrmDestroyIndexerAndMessages = _mrmsupport.lookupFunction<
    Int32 Function(MrmResourceIndexerHandle indexer),
    int Function(
        MrmResourceIndexerHandle indexer)>('MrmDestroyIndexerAndMessages');
...
int MrmDumpPriDataInMemory(
        ...
        Pointer<Pointer<Uint8>> outputXmlData,
        Pointer<Uint32> outputXmlSize) =>
    _MrmDumpPriDataInMemory(inputPriData, inputPriSize, schemaPriData,
        schemaPriSize, dumpType, outputXmlData, outputXmlSize);
...
late final _MrmDumpPriDataInMemory = _mrmsupport.lookupFunction<
    ...
    int Function(
        ...
        int dumpType,
        Pointer<Pointer<Uint8>> outputXmlData,
        Pointer<Uint32> outputXmlSize)>('MrmDumpPriDataInMemory');

int MrmDumpPriFile(Pointer<Utf16> indexFileName, Pointer<Utf16> schemaPriFile,
        int dumpType, Pointer<Utf16> outputXmlFile) =>
    _MrmDumpPriFile(indexFileName, schemaPriFile, dumpType, outputXmlFile);

late final _MrmDumpPriFile = _mrmsupport.lookupFunction<
    Int32 Function(Pointer<Utf16> indexFileName, Pointer<Utf16> schemaPriFile,
        Uint32 dumpType, Pointer<Utf16> outputXmlFile),
    int Function(Pointer<Utf16> indexFileName, Pointer<Utf16> schemaPriFile,
        int dumpType, Pointer<Utf16> outputXmlFile)>('MrmDumpPriFile');
...
int MrmDumpPriFileInMemory(
    ...
    _MrmDumpPriFileInMemory(
        indexFileName, schemaPriFile, dumpType, outputXmlData, outputXmlSize);
...
late final _MrmDumpPriFileInMemory = _mrmsupport.lookupFunction<
    ...
    int Function(
        ...
        int dumpType,
        Pointer<Pointer<Uint8>> outputXmlData,
        Pointer<Uint32> outputXmlSize)>('MrmDumpPriFileInMemory');

int MrmFreeMemory(Pointer<Uint8> data) => _MrmFreeMemory(data);

late final _MrmFreeMemory = _mrmsupport.lookupFunction<
    Int32 Function(Pointer<Uint8> data),
    int Function(Pointer<Uint8> data)>('MrmFreeMemory');
...
int MrmIndexEmbeddedData(
    ...
    _MrmIndexEmbeddedData(
        indexer, resourceUri, embeddedData, embeddedDataSize, qualifiers);
...
late final _MrmIndexEmbeddedData = _mrmsupport.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Uint8> embeddedData,
        int embeddedDataSize,
        Pointer<Utf16> qualifiers)>('MrmIndexEmbeddedData');

int MrmIndexFile(MrmResourceIndexerHandle indexer, Pointer<Utf16> resourceUri,
        Pointer<Utf16> filePath, Pointer<Utf16> qualifiers) =>
    _MrmIndexFile(indexer, resourceUri, filePath, qualifiers);

late final _MrmIndexFile = _mrmsupport.lookupFunction<
    Int32 Function(MrmResourceIndexerHandle indexer, Pointer<Utf16> resourceUri,
        Pointer<Utf16> filePath, Pointer<Utf16> qualifiers),
    int Function(MrmResourceIndexerHandle indexer, Pointer<Utf16> resourceUri,
        Pointer<Utf16> filePath, Pointer<Utf16> qualifiers)>('MrmIndexFile');

int MrmIndexFileAutoQualifiers(
        MrmResourceIndexerHandle indexer, Pointer<Utf16> filePath) =>
    _MrmIndexFileAutoQualifiers(indexer, filePath);

late final _MrmIndexFileAutoQualifiers = _mrmsupport.lookupFunction<
    Int32 Function(MrmResourceIndexerHandle indexer, Pointer<Utf16> filePath),
    int Function(MrmResourceIndexerHandle indexer,
        Pointer<Utf16> filePath)>('MrmIndexFileAutoQualifiers');

int MrmIndexResourceContainerAutoQualifiers(
        MrmResourceIndexerHandle indexer, Pointer<Utf16> containerPath) =>
    _MrmIndexResourceContainerAutoQualifiers(indexer, containerPath);
...
int MrmIndexString(MrmResourceIndexerHandle indexer, Pointer<Utf16> resourceUri,
        Pointer<Utf16> resourceString, Pointer<Utf16> qualifiers) =>
    _MrmIndexString(indexer, resourceUri, resourceString, qualifiers);
...
late final _MrmIndexString = _mrmsupport.lookupFunction<
    ...
    int Function(
        ...
        Pointer<Utf16> qualifiers)>('MrmIndexString');
...
int MrmPeekResourceIndexerMessages(
    ...
    _MrmPeekResourceIndexerMessages(handle, messages, numMsgs);
...
late final _MrmPeekResourceIndexerMessages = _mrmsupport.lookupFunction<
    ...
    int Function(
        MrmResourceIndexerHandle handle,
        Pointer<Pointer<MrmResourceIndexerMessage>> messages,
        Pointer<Uint32> numMsgs)>('MrmPeekResourceIndexerMessages');
...
int GetFileTitle(Pointer<Utf16> param0, Pointer<Utf16> Buf, int cchSize) =>
    _GetFileTitle(param0, Buf, cchSize);

late final _GetFileTitle = _comdlg32.lookupFunction<
    Int16 Function(Pointer<Utf16> param0, Pointer<Utf16> Buf, Uint16 cchSize),
    int Function(Pointer<Utf16> param0, Pointer<Utf16> Buf,
        int cchSize)>('GetFileTitleW');
...
int PageSetupDlg(Pointer<PAGESETUPDLG> param0) => _PageSetupDlg(param0);

late final _PageSetupDlg = _comdlg32.lookupFunction<
    Int32 Function(Pointer<PAGESETUPDLG> param0),
    int Function(Pointer<PAGESETUPDLG> param0)>('PageSetupDlgW');

int PrintDlgEx(Pointer<PRINTDLGEX> pPD) => _PrintDlgEx(pPD);

late final _PrintDlgEx = _comdlg32.lookupFunction<
    Int32 Function(Pointer<PRINTDLGEX> pPD),
    int Function(Pointer<PRINTDLGEX> pPD)>('PrintDlgExW');

int PrintDlg(Pointer<PRINTDLG> pPD) => _PrintDlg(pPD);

late final _PrintDlg = _comdlg32.lookupFunction<
    Int32 Function(Pointer<PRINTDLG> pPD),
    int Function(Pointer<PRINTDLG> pPD)>('PrintDlgW');
