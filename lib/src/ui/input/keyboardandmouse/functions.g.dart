...
late final _BlockInput = _user32.lookupFunction<
    Int32 Function(
  Int32 fBlockIt,
),
    int Function(
...
late final _GetKeyState = _user32.lookupFunction<
    Int16 Function(
  Int32 nVirtKey,
),
    int Function(
...
late final _IsWindowEnabled = _user32.lookupFunction<
    Int32 Function(
  IntPtr hWnd,
),
    int Function(
...
late final _SetCapture = _user32.lookupFunction<
    IntPtr Function(
  IntPtr hWnd,
),
    int Function(
...
late final _SetFocus = _user32.lookupFunction<
    IntPtr Function(
  IntPtr hWnd,
),
    int Function(
...
int TrackMouseEvent(
  Pointer<TRACKMOUSEEVENT> lpEventTrack,
) =>
    _TrackMouseEvent(
      lpEventTrack,
    );
...
int UnloadKeyboardLayout(
  int hkl,
    ...
    _UnloadKeyboardLayout(
      hkl,
    );

late final _UnloadKeyboardLayout = _user32.lookupFunction<
    Int32 Function(
  IntPtr hkl,
),
    int Function(
...
late final _VkKeyScan = _user32.lookupFunction<
    Int16 Function(
  Uint16 ch,
),
    int Function(
