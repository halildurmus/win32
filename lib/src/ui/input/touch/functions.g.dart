...
int UnregisterTouchWindow(
  int hwnd,
    ...
    _UnregisterTouchWindow(
      hwnd,
    );

late final _UnregisterTouchWindow = _user32.lookupFunction<
    Int32 Function(
  IntPtr hwnd,
),
    int Function(
