...
/// @nodoc
const IID_IActiveIMMIME = '{08C03411-F96B-11D0-A475-00AA006BCC59}';

/// {@category Interface}
/// {@category com}
class IActiveIMMIME extends IUnknown {
  // vtable begins at 3, is 88 entries long.
  IActiveIMMIME(Pointer<COMObject> ptr) : super(ptr);
  ...
  int LockIMC(
    int hIMC,
    Pointer<Pointer<INPUTCONTEXT>> ppIMC,
  ) =>
      ptr.ref.lpVtbl.value
          .elementAt(61)
          .cast<
  ...
  int GetHotKey(
    int dwHotKeyID,
    Pointer<Uint32> puModifiers,
    Pointer<Uint32> puVKey,
    Pointer<IntPtr> phKL,
  ) =>
      ptr.ref.lpVtbl.value
          .elementAt(71)
  ...
  int CreateSoftKeyboard(
    int uType,
    int hOwner,
    int x,
    int y,
    Pointer<IntPtr> phSoftKbdWnd,
  ) =>
      ptr.ref.lpVtbl.value
          .elementAt(73)
          .cast<
  ...
  int LockModal() => ptr.ref.lpVtbl.value
          .elementAt(79)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int UnlockModal() => ptr.ref.lpVtbl.value
          .elementAt(80)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int IsSleeping() => ptr.ref.lpVtbl.value
          .elementAt(90)
          .cast<
              Pointer<
                  NativeFunction<
