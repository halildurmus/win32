/// {@category Enum}
class ANCHOR_CHANGE_HISTORY_FLAGS {
  static const TS_CH_PRECEDING_DEL = 0x00000001;
  static const TS_CH_FOLLOWING_DEL = 0x00000002;
}

/// {@category Enum}
class GET_TEXT_AND_PROPERTY_UPDATES_FLAGS {
  static const TF_GTP_NONE = 0x00000000;
  static const TF_GTP_INCL_TEXT = 0x00000001;
}

/// {@category Enum}
class INSERT_TEXT_AT_SELECTION_FLAGS {
...
/// {@category Enum}
class LANG_BAR_ITEM_ICON_MODE_FLAGS {
  static const TF_DTLBI_NONE = 0x00000000;
  static const TF_DTLBI_USEPROFILEICON = 0x00000001;
}

/// {@category Enum}
class TEXT_STORE_CHANGE_FLAGS {
  static const TS_TC_NONE = 0x00000000;
  static const TS_TC_CORRECTION = 0x00000001;
}

/// {@category Enum}
class TEXT_STORE_LOCK_FLAGS {
  static const TS_LF_READ = 0x00000002;
  static const TS_LF_READWRITE = 0x00000006;
}

/// {@category Enum}
class TEXT_STORE_TEXT_CHANGE_FLAGS {
  static const TS_ST_NONE = 0x00000000;
  static const TS_ST_CORRECTION = 0x00000001;
}

/// {@category Enum}
class TF_CONTEXT_EDIT_CONTEXT_FLAGS {
