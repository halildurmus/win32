...
/// @nodoc
const IID_IInkPicture = '{E85662E0-379A-40D7-9B5C-757D233F9923}';

/// {@category Interface}
/// {@category com}
class IInkPicture extends IDispatch {
  // vtable begins at 7, is 59 entries long.
  IInkPicture(Pointer<COMObject> ptr) : super(ptr);
  ...
  set Picture(Pointer<COMObject> value) {
    final hr = ptr.ref.lpVtbl.value
        .elementAt(37)
        .cast<
            Pointer<
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
            Pointer,
            Pointer<Pointer<COMObject>> ppPicture,
          )>>>()
          .value
          .asFunction<
              int Function(
...
/// @nodoc
const CLSID_InkPicture = '{04A1E553-FE36-4FDE-865E-344194E69424}';

/// {@category com}
class InkPicture extends IInkPicture {
  InkPicture(Pointer<COMObject> ptr) : super(ptr);

  factory InkPicture.createInstance() {
    final ptr = calloc<COMObject>();
    final clsid = calloc<GUID>()..ref.setGUID(CLSID_InkPicture);
    final iid = calloc<GUID>()..ref.setGUID(IID_IInkPicture);
