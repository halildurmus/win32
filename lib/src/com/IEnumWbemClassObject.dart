...
typedef NextAsync_Dart = int Function(Pointer obj, int uCount, Pointer pSink);

typedef Clone_Native = Int32 Function(Pointer obj, Pointer ppEnum);
typedef Clone_Dart = int Function(Pointer obj, Pointer ppEnum);
