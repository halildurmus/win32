...
import '../../system/remotedesktop/IWRdsProtocolLogonErrorRedirector.dart';
import '../../foundation/structs.g.dart';
import '../../system/remotedesktop/structs.g.dart';
import '../../system/remotedesktop/IWRdsProtocolLicenseConnection.dart';
import '../../system/remotedesktop/IWRdsProtocolShadowConnection.dart';

/// @nodoc
const IID_IWRdsProtocolConnection = '{324ED94F-FDAF-4FF6-81A8-42ABE755830B}';

/// {@category Interface}
/// {@category com}
class IWRdsProtocolConnection extends IUnknown {
  // vtable begins at 3, is 24 entries long.
  IWRdsProtocolConnection(Pointer<COMObject> ptr) : super(ptr);
  ...
  int GetClientMonitorData(
    Pointer<Uint32> pNumMonitors,
    Pointer<Uint32> pPrimaryMonitor,
  ) =>
      ptr.ref.lpVtbl.value
          .elementAt(6)
          .cast<
  ...
  int NotifyCommandProcessCreated(
    int SessionId,
  ) =>
      ptr.ref.lpVtbl.value
          .elementAt(26)
