...
late final _ClosePseudoConsole = _kernel32.lookupFunction<
    Void Function(
  IntPtr hPC,
),
    void Function(
...
void ExpungeConsoleCommandHistory(
  Pointer<Utf16> ExeName,
) =>
    _ExpungeConsoleCommandHistory(
      ExeName,
    );
...
int GetConsoleAliasExes(
  Pointer<Utf16> ExeNameBuffer,
  int ExeNameBufferLength,
) =>
    _GetConsoleAliasExes(
      ExeNameBuffer,
      ExeNameBufferLength,
    );
...
int GetConsoleAliasesLength(
  Pointer<Utf16> ExeName,
) =>
    _GetConsoleAliasesLength(
      ExeName,
    );
...
int GetConsoleAliases(
  Pointer<Utf16> AliasBuffer,
...
int GetConsoleCommandHistoryLength(
  Pointer<Utf16> ExeName,
) =>
    _GetConsoleCommandHistoryLength(
      ExeName,
    );
...
int GetConsoleCommandHistory(
  Pointer<Utf16> Commands,
  int CommandBufferLength,
  Pointer<Utf16> ExeName,
) =>
    _GetConsoleCommandHistory(
      Commands,
      CommandBufferLength,
      ExeName,
    );
...
int GetConsoleDisplayMode(
  Pointer<Uint32> lpModeFlags,
) =>
    _GetConsoleDisplayMode(
      lpModeFlags,
    );
...
int GetConsoleHistoryInfo(
  Pointer<CONSOLE_HISTORY_INFO> lpConsoleHistoryInfo,
) =>
    _GetConsoleHistoryInfo(
...
int GetConsoleOriginalTitle(
  Pointer<Utf16> lpConsoleTitle,
  int nSize,
) =>
    _GetConsoleOriginalTitle(
      lpConsoleTitle,
      nSize,
    );
...
int GetConsoleProcessList(
  Pointer<Uint32> lpdwProcessList,
  int dwProcessCount,
) =>
...
int GetNumberOfConsoleMouseButtons(
  Pointer<Uint32> lpNumberOfMouseButtons,
) =>
...
int ReadConsoleOutputAttribute(
  ...
  int nLength,
  COORD dwReadCoord,
  Pointer<Uint32> lpNumberOfAttrsRead,
) =>
...
int ReadConsoleOutputCharacter(
  int hConsoleOutput,
...
int SetConsoleNumberOfCommands(
  int Number,
  Pointer<Utf16> ExeName,
) =>
    _SetConsoleNumberOfCommands(
      Number,
      ExeName,
    );
...
int WriteConsoleInput(
  int hConsoleInput,
  Pointer<INPUT_RECORD> lpBuffer,
  int nLength,
  Pointer<Uint32> lpNumberOfEventsWritten,
) =>
    _WriteConsoleInput(
      hConsoleInput,
      lpBuffer,
