...
/// @nodoc
const IID_IDebugAdvanced4 = '{D1069067-2A65-4BF0-AE97-76184B67856B}';

/// {@category Interface}
/// {@category com}
class IDebugAdvanced4 extends IUnknown {
  // vtable begins at 3, is 11 entries long.
  IDebugAdvanced4(Pointer<COMObject> ptr) : super(ptr);
  ...
  int GetSymbolInformationWideEx(
    ...
    int StringBufferSize,
    Pointer<Uint32> StringSize,
    Pointer<SYMBOL_INFO_EX> pInfoEx,
  ) =>
      ptr.ref.lpVtbl.value
          .elementAt(13)
          .cast<
