...
/// @nodoc
const IID_IRunningTask = '{653758FB-7B9A-4F1E-A471-BEEB8E9B834E}';

/// {@category Interface}
/// {@category com}
class IRunningTask extends IDispatch {
  // vtable begins at 7, is 8 entries long.
  IRunningTask(Pointer<COMObject> ptr) : super(ptr);
  ...
  Pointer<Utf16> get InstanceGuid {
    final retValuePtr = calloc<Pointer<Utf16>>();
  ...
  Pointer<Utf16> get CurrentAction {
    final retValuePtr = calloc<Pointer<Utf16>>();
