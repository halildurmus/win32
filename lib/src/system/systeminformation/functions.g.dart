...
int GetPhysicallyInstalledSystemMemory(
  Pointer<Uint64> TotalMemoryInKilobytes,
    ...
    _GetPhysicallyInstalledSystemMemory(
...
int GetSystemCpuSetInformation(
  Pointer<SYSTEM_CPU_SET_INFORMATION> Information,
  int BufferLength,
  Pointer<Uint32> ReturnedLength,
  int Process,
  int Flags,
...
late final _GetSystemCpuSetInformation = _kernel32.lookupFunction<
    Int32 Function(
  Pointer<SYSTEM_CPU_SET_INFORMATION> Information,
  Uint32 BufferLength,
  Pointer<Uint32> ReturnedLength,
...
late final _GetSystemDEPPolicy = _kernel32
    .lookupFunction<Int32 Function(), int Function()>('GetSystemDEPPolicy');
...
int GetSystemLeapSecondInformation(
  ...
  Pointer<Uint32> Flags,
    ...
    _GetSystemLeapSecondInformation(
      Enabled,
      Flags,
    );
...
void GetSystemTimeAsFileTime(
  Pointer<FILETIME> lpSystemTimeAsFileTime,
) =>
...
int GetSystemWindowsDirectory(
  Pointer<Utf16> lpBuffer,
  int uSize,
) =>
    _GetSystemWindowsDirectory(
      lpBuffer,
      uSize,
    );
...
int GetSystemWow64Directory(
  Pointer<Utf16> lpBuffer,
  int uSize,
) =>
    _GetSystemWow64Directory(
      lpBuffer,
      uSize,
    );
...
int IsWow64GuestMachineSupported(
  int WowGuestMachine,
  Pointer<Int32> MachineIsSupported,
) =>
    _IsWow64GuestMachineSupported(
      WowGuestMachine,
      MachineIsSupported,
    );
...
late final _SetSystemTimeAdjustment = _kernel32.lookupFunction<
    Int32 Function(
  Uint32 dwTimeAdjustment,
  Int32 bTimeAdjustmentDisabled,
),
    int Function(
  int dwTimeAdjustment,
  int bTimeAdjustmentDisabled,
...
int SetSystemTimeAdjustmentPrecise(
  ...
  int bTimeAdjustmentDisabled,
    ...
    _SetSystemTimeAdjustmentPrecise(
      dwTimeAdjustment,
      bTimeAdjustmentDisabled,
    );
...
int GetIntegratedDisplaySize(
  Pointer<Double> sizeInInches,
) =>
    _GetIntegratedDisplaySize(
      sizeInInches,
    );
...
int RtlConvertDeviceFamilyInfoToString(
  ...
  Pointer<Utf16> DeviceForm,
    ...
    _RtlConvertDeviceFamilyInfoToString(
...
void RtlGetDeviceFamilyInfoEnum(
  Pointer<Uint64> pullUAPInfo,
  Pointer<Uint32> pulDeviceFamily,
  Pointer<Uint32> pulDeviceForm,
) =>
    _RtlGetDeviceFamilyInfoEnum(
      pullUAPInfo,
      pulDeviceFamily,
      pulDeviceForm,
    );
...
int RtlSwitchedVVI(
  Pointer<OSVERSIONINFOEX> VersionInfo,
  int TypeMask,
  int ConditionMask,
) =>
    _RtlSwitchedVVI(
