...
class WM_WRITER_STATISTICS extends Struct {
  @Uint64() external int qwSampleCount;
  @Uint64() external int qwByteCount;
  @Uint64() external int qwDroppedSampleCount;
  @Uint64() external int qwDroppedByteCount;
  @Uint32() external int dwCurrentBitrate;
  @Uint32() external int dwAverageBitrate;
  @Uint32() external int dwExpectedBitrate;
  @Uint32() external int dwCurrentSampleRate;
  @Uint32() external int dwAverageSampleRate;
  @Uint32() external int dwExpectedSampleRate;
}

class WM_WRITER_STATISTICS_EX extends Struct {
  @Uint32() external int dwBitratePlusOverhead;
  @Uint32() external int dwCurrentSampleDropRateInQueue;
  @Uint32() external int dwCurrentSampleDropRateInCodec;
  @Uint32() external int dwCurrentSampleDropRateInMultiplexer;
  @Uint32() external int dwTotalSampleDropsInQueue;
  @Uint32() external int dwTotalSampleDropsInCodec;
  @Uint32() external int dwTotalSampleDropsInMultiplexer;
}

class WM_READER_STATISTICS extends Struct {
  @Uint32() external int cbSize;
  @Uint32() external int dwBandwidth;
  @Uint32() external int cPacketsReceived;
  @Uint32() external int cPacketsRecovered;
  @Uint32() external int cPacketsLost;
  @Uint16() external int wQuality;
}
...
class WMT_FILESINK_DATA_UNIT extends Struct {
  ...
  @Uint32() external int cPayloads;
  external Pointer<WMT_BUFFER_SEGMENT> pPayloadHeaderBuffers;
  @Uint32() external int cPayloadDataFragments;
...
class WMT_WEBSTREAM_FORMAT extends Struct {
  ...
  @Uint16() external int cbSampleHeaderFixedData;
...
class WMT_WATERMARK_ENTRY extends Struct {
  @Uint32() external int wmetType;
  external GUID clsid;
  @Uint32() external int cbDisplayName;
...
class WMT_VIDEOIMAGE_SAMPLE extends Struct {
  ...
  @Uint32() external int dwControlFlags;
  @Uint32() external int dwInputFlagsCur;
  @Int32() external int lCurMotionXtoX;
  @Int32() external int lCurMotionYtoX;
  @Int32() external int lCurMotionXoffset;
  @Int32() external int lCurMotionXtoY;
  @Int32() external int lCurMotionYtoY;
  @Int32() external int lCurMotionYoffset;
  @Int32() external int lCurBlendCoef1;
  @Int32() external int lCurBlendCoef2;
  @Uint32() external int dwInputFlagsPrev;
  @Int32() external int lPrevMotionXtoX;
  @Int32() external int lPrevMotionYtoX;
  @Int32() external int lPrevMotionXoffset;
  @Int32() external int lPrevMotionXtoY;
  @Int32() external int lPrevMotionYtoY;
  @Int32() external int lPrevMotionYoffset;
  @Int32() external int lPrevBlendCoef1;
  @Int32() external int lPrevBlendCoef2;
}
...
class WMT_VIDEOIMAGE_SAMPLE2 extends Struct {
  ...
  @Uint32() external int dwControlFlags;
  @Uint32() external int dwViewportWidth;
  @Uint32() external int dwViewportHeight;
  @Uint32() external int dwCurrImageWidth;
  @Uint32() external int dwCurrImageHeight;
  @Float() external double fCurrRegionX0;
  @Float() external double fCurrRegionY0;
  @Float() external double fCurrRegionWidth;
  @Float() external double fCurrRegionHeight;
  @Float() external double fCurrBlendCoef;
  @Uint32() external int dwPrevImageWidth;
  @Uint32() external int dwPrevImageHeight;
  @Float() external double fPrevRegionX0;
  @Float() external double fPrevRegionY0;
  @Float() external double fPrevRegionWidth;
  @Float() external double fPrevRegionHeight;
  @Float() external double fPrevBlendCoef;
  @Uint32() external int dwEffectType;
  @Uint32() external int dwNumEffectParas;
  @Float() external double fEffectPara0;
  @Float() external double fEffectPara1;
  @Float() external double fEffectPara2;
  @Float() external double fEffectPara3;
  @Float() external double fEffectPara4;
  @Int32() external int bKeepPrevImage;
}
...
class WMT_COLORSPACEINFO_EXTENSION_DATA extends Struct {
  @Uint8() external int ucColorPrimaries;
  @Uint8() external int ucColorTransferChar;
  @Uint8() external int ucColorMatrixCoef;
}

class WMT_TIMECODE_EXTENSION_DATA extends Struct {
  @Uint16() external int wRange;
  @Uint32() external int dwTimecode;
  @Uint32() external int dwUserbits;
  @Uint32() external int dwAmFlags;
}
...
class WMDRM_IMPORT_INIT_STRUCT extends Struct {
  ...
  @Uint32() external int cbEncryptedSessionKeyMessage;
  external Pointer<Uint8> pbEncryptedSessionKeyMessage;
  @Uint32() external int cbEncryptedKeyMessage;
  external Pointer<Uint8> pbEncryptedKeyMessage;
}

class DRM_MINIMUM_OUTPUT_PROTECTION_LEVELS extends Struct {
  @Uint16() external int wCompressedDigitalVideo;
  @Uint16() external int wUncompressedDigitalVideo;
  @Uint16() external int wAnalogVideo;
  @Uint16() external int wCompressedDigitalAudio;
  @Uint16() external int wUncompressedDigitalAudio;
}

class DRM_OPL_OUTPUT_IDS extends Struct {
  @Uint16() external int cIds;
  external Pointer<GUID> rgIds;
}

class DRM_OUTPUT_PROTECTION extends Struct {
  external GUID guidId;
  @Uint8() external int bConfigData;
}

class DRM_VIDEO_OUTPUT_PROTECTION_IDS extends Struct {
  @Uint16() external int cEntries;
