...
/// @nodoc
const IID_ID3D10RenderTargetView = '{9B7E4C08-342C-4106-A19F-4F2704F689F0}';

/// {@category Interface}
/// {@category com}
class ID3D10RenderTargetView extends ID3D10View {
  // vtable begins at 8, is 1 entries long.
  ID3D10RenderTargetView(Pointer<COMObject> ptr) : super(ptr);
