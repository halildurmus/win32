...
/// @nodoc
const IID_IDirectDrawSurface4 = '{0B2B8630-AD35-11D0-8EA6-00609797EA5B}';
...
typedef _EnumAttachedSurfaces_Native = Int32 Function(Pointer obj,
    Pointer param0, Pointer<NativeFunction<LPDDENUMSURFACESCALLBACK2>> param1);
typedef _EnumAttachedSurfaces_Dart = int Function(Pointer obj, Pointer param0,
    Pointer<NativeFunction<LPDDENUMSURFACESCALLBACK2>> param1);

typedef _EnumOverlayZOrders_Native = Int32 Function(Pointer obj, Uint32 param0,
    Pointer param1, Pointer<NativeFunction<LPDDENUMSURFACESCALLBACK2>> param2);
...
class IDirectDrawSurface4 extends IUnknown {
  // vtable begins at 3, ends at 44

  IDirectDrawSurface4(Pointer<COMObject> ptr) : super(ptr);
  ...
  int EnumOverlayZOrders(int param0, Pointer param1,
          Pointer<NativeFunction<LPDDENUMSURFACESCALLBACK2>> param2) =>
      ptr.ref.lpVtbl.value
              .elementAt(10)
