...
/// @nodoc
const IID_IDirectDrawSurface7 = '{06675A80-3B9B-11D2-B92F-00609797EA5B}';
...
typedef _EnumAttachedSurfaces_Native = Int32 Function(Pointer obj,
    Pointer param0, Pointer<NativeFunction<LPDDENUMSURFACESCALLBACK7>> param1);
typedef _EnumAttachedSurfaces_Dart = int Function(Pointer obj, Pointer param0,
    Pointer<NativeFunction<LPDDENUMSURFACESCALLBACK7>> param1);

typedef _EnumOverlayZOrders_Native = Int32 Function(Pointer obj, Uint32 param0,
    Pointer param1, Pointer<NativeFunction<LPDDENUMSURFACESCALLBACK7>> param2);
...
typedef _GetAttachedSurface_Native = Int32 Function(
    Pointer obj, Pointer<DDSCAPS2> param0, Pointer<COMObject> param1);
...
typedef _GetCaps_Native = Int32 Function(Pointer obj, Pointer<DDSCAPS2> param0);
typedef _GetCaps_Dart = int Function(Pointer obj, Pointer<DDSCAPS2> param0);
...
typedef _Initialize_Native = Int32 Function(
    Pointer obj, COMObject param0, Pointer<DDSURFACEDESC2> param1);
...
typedef _Lock_Native = Int32 Function(Pointer obj, Pointer<RECT> param0,
    Pointer<DDSURFACEDESC2> param1, Uint32 param2, IntPtr param3);
typedef _Lock_Dart = int Function(Pointer obj, Pointer<RECT> param0,
    Pointer<DDSURFACEDESC2> param1, int param2, int param3);
...
typedef _Unlock_Native = Int32 Function(Pointer obj, Pointer<RECT> param0);
typedef _Unlock_Dart = int Function(Pointer obj, Pointer<RECT> param0);
...
typedef _SetSurfaceDesc_Native = Int32 Function(
    Pointer obj, Pointer<DDSURFACEDESC2> param0, Uint32 param1);
typedef _SetSurfaceDesc_Dart = int Function(
    Pointer obj, Pointer<DDSURFACEDESC2> param0, int param1);

typedef _SetPrivateData_Native = Int32 Function(Pointer obj,
    Pointer<GUID> param0, Pointer param1, Uint32 param2, Uint32 param3);
typedef _SetPrivateData_Dart = int Function(
    Pointer obj, Pointer<GUID> param0, Pointer param1, int param2, int param3);

typedef _GetPrivateData_Native = Int32 Function(
    Pointer obj, Pointer<GUID> param0, Pointer param1, Pointer<Uint32> param2);
typedef _GetPrivateData_Dart = int Function(
    Pointer obj, Pointer<GUID> param0, Pointer param1, Pointer<Uint32> param2);

typedef _FreePrivateData_Native = Int32 Function(
    Pointer obj, Pointer<GUID> param0);
typedef _FreePrivateData_Dart = int Function(Pointer obj, Pointer<GUID> param0);

typedef _GetUniquenessValue_Native = Int32 Function(
    Pointer obj, Pointer<Uint32> param0);
typedef _GetUniquenessValue_Dart = int Function(
    Pointer obj, Pointer<Uint32> param0);

typedef _ChangeUniquenessValue_Native = Int32 Function(Pointer obj);
typedef _ChangeUniquenessValue_Dart = int Function(Pointer obj);

typedef _SetPriority_Native = Int32 Function(Pointer obj, Uint32 param0);
typedef _SetPriority_Dart = int Function(Pointer obj, int param0);

typedef _GetPriority_Native = Int32 Function(
    Pointer obj, Pointer<Uint32> param0);
typedef _GetPriority_Dart = int Function(Pointer obj, Pointer<Uint32> param0);

typedef _SetLOD_Native = Int32 Function(Pointer obj, Uint32 param0);
typedef _SetLOD_Dart = int Function(Pointer obj, int param0);

typedef _GetLOD_Native = Int32 Function(Pointer obj, Pointer<Uint32> param0);
typedef _GetLOD_Dart = int Function(Pointer obj, Pointer<Uint32> param0);

/// {@category Interface}
/// {@category com}
class IDirectDrawSurface7 extends IUnknown {
  // vtable begins at 3, ends at 48

  IDirectDrawSurface7(Pointer<COMObject> ptr) : super(ptr);
  ...
  int EnumOverlayZOrders(int param0, Pointer param1,
          Pointer<NativeFunction<LPDDENUMSURFACESCALLBACK7>> param2) =>
      ptr.ref.lpVtbl.value
              .elementAt(10)
  ...
  int GetAttachedSurface(Pointer<DDSCAPS2> param0, Pointer<COMObject> param1) =>
      ptr.ref.lpVtbl.value
              .elementAt(12)
  ...
  int GetCaps(Pointer<DDSCAPS2> param0) => ptr.ref.lpVtbl.value
      .elementAt(14)
  ...
  int GetSurfaceDesc(Pointer<DDSURFACEDESC2> param0) => ptr.ref.lpVtbl.value
      .elementAt(22)
      .cast<Pointer<NativeFunction<_GetSurfaceDesc_Native>>>()
      .value
      .asFunction<_GetSurfaceDesc_Dart>()(ptr.ref.lpVtbl, param0);

  int Initialize(COMObject param0, Pointer<DDSURFACEDESC2> param1) =>
      ptr.ref.lpVtbl.value
          .elementAt(23)
  ...
  int Lock(Pointer<RECT> param0, Pointer<DDSURFACEDESC2> param1, int param2,
          int param3) =>
      ptr.ref.lpVtbl.value
              .elementAt(25)
  ...
  int Unlock(Pointer<RECT> param0) => ptr.ref.lpVtbl.value
      .elementAt(32)
  ...
  int SetSurfaceDesc(Pointer<DDSURFACEDESC2> param0, int param1) =>
      ptr.ref.lpVtbl.value
          .elementAt(39)
  ...
  int SetPrivateData(
          Pointer<GUID> param0, Pointer param1, int param2, int param3) =>
      ptr.ref.lpVtbl.value
              .elementAt(40)
  ...
  int GetPrivateData(
          Pointer<GUID> param0, Pointer param1, Pointer<Uint32> param2) =>
      ptr.ref.lpVtbl.value
              .elementAt(41)
  ...
  int FreePrivateData(Pointer<GUID> param0) => ptr.ref.lpVtbl.value
      .elementAt(42)
      .cast<Pointer<NativeFunction<_FreePrivateData_Native>>>()
      .value
      .asFunction<_FreePrivateData_Dart>()(ptr.ref.lpVtbl, param0);

  int GetUniquenessValue(Pointer<Uint32> param0) => ptr.ref.lpVtbl.value
      .elementAt(43)
      .cast<Pointer<NativeFunction<_GetUniquenessValue_Native>>>()
      .value
      .asFunction<_GetUniquenessValue_Dart>()(ptr.ref.lpVtbl, param0);

  int ChangeUniquenessValue() => ptr.ref.lpVtbl.value
      .elementAt(44)
      .cast<Pointer<NativeFunction<_ChangeUniquenessValue_Native>>>()
      .value
      .asFunction<_ChangeUniquenessValue_Dart>()(ptr.ref.lpVtbl);

  int SetPriority(int param0) => ptr.ref.lpVtbl.value
      .elementAt(45)
      .cast<Pointer<NativeFunction<_SetPriority_Native>>>()
      .value
      .asFunction<_SetPriority_Dart>()(ptr.ref.lpVtbl, param0);

  int GetPriority(Pointer<Uint32> param0) => ptr.ref.lpVtbl.value
      .elementAt(46)
      .cast<Pointer<NativeFunction<_GetPriority_Native>>>()
      .value
      .asFunction<_GetPriority_Dart>()(ptr.ref.lpVtbl, param0);

  int SetLOD(int param0) => ptr.ref.lpVtbl.value
      .elementAt(47)
      .cast<Pointer<NativeFunction<_SetLOD_Native>>>()
      .value
      .asFunction<_SetLOD_Dart>()(ptr.ref.lpVtbl, param0);

  int GetLOD(Pointer<Uint32> param0) => ptr.ref.lpVtbl.value
      .elementAt(48)
      .cast<Pointer<NativeFunction<_GetLOD_Native>>>()
      .value
      .asFunction<_GetLOD_Dart>()(ptr.ref.lpVtbl, param0);
}
