...
/// @nodoc
const IID_IDirectDraw7 = '{15E65EC0-3B9C-11D2-B92F-00609797EA5B}';
...
typedef _EnumSurfaces_Native = Int32 Function(
    ...
    Pointer<DDSURFACEDESC2> param1,
    Pointer param2,
    Pointer<NativeFunction<LPDDENUMSURFACESCALLBACK7>> param3);
...
typedef _GetDeviceIdentifier_Native = Int32 Function(
    Pointer obj, Pointer<DDDEVICEIDENTIFIER2> param0, Uint32 param1);
typedef _GetDeviceIdentifier_Dart = int Function(
    Pointer obj, Pointer<DDDEVICEIDENTIFIER2> param0, int param1);

typedef _StartModeTest_Native = Int32 Function(
    Pointer obj, Pointer<SIZE> param0, Uint32 param1, Uint32 param2);
typedef _StartModeTest_Dart = int Function(
    Pointer obj, Pointer<SIZE> param0, int param1, int param2);

typedef _EvaluateMode_Native = Int32 Function(
    Pointer obj, Uint32 param0, Pointer<Uint32> param1);
typedef _EvaluateMode_Dart = int Function(
    Pointer obj, int param0, Pointer<Uint32> param1);
...
class IDirectDraw7 extends IUnknown {
  ...
  IDirectDraw7(Pointer<COMObject> ptr) : super(ptr);
  ...
  int GetDeviceIdentifier(Pointer<DDDEVICEIDENTIFIER2> param0, int param1) =>
      ptr.ref.lpVtbl.value
              .elementAt(27)
              .cast<Pointer<NativeFunction<_GetDeviceIdentifier_Native>>>()
              .value
              .asFunction<_GetDeviceIdentifier_Dart>()(
          ptr.ref.lpVtbl, param0, param1);

  int StartModeTest(Pointer<SIZE> param0, int param1, int param2) =>
      ptr.ref.lpVtbl.value
              .elementAt(28)
              .cast<Pointer<NativeFunction<_StartModeTest_Native>>>()
              .value
              .asFunction<_StartModeTest_Dart>()(
          ptr.ref.lpVtbl, param0, param1, param2);

  int EvaluateMode(int param0, Pointer<Uint32> param1) => ptr.ref.lpVtbl.value
      .elementAt(29)
      .cast<Pointer<NativeFunction<_EvaluateMode_Native>>>()
      .value
      .asFunction<_EvaluateMode_Dart>()(ptr.ref.lpVtbl, param0, param1);
}
