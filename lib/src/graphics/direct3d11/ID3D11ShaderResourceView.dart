...
/// @nodoc
const IID_ID3D11ShaderResourceView = '{B0E06FE0-8192-4E1A-B1CA-36D7414710B2}';

/// {@category Interface}
/// {@category com}
class ID3D11ShaderResourceView extends ID3D11View {
  // vtable begins at 8, is 1 entries long.
  ID3D11ShaderResourceView(Pointer<COMObject> ptr) : super(ptr);
