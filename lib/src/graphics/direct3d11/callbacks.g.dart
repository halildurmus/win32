...
typedef PFN_D3D11_CREATE_DEVICE = Int32 Function(
  ...
  Pointer<Int32> param8,
  Pointer<Pointer<COMObject>> param9,
);
typedef PFN_D3D11_CREATE_DEVICE_AND_SWAP_CHAIN = Int32 Function(
  Pointer<COMObject> param0,
  Int32 param1,
  IntPtr param2,
  Uint32 param3,
  ...
  Uint32 FeatureLevels,
  Uint32 param6,
  Pointer<DXGI_SWAP_CHAIN_DESC> param7,
  Pointer<Pointer<COMObject>> param8,
  Pointer<Pointer<COMObject>> param9,
  Pointer<Int32> param10,
  Pointer<Pointer<COMObject>> param11,
);
