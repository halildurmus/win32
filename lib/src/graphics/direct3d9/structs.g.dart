...
class D3DAUTHENTICATEDCHANNEL_PROTECTION_FLAGS extends Struct {
  external _D3DAUTHENTICATEDCHANNEL_PROTECTION_FLAGS__Anonymous_e__Union
      Anonymous;
}

/// {@category Struct}
class _D3DAUTHENTICATEDCHANNEL_PROTECTION_FLAGS__Anonymous_e__Union
    extends Union {
  external _D3DAUTHENTICATEDCHANNEL_PROTECTION_FLAGS__Anonymous_e__Union__Anonymous_e__Struct
      Anonymous;
...
/// {@category Struct}
class _D3DAUTHENTICATEDCHANNEL_PROTECTION_FLAGS__Anonymous_e__Union__Anonymous_e__Struct
    extends Struct {
  @Uint32()
  external int bitfield;
}

extension D3DAUTHENTICATEDCHANNEL_PROTECTION_FLAGS__Anonymous_e__Union_Extension
    on D3DAUTHENTICATEDCHANNEL_PROTECTION_FLAGS {
  int get bitfield => this.Anonymous.Anonymous.bitfield;
  set bitfield(int value) => this.Anonymous.Anonymous.bitfield = value;
}

extension D3DAUTHENTICATEDCHANNEL_PROTECTION_FLAGS_Extension
    on D3DAUTHENTICATEDCHANNEL_PROTECTION_FLAGS {
  _D3DAUTHENTICATEDCHANNEL_PROTECTION_FLAGS__Anonymous_e__Union__Anonymous_e__Struct
