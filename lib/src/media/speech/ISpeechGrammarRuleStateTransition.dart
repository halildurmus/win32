// ISpeechGrammarRuleStateTransition.dart
...
/// @nodoc
const IID_ISpeechGrammarRuleStateTransition =
...
class ISpeechGrammarRuleStateTransition extends IDispatch {
  ...
  ISpeechGrammarRuleStateTransition(Pointer<COMObject> ptr) : super(ptr);
  ...
  Pointer<COMObject> get NextState {
    final retValuePtr = calloc<Pointer<COMObject>>();
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
            Pointer,
            Pointer<Pointer<COMObject>> NextState,
          )>>>()
          .value
          .asFunction<
              int Function(
