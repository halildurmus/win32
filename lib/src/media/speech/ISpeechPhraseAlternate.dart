...
class ISpeechPhraseAlternate extends IDispatch {
  ...
  ISpeechPhraseAlternate(Pointer<COMObject> ptr) : super(ptr);

  Pointer<COMObject> get RecoResult {
          ...
          .cast<
              Pointer<
                  NativeFunction<
                      Int32 Function(
            Pointer,
            Pointer<Pointer<COMObject>> RecoResult,
          )>>>()
          .value
          .asFunction<
              int Function(
  ...
  int get NumberOfElementsInResult {
    final retValuePtr = calloc<Int32>();
