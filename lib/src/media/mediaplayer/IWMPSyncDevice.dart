...
/// @nodoc
const IID_IWMPSyncDevice = '{82A2986C-0293-4FD0-B279-B21B86C058BE}';

/// {@category Interface}
/// {@category com}
class IWMPSyncDevice extends IUnknown {
  // vtable begins at 3, is 16 entries long.
  IWMPSyncDevice(Pointer<COMObject> ptr) : super(ptr);
  ...
  int deletePartnership() => ptr.ref.lpVtbl.value
          .elementAt(14)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int showSettings() => ptr.ref.lpVtbl.value
          .elementAt(17)
          .cast<
              Pointer<
                  NativeFunction<
