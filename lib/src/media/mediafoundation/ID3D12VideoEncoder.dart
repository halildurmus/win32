...
/// @nodoc
const IID_ID3D12VideoEncoder = '{2E0D212D-8DF9-44A6-A770-BB289B182737}';

/// {@category Interface}
/// {@category com}
class ID3D12VideoEncoder extends ID3D12Pageable {
  // vtable begins at 8, is 7 entries long.
  ID3D12VideoEncoder(Pointer<COMObject> ptr) : super(ptr);
  ...
  int GetEncoderFlags() => ptr.ref.lpVtbl.value
          .elementAt(9)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int GetInputFormat() => ptr.ref.lpVtbl.value
          .elementAt(13)
          .cast<
              Pointer<
                  NativeFunction<
  ...
  int GetMaxMotionEstimationPrecision() => ptr.ref.lpVtbl.value
          .elementAt(14)
          .cast<
              Pointer<
                  NativeFunction<
