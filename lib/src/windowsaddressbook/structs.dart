...
class _PV extends Struct {
  @Int16() external int i;
  @Int32() external int l;
  @Uint32() external int ul;
  @Float() external double flt;
  @Double() external double dbl;
  @Uint16() external int b;
  external CY cur;
  @Double() external double at;
...
class SPropValue extends Struct {
  ...
  @Uint32() external int dwAlignPad;
  external _PV Value;
}
...
class SRow extends Struct {
  @Uint32() external int ulAdrEntryPad;
  @Uint32() external int cValues;
...
class MAPIERROR extends Struct {
  ...
  @Uint32() external int ulLowLevelError;
  @Uint32() external int ulContext;
}

class ERROR_NOTIFICATION extends Struct {
  @Uint32() external int cbEntryID;
...
class NEWMAIL_NOTIFICATION extends Struct {
  @Uint32() external int cbEntryID;
  external Pointer<ENTRYID> lpEntryID;
  @Uint32() external int cbParentID;
  external Pointer<ENTRYID> lpParentID;
  @Uint32() external int ulFlags;
  external Pointer<Int8> lpszMessageClass;
  @Uint32() external int ulMessageFlags;
}

class OBJECT_NOTIFICATION extends Struct {
  @Uint32() external int cbEntryID;
  external Pointer<ENTRYID> lpEntryID;
  @Uint32() external int ulObjType;
  @Uint32() external int cbParentID;
  external Pointer<ENTRYID> lpParentID;
  @Uint32() external int cbOldID;
  external Pointer<ENTRYID> lpOldID;
  @Uint32() external int cbOldParentID;
...
class SContentRestriction extends Struct {
  @Uint32() external int ulFuzzyLevel;
  @Uint32() external int ulPropTag;
  external Pointer<SPropValue> lpProp;
}

class SBitMaskRestriction extends Struct {
  @Uint32() external int relBMR;
  @Uint32() external int ulPropTag;
  @Uint32() external int ulMask;
}
...
class SComparePropsRestriction extends Struct {
  @Uint32() external int relop;
  @Uint32() external int ulPropTag1;
  @Uint32() external int ulPropTag2;
}
...
class SSubRestriction extends Struct {
  @Uint32() external int ulSubObject;
  external Pointer<SRestriction> lpRes;
}
...
class ADRPARM extends Struct {
  @Uint32() external int cbABContEntryID;
  external Pointer<ENTRYID> lpABContEntryID;
  @Uint32() external int ulFlags;
  external Pointer lpReserved;
  @Uint32() external int ulHelpContext;
  ...
  @Uint32() external int cDestFields;
  @Uint32() external int nDestFieldFocus;
...
class DTBLLABEL extends Struct {
  @Uint32() external int ulbLpszLabelName;
  @Uint32() external int ulFlags;
}

class DTBLEDIT extends Struct {
  @Uint32() external int ulbLpszCharsAllowed;
  @Uint32() external int ulFlags;
  @Uint32() external int ulNumCharsAllowed;
  @Uint32() external int ulPropTag;
}

class DTBLLBX extends Struct {
  @Uint32() external int ulFlags;
  @Uint32() external int ulPRSetProperty;
  @Uint32() external int ulPRTableName;
}
...
class DTBLCOMBOBOX extends Struct {
  ...
  @Uint32() external int ulFlags;
  @Uint32() external int ulNumCharsAllowed;
  @Uint32() external int ulPRPropertyName;
  @Uint32() external int ulPRTableName;
}

class DTBLDDLBX extends Struct {
  @Uint32() external int ulFlags;
  @Uint32() external int ulPRDisplayProperty;
  @Uint32() external int ulPRSetProperty;
  @Uint32() external int ulPRTableName;
}

class DTBLCHECKBOX extends Struct {
  @Uint32() external int ulbLpszLabel;
  @Uint32() external int ulFlags;
  @Uint32() external int ulPRPropertyName;
}
...
class DTBLBUTTON extends Struct {
  @Uint32() external int ulbLpszLabel;
  @Uint32() external int ulFlags;
  @Uint32() external int ulPRControl;
}

class DTBLPAGE extends Struct {
  @Uint32() external int ulbLpszLabel;
  @Uint32() external int ulFlags;
  @Uint32() external int ulbLpszComponent;
  @Uint32() external int ulContext;
}
...
class DTBLRADIOBUTTON extends Struct {
  @Uint32() external int ulbLpszLabel;
  @Uint32() external int ulFlags;
  @Uint32() external int ulcButtons;
  @Uint32() external int ulPropTag;
  @Int32() external int lReturnValue;
}

class DTBLMVLISTBOX extends Struct {
  @Uint32() external int ulFlags;
  @Uint32() external int ulMVPropTag;
}
...
class WABEXTDISPLAY extends Struct {
  ...
  @Int32() external int fReadOnly;
  @Int32() external int fDataChanged;
  @Uint32() external int ulFlags;
