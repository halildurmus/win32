...
export 'src/winrt/foundation/iuriruntimeclass.dart';
export 'src/winrt/foundation/iuriruntimeclasswithabsolutecanonicaluri.dart';
export 'src/winrt/foundation/iwwwformurldecoderentry.dart';
export 'src/winrt/foundation/iwwwformurldecoderruntimeclass.dart';
export 'src/winrt/foundation/propertyvalue.dart';
export 'src/winrt/foundation/uri.dart';
export 'src/winrt/foundation/wwwformurldecoder.dart';
export 'src/winrt/foundation/wwwformurldecoderentry.dart';
