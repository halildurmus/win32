...
typedef SetBackgroundColor_Native = Int32 Function(
  Pointer obj,
  Uint32 color
);
typedef SetBackgroundColor_Dart = int Function(
  Pointer obj,
  int color
);
...
typedef SetPosition_Native = Int32 Function(
  Pointer obj,
  Int32 position
);
typedef SetPosition_Dart = int Function(
  Pointer obj,
  int position
);
...
typedef GetPosition_Dart = int Function(
  Pointer obj,
  Pointer<Int32> position
);
...
typedef SetSlideshow_Dart = int Function(
  Pointer obj,
  Pointer items
);
...
typedef GetSlideshow_Dart = int Function(
  Pointer obj,
  Pointer items
);
...
typedef GetStatus_Native = Int32 Function(
  Pointer obj,
  Pointer<Int32> state
);
typedef GetStatus_Dart = int Function(
  Pointer obj,
  Pointer<Int32> state
);

typedef Enable_Native = Int32 Function(
  Pointer obj,
  Int32 enable
);
typedef Enable_Dart = int Function(
  Pointer obj,
  int enable
);
...
class IDesktopWallpaper extends IUnknown {
  ...
  int GetMonitorDevicePathCount(Pointer<Uint32> count) =>
    Pointer<NativeFunction<GetMonitorDevicePathCount_Native>>.fromAddress(
            ...
            .asFunction<GetMonitorDevicePathCount_Dart>()(
         ptr.ref.lpVtbl, count);
  ...
  int SetBackgroundColor(int color) =>
    Pointer<NativeFunction<SetBackgroundColor_Native>>.fromAddress(
            ...
            .asFunction<SetBackgroundColor_Dart>()(
  ...
  int GetSlideshowOptions(Pointer<Int32> options, Pointer<Uint32> slideshowTick) =>
