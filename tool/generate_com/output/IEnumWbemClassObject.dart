...
typedef Reset_Native = Int32 Function(
  Pointer obj);
typedef Reset_Dart = int Function(
  Pointer obj);
...
typedef Clone_Dart = int Function(
  Pointer obj,
  Pointer ppEnum
);
...
typedef Skip_Dart = int Function(
  Pointer obj,
  int lTimeout, 
  int nCount
);
...
class IEnumWbemClassObject extends IUnknown {
  ...
  int Reset() =>
    Pointer<NativeFunction<Reset_Native>>.fromAddress(
                ptr.ref.vtable.elementAt(3).value)
            .asFunction<Reset_Dart>()(
         ptr.ref.lpVtbl);

  int Next(int lTimeout, int uCount, Pointer apObjects, Pointer<Uint32> puReturned) =>
