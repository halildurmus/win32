...
class NotepadResources {
  static int loadMenus() {
    final hMenu = CreateMenu().value;

    var hMenuPopup = CreateMenu().value;
  ...
  static int loadAccelerators() {
    ...
    final Win32Result(value: result, :error) = CreateAcceleratorTable(
      pTable,
      18,
    );
    if (result == NULL) {
      print('Error loading accelerators: ${error.toHRESULT()}');
    }
