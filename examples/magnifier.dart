...
const MAGFACTOR = 2.0;
final RESTOREDWINDOWSTYLES =
    WS_SIZEBOX | WS_SYSMENU | WS_CLIPCHILDREN | WS_CAPTION | WS_MAXIMIZEBOX;

const timerInterval = 16;
final windowClassName = w('MagnifierWindow');
final windowTitle = w('Screen Magnifier Sample');

// Global variables
int hwndMag = NULL;
int hwndHost = NULL;
final magWindowRect = loggingCalloc<RECT>();
final hostWindowRect = loggingCalloc<RECT>();
