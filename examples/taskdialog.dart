...
void showCustomTaskDialog() {
  using((arena) {
    ...
    config.ref
      ...
      ..pszWindowTitle = w('TaskDialogIndirect Sample').ptr
      ..pszMainInstruction = w('Which pill will you take?').ptr
      ..pszContent =
          w('This is your last chance. There is no turning back.').ptr
      ..hMainIcon = TD_WARNING_ICON.address
      ..pszExpandedInformation = w(matrixDescription).ptr
