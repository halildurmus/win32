...
void createShortcut(String path, String pathLink, String? description) {
  final shellLink = createInstance<IShellLink>(ShellLink)..setPath(w(path).ptr);
  if (description != null) {
    shellLink.setDescription(w(description).ptr);
  }
  shellLink.cast<IPersistFile>().save(w(pathLink).ptr, true);
}
