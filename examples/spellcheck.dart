...
void main(List<String> args) {
  ...
  if (!spellCheckerFactory.isSupported(languageTag.ptr)) {
    print("Spell checking is not supported for the 'en-US'.");
    return;
  }
  ...
  final errors = spellChecker2.comprehensiveCheck(w(input).ptr)!;
  ...
  while (errors.next(errorPtr) == S_OK) {
    ...
    switch (error.correctiveAction) {
      ...
      case CORRECTIVE_ACTION_GET_SUGGESTIONS:
        ...
        final suggestions = spellChecker2.suggest(w(word).ptr)!;
