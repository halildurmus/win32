...
int runCommand(String distributionName, String command) {
  ...
  try {
    ...
    final processHandle = WslLaunch(
      ...
      lpCommand.ptr,
      false,
      GetStdHandle(STD_INPUT_HANDLE).value, // redirect as appropriate
      GetStdHandle(STD_OUTPUT_HANDLE).value, // redirect as appropriate
      GetStdHandle(STD_ERROR_HANDLE).value, // redirect as appropriate
    );
