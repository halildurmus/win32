...
final pszTop = w(szTop);
final pszUnd = w(szUnd);
...
final className = w('Keyboard Hook WndClass');
final windowCaption = w('Keyboard message viewer');
  ...
  if (code == HC_ACTION) {
    ...
    if ((kbs.ref.flags & LLKHF_INJECTED) == 0) {
      ...
      input.ref.ki.dwFlags =
          wParam == WM_KEYDOWN ? const KEYBD_EVENT_FLAGS(0) : KEYEVENTF_KEYUP;
      ...
      input.ref.ki.wVk =
          kbs.ref.vkCode == VK_A ? VK_B : VIRTUAL_KEY(kbs.ref.vkCode);
